...
@author: KS13172
TestCase_ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667358&group_by=cases:section_id&group_id=512354&group_order=asc
...
class C6667358_TestClass(BaseTestCase):

    def test_C6667358(self):
        ...
        gaugelabels=['0', '0.3M', '0.6M', '0.9M', '1.2M', '1.5M', '0', '0.3M', '0.6M', '0.9M', '1.2M', '1.5M']
        ...
        """ 
        report_obj.run_fex_using_api_url(folder_name, fex_name, mrid=username, mrpass=password, no_of_element=15)
...
#         report_obj.create_acrossreport_data_set_in_preview("TableChart_1", 2, 2, 10, 2, Test_Case_ID+"Step11_Ds01.xlsx")
        ...
        """
        report_obj.edit_fex_using_api_url(folder_name = fex_folder_after_save, fex_name = new_fex_name, mrid=username, mrpass=password)
        report_obj.wait_for_visible_text(preview_title_css, "Top Ten Stores MODEL", long_wait)
