...
class C6667358_TestClass(BaseTestCase):
    ...
    def test_C6667358(self):
        ...
        no_of_rows="table[summary='Summary'] > tbody > tr"
        ...
        """ 
        report_obj.run_fex_using_api_url(folder_name, fex_name, mrid=username, mrpass=password, run_table_css=no_of_rows, no_of_element=15)
