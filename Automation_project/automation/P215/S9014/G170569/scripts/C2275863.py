...
@author: BM13368
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/2275863&group_by=cases:section_id&group_order=asc&group_id=170569
...
class C2275863_TestClass(BaseTestCase):

    def test_C2275863(self):
        ...
        query_field_list=['Chart (wf_retail_lite)', 'Categories', 'Grouping', 'Product,Category', 'Model', 'Metric', 'Size', 'Revenue', 'Color', 'AVE.Margin', 'Tooltip', 'Multi-graph', 'Animate'] 
        ...
        chart_obj.verify_legends_in_preview(preview_expected_legend_list, msg="Step 08:05: Verify legends in preview")
