...
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/2275860&group_by=cases:section_id&group_id=170569&group_order=asc
Testcase Name : Verify to Run and Edit 'Scatter Matrix - Profit vs Cogs' 
'''
import unittest
from common.wftools import chart
from common.lib.basetestcase import BaseTestCase

class C2275860_TestClass(BaseTestCase):

    def test_C2275860(self):
        ...
        EXPECTED_XAXIS_LABEL_LIST=['0', '1,000', '2,000', '3,000', '4,000', '5,000', '', '0', '1,000', '2,000', '3,000', '4,000', '5,000', '', '0', '1,000', '2,000', '3,000', '4,000', '5,000', '', '0', '1,000', '2,000', '3,000', '4,000', '5,000', '']
        EXPECTED_YAXIS_LABEL_LIST=['-400', '0', '400', '800', '1,200', '1,600', '2,000', '', '-400', '0', '400', '800', '1,200', '1,600', '2,000', '', '-400', '0', '400', '800', '1,200', '1,600', '2,000', '', '-400', '0', '400', '800', '1,200', '1,600', '2,000', '']
        ...
        PREVIEW_EXPECTED_XAXIS_LABEL_LIST=['0', '500', '1,000', '1,500', '2,000', '2,500', '3,000', '']
        PREVIEW_EXPECTED_YAXIS_LABEL_LIST=['-200', '0', '200', '400', '600', '']
        ...
        chart_obj.verify_legends_in_run_window(EXPECTED_LEGEND_LIST, parent_css="#"+RUN_PARENT_CSS, msg="Step 03:11:")  
        ...
        chart_obj.verify_legends_in_preview(PREVIEW_EXPECTED_LEGEND_LIST, parent_css="#"+PREVIEW_PARENT_CSS, msg="Step 08:12:")
        ...
        chart_obj.verify_legends_in_preview(PREVIEW_EXPECTED_LEGEND_LIST, parent_css="#"+PREVIEW_PARENT_CSS, msg="Step 12:12:")
