...
class C2275849_TestClass(BaseTestCase):

    def test_C2275849(self):
        ...
        """
        chart_obj.run_fex_using_api_url(folder_name, fex_name, mrid="mrid", mrpass="mrpass", run_chart_css="#jschart_HOLD_0.chart text.title", no_of_element=1)
        css="#jschart_HOLD_0.chart text.title"
        chart_title_text="Gross Profit Year to Year"
        time_out=30
        chart_obj.wait_for_visible_text(css, chart_title_text,time_out=time_out)
        ...
        gaugelabels=['0', '10M', '20M', '30M', '40M', '47.2M', '0', '10M', '20M', '30M', '40M', '47.2M']
        ...
        """
            ...
            Edit the Chart using "rsadv" with the below API URL
        ...
        visible_text="2015"
        time_out=60
        chart_obj.wait_for_visible_text(css, visible_text, time_out=time_out)
        ...
        labels=['0', '30', '60', '90', '120123']
        chart_obj.verify_data_labels('TableChart_1',labels,'Step 06:08: Verify labels',custom_css=".chartPanel g text[transform*='rotate']")
        chart_obj.verify_number_of_chart_segment('TableChart_1', 5, "Step 06:09: verify the Gauge", custom_css=".chartPanel path[class*='gaugeRange']")
        chart_obj.verify_number_of_chart_segment('TableChart_1', 1, "Step 06:10: verify the Gauge", custom_css=".chartPanel path[class*='needle']")
        ...
        chart_obj.wait_for_number_of_element(parent_css, 1, time_out=45)
        chart_obj.switch_to_frame()
        css="#jschart_HOLD_0 svg g .title"
        chart_title_text="Gross Profit Year to Year"
        time_out=30
        chart_obj.wait_for_visible_text(css, chart_title_text,time_out=time_out)
        
        expected_title="Gross Profit Year to Year"
        chart_obj.verify_chart_title(expected_title, 'run', "Step 07:00:Verify preview chart title")
        ...
        css="#TableChart_1 [class='groupLabel!g0!mgroupLabel!']"
        chart_obj.wait_for_visible_text(css, "2015", time_out=75)
