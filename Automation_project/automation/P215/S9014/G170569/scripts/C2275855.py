...
class C2275855_TestClass(BaseTestCase):

    def test_C2275855(self):
        ...
        """
            Step 07 : Verify the following Query Pane,Filter Pane and Live Preview
        """
        chart_obj.verify_all_fields_in_query_pane(query_field_list, "Step 07:01: Verify the Query panel in preview")
        chart_obj.verify_chart_color_using_get_css_property_in_preview(chart_color_css, "bar_blue", parent_css="#"+chart_parent_preview_css, attribute='stroke', msg='Step 07:02: Verify chart color in preview')
        chart_obj.verify_x_axis_label_in_preview(preview_chart_x_axis_label, parent_css="#"+chart_parent_preview_css, msg="Step 07:03: Verify xaxis label")
        chart_obj.verify_y_axis_label_in_preview(preview_chart_y_axis_label, parent_css="#"+chart_parent_preview_css, msg="Step 07:04: Verify yaxis label")
        chart_obj.verify_chart_color_using_get_css_property_in_preview(chart_color_css, "white", parent_css="#"+chart_parent_preview_css, msg="Step 07:05: Verify chart color")
        chart_obj.verify_number_of_chart_segment(chart_parent_preview_css, 1, "Step 07:05: Verify number of chart segments in preview", custom_css=riser_preview_css)
        ...
        chart_obj.verify_x_axis_title_in_preview(expected_x_axis_title_list, parent_css="#"+chart_parent_preview_css, msg="Step 07:07:Verify x-axis title in preview")
        chart_obj.verify_y_axis_title_in_preview(expected_y_axis_title_list, parent_css="#"+chart_parent_preview_css, msg="Step 07:08:Verify yaxis title in preview")
        chart_obj.verify_chart_title(expected_chart_title, 'preview',"Step 07:09:Verify preview chart title")
        chart_obj.verify_filter_pane_field(filter_field, 1, "Step 07:10: Verify filter pane field is available in filterbox")
        ...
        chart_obj.verify_chart_title(expected_chart_title, 'run', "Step 08:03:Verify chart title at runtime")
        chart_obj.verify_x_axis_title_in_run_window(expected_x_axis_title_list, msg="Step 08:04:Verify x_axis title at runtime")
        chart_obj.verify_y_axis_title_in_run_window(expected_y_axis_title_list, msg="Step 08:05:Verify y_axis title at runtime")
        chart_obj.verify_number_of_risers(parent_css_with_tag_name, 1, 7, msg="Step 08:06:Verify number of risers at runtime")
        chart_obj.verify_number_of_chart_segment(chart_parent_run_css, 91, "Step 08:07:Verify number of chart segments")
        chart_obj.verify_chart_color(chart_parent_run_css, 'riser!s0!g0!mline!', 'bar_blue', "Step 08:08:Verify chart color")
        chart_obj.verify_legends_in_run_window(expected_legends, msg="Step 08:09: Verify legends")

        """
            Step 09 : Click IA > Save> Select "SmokeTest" folder > Enter title as "Line Product Revenue By Month Sized by Discount1" > Click Save
        """
        ...
        chart_obj.verify_chart_color_using_get_css_property_in_preview(chart_color_css, "white", parent_css="#"+chart_parent_preview_css, msg="Step 11:04: Verify chart color")
        chart_obj.verify_number_of_chart_segment(chart_parent_preview_css, 1, "Step 11:05: Verify number of chart segments in preview", custom_css=riser_preview_css)
        ...
        chart_obj.verify_chart_title(expected_chart_title, 'preview',"Step 11:09:Verify preview chart title")
