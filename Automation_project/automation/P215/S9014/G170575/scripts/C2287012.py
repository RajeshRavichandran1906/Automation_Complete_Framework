...
@author: KS13172
TestCase_ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2287012
...
class C2287012_TestClass(BaseTestCase):

    def test_C2287012(self):
        
        driver = self.driver
        chart_obj = chart.Chart(driver)
        
        "-------------------------------------------------------------------Test Case Variables--------------------------------------------------------------------------"
        Test_Case_ID = 'C2287012'
        short_wait = 2
        medium_wait= 30
        long_wait= 60
        username= 'mradvid'
        ...
        preview_sizelegend_list= ['65,823.08']
        run_map_scale=['1000km', '600mi']
        riser_css= "riser!s1!g4!mmarker"
        preview_riser_css= "riser!s0!g0!mmarker"
        
        "----------------------------------------------------------------------------CSS--------------------------------------------------------------------------------"
        parent_run_css= 'jschart_HOLD_0'
        parent_preview_css= 'pfjTableChart_1'
