...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/8320683
Test Case Title =  Launch Designer workbook, save and restore
'''
...
#class C8320683_TestClass(BaseTestCase):
class C8320683_TestClass(BaseTestCaseDocker):

    def test_C8320683(self):
        ...
        """
        designer_chartobj.invoke_designer_chart_using_api('ibisamp/car', tool='workbook')
        ...
        designer_chartobj.verify_number_of_risers("[id*='chartpreview'] rect", 1, 25, msg="Step 01.03: Verify number of risers_in_preview")
        ...
        """
        STEP 5 : Edit the saved workbook:
        http://machine:port/{alias}/designer?item=IBFS:/WFC/Repository/Smoke/C8320683&startlocation=IBFS:/WFC/Repository/Smoke
        """
