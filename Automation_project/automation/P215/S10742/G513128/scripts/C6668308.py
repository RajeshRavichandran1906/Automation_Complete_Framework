...
@author: BM13368
TestCase ID : http://172.19.2.180/testrail/index.php?/cases/view/6668308&group_by=cases:section_id&group_order=asc&group_id=513128
...
class C6668308_TestClass(BaseTestCase):

    def test_C6668308(self):
        ...
        expected_x_axis_top_level_title=['Gender']
        ...
        expected_x_axis_title=['Sale Year/Quarter']
        expected_y_axis_title=['Gross Profit']
        expected_x_axis_title_in_preview=['Sale Year/Quarter', 'Sale Year/Quarter']
        ...
        """
            Verify the output
        """
        chart_obj.verify_x_axis_title_in_run_window(expected_x_axis_title, msg="Step 02:01:Verify x_axis title")
        chart_obj.verify_y_axis_title_in_run_window(expected_y_axis_title, msg="Step 02:02:Verify y axis title")
        chart_obj.verify_x_axis_label_in_run_window(expected_x_axis_labels, msg="Step 02:03:Verify x_axis labels")
        ...
        chart_obj.verify_x_axis_title_in_preview(expected_x_axis_title_in_preview, parent_css="#"+chart_parent_preview_css, msg="Step 05:02:Verify x-axis title")
        ...
        """ Verify the output: """
        chart_obj.verify_x_axis_title_in_run_window(expected_x_axis_title, msg="Step 06:01:Verify x_axis title")
        chart_obj.verify_y_axis_title_in_run_window(expected_y_axis_title, msg="Step 06:02:Verify y axis title")
        chart_obj.verify_x_axis_label_in_run_window(expected_x_axis_labels, msg="Step 06:03:Verify x_axis labels")
        chart_obj.verify_y_axis_label_in_run_window(expected_y_axis_labels, msg="Step 06:04:Verify x_axis labels")
        chart_obj.verify_x_axis_label_in_run_window(expected_x_axis_top_level_title, xyz_axis_label_css="[class='colHeader-label!']", msg="Step 06:05:Verify x-axis top level title at runtime")
        chart_obj.verify_x_axis_label_in_run_window(expected_x_axis_top_level_labels, xyz_axis_label_css="[class^='colLabel!']", msg="Step 06:06: Verify x-axis top level labels at runtime")
        chart_obj.verify_legends_in_run_window(expected_legend_list, msg="Step 06:07: Verify expected legend list")
        chart_obj.verify_chart_color_using_get_css_property_in_run_window(riser_css, "bar_blue", msg="Step 06:08: Verify area chart color")
        chart_obj.verify_number_of_chart_segment(chart_parent_run_css, 350, "Step 06:09: Verify chart segments in the area chart")
        chart_obj.verify_number_of_risers("#"+chart_parent_run_css+" path", 2, 7, msg="Step 06:10: Verify number of risers")
        ...
        chart_obj.verify_x_axis_title_in_preview(expected_x_axis_title_in_preview, parent_css="#"+chart_parent_preview_css, msg="Step 09:02:Verify x-axis title")
