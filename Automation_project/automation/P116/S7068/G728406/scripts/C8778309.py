...
Testcase Name : AHTML: Verify Filter operators against various DATETIME fields(Part 7)
'''
...
class C8778309_TestClass(BaseTestCase):

    def test_C8778309(self):
        ...
        '''Expect 985 rows - all Greater than 2011/03/30 10:23:24PM.''' 
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('985', '18'), page_summary_message.format('2.1','985','2011/03/30 10:23:24PM'))
        ...
        active_report_obj.filter_button_click(filter_button)
        '''Expect 10 rows - all Greater than 2002.'''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('10', '1'), page_summary_message.format('2.3','10','2002'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(filter_button)
        '''Expect 10 rows - all Greater than 12:13:14PM .''' 
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('10', '1'), page_summary_message.format('2.5','10','12:13:14PM'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(filter_button)
        '''Expect 20 rows - all Greater than 01/01/2013 00:00'''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('20', '1'), page_summary_message.format('2.7','20','01/01/2013 00:00'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(filter_button)
        '''Expect 15 rows - all Greater than 2013/04/04 00:00:00.000000 '''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('15', '1'), page_summary_message.format('2.9','15','2013/04/04 00:00:00.000000'))
        active_report_obj.close_filter_dialog()
        
        '''HYYMDn Datetime - 2013/01/01 00:00:00.000000000 '''
        active_report_obj.select_menu_items(table_id, "6", selection_type, type_value)
        active_report_obj.create_filter(popup_dialog_number, type_value, value1='2013/01/01 00:00:00.000000000')
        active_report_obj.filter_button_click(filter_button)
        '''Expect 20 rows - all Greater than 2013/01/01 00:00:00.000000000 '''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('20', '1'), page_summary_message.format('2.11','20','2013/01/01 00:00:00.000000000'))
        active_report_obj.close_filter_dialog()   
        ...
        active_report_obj.filter_button_click(filter_button)
        '''Expect 15 rows - all Greater than 2013/04/04 00'''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('15', '1'), page_summary_message.format('2.13','15','2013/04/04 00'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(filter_button)
        '''Expect 10 rows - all Greater than 14 Jul 13'''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('10', '1'), page_summary_message.format('2.15','10','14 Jul 13'))
        active_report_obj.close_filter_dialog()
