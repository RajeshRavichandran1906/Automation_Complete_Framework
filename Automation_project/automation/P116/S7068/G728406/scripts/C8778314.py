...
@author: AA14564
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/8778314
Testcase Name : AHTML: Verify Filter operators against various DATETIME fields(Part 12)
'''
...
class C8778314_TestClass(BaseTestCase):

    def test_C8778314(self):
        ...
        """
        Step 2: For the following DATETIME fields, select Filter, then Not Between and use the pairs of values:
                ...
                HYYMDH Datetime - 2013/01/01 00 & 2013/04/04 00
                HDMtY Datetime - 04 Apr 13 & 14 Jul 13
                Verify that the report contains only those rows that are Not Between the pair of values selected.
                ...
                Expect 990 rows - all Not Between 12:13:14PM & 10:23:24PM
                Expect 980 rows - all Not Between 04/04/2013 00:00 & 10/04/2013 00:00
                Expect 985 rows - all Not Between 2013/07/14 00:00:00.000000 & 2013/10/04 00:00:00.000000
                Expect 15 rows - all Not Between 2013/01/01 00:00:00.000000000 & 2013/04/04 00:00:00.000000000
                Expect 15 rows - all Not Between 2013/07/14 00 &  2013/10/04 00
                Expect 990 rows - all Not Between 04 Apr 13 & 14 Jul 13
        """
        ''' HYYMDSA - 2011/03/30 10:23:24PM & 2013/10/04 1:02:03AM '''
        ...
        ''' Expect 10 rows - all Not Between 2011/03/30 10:23:24PM & 2013/10/04 1:02:03AM ''' 
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('10', '1'), page_summary_message.format('2', '10', '2011/03/30 10:23:24PM & 2013/10/04 1:02:03AM'))
        ...
        active_report_obj.filter_button_click(selection_type)
        ''' Expect 990 rows - all Not Between 12:13:14PM & 10:23:24PM ''' 
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('990', '18'), page_summary_message.format('2.2', '990', '12:13:14PM & 10:23:24PM'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(selection_type)
        ''' Expect 980 rows - all Not Between 04/04/2013 00:00 & 10/04/2013 00:00 '''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('980', '18'), page_summary_message.format('2.3', '980', '04/04/2013 00:00 & 10/04/2013 00:00'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(selection_type)
        ''' Expect 985 rows - all Not Between 2013/07/14 00:00:00.000000 & 2013/10/04 00:00:00.000000 '''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('985', '18'), page_summary_message.format('2.4', '985', '2013/07/14 00:00:00.000000 & 2013/10/04 00:00:00.000000'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(selection_type)
        ''' Expect 15 rows - all Not Between 2013/01/01 00:00:00.000000000 & 2013/04/04 00:00:00.000000000 '''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('15', '1'), page_summary_message.format('2.5', '15', '2013/01/01 00:00:00.000000000 & 2013/04/04 00:00:00.000000000'))
        active_report_obj.close_filter_dialog()
        
        ''' HYYMDH Datetime - 2013/01/01 00 & 2013/04/04 00 '''
        active_report_obj.select_menu_items(table_id, "7", selection_type, type_value)
        active_report_obj.create_filter(popup_dialog_number, type_value, value1='2013/01/01 00', value2='2013/04/04 00')
        active_report_obj.filter_button_click(selection_type)
        ''' Expect 15 rows - all Not Between 2013/07/14 00 &  2013/10/04 00 '''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('15', '1'), page_summary_message.format('2.6', '15', '2013/01/01 00 & 2013/04/04 00'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(selection_type)
        ''' Expect 990 rows - all Not Between 04 Apr 13 & 14 Jul 13 '''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('990', '18'), page_summary_message.format('2.7', '990', '04 Apr 13 & 14 Jul 13'))
        active_report_obj.close_filter_dialog()
