...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050486
'''
import unittest
...
class C2050486_TestClass(BaseTestCase):

    def test_C2050486(self):
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2050486'
        """
...
#         driver.implicitly_wait(35) #Intializing common implicit wait for throughout the test
        ...
        miscelanousobj.verify_calculated_value('2', '5', "Total Avg 34476", True, 'Step 02: Verify Total Avg is applied for Unit Sales column and same is displayed under the column heading Verify the value: Total Avg 34,476')
