...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050468
'''
import unittest
import time
...
#         driver.implicitly_wait(50) #Intializing common implicit wait for throughout the test
        ...
        """Step 02: Select Unit Sales > Filter > Contains (match case)""" 
        
        miscelanousobj.select_menu_items("ITableData0", "4", "Filter","Contains")
        #Verify Filter selection pop up is opened.
        filterselectionobj.verify_filter_selection_dialog(True, 'Step 02: Verify Filter selection pop up is opened.',['Unit Sales', 'Contains'])
        ...
        """Step 04  : Enter '65' in the text field."""
        
        filterselectionobj.create_filter(1, 'Contains','large', value1='65')
        time.sleep(4)
        ...
        miscelanousobj.verify_page_summary('0','4of107records,Page1of1', _step06+'page summary')
        
        utillobj.verify_data_set('ITableData0','I0r','C2050468_Ds01.xlsx',_step06)
        #utillobj.create_data_set('ITableData0','I0r','C2050468_Ds01.xlsx')
