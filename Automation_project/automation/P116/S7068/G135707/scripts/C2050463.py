...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050463
'''
import unittest
import time
...
#         driver.implicitly_wait(50) #Intializing common implicit wait for throughout the test
        ...
        miscelanousobj.verify_menu_items('ITableData0',5,'Filter',option,step02)
        
        """Step 03: Select Filter > Greater then or equal to"""
        miscelanousobj.select_menu_items("ITableData0", "5", "Filter","Greater than or equal to")
        #Verify Filter selection pop up is opened.
        filterselectionobj.verify_filter_selection_dialog(True, 'Step 03: Select Filter > Greater then',['Dollar Sales', 'Greater than or equal to'])
        ...
        filterselectionobj.create_filter(1, 'Greater than or equal to','large', value1='608423')
        time.sleep(4)
        filterselectionobj.filter_button_click('Filter')
        time.sleep(4)
        
        
        """ Step 06: Verify that all 20 records returned have values greater than selected value.  """
        _step06 = 'Step 06:Verify that all 20 records returned have values greater than or equal to selected value.  '
        
        miscelanousobj.verify_page_summary('0','20of107records,Page1of1', _step06+'page summary')

        
        utillobj.verify_data_set('ITableData0','I0r','C2050463_Ds01.xlsx',_step06)
        
        #utillobj.create_data_set('ITableData0','I0r','C2050463_Ds01.xlsx')
