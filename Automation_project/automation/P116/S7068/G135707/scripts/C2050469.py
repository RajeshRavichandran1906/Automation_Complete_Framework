...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050469
'''
import unittest
import time
...
#         driver.implicitly_wait(50) #Intializing common implicit wait for throughout the test
        ...
        """Step 02:  Select State > Filter > Omits""" 
        
        miscelanousobj.select_menu_items("ITableData0", "3", "Filter","Omits")

    
        #Verify Filter selection pop up is opened.
        filterselectionobj.verify_filter_selection_dialog(True, 'Step 02: Verify Filter selection pop up is opened.',['State', 'Omits'])
        ...
        """Step 04  : Enter 'c' in the text field."""
        ...
        utillobj.verify_data_set('ITableData0','I0r','C2050469_Ds01.xlsx',_step06)
        #utillobj.create_data_set('ITableData0','I0r','C2050469_Ds01.xlsx')
