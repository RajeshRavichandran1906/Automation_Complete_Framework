...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050465
'''
import unittest
import time
...
#         driver.implicitly_wait(50) #Intializing common implicit wait for throughout the test
        ...
        """Step 03: Select Filter > Less Than or equal to"""
        miscelanousobj.select_menu_items("ITableData0", "5", "Filter","Less than or equal to")
        #Verify Filter selection pop up is opened.
        filterselectionobj.verify_filter_selection_dialog(True, 'Step 03: Verify Filter selection pop up is opened.',['Dollar Sales', 'Less than or equal to'])
...
#         filterselectionobj.verify_filter_values_menu_list(1, menu_list, 'Step 05 : Click dropdown next to <Value> (for State column)')
        """Step 06  : Select "606079" value in this test"""
        
        filterselectionobj.create_filter(1, 'Less than or equal to','large', value1='606079')
        time.sleep(4)
        ...
        _step06 = 'Step 06:Verify that all 87 records returned have values less than or equal to selected value.'
        
        miscelanousobj.verify_page_summary('0','87of107records,Page1of2', _step06+'page summary')
        
        utillobj.verify_data_set('ITableData0','I0r','C2050465_Ds01.xlsx',_step06)
        #utillobj.create_data_set('ITableData0','I0r','C2050465_Ds01.xlsx')
