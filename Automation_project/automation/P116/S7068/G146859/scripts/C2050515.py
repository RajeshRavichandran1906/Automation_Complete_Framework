...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050515
'''
...
class C2050515_TestClass(BaseTestCase):

    def test_C2050515(self):
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2050515'
        """
        ...
        """
            ...
            For column Date YYMD, select Rollup from the drop down option list.
            Select Order Number INTEGER as the Rollup column.
        """
        
        
        option='Group By (X)(COU)'
        miscelanousobj.verify_menu_items('ITableData0', 2, "Rollup",option,"Step 02: Expect to see Group by (X)(COU) which indicates a Count value will be produced.",all_items='no')
        
        miscelanousobj.select_menu_items('ITableData0', "2", "Rollup","Order Number INTEGER")
        
        """Expect to see two columns"""
        column=['Order Number INTEGER','Date YYMD']
        ...
        utillobj.verify_popup_data_set("wall1", "ITableData1", "C2050515_Ds01.xlsx","Step 02: Verify table")
        #utillobj.create_popup_data_set("wall1", "ITableData1", "C2050515_Ds01.xlsx")
        miscelanousobj.close_popup_dialog("1")
        
        """
            Step 03: Select ALPHA Store Code as the Rollup column..
        """
        miscelanousobj.select_menu_items('ITableData0', "2", "Rollup","ALPHA Store Code")
        
        """Expect to see two columns"""
        coulumn_alpha=['ALPHA Store Code','Date YYMD']
        ...
        """Expect to see two columns, 12 rows, one for each unique Store Code. The second column contains a Count of Date YYMD to the Store Code level. 
        First six rows should have values 90, 90, 89, 90, 90 & 90.."""
        
        
        utillobj.verify_popup_data_set("wall1", "ITableData2", "C2050515_Ds02.xlsx","Step 03: Verify table")
        #utillobj.create_popup_data_set("wall1", "ITableData2", "C2050515_Ds02.xlsx")
        miscelanousobj.close_popup_dialog("1")
        
        """
            Step 04: Select Date YYMD as the Rollup column.
        """
        miscelanousobj.select_menu_items('ITableData0', "2", "Rollup","Date YYMD")
        
        """Expect to see two columns"""
        column_yymd=['Date YYMD','Date YYMD']
        ...
        """Expect to see two columns, 6 rows, one for each unique YYMD date. The second column contains a Count of Date YYMD to the YYMD level.
         Values should 180, 180, 180, 180, 180 & 100. ."""
        utillobj.verify_popup_data_set("wall1", "ITableData3", "C2050515_Ds03.xlsx","Step 04: Verify table")
        #utillobj.create_popup_data_set("wall1", "ITableData3", "C2050515_Ds03.xlsx")
        miscelanousobj.close_popup_dialog("1")
        time.sleep(3)#conditional wait for make ready do the action
        """
            Step 05: Select Date MDYY as the Rollup column.
        """
        miscelanousobj.select_menu_items('ITableData0', "2", "Rollup","Date MDYY")
        
        """Expect to see two columns"""
        column_mdyy=['Date MDYY','Date YYMD']
        ...
        The second column contains a Count of Date YYMD to the MDYY level. Values same as YYMD."""
        utillobj.verify_popup_data_set("wall1", "ITableData4", "C2050515_Ds04.xlsx","Step 05: Verify table")
        
        #utillobj.create_popup_data_set("wall1", "ITableData4", "C2050515_Ds04.xlsx")
        ...
        """
        miscelanousobj.select_menu_items('ITableData0', "2", "Rollup","Date DMYY")
        
        """Expect to see two columns"""
        column_dmyy=['Date DMYY','Date YYMD']
        ...
        """Expect to see two columns, 6 rows, one for each unique MDYY date. 
        The second column contains a Count of Date YYMD to the DMYY level. Values same as YYMD.."""
        utillobj.verify_popup_data_set("wall1", "ITableData5", "C2050515_Ds05.xlsx","Step 06: Verify table")
        
        #utillobj.create_popup_data_set("wall1", "ITableData5", "C2050515_Ds05.xlsx")
        ...
        """
        miscelanousobj.select_menu_items('ITableData0', "2", "Rollup","D10.2 Unit Price")
        
        """Expect to see two columns"""
        columnd_unit_price=['D10.2 Unit Price','Date YYMD']
        ...
        """Expect to see two columns, 10 rows, one for each unique Unit Price value. The second column containing a Count of Date YYMD to the D10.2 Unit Price level. 
        The first 5 rows should have values 84, 99, 134, 148 & 84.."""
         
        utillobj.verify_popup_data_set("wall1", "ITableData6", "C2050515_Ds06.xlsx","Step 07: Verify table")
        #utillobj.create_popup_data_set("wall1", "ITableData6", "C2050515_Ds06.xlsx")
        miscelanousobj.close_popup_dialog("1")
        ...
        """
        miscelanousobj.select_menu_items('ITableData0', "2", "Rollup","P9.2M Unit Price")
        
        """Expect to see two columns"""
        column_p = ["P9.2M Unit Price",'Date YYMD']
        ...
        The second column containing a Count of Date YYMD to the P9.2M Unit Price level. 
        All rows will have a Count of one, except for $59.00, &74.00, $75.00 & $84.00. Page down to verify these."""
        utillobj.verify_popup_data_set("wall1", "ITableData7", "C2050515_Ds07.xlsx","Step 08: Verify table")
        
        #utillobj.create_popup_data_set("wall1", "ITableData7", "C2050515_Ds07.xlsx")
        ...
        """
        miscelanousobj.select_menu_items('ITableData0', "2", "Rollup","DATETIME HYYMDSA")
        
        """Expect to see two columns"""
        column_datetime=["DATETIME HYYMDSA",'Date YYMD']
        ...
        The second column contains a Count of Date YYMD to the DATETIME HYYMDSA level.
        Values should be 5, 5, 5, & 985."""
        utillobj.verify_popup_data_set("wall1", "ITableData8", "C2050515_Ds08.xlsx","Step 09: Verify table")
        #utillobj.create_popup_data_set("wall1", "ITableData8", "C2050515_Ds08.xlsx")
        miscelanousobj.close_popup_dialog("1")
        time.sleep(3)#conditional wait for make ready do the action
