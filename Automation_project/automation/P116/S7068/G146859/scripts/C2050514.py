...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050514
'''
...
class C2050514_TestClass(BaseTestCase):

    def test_C2050514(self):
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2050514'
        """
        ...
        """
            ...
            For column ALPHA Store Code, select Rollup from the drop down option list.
            Select ALPHA Store Code as the Rollup column.
        """
        
        
        option='Group By (X)(COU)'
        miscelanousobj.verify_menu_items('ITableData0', 1, "Rollup",option,"Step 02: Expect to see Group by (X)(COU) which indicates a Count value will be produced.",all_items='no')
        
        miscelanousobj.select_menu_items('ITableData0', "1", "Rollup","Order Number INTEGER")
        
        """Expect to see two columns"""
        column=['Order Number INTEGER','ALPHA Store Code']
        ...
        """Expect to see two columns, 1000 rows, because all values of INTEGER are unique. Each value has an ALPHA Store Count of 1."""
        
        utillobj.verify_popup_data_set("wall1", "ITableData1", "C2050514_Ds01.xlsx","Step 02: Verify table")
        #utillobj.create_popup_data_set("wall1", "ITableData1", "C2050514_Ds01.xlsx")
        miscelanousobj.close_popup_dialog("1")
        
        """
            Step 03: Select ALPHA Store Code as the Rollup column..
        """
        miscelanousobj.select_menu_items('ITableData0', "1", "Rollup","ALPHA Store Code")
        
        """Expect to see two columns"""
        coulumn_alpha=['ALPHA Store Code','ALPHA Store Code']
        ...
        """Expect to see two columns, 12 rows, one for each unique ALPHA Store Code. 
        The second column contains a Count of ALPHA Store Codes to the Store Code level. First six rows should have values 90, 90, 89, 90, 90 & 90."""
        
        
        utillobj.verify_popup_data_set("wall1", "ITableData2", "C2050514_Ds02.xlsx","Step 03: Verify table")
        #utillobj.create_popup_data_set("wall1", "ITableData2", "C2050514_Ds02.xlsx")
        miscelanousobj.close_popup_dialog("1")
        
        """
            Step 04: Select Date YYMD as the Rollup column.
        """
        miscelanousobj.select_menu_items('ITableData0', "1", "Rollup","Date YYMD")
        
        """Expect to see two columns"""
        column_yymd=['Date YYMD','ALPHA Store Code']
        ...
        """The second column contains a Count of ALPHA Store Code to the YYMD level. Values should 180, 180, 180, 180, 180 & 100."""
        utillobj.verify_popup_data_set("wall1", "ITableData3", "C2050514_Ds03.xlsx","Step 04: Verify table")
        #utillobj.create_popup_data_set("wall1", "ITableData3", "C2050514_Ds03.xlsx")
        miscelanousobj.close_popup_dialog("1")
        time.sleep(3)#conditional wait for make ready do the action
        """
            Step 05: Select Date MDYY as the Rollup column.
        """
        miscelanousobj.select_menu_items('ITableData0', "1", "Rollup","Date MDYY")
        
        """Expect to see two columns"""
        column_mdyy=['Date MDYY','ALPHA Store Code']
        ...
        utillobj.verify_popup_data_set("wall1", "ITableData4", "C2050514_Ds04.xlsx","Step 05: Verify table")
        
        #utillobj.create_popup_data_set("wall1", "ITableData4", "C2050514_Ds04.xlsx")
        ...
        """
        miscelanousobj.select_menu_items('ITableData0', "1", "Rollup","Date DMYY")
        
        """Expect to see two columns"""
        column_dmyy=['Date DMYY','ALPHA Store Code']
        ...
        utillobj.verify_popup_data_set("wall1", "ITableData5", "C2050514_Ds05.xlsx","Step 06: Verify table")
        
        #utillobj.create_popup_data_set("wall1", "ITableData5", "C2050514_Ds05.xlsx")
        ...
        """
        miscelanousobj.select_menu_items('ITableData0', "1", "Rollup","D10.2 Unit Price")
        
        """Expect to see two columns"""
        columnd_unit_price=['D10.2 Unit Price','ALPHA Store Code']
        ...
        utillobj.verify_popup_data_set("wall1", "ITableData6", "C2050514_Ds06.xlsx","Step 07: Verify table")
        #utillobj.create_popup_data_set("wall1", "ITableData6", "C2050514_Ds06.xlsx")
        miscelanousobj.close_popup_dialog("1")
        ...
        """
        miscelanousobj.select_menu_items('ITableData0', "1", "Rollup","P9.2M Unit Price")
        
        """Expect to see two columns"""
        column_p = ["P9.2M Unit Price",'ALPHA Store Code']
        ...
        utillobj.verify_popup_data_set("wall1", "ITableData7", "C2050514_Ds07.xlsx","Step 08: Verify table")
        
        #utillobj.create_popup_data_set("wall1", "ITableData7", "C2050514_Ds07.xlsx")
        ...
        """
        miscelanousobj.select_menu_items('ITableData0', "1", "Rollup","DATETIME HYYMDSA")
        
        """Expect to see two columns"""
        column_datetime=["DATETIME HYYMDSA","ALPHA Store Code"]
        ...
        utillobj.verify_popup_data_set("wall1", "ITableData8", "C2050514_Ds08.xlsx","Step 09: Verify table")
        #utillobj.create_popup_data_set("wall1", "ITableData8", "C2050514_Ds08.xlsx")
        miscelanousobj.close_popup_dialog("1")
        time.sleep(3)#conditional wait for make ready do the action
