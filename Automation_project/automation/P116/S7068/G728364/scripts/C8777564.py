...
@author: BM13368
Testcase ID : http://172.19.2.180/testrail/index.php?/tests/view/21601200&group_by=cases:section_id&group_order=asc&group_id=728364
Testcase Name : AHTML: Verify Filter operators against various DATE fields(Part 11)
'''
...
class C8777564_TestClass(BaseTestCase):

    def test_C8777564(self):
        ...
        """
        Step 2: For the following DATE fields, select Filter, then Between the pair of values:
        ...
        Verify that the report contains only those rows that are Between the pair of selected values.
        """
        ...
        active_report_obj.verify_page_summary(0, '360of1000records,Page1of7', "Step 2:01: Expect 360 rows - between 19960201 and 19960301")
        ...
        active_report_obj.filter_button_click('Filter')
        active_report_obj.verify_page_summary(0, '540of1000records,Page1of10', "Step 2:02: Expect 540 rows - between MARCH 1, 1996 & MAY 1, 1996")
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click('Filter')
        active_report_obj.verify_page_summary(0, '720of1000records,Page1of13', "Step 2:03: Expect 183 rows - values 0.13D+02 & 0.17D+02")
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click('Filter')
        active_report_obj.verify_page_summary(0, '460of1000records,Page1of9', "Step 2:04: Expect 460 rows - between 96/092 & 96/153")
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click('Filter')
        active_report_obj.verify_page_summary(0, '1000of1000records,Page1of18', "Step 2:05: Expect 1000 rows - between Q1 1996 & Q2 1996")
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click('Filter')
        active_report_obj.verify_page_summary(0, '360of1000records,Page1of7', "Step 2:06: Expect 360 rows - between Monday, Apr 1 1996 & Wednesday, May 1 1996")
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click('Filter')
        active_report_obj.verify_page_summary(0, '280of1000records,Page1of5', "Step 2:07: Expect 280 rows - between May & June")
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click('Filter')
        active_report_obj.verify_page_summary(0, '540of1000records,Page1of10', "Step 2:08: Expect 540 rows - between Wednesday & Friday")
        active_report_obj.close_filter_dialog()
