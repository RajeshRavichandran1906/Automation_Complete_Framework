...
@author: AA14564
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/8777561
Testcase Name : AHTML: Verify Filter operators against various DATE fields(Part 8)
'''
...
class C8777561_TestClass(BaseTestCase):

    def test_C8777561(self):
        ...
        page_summary_message = "Step {0}: Expect {1} rows - equal to {2} or later"
        ...
        """
        Step 2: For the following DATE fields, select Filter, then Greater than or equal to and use these values:
        ...
        active_report_obj.filter_button_click(selection_type)
        '''Expect 640 rows - equal to MARCH 1, 1996 or later'''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('640', '12'), page_summary_message.format('2.1', '640', 'MARCH 1, 1996'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(selection_type)
        '''Expect 1000 rows - equal to 1996/001 or later''' 
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('1000', '18'), page_summary_message.format('2.2', '1000', '1996/001'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(selection_type)
        '''Expect 460 rows - equal to 96/092 or later'''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('460', '9'), page_summary_message.format('2.3', '460', '96/092'))
        active_report_obj.close_filter_dialog()
        ...
        active_report_obj.filter_button_click(selection_type)
        '''Expect 1000 rows - equal to Q1 1996 or later'''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('1000', '18'), page_summary_message.format('2.4', '1000', 'Q1 1996'))
        active_report_obj.close_filter_dialog()
        
        '''wrMtrYY Order Date - Monday, Apr 1 1996'''
        active_report_obj.select_menu_items(table_id, "6", selection_type, type_value)
        active_report_obj.create_filter(popup_dialog_number, type_value,value1='Monday, April 1 1996')
        active_report_obj.filter_button_click(selection_type)
        '''Expect 460 rows - equal to Monday, Apr 1 1996 or later'''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('460', '9'), page_summary_message.format('2.5', '460', 'Monday, April 1 1996'))
        active_report_obj.close_filter_dialog()
        
        '''Mtr Order Date - May'''
        active_report_obj.select_menu_items(table_id, "7", selection_type, type_value)
        active_report_obj.create_filter(popup_dialog_number, type_value,value1='May')
        active_report_obj.filter_button_click(selection_type)
        '''Expect 280 rows - equal to May or later'''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('280', '5'), page_summary_message.format('2.6', '280', 'May'))
        active_report_obj.close_filter_dialog()
        
        ''' Wtr Order Date - Wednesday'''
        active_report_obj.select_menu_items(table_id, "8", selection_type, type_value)
        active_report_obj.create_filter(popup_dialog_number, type_value,value1='Wednesday')
        active_report_obj.filter_button_click(selection_type)
        '''Expect 640 rows - equal to Wednesday or later'''
        active_report_obj.verify_page_summary(page_summary_number, expected_page_summary.format('640', '12'), page_summary_message.format('2.7', '640', 'Wednesday'))
        active_report_obj.close_filter_dialog()
