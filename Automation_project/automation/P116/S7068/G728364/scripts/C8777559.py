...
@author: AA14564
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/8777559
Testcase Name : AHTML: Verify Filter operators against various DATE fields(Part 6)
'''
...
class C8777559_TestClass(BaseTestCase):

    def test_C8777559(self):
        ...
        row_color_type = 'rgb'
        data_set_message = "Step {0}: Expect all rows not equal to {1} to be Highlighted, page down to verify."
        ...
        Step 2: For the following DATE fields, select Filter, then Not equal and use these values:
                ...
                Expect all rows not equal to 19960201 to be Highlighted, page down to verify.
                Expect all rows not equal to MARCH 1, 1996 to be Highlighted, page down to verify.
                Expect all rows not equal to 1996/001 to be Highlighted, page down to verify.
                Expect all rows not equal to 96/092 to be Highlighted, page down to verify.
                Expect all rows not equal to Q1 1996 to be Highlighted, page down to verify.
                Expect all rows not equal to Wednesday, May 1 1996 to be Highlighted, page down to verify.
                Expect all rows not equal to June to be Highlighted, page down to verify.
                Expect all rows not equal to Monday to be Highlighted, page down to verify.
        """
        '''YYMD Order Date - 19960201'''
