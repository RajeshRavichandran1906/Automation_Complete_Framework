...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2358883
...
class C2358883_TestClass(BaseTestCase):

    def test_C2358883(self):
        
        """   
            TESTCASE VARIABLES 
        """
        Test_Case_ID='C2358883'
        ...
        visul_result.wait_for_property("#IbfsOpenFileDialog7_btnOK div", 1, 25, string_value='Open')
        
        """
            Step 02 : Select "SMLOGO1" from the image list
        """
        utillobj.ibfs_save_as('smplogo1')
        visul_result.wait_for_property("#PageItemImage_1 img[src*='config']", 1, 8)
        ...
        visul_result.wait_for_property("#pfjTableChart_2 rect[class='riser!s0!g0!mbar!']", 1, 30)
