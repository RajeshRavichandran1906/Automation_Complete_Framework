...
@author: Varun
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6986664
Testcase Name : Verify Curved Line Chart with Markers via Advance chart tool bar.
'''
import unittest
...
class C6986664_TestClass(BaseTestCase):

    def test_C6986664(self):
        """
        Testcase objects
        """
        ...
        active_chart_obj.select_advance_chart('wall1', 'curvedplusmarkers', 0)
        active_chart_obj.wait_for_number_of_element(circle_marker_css, 3, base_obj.chart_medium_timesleep)
        active_chart_obj.verify_x_axis_label_in_run_window(expected_run_xval_list, parent_css='#MAINTABLE_wbody0', msg="Step 8.1: x-label verification for the curved marker")
        active_chart_obj.verify_y_axis_label_in_run_window(expected_run_yval_list_stacked, parent_css='#MAINTABLE_wbody0', msg="Step 8.2: y-label verification for curved marker")
        chart_obj.verify_number_of_markers('#MAINTABLE_wbody0', 1, 20, 'Step 8.3: Verify Number of markers in the run window')
        active_chart_obj.verify_chart_color_using_get_css_property_in_run_window("[class^='marker!s0!']", "bar_blue", parent_css="#MAINTABLE_wbody0", attribute='stroke', msg='Step 8.4: Blue marker verification')
        active_chart_obj.verify_chart_color_using_get_css_property_in_run_window("[class^='marker!s1!']", "pale_green", parent_css="#MAINTABLE_wbody0", attribute='stroke', msg='Step 8.5: Pale green marker verification')
        active_chart_obj.verify_x_axis_title_in_run_window(['Product'], parent_css='#MAINTABLE_wbody0', msg="Step 8.6: y-label verification curved marker")
