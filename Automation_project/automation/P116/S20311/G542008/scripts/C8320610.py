...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/8320610
Test Case Title =  AHTML:Converting chart into Pyramid chart
'''
...
class C8320610_TestClass(BaseTestCase):

    def test_C8320610(self):
        ...
        """
        Step 06 : From the Format tab, select Other option and select Pyramid Chart from Special tab and Click Ok
        """
        ...
        """
        STEP 07.1 : Verify the Pyramid Chart is displayed properly
        """
