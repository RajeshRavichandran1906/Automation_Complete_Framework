...
@author: Varun
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6984779
...
class C6984779_TestClass(BaseTestCase):

    def test_C6984779(self):
        """
        ...
        expected_run_yval_list_stacked=['0', '3M', '6M', '9M', '12M', '15M']
        ...
        active_chart_obj.select_advance_chart('wall1', 'stackedarea', 0)
        ...
        active_chart_obj.verify_y_axis_label_in_run_window(expected_run_yval_list_stacked, parent_css='#MAINTABLE_wbody0', msg="Step 8.2: y-label verification for the area")
