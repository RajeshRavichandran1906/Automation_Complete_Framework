...
@author: Varun
Testcase ID : lnxtestrail.ibi.com/testrail/index.php?/cases/view/6984778
Testcase Name : Verify Area chart via Advance chart tool bar.
'''
import unittest
...
class C6984778_TestClass(BaseTestCase):

    def test_C6984778(self):
        """
        ...
        Step 8: Select Area Chart and click OK.
        Expect to see the bar chart converted into an Area Chart.
        """
        ...
        active_chart_obj.select_advance_chart('wall1', 'area', 0)
        active_chart_obj.wait_for_number_of_element("path[class*='g0!marea!r0']", 6, short_time)
        active_chart_obj.verify_x_axis_label_in_run_window(expected_run_xval_list, parent_css='#MAINTABLE_wbody0', msg="Step 7.1: x-label verification for the area")
        active_chart_obj.verify_y_axis_label_in_run_window(expected_run_yval_list, parent_css='#MAINTABLE_wbody0', msg="Step 7.2: y-label verification for the area")
        active_chart_obj.verify_number_of_risers_in_run_window('path', 1, 6, parent_css="#MAINTABLE_wbody0", msg="Step 7.3: Riser verification in run window")
        active_chart_obj.verify_chart_color_using_get_css_property_in_run_window("[class='riser!s0!g0!marea!r0!c0!']", "bar_blue", parent_css="#MAINTABLE_wbody0", attribute='fill', msg='Step 7.4, First top area Colour verification')
        active_chart_obj.verify_chart_color_using_get_css_property_in_run_window("[class='riser!s1!g0!marea!r0!c1!']", "pale_green", parent_css="#MAINTABLE_wbody0", attribute='fill', msg='Step 7.5, first bottom area Colour verification')
        active_chart_obj.verify_x_axis_title_in_run_window(['Product'], parent_css='#MAINTABLE_wbody0', msg="Step 7.6: y-label verification for the area")
        ...
        active_chart_obj.logout_chart_using_api()
