...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6984777
Test Case Title =  Verify Step Line chart via Advance chart tool bar.
'''
...
class C6984777_TestClass(BaseTestCase):

    def test_C6984777(self):
        ...
        """
        STEP 08 : Select Step Line chart and click OK.
        """
        active_chart.select_advance_chart('wall1', 'stepline', 0)
        active_chart.wait_for_number_of_element("#MAINTABLE_wbody0_f path[class*='line']", 6, MEDIUM_WAIT_TIME)
        
        """
        STEP 08.01 : Expect to see the bar chart converted into a Step Line Chart.
        """
