...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2251667
'''
import unittest
import time
...
class C2251667_TestClass(BaseTestCase):

    def test_C2251667(self):
        
        """ TESTCASE VARIABLES """
        Test_Case_ID = 'C2251667'
        driver = self.driver
        ...
        """    4. Add Unit Sales to Field and change 'Condition' as 'Less than or equal to', select 'OK' .    """
        source_dict={'select_field':'Unit Sales', 'select_condition':'Less than or equal to'}
        ...
        #utillobj.create_data_set('ITableData0', 'I0r', 'C2251667_Ds01.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', 'C2251667_Ds01.xlsx', 'Step 05c(1): Verify data.')
        ...
        """Choose 190081 value from drop-down and notice that report is filtered according to selection.
        Report should be filtered according to the given condition -'Not equal to'"""
        utillobj.select_dropdown('#combobox_dsPROMPT_1', 'value', '190081')
        utillobj.synchronize_with_number_of_element("#ITableData0 #TCOL_0_C_0 span", 1, 45)
        miscobj.verify_page_summary(0, '3of10records,Page1of1', 'Step 05a(2): Verify the Report Heading')
        column_list=['Category', 'Product', 'Unit Sales']
        miscobj.verify_column_heading('ITableData0', column_list, 'Step 05b(2): Verify the column heading')
        #utillobj.create_data_set('ITableData0', 'I0r', 'C2251667_Ds02.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', 'C2251667_Ds02.xlsx', 'Step 05c(2): Verify data.')
        utillobj.verify_dropdown_value("#combobox_dsPROMPT_1",expected_default_selected_value='190081', default_selection_msg="Step 05d(2): Verify the first check box is '190081' and selected")
