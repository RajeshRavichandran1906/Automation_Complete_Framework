...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2251665
'''
...
class C2251665_TestClass(BaseTestCase):

    def test_C2251665(self):
        """ TESTCASE VARIABLES """
        Test_Case_ID = 'C2251665'
        ...
        """    4. Add Unit Sales to Field and change 'Condition' as 'Not equal to', select 'OK' .    """
        source_dict={'select_field':'Unit Sales', 'select_condition':'Not equal to'}
        ...
        #utillobj.create_data_set('ITableData0', 'I0r', 'C2251665_Ds01.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', 'C2251665_Ds01.xlsx', 'Step 05c(1): Verify data.')
        ...
        utillobj.synchronize_with_number_of_element("#ITableData0 #TCOL_0_C_0 span", 1, 45)
        miscobj.verify_page_summary(0, '9of10records,Page1of1', 'Step 05a(2): Verify the Report Heading')
        column_list=['Category', 'Product', 'Unit Sales']
        miscobj.verify_column_heading('ITableData0', column_list, 'Step 05b(2): Verify the column heading')
        #utillobj.create_data_set('ITableData0', 'I0r', 'C2251665_Ds02.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', 'C2251665_Ds02.xlsx', 'Step 05c(2): Verify data.')
