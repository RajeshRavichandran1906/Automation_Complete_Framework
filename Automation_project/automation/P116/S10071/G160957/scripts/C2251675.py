...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2251675
TestCase Name = Verify that Slider Controls using Between Filtering work in a Document.
'''
...
class C2251675_TestClass(BaseTestCase):

    def test_C2251675(self):
        
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2251675'
        ...
        """    1. Execute slider1.fex which displays a Compound Document.    """
            
        utillobj.active_run_fex_api_login('slider1.fex', 'S10071_3', 'mrid', 'mrpass')
        ...
        utillobj.asequal(slider_count,6, 'Step 1. Verify 6 slider objects visible')
        
        slider_text=['CAR', 'H slider for Dealer_Cost', 'V slider for Retail_Cost', 'H slider for not between for Dealer_Cost', 'V slider for Retail_Cost Not Between']
        ...
        time.sleep(4)
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "up",911, 0, 0.1)
        time.sleep(4)
      
        miscelanousobj.verify_page_summary(0, '18of18records,Page1of1', 'Step 2.2a: Verify the Report Heading for report 1')
        miscelanousobj.verify_page_summary(1, '7of18records,Page1of1', 'Step 2.2a: Verify the Report Heading for report 2')
        ...
        miscelanousobj.verify_page_summary(1, '1of18records,Page1of1', 'Step 3.2a: Verify the Report Heading for report 2')
        ...
        time.sleep(3)
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "pagedown",3, 1, 1)
        time.sleep(6)
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "down",1500, 1, 0)
        time.sleep(6)
        
        miscelanousobj.verify_page_summary(0, '18of18records,Page1of1', 'Step 4.2a: Verify the Report Heading for report 1')
        miscelanousobj.verify_page_summary(1, '14of18records,Page1of1', 'Step 4.2a: Verify the Report Heading for report 2')
        ...
        """    5.3. Expect to see the original report appear after the button had been reset.    """
        """    5.4. Expect the right-side report to be unchanged.    """
        miscelanousobj.verify_page_summary(0, '18of18records,Page1of1', 'Step 5.4a: Verify the Report Heading for report 1')
        miscelanousobj.verify_page_summary(1, '18of18records,Page1of1', 'Step 5.4a: Verify the Report Heading for report 2')
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds01.xlsx', 'Step 5.3c: Verify data report 1.')
        
        utillobj.verify_data_set('ITableData1', 'I1r', Test_Case_ID+'_Ds02.xlsx', 'Step 5.4c: Verify data report 2.')
        ...
        time.sleep(3)
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "down",1400, 2, 0.1)
        time.sleep(3)
        ...
        time.sleep(2)
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "pagedown",4, 3, 1)
        time.sleep(6)
        miscelanousobj.verify_page_summary(0, '10of18records,Page1of1', 'Step 8.2a: Verify the Report Heading for report 1')
