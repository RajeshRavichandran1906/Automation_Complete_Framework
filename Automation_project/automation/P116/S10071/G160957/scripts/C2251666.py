...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2251666
'''
import unittest
import time
...
class C2251666_TestClass(BaseTestCase):

    def test_C2251666(self):
        """ TESTCASE VARIABLES """
        Test_Case_ID = 'C2251666'
        driver = self.driver
        ...
        """    4. Add Unit Sales to Field and change 'Condition' as 'Less than', select 'OK' .    """
        source_dict={'select_field':'Unit Sales', 'select_condition':'Less than'}
        ...
        #utillobj.create_data_set('ITableData0', 'I0r', 'C2251666_Ds01.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', 'C2251666_Ds01.xlsx', 'Step 05c(1): Verify data.')
        ...
        """Choose 360570 value from drop-down and notice that report is filtered according to selection.
        Report should be filtered according to the given condition -'Not equal to'"""
        utillobj.select_dropdown('#combobox_dsPROMPT_1', 'value', '360570')
        utillobj.synchronize_with_number_of_element("#ITableData0 #TCOL_0_C_0 span", 1, 45)
        ...
        #utillobj.create_data_set('ITableData0', 'I0r', 'C2251666_Ds02.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', 'C2251666_Ds02.xlsx', 'Step 05c(2): Verify data.')
        utillobj.verify_dropdown_value("#combobox_dsPROMPT_1",expected_default_selected_value='360570', default_selection_msg="Step 05d(2): Verify the first check box is '360570' and selected")
