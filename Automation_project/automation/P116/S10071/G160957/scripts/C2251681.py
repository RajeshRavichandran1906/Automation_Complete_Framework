...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2251681
TestCase Name = Verify that Slider Controls using a single Button(GE & LE) work in a Document.
'''
...
class C2251681_TestClass(BaseTestCase):

    def test_C2251681(self):
        
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2251681'
        ...
        utillobj.active_run_fex_api_login('slider_GE_LE.fex', 'S10071_3', 'mrid', 'mrpass')
...
#         utillobj.create_data_set('ITableData1', 'I1r', Test_Case_ID+'_Ds02.xlsx')
        ...
        slider_text=['CAR', 'H slider for Dealer_Cost Greater Than or Equal', 'V slider for Dealer_Cost Less Than or Equal', 'H slider for Retail_Cost Greater Than or Equal', 'V slider for Retail_Cost Less Than or Equal']
        ...
        time.sleep(4)
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "up",1000, 2, 0)
        time.sleep(4)
      
        
        miscelanousobj.verify_page_summary(0, '5of18records,Page1of1', 'Step 2.2a: Verify the Report Heading for report 1')
...
#         utillobj.create_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds03.xlsx')
        ...
        """
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "pageup",7, 2, 1)
        time.sleep(6)
        
        miscelanousobj.verify_page_summary(0, '1of18records,Page1of1', 'Step 3.2a: Verify the Report Heading for report 1')
...
#         utillobj.create_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds04.xlsx')
        ...
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "pageup",2, 3, 1)
        time.sleep(6)
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "up",650, 3, 0)
        time.sleep(6)
        
        miscelanousobj.verify_page_summary(0, '16of18records,Page1of1', 'Step 5.2a: Verify the Report Heading for report 1')
...
#         utillobj.create_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds06.xlsx')
        ...
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "pageup",7, 3, 1)
        time.sleep(3)
        ...
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "pagedown",7, 3, 1)
        time.sleep(6)
        
        miscelanousobj.verify_page_summary(0, '1of18records,Page1of1', 'Step 7.2a: Verify the Report Heading for report 1')
...
#         utillobj.create_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds07.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds07.xlsx', 'Step 7.1: Verify data report1.')
        ...
        time.sleep(2)
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "up",400, 0, 0)
        time.sleep(6)
        miscelanousobj.verify_page_summary(0, '1of18records,Page1of1', 'Step 8.2a: Verify the Report Heading for report 1')
        miscelanousobj.verify_page_summary(1, '7of18records,Page1of1', 'Step 8.2a: Verify the Report Heading for report 2')
        
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds07.xlsx', 'Step 8.1: Verify data report1.')
#         utillobj.create_data_set('ITableData1', 'I1r', Test_Case_ID+'_Ds08.xlsx')
        utillobj.verify_data_set('ITableData1', 'I1r', Test_Case_ID+'_Ds08.xlsx', 'Step 8.2: Verify data report 2.')
        ...
        miscelanousobj.verify_page_summary(0, '1of18records,Page1of1', 'Step 9.2a: Verify the Report Heading for report 1')
        miscelanousobj.verify_page_summary(1, '1of18records,Page1of1', 'Step 9.2a: Verify the Report Heading for report 2')
        
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds07.xlsx', 'Step 9.1: Verify data report1.')
#         utillobj.create_data_set('ITableData1', 'I1r', Test_Case_ID+'_Ds09.xlsx')
        ...
        miscelanousobj.verify_page_summary(0, '1of18records,Page1of1', 'Step 10.2a: Verify the Report Heading for report 1')
        miscelanousobj.verify_page_summary(1, '18of18records,Page1of1', 'Step 10.2a: Verify the Report Heading for report 2')
        
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds07.xlsx', 'Step 10.1: Verify data report1.')
#         utillobj.create_data_set('ITableData1', 'I1r', Test_Case_ID+'_Ds10.xlsx')
        ...
        time.sleep(6)
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "down",1378, 1, 0)
        time.sleep(6)
        miscelanousobj.verify_page_summary(0, '1of18records,Page1of1', 'Step 11.2a: Verify the Report Heading for report 1')
        miscelanousobj.verify_page_summary(1, '14of18records,Page1of1', 'Step 11.2a: Verify the Report Heading for report 2')
        
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds07.xlsx', 'Step 11.1: Verify data report1.')
#         utillobj.create_data_set('ITableData1', 'I1r', Test_Case_ID+'_Ds11.xlsx')
        ...
        """
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "pageup",7, 1, 1)
        time.sleep(6)
       
        miscelanousobj.verify_page_summary(0, '1of18records,Page1of1', 'Step 12.2a: Verify the Report Heading for report 1')
        miscelanousobj.verify_page_summary(1, '18of18records,Page1of1', 'Step 12.2a: Verify the Report Heading for report 2')
        
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds07.xlsx', 'Step 12.1: Verify data report1.')
#         utillobj.create_data_set('ITableData1', 'I1r', Test_Case_ID+'_Ds12.xlsx')
        ...
        """
        utillobj.drag_slider_using_pageup_or_pagedown("#orgdiv0", "[class^='ui-slider-handle']", "pagedown",7, 1, 1)
        time.sleep(6)
       
        miscelanousobj.verify_page_summary(0, '1of18records,Page1of1', 'Step 13.2a: Verify the Report Heading for report 1')
        miscelanousobj.verify_page_summary(1, '1of18records,Page1of1', 'Step 13.2a: Verify the Report Heading for report 2')
        
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds07.xlsx', 'Step 13.1: Verify data report1.')
