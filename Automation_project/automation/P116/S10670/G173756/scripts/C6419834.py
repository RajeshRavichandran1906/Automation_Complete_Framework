...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6419834
...
class C6419834_TestClass(BaseTestCase):

    def test_C6419834(self):
        ...
        y_axis_label_preview=['0', '20', '40', '60', '80', '100', '120']
        ...
        active_chartobj.verify_y_axis_label_in_preview(['0', '10', '20', '30', '40', '50'], msg='Step 01.04')
        ...
        Vertical Dual-Axis Stacked Line Graph and
        Click OK.
        """
        chart_obj.select_ia_ribbon_item('Format', 'Other')
        time.sleep(2)
        active_chartobj.select_other_chart_type('line','vertical_dual_axis_stacked_line',5)
