...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6419837
Test Case Title =  Verify Funnel Chart in others tab under Format menu.
'''
...
class C6419837_TestClass(BaseTestCase):

    def test_C6419837(self):
        ...
        From the Special charts, select Funnel Chart.
        Click OK.
        """
        ...
        """
        STEP 05.1 : Expect to see the Clustered bar chart converted into the Preview pane for Funnel Chart.
        """
        ...
        """
        STEP 06.1 : Expect to see the following Funnel Chart.
        """
