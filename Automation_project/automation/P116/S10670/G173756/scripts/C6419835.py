...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6419835
Test Case Title =  Horizontal Dual-Axis Absolute Line Graph 
'''
...
class C6419835_TestClass(BaseTestCase):

    def test_C6419835(self):
        ...
        Horizontal Dual-Axis Absolute Line Graph and
        Click OK.   
        """
        chart_obj.select_ia_ribbon_item('Format', 'Other')
        active_chart.select_other_chart_type('line', 'horizontal_dual_axis_absolute_line', 10)
        ...
        """
        Expect to see the following Horizontal Dual Axis Absolute Line Graph Preview panel. 
        """
        ...
        """
        STEP 05 : Click the Run button to generate the Horizontal Dual Axis Absolute Line Graph.
        """
        ...
        """
        STEP 05.1 : Expect top see the following Horizontal Dual Axis Absolute Line Graph.
        ...
        active_chart.verify_y_axis_label_in_run_window(['0', '3M', '6M', '9M', '12M'], msg='Step 05.3')
