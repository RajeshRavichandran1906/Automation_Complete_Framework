...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2313690
TestCase Name = AHTML: Vertical Dual-Axis Absolute Line Chart Filter/Exclude tests.
'''
import unittest
import time
...
class C2313690_TestClass(BaseTestCase):

    def test_C2313690(self):
        
        Test_Case_ID="C2313690"
        """
            TESTCASE VARIABLES
        """     
        ...
        """
        Step 03:Hover over the point on the lower line for Alfa Romeo.
...
#         resobj.select_default_tooltip_menu("MAINTABLE_wbody0","marker!s0!g0!mmarker!", 'Exclude from Chart')
#         css="#MAINTABLE_wbody0 .chartPanel"
#         move=driver.find_element_by_css_selector(css)
#         utillobj.click_on_screen(move, 'bottom_left')
#         time.sleep(5)
#         tooltip_css="#MAINTABLE_wbody0 span[id*='tdgchart-tooltip'][style*='visible'] [onclick^='ibiChart']:nth-child(3)"
#         visobj.select_tooltip_with_limited_search("#MAINTABLE_wbody0", "marker!s0!g0!mmarker!", tooltip_css, 'Exclude from Chart', element_location='left', javascript_marker_enable=True, mouse_duration=3.5)
        time.sleep(5)
        ...
        """
        Step 04:Hover over the point on the upper line for BMW.Select Exclude from Chart.
        Expect to see the following Line Chart, with Alfa Romeo & BMW removed.
        """
        miscelaneousobj.select_or_verify_marker_tooltip('marker!s1!g1!mmarker!', select_tooltip='Exclude from Chart', msg='Step 4.1 : seleted marker tooltip')
#         css="#MAINTABLE_wbody0 .chartPanel"
#         move=driver.find_element_by_css_selector(css)
#         utillobj.click_on_screen(move, 'start')
#         time.sleep(5)
#         tooltip_css="#MAINTABLE_wbody0 span[id*='tdgchart-tooltip'][style*='visible'] [onclick^='ibiChart']:nth-child(3)"
#         visobj.select_tooltip_with_limited_search("#MAINTABLE_wbody0", "marker!s1!g1!mmarker!", tooltip_css, 'Exclude from Chart', element_location='start', javascript_marker_enable=True, mouse_duration=3.5)
        time.sleep(5)
        ...
        """
        Step 05:Hover over the point on the lower line for Audi.Select Remove Filter.
        Expect to see the original Line Chart with 
        Alfa Romeo and BMW restored.
        """
...
#         visobj.select_tooltip_with_limited_search("#MAINTABLE_wbody0", "marker!s0!g0!mmarker!", tooltip_css, 'Remove Filter', element_location='bottom_left', javascript_marker_enable=True, mouse_duration=3.5)
        time.sleep(5)
        ...
        """
        Step 06:Left-click and draw a box around the 4 points for Alfa Romeo and Audi.
        Select Exclude from Chart.
        Expect to see the following Line chart with both Alfa Romeo and Audi lines removed.
        """
        elem1=driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class='marker!s1!g0!mmarker!']")
        source_elem=utillobj.enable_marker_using_javascript(elem1)
        elem2=driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class='marker!s0!g1!mmarker!']")
        target_elem=utillobj.enable_marker_using_javascript(elem2)  
        time.sleep(3)
        utillobj.drag_drop_on_screen(sx_offset=source_elem['x']-20,sy_offset=source_elem['y']-20,tx_offset=target_elem['x']+10,ty_offset=target_elem['y']+10)
        ...
        """
        Step 07:Hover over the point on the lower line for BMW.
        Select Remove Filter.
        Expect to see the original Line Chart with Alfa Romeo and Audi restored.
        """
        miscelaneousobj.select_or_verify_marker_tooltip('marker!s0!g0!mmarker!', select_tooltip='Remove Filter', msg='Step 7.1 : seleted marker tooltip')
#         css="#MAINTABLE_wbody0 .chartPanel"
#         move=driver.find_element_by_css_selector(css)
#         utillobj.click_on_screen(move, 'start')
#         time.sleep(5)
#         tooltip_css="#MAINTABLE_wbody0 span[id*='tdgchart-tooltip'][style*='visible'] [onclick^='ibiChart']:nth-child(4)"
#         visobj.select_tooltip_with_limited_search("#MAINTABLE_wbody0", "marker!s0!g0!mmarker!", tooltip_css, 'Remove Filter', element_location='start', javascript_marker_enable=True, mouse_duration=3.5)
        time.sleep(5)
        ...
        """
        Step 08:Left-click and draw a box around the 6 points for 
        Peugeot, Toyota & Triumph.Select Filter Chart.
        ...
        target_elem=utillobj.enable_marker_using_javascript(elem2)  
        time.sleep(6)
        utillobj.drag_drop_on_screen(sx_offset=source_elem['x']-25,sy_offset=source_elem['y']+16,tx_offset=target_elem['x']+15,ty_offset=target_elem['y']-20)
        ...
        """
        Step 09:Hover over the point on the lower line for Triumph.
        Click Exclude from Chart.
        Expect to see the following Line Chart with lines for only Peugeot and Toyota.
        """
...
#         css="#MAINTABLE_wbody0 .chartPanel"
#         move=driver.find_element_by_css_selector(css)
#         utillobj.click_on_screen(move, 'right')
#         time.sleep(5)
#         tooltip_css="#MAINTABLE_wbody0 span[id*='tdgchart-tooltip'][style*='visible'] [onclick^='ibiChart']:nth-child(3)"
#         visobj.select_tooltip_with_limited_search("#MAINTABLE_wbody0", "marker!s1!g2!mmarker!", tooltip_css, 'Exclude from Chart', element_location='right', javascript_marker_enable=True, mouse_duration=3.5)
        time.sleep(5)
        ...
        """
        Step 10:Hover over the point on the upper line for Toyota.
        Select Remove Filter.
        Expect to see the original Dual Axis Absolute Line Chart with all lines restored.
        """
        miscelaneousobj.select_or_verify_marker_tooltip('marker!s1!g1!mmarker!', select_tooltip='Remove Filter', msg='Step 10.1 : seleted marker tooltip')
#         css="#MAINTABLE_wbody0 .chartPanel"
#         move=driver.find_element_by_css_selector(css)
#         utillobj.click_on_screen(move, 'top_right')
#         time.sleep(5)
#         tooltip_css="#MAINTABLE_wbody0 span[id*='tdgchart-tooltip'][style*='visible'] [onclick^='ibiChart']:nth-child(4)"
#         visobj.select_tooltip_with_limited_search("#MAINTABLE_wbody0", "marker!s1!g1!mmarker!", tooltip_css, 'Remove Filter', element_location='top_right', javascript_marker_enable=True, mouse_duration=3.5)
#         time.sleep(5)
