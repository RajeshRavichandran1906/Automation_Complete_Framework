...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2313699 
TestCase Name = AHTML: Vertical Dual-Axis Stacked Line Chart Active Control icon functionality.
'''
import unittest
import time
...
class C2313699_TestClass(BaseTestCase):

    def test_C2313699(self):
        
        Test_Case_ID="C2313699"
        """
            TESTCASE VARIABLES
        """     
...
#         driver.implicitly_wait(15) #Intializing common implicit wait for throughout the test
        ...
        """
            Step 02:Click the Run button. Expect to see the following Vertical Dual-Axis Stacked Line Chart.
        """
        ...
        """
            Step 04:Select the Bar Chart option.
                    Click OK.
            Expect to see the Vertical Dual-axis Stacked Line Chart converted into a Horizontal Dual-axis Bar chart.Currently a Horizontal Clustered Bar Chart is shown.
        """
        ...
        """
            ...
            Expect to see the Horizontal Dual-axis Stacked Bar chart converted back into the original Vertical Dual-axis Stacked Line chart.
        """
        ...
        Step 07:Select the Stacked Depth option.
                    Click OK.
            Expect to see the Vertical Dual-axis Line chart converted into a Stacked Depth Bar chart.Verify the presence of both axis.
        """
        ...
        """
            Step 08:Hover over the bottom left bar for Alfa Romeo.
                    ...
                    Hover over the top right bar for Alfa Romeo.
                    Expect to see the following Tooltip information for Height for Alfa Romeo.
        """
        time.sleep(2)
        utillobj.switch_to_frame(pause=2)
        time.sleep(5)
        ...
        """
        Step 09: Using the second icon at the top,
                click Advanced Chart. 
                
                Scroll down and select the Curved Line Chart option.Click OK.
                Expect to see the Stacked Depth Bar chart converted into a Curved Line Chart, with Dual axis.
        """
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 1)
        time.sleep(3)
        ...
        """
            Step 10:Hover over the point on the top line for Alfa Romeo.
                    Expect to see the following Tooltip information for Dealer_Cost for Alfa Romeo.

                     Hover over the point on the line for BMW.
                    Expect to see the following Tooltip information for Weight for BMW.
        """
        expected_tooltip_list=['CAR:  ALFA ROMEO', 'DEALER_COST:  16,235', 'Filter Chart', 'Exclude from Chart']
        ia_resultobj.verify_marker_tooltip('MAINTABLE_wbody0', 'marker!s0!g0!mmarker!', expected_tooltip_list, 'Step 10.1: Verify tooltip')
        time.sleep(5)
        expected_tooltip_list=['CAR:  BMW', 'WEIGHT:  11,300', 'Filter Chart', 'Exclude from Chart']
        ia_resultobj.verify_marker_tooltip('MAINTABLE_wbody0', 'marker!s1!g2!mmarker!', expected_tooltip_list, 'Step 10.2: Verify tooltip')

        """
            Step 11:Using the second icon at the top,click Advanced Chart. 
                    Scroll down and select the Donut with Depth option.
                    Click OK.
    
            Expect to see the Vertical Dual-axis bar chart converted into four PIE charts, one for Dealer_Cost, Weight, Length & Height. Dual axis does not apply to PIE charts.
        """
        time.sleep(8)
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 1)
        parent_css="#wall1"
        ...
        """
            Step 12:Click the third icon at the top.
                    ...
                    Expect to see the original Vertical Dual-Axis Clustered Line Chart.
        """
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 2)
        time.sleep(3)
        expected_xval_list=['ALFA ROMEO', 'AUDI', 'BMW', 'DATSUN','JAGUAR','JENSEN','MASERATI','PEUGEOT','TOYOTA','TRIUMPH']
        ...
        """
            Step 13:Using the first icon at the top of the chart, select More Options, then select Export/Excel.
                ...
                Expect to see the following Excel sheet appear with a summary report and a Vertical Stacked Line chart.
