...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/5852498
TestCase Name = AHTML: Restore Vertical Dual-Axis Stacked Line Chart via API.
'''
import unittest
...
class C5852498_TestClass(BaseTestCase):

    def test_C5852498(self):
        ...
        fex_name='Vertical_Dual_Axis_Stacked_Line'
        ...
        IBFS%253A%252FWFC%252FRepository%252FP116_S10670%252FG168276%252F&BIP_item=Vertical_Dual_Axis_Stacked_Line.fex
        """
        ...
        """
        Step:3 Verify the Vertical_Dual_Axis_Stacked_Line Chart is generated.
        """
        ...
        active_chartobj.verify_number_of_risers_in_run_window('path',1,4,msg="Step 03.07 Verify Number of risers")
        active_chartobj.verify_chart_color_using_get_css_property_in_run_window("path[class='riser!s0!g0!mline!']", 'bar_blue',parent_css='#MAINTABLE_wbody0',attribute='stroke',msg="Step 03.08")
        active_chartobj.verify_chart_color_using_get_css_property_in_run_window("path[class='riser!s1!g0!mline!']", 'pale_green',parent_css='#MAINTABLE_wbody0',attribute='stroke',msg="Step 03.09")
        active_chartobj.verify_chart_color_using_get_css_property_in_run_window("path[class='riser!s3!g0!mline!']", 'pale_yellow',parent_css='#MAINTABLE_wbody0',attribute='stroke',msg="Step 03.10")
        active_chartobj.verify_chart_color_using_get_css_property_in_run_window("path[class='riser!s2!g0!mline!']", 'dark_green',parent_css='#MAINTABLE_wbody0',attribute='stroke',msg="Step 03.11")
