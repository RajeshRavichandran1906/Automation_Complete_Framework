...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2313687
TestCase Name = AHTML: Vertical Dual-Axis Stacked Line Chart procedure creation.
'''
...
class C2313687_TestClass(BaseTestCase):

    def test_C2313687(self):
        
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID="C2313687"
        time_out=15
        ...
        """
        Step 03: Select the Vertical Dual-Axis Stacked Line chart option.
        Click OK..
        ...
        Hover over the point of the lowest line for Alfa Romeo.
        Hover over the point of the top line for Alfa Romeo..
        """
        ...
        """
        Height uses the left-side and has a value of 158.
        """
        time.sleep(5)
        parent_obj = driver.find_element_by_css_selector("#MAINTABLE_wbody0")
        utillobj.click_on_screen(parent_obj,'left')
        ...
        miscelaneousobj.select_or_verify_marker_tooltip(marker_class='marker!s3!g0!mmarker!',verify_tooltip_list=expected_tooltip_list, msg='Step 05.2 : Verify tooltip')
        ...
        """
        Step 06: Hover over the point of the lowest line for Triumph.
        Hover over the point of the top line for Triumph.
        Expect to see the following Tooltip information.
        Dealer_Cost uses the left-side axis scale and has a value of 4,292.
        """
        time.sleep(5)
        parent_obj = driver.find_element_by_css_selector("#MAINTABLE_wbody0")
        utillobj.click_on_screen(parent_obj,'bottom_right')
        time.sleep(5)
        ...
        The total is 4341 and maps to the right-side scale.
        """
        time.sleep(5)
        parent_obj = driver.find_element_by_css_selector("#MAINTABLE_wbody0")
        utillobj.click_on_screen(parent_obj,'right')
        time.sleep(5)
        ...
        """
        Step 07 : Save the procedure as Vertical_Dual_Axis_Stacked_Line and exit IA+.
        """
        time.sleep(2)
