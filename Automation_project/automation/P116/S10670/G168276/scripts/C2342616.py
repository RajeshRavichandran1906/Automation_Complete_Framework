...
@author: BM13368
TestName : Horizontal Dual-Axis Absolute Line Graph
TestCase_ID : http://172.19.2.180/testrail/index.php?/cases/view/2342616&group_by=cases:section_id&group_id=168276&group_order=asc
'''
...
class C2342616_TestClass(BaseTestCase):

    def test_C2342616(self):
        ...
        """
            Expect to see the following Chart Preview, including areas Horizontal Axis 1 Measure & Horizontal Axis 2 Measure.
        """
        ...
        """
            ...
            Expect top see the following Horizontal Dual Axis Absolute Line Graph.
