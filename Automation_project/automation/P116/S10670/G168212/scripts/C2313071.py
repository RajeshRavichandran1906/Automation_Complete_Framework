...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2313071
TestCase Name = AHTML: Mekko chart basic procedure creation.
'''
...
class C2313071_TestClass(BaseTestCase):

    def test_C2313071(self):
        
        Test_Case_ID="C2313071"
        """
            TESTCASE VARIABLES
        """     
        ...
        utillobj.synchronize_with_visble_text(parent_css, visble_element_text='CAR', expire_time=15)
        
        metadataobj.datatree_field_click('DEALER_COST', 2, 0)
        parent_css="#queryTreeWindow table tr:nth-child(4) td"
        utillobj.synchronize_with_visble_text(parent_css, visble_element_text='DEALER_COST', expire_time=15)
        
        metadataobj.datatree_field_click('RETAIL_COST', 2, 0)
        parent_css="#queryTreeWindow table tr:nth-child(5) td"
        utillobj.synchronize_with_visble_text(parent_css, visble_element_text='RETAIL_COST', expire_time=15)
        ...
        utillobj.synchronize_with_visble_text("#MAINTABLE_wbody0 text[class^='xaxis'][class$='title']", "CAR", 45)
        ...
        resobj.verify_number_of_riser("MAINTABLE_wbody0", 1, 20, 'Step 04.3: Verify the total number of risers displayed on run')
        utillobj.verify_chart_color('MAINTABLE_wbody0', 'riser!s0!g2!mbar!', 'bar_blue1', 'Step 04.4: Verify Color')       
        ...
        time.sleep(2)
        """
            Step 05:Save & close the IA procedure as MekkoBasic.
            Expect to see the Mekko_Basic Fex in the tree.
        """
