...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2313575
TestCase Name = AHTML: Vertical Dual-Axis Clustered Bar Chart Active Control icon functionality.
'''
import unittest
import time
...
class C2313575_TestClass(BaseTestCase):

    def test_C2313575(self):
        
        """
            TESTCASE VARIABLES
        """ 
        Test_Case_ID="C2313575"
        ...
        """
            Step 09:Using the second icon at the top,
                    click Advanced Chart. 
                    Scroll down and select the Line Chart option.Click OK.
            
            Expect to see the Vertical Dual-axis bar chart converted into a Line Chart, with Dual axis.
        """
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 1)
        time.sleep(3)
        ...
        menu_bar_css=utillobj.validate_and_get_webdriver_object(".arChartMenuBar", "menu_bar_css")
        core_utility_obj.move_to_element(menu_bar_css)
        expected_tooltip_list=['CAR:ALFA ROMEO', 'LENGTH:510', 'Filter Chart', 'Exclude from Chart']
        ...
        """
            Step 11:Using the second icon at the top,click Advanced Chart. 
                Scroll down and select the PIE option.Click OK.
        ...
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0', 20, "Step 11.08: Verify number of pie", custom_css=".chartPanel path[class*='riser!s']")
        ...
        if browser=='IE' :
            ...
            time.sleep(4)
            utillobj.verify_excel_sheet(Test_Case_ID+'_DS13_.xlsx', Test_Case_ID+'_DS13_.xlsx', 'Sheet1', 'Step 13.01: Expect to see the Excel spreadsheet')
        else :
