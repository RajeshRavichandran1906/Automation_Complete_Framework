...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2313606
TestCase Name =  AHTML: Vertical Dual-Axis Stacked Bar Chart Active Control icon functionality.
'''
...
class C2313606_TestClass(BaseTestCase):

    def test_C2313606(self):
        
        """
            TESTCASE VARIABLES
        """ 
        Test_Case_ID="C2313606"
        ...
        utillobj.infoassist_api_edit("Vertical_Stacked_Bar", 'chart', 'P116/S10670', mrid='mrid', mrpass='mrpass')
        ...
        utillobj.verify_chart_color("TableChart_1", "riser!s0!g2!mbar!", "bar_blue", "Step 01.3: Verify  riser color")
        utillobj.verify_chart_color("TableChart_1", "riser!s2!g2!ay2!mbar!", "dark_green", "Step 01.4: Verify  riser color")
        utillobj.verify_chart_color("TableChart_1", "riser!s3!g2!ay2!mbar!", "pale_yellow", "Step 01.5: Verify  riser color")
        utillobj.verify_chart_color("TableChart_1", "riser!s1!g2!mbar!", "pale_green", "Step 01.6: Verify  riser color")
        ...
        """
            Step 02:Click the Run button.Expect to see the following Vertical Dual-Axis Clustered Bar Chart.
        ...
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g2!mbar!", "bar_blue", "Step 02.5: Verify  riser color")
        legend=["DEALER_COST","WEIGHT","LENGTH","HEIGHT"]
        resobj.verify_riser_legends("MAINTABLE_wbody0", legend, "Step 02.6: Verify legend")
        ...
        """
            ...
            Expect to see the Vertical Dual-axis bar chart converted into a Horizontal Dual-axis bar chart.
        """
        ...
        """
            ...
            Expect to see the Horizontal Dual-axis bar chart converted back into the original Horizontal Dual-axis bar chart.
        """
        ...
        resobj.verify_number_of_riser("MAINTABLE_wbody0", 1, 40, 'Step 05.4: Verify the total number of risers displayed on preview')
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g2!mbar!", "bar_blue", "Step 04.5: Verify  riser color")
        legend=["DEALER_COST","WEIGHT","LENGTH","HEIGHT"]
        resobj.verify_riser_legends("MAINTABLE_wbody0", legend, "Step 05.6: Verify legend")
        ...
        """
            Step 07:Select the Stacked Depth option.Click OK.
            Expect to see the Vertical Dual-axis bar chart converted into a Column Depth bar chart.
        ...
        resobj.verify_default_tooltip_values("MAINTABLE_wbody0", "riser!s1!g0!mbar!", expected_tooltip_list, "Step 08.2: Verify bar value",x_offset=-10)
          
        """
            Step 09:Using the second icon at the top,click Advanced Chart. 
                Scroll down and select the Straight Line Chart option.Click OK.
                Expect to see the Vertical Dual-axis bar chart converted into a Straight Line Chart, with Dual axis.
        """
         
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 1)
        time.sleep(3)
        rollupobj.select_advance_chart('wall1', 'strightline')
        time.sleep(3)
        expected_xval_list=['ALFA ROMEO', 'AUDI', 'BMW', 'DATSUN','JAGUAR','JENSEN','MASERATI','PEUGEOT','TOYOTA','TRIUMPH']
        expected_yval1_list=['0', '10K', '20K', '30K', '40K', '50K','60K']
        ...
        expected_tooltip_list=['CAR:ALFA ROMEO', 'DEALER_COST:16,235', 'Filter Chart', 'Exclude from Chart']
        miscelaneous_obj.select_or_verify_marker_tooltip(marker_class='marker!s0!g0!mmarker!',verify_tooltip_list=expected_tooltip_list, msg='Step 10.1 : Verify tooltip')
        time.sleep(5)
        expected_tooltip_list=['CAR:ALFA ROMEO', 'LENGTH:510', 'Filter Chart', 'Exclude from Chart']
        miscelaneous_obj.select_or_verify_marker_tooltip(marker_class='marker!s2!g0!mmarker!',verify_tooltip_list=expected_tooltip_list, msg='Step 10.2 : Verify tooltip')

         
        """
            Step 11:Using the second icon at the top,click Advanced Chart. 
            Scroll down and select the Donut option.Click OK.
            Expect to see the Vertical Dual-axis bar chart converted into four PIE charts, one for Dealer_Cost, Weight, Length & Height. 
        ...
        resobj.verify_data_labels('MAINTABLE_wbody0', ['144K', '45,791', '3,248', '965.1'], "Step 11.9: verify total lable ", custom_css=".chartPanel g text[class*='totalLabel']")
        resobj.verify_data_labels('MAINTABLE_wbody0', ["DEALER_COST","WEIGHT","LENGTH","HEIGHT"], "Step 11.9: verify total lable ", custom_css=".chartPanel g text[class*='pieLabel']")
         
        """
            Step 12:Click the third icon at the top.Expect to see the following Vertical Dual-Axis Clustered Bar Chart.
        """
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 2)
        time.sleep(3)
        expected_xval_list=['ALFA ROMEO', 'AUDI', 'BMW', 'DATSUN','JAGUAR','JENSEN','MASERATI','PEUGEOT','TOYOTA','TRIUMPH']
        ...
        resobj.verify_number_of_riser("MAINTABLE_wbody0", 1, 40, 'Step 12.4: Verify the total number of risers displayed on preview')
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g2!mbar!", "bar_blue", "Step 12.5: Verify  riser color")
        legend=["DEALER_COST","WEIGHT","LENGTH","HEIGHT"]
        resobj.verify_riser_legends("MAINTABLE_wbody0", legend, "Step 12:6: Verify legend")
        ...
        """
            Step 13:Using the first icon at the top of the chart, select More Options, then select Export/Excel.
                ...
                Expect to see the following Excel sheet appear with a summary report and a Vertical Stacked Bar chart.Currently the Excel file contains a Horizontal Bar chart.
