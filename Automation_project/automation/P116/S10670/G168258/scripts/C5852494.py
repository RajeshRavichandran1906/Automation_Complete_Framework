...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/5852494
TestCase Name =AHTML: Restore Horizontal Dual-Axis Clustered Bar Chart via API.
'''
import unittest
...
class C5852494_TestClass(BaseTestCase):

    def test_C5852494(self):
        ...
        fex_name='Horizontal_Dual_Axis_Clustered_Bars'
        ...
        IBFS%253A%252FWFC%252FRepository%252FP116_S10670%252FG168276%252F&BIP_item=Horizontal_Dual_Axis_Clustered_Bars.fex
        """
