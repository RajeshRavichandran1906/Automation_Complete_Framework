...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2313659
TestCase Name = AHTML: Horizontal Dual-Axis Stacked Bar Chart Active Control icon functionality.
'''
import unittest
import time
...
class C2313659_TestClass(BaseTestCase):

    def test_C2313659(self):
        
        Test_Case_ID="C2313659"
        """
            TESTCASE VARIABLES
        """     
...
#         driver.implicitly_wait(15) #Intializing common implicit wait for throughout the test
        ...
        utillobj.verify_chart_color("TableChart_1", "riser!s2!g2!mbar!", "dark_green", "Step 01.4: Verify  riser color")
        utillobj.verify_chart_color("TableChart_1", "riser!s3!g2!mbar!", "pale_yellow", "Step 01.5: Verify  riser color")
        ...
        """
            Step 02:Click the Run button.Expect to see the following Horizontal Dual-Axis Stacked Bar Chart.
        ...
        resobj.verify_default_tooltip_values("MAINTABLE_wbody0_f", "riser!s0!g2!mbar!", expected_tooltip_list, "Step 02.7: Verify bar value")
        ...
        """
            Step 04:Select the Stacked Column option.
                    Click OK.Expect to see the Horizontal Dual-axis bar chart converted into a Stacked Column Dual-axis bar chart.
        """
        ...
        """
            ...
            Expect to see the Stacked Column chart converted back into the original Horizontal Dual-axis bar chart.
        """
        ...
        expected_tooltip_list=['CAR:BMW', 'DEALER_COST:49,500', 'Filter Chart', 'Exclude from Chart']
        resobj.verify_default_tooltip_values("MAINTABLE_wbody0_f", "riser!s0!g2!mbar!", expected_tooltip_list, "Step 05.7: Verify bar value")
        ...
        """
            Step 07:Select the Stacked Depth option.
                ...
                Expect to see the Horizontal Dual-axis bar chart converted into a Stacked Depth bar chart.Verify the presence of both axis.
        """
...
#         utillobj.click_on_screen(parent_obj,'middle')
        ...
        """
            Step 09:Using the second icon at the top,click Advanced Chart. 
                    Scroll down and select the Step Line Chart option.
                    Click OK.
        ...
        """
            Step 11:Using the second icon at the top,
                    click Advanced Chart. 
                    Scroll down and select the Donut with Depth option.Click OK.
        ...
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0', 256, "Step 11.8: Verify number of pie", custom_css=".chartPanel path[class*='riser!s']")
        ...
        """
            Step 12:Click the third icon at the top.
                    Expect to see the original Horizontal Dual-Axis Stacked Bar Chart.
        """
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 2)
        time.sleep(3)
        expected_xval_list=['ALFA ROMEO', 'AUDI', 'BMW', 'DATSUN','JAGUAR','JENSEN','MASERATI','PEUGEOT','TOYOTA','TRIUMPH']
        ...
        expected_tooltip_list=['CAR:BMW', 'DEALER_COST:49,500', 'Filter Chart', 'Exclude from Chart']
        resobj.verify_default_tooltip_values("MAINTABLE_wbody0_f", "riser!s0!g2!mbar!", expected_tooltip_list, "Step 12.7: Verify bar value")
