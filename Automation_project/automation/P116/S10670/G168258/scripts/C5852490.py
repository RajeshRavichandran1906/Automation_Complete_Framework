...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/5852490
TestCase Name =AHTML:Restore Dual-Axis Clustered Bar Chart via API.
'''
import unittest
...
class C5852490_TestClass(BaseTestCase):

    def test_C5852490(self):
        ...
        fex_name='Vertical_Dual_Axis_Clustered_Bars'
        ...
        IBFS%253A%252FWFC%252FRepository%252FP116_S10670%252FG168276%252F&BIP_item=Vertical_Dual_Axis_Clustered_Bars.fex
        """
        ...
        """
        Step:3 Verify the Vertical Dual Axis Clustered Bars is generated.
        """
        ...
        active_chartobj.verify_y_axis_label_in_run_window(['0', '300', '600', '900', '1,200'], xyz_axis_label_css="text[class*='y2axis-labels']",msg="Step 03.03")
        ...
        active_chartobj.verify_y_axis_title_in_run_window(expected_ytitle_list,msg="Step 03.06")
        active_chartobj.verify_y_axis_title_in_run_window(['LENGTH'],x_or_y_axis_title_css="text[class*='y2axis-title']",msg="Step 03.07")
        active_chartobj.verify_active_chart_toolbar(['More Options', 'Advanced Chart', 'Original Chart', 'Aggregation', 'Sum'], msg='Step 03.08', parent_css='#MAINTABLE_wmenu0')
        active_chartobj.verify_number_of_risers_in_run_window('rect',1,20,msg="Step 03.09: Verify Number of risers")
        active_chartobj.verify_chart_color_using_get_css_property_in_run_window("rect[class='riser!s0!g0!mbar!']",'bar_blue',parent_css='#MAINTABLE_wbody0',msg="Step 03.10")
        active_chartobj.verify_chart_color_using_get_css_property_in_run_window("rect[class='riser!s1!g0!ay2!mbar!']", 'pale_green',parent_css='#MAINTABLE_wbody0',msg="Step 03.11")
