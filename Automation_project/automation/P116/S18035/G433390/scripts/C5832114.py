...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/5832114
...
class C5832114_TestClass(BaseTestCase):

    def test_C5832114(self):
        ...
        chart_obj.select_other_chart_type('threed', 'threed_bars', 1)
