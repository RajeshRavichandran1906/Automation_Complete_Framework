...
class C2204995_TestClass(BaseTestCase):

    def test_C2204995(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2204995'
        driver = self.driver
        ...
        """
        Step 01: Execute 152241.fex
        """
        utillobj.active_run_fex_api_login("152241.fex", "S7074", 'mrid', 'mrpass')
        time.sleep(7)
        ...
        """
        Step 02: Select Dealer Cost field using Add (Y) menu option in the chart tool bar
        Step 03: Verify Dealer_Cost is added to the chart. 
        """
