...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2204889
TestCase Name = Verify that Restore Original menu is available in chart dropdown menu (128393)
'''
...
class C2204889_TestClass(BaseTestCase):

    def test_C2204889(self):
        ...
        """
            Step 01:Execute attached fex "Chart_AHTML.fex" in IA.(Fex name modified as Chart_AHTML_1.fex)
        """
        ...
        """
            Step 02:see attached fex "Chart_AHTML.fex" in IA. ( Fex name modified as Chart_AHTML_1.fex)
        """
        ...
        miscelaneous_obj.verify_chart_title('MAINTABLE_wbody0_ft', 'Unit Sales by Category, Product', 'Step 02.6: Verify Chart Title')
        ...
        """
        Step 03:Click on Chart/Rollup icon
        """ 
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 1)
        time.sleep(4)
        
        """ 
        Step 04:From the 'Chart' tab, select 'Donut (Bevel)' and click ok
        """
        ...
        """
        Step 05:Click on Drop down menu and select 'Restore Original' option
        """
        rollupobj.select_chartmenubar_option('MAINTABLE_wmenu0',1,'Restore Original',0,custom_css='cpop')
        time.sleep(3)
        ...
        miscelaneous_obj.verify_active_chart_tooltip('MAINTABLE_wbody0', 'riser!s0!g2!mbar!', expected_tooltip_list, "Step 05.6: verify tooltip values")
