...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2318011
TestCase Name = Verify Vertical Absolute Line Chart in others tab under Format menu.
'''
...
class C2318011_TestClass(BaseTestCase):

    def test_C2318011(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2318011'
        driver = self.driver
        ...
        Vertical Absolute Line Chart.
        Click OK.
        Expect to see the Clustered bar chart converted into the Preview pane for Vertical Absolute Line Chart.
        """
        ...
        Expect to see the following Vertical Absolute Line Chart.
        """
        ribbonobj.select_top_toolbar_item('toolbar_run')
        time.sleep(8)
        utillobj.switch_to_frame(pause=2)
        ...
        time.sleep(5)
        parent_elem=self.driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class*='marker!s0!g0!mmarker']")
        utillobj.click_on_screen(parent_elem, 'left',javascript_marker_enable=True,mouse_duration=2.5)
        ...
        utillobj.take_screenshot(ele,'C2318011_Actual_step05', image_type='actual',x=1, y=1, w=-1, h=-1)
        result_obj._validate_page(elem1)
