...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2234983
TestCase Name = Scatter diagram from Compound Report - Cache=ON, Cachemode=NOEXTRACT, Preview=OFF, IF test
'''
import unittest
import time
...
class C2234983_TestClass(BaseTestCase):

    def test_C2234983(self):
        
        TestCase_ID='C2234983'
        ...
        """ 
        Step 01 : Execute the attached repro - IA-2969E.
        """
        utillobj.active_run_fex_api_login('IA-2969E.fex', 'S7074', 'mrid', 'mrpass')
