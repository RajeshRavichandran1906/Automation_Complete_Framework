...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2316737
TestCase Name = Verify Straight Line chart via Advance chart tool bar.
'''
import unittest
...
class C2316737_TestClass(BaseTestCase):

    def test_C2316737(self):
        """
            TESTCASE VARIABLES
        """
...
#         resobj.verify_default_tooltip_values("MAINTABLE_wbody0", "riser!s1!g6!mbar!r0!c0!", expected_tooltip_list, "Step 04.11: Verify bar value")
        """
            ...
            Step 06:Select Stright line and click OK.
        """
