...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2316740
...
class C2316740_TestClass(BaseTestCase):
    def test_C2316740(self):
        ...
        """    6. Select Area Chart and click OK.    """
        ...
        result_obj.verify_riser_chart_XY_labels("MAINTABLE_wbody0", expected_xval_list, expected_yval_list, "Step 06.2: Verify XY labels")
        ...
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s1!g0!marea!r0!c0!", "pale_green", "Step 06.4b: Verify Second Series bar color")
