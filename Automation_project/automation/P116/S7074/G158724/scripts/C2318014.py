...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2318014
TestCase Name = Verify Vertical Absolute Area Chart in others tab under Format menu.
'''
...
class C2318014_TestClass(BaseTestCase):

    def test_C2318014(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2318014'
        driver = self.driver
...
#         result_obj.verify_default_tooltip_values('MAINTABLE_wbody0', 'riser!s1!g0!mbar!', expected_tooltip_list, 'Step 03.5: verify the default tooltip values', default_move=True)
        ...
        Click OK.
        Expect to see the Clustered bar chart converted into the Preview pane for Vertical Absolute Area Chart.
        """
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('area', 'vertical_absolute_area', 1, ok_btn_click=True)
        ...
        Expect to see the following Vertical Absolute Area Chart.
        """
        ribbonobj.select_top_toolbar_item('toolbar_run')
        element_css="#resultArea [id^=ReportIframe-]"
        utillobj.synchronize_with_number_of_element(element_css, 1, 20)
...
#         parent_elem=self.driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class*='marker!s1!g5!mmarker!']")
...
#         miscelaneousobj.verify_active_chart_tooltip('MAINTABLE_wbody0','riser!s0!g0!marea!', expected_tooltip_list, 'Step 05.6: verify the default tooltip values', default_move=True)
        ...
        utillobj.take_screenshot(ele,'C2318014_Actual_step05', image_type='actual',x=1, y=1, w=-1, h=-1)
