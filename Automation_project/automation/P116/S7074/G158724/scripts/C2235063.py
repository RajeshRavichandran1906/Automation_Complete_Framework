...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2235063
...
class C2235063_TestClass(BaseTestCase):

    def test_C2235063(self):
        
        """
            TESTCASE VARIABLES
        """
        TestCase_ID = 'C2235063'
        driver = self.driver
        ...
        """
            Step 02: From the Format Tab select Chart Types, then Other, then Vertical Dual-Axis Absolute Lines and Click OK. 
        """
        ...
        """
            Step 02.1 : Expect to see the following Chart Preview, including areas for Horizontal axis and Vertical axis 1 & 2.
        """
        expected_xval_list=['Group 0','Group 1','Group 2','Group 3','Group 4']
        expected_yval_list=['0','10','20','30','40','50']
        result_obj.verify_riser_chart_XY_labels('pfjTableChart_1', expected_xval_list, expected_yval_list, 'Step 02.1: Verify XY labels')
        expected_datalabel=['0','5','10','15','20','25','30','35','40','45']
        ...
        """
            Step 03 : Add field Category & Product under the Horizontal axis, then Budget Dollars & Budget Units under the Vertical axis 1 and Unit Sales under the Vertical axis 2.
        ...
        """
            Step 03.1 : Expect to see the following Vertical Dual Axis Absolute Line Graph Preview panel. 
        """
        ...
        """
            Step 04 : Click the Run button to generate the Vertical Dual Axis Absolute Line Graph.
        """
        ...
        """
            Step 04.1 : Expect top see the following Vertical Dual Axis Absolute Line Graph.
