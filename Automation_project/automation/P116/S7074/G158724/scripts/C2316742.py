...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2316742
...
class C2316742_TestClass(BaseTestCase):

    def test_C2316742(self):
        """
            TESTCASE VARIABLES
        """
...
#         resobj.verify_default_tooltip_values("MAINTABLE_wbody0", "riser!s1!g6!mbar!r0!c0!", expected_tooltip_list, "Step 04.11: Verify bar value")
        """
            Step 05:Select Advance Chart icon from the tool bar.Scroll down to the Area charts.
            Step 06:Select Percent Area Chart and click OK.
        """
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 1)
        rollupobj.select_advance_chart('wall1', 'percentarea')
        ...
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0', 26, "Step 06.3: Verify number of percent area")
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g0!marea!r0!c0!", "bar_blue", "Step 06.4: Verify  bar color")
        legend=["Unit Sales", "Dollar Sales"]
...
#         utillobj.click_on_screen(parent_obj,'bottom_left', javascript_marker_enable=True, mouse_duration=2.5)
#         expected_tooltip_list=['Category:Coffee', 'Product:Latte', 'Dollar Sales:10943622', 'Filter Chart', 'Exclude from Chart']
