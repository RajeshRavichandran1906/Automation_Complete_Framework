...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2316734
...
class C2316734_TestClass(BaseTestCase):

    def test_C2316734(self):
...
#         resobj.verify_default_tooltip_values("MAINTABLE_wbody0", "riser!s1!g6!mbar!r0!c0!", expected_tooltip_list, "Step 04.11: Verify bar value")
        ...
        """
            ...
            Step 06:Select Curved + Markers and click OK.
        """
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 1)
        rollupobj.select_advance_chart('wall1', 'strightplusmarkers')
        ...
        utillobj.verify_chart_color("MAINTABLE_wbody0", "marker!s0!g6!mmarker!r0!c0!", "bar_blue", "Step 06.4: Verify  bar color",attribute_type='stroke')
        legend=["Unit Sales", "Dollar Sales"]
...
#         expected_tooltip_list=['Category:Coffee', 'Product:Latte', 'Dollar Sales:10943622', 'Filter Chart', 'Exclude from Chart']
#         resobj.verify_default_tooltip_values("MAINTABLE_wbody0", "marker!s1!g6!mmarker!r0!c0!", expected_tooltip_list, "Step 06.11: Verify bar value",cord_type='middle',x_offset=-4,y_offset=-8)
