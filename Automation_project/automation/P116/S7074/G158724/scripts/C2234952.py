...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2234952
...
class C2234952_TestClass(BaseTestCase):

    def test_C2234952(self):
        ...
        rollupobj.select_advance_chart('wall1', 'curvedplusmarkers')
