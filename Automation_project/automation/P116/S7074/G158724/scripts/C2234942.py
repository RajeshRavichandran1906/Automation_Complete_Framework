...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2234942
...
class C2234942_TestClass(BaseTestCase):

    def test_C2234942(self):
        ...
        """    Step 4: Click the Run button to generate the Horizontal Dual Axis Absolute Line Graph.    """
        ...
        expected_xval_list=['Coffee/Capuccino', 'Coffee/Espresso', 'Coffee/Latte', 'Food/Biscotti', 'Food/Croissant', 'Food/Scone', 'Gifts/Coffee Grinder', 'Gifts/Coffee Pot', 'Gifts/Mug', 'Gifts/Thermos']
        result_obj.verify_riser_chart_XY_labels('MAINTABLE_wbody0', expected_xval_list, expected_y2val_list, 'Step 4c: Verify Y2 Label', y_custom_css="text[class^='y2axis-labels']")
        expected_label_list=['Budget Dollars', 'Budget Units', 'Unit Sales']
