...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2318022
TestCase Name = Verify XY Scatter Diagram in others tab under Format menu
'''
import unittest
...
class C2318022_TestClass(BaseTestCase):

    def test_C2318022(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2318022'
        driver = self.driver
        ...
        element_css= "#MAINTABLE_wbody0 svg g text[class*='yaxis-labels']"
        utillobj.synchronize_with_number_of_element(element_css, 7, 20)
...
#         result_obj.verify_default_tooltip_values('MAINTABLE_wbody0', 'riser!s1!g0!mbar!', expected_tooltip_list, 'Step 03.5: verify the default tooltip values')
        ...
        ia_ribbobj.select_other_chart_type('x_y_plots', 'x_y_plots_scatter', 1, ok_btn_click=True)
        element_css= "#pfjTableChart_1 svg g text[class*='yaxis-labels']"
        utillobj.synchronize_with_number_of_element(element_css, 8, 20)
        
        xaxis_value="Product"
        yaxis_value="Unit Sales"
        result_obj.verify_xaxis_title("pfjTableChart_1", xaxis_value, "Step 04:a(i) Verify X-Axis Title")
        result_obj.verify_yaxis_title("pfjTableChart_1", yaxis_value, "Step 04:a(ii) Verify Y-Axis Title")
        expected_xval_list=['Capuccino','Espresso']
        ...
        ia_resultobj.verify_number_of_chart_segment('pfjTableChart_1', 2, 'Step 04: Verify Number of riser', custom_css="circle[class^='riser']")
        ...
        result_obj.verify_riser_chart_XY_labels('MAINTABLE_wbody0', expected_xval_list, expected_yval_list, 'Step 0: Verify XY labels')
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0', 10, 'Step 05: Verify Number of riser', custom_css="circle[class^='riser']")
#         expected_tooltip_list=['Product:Biscotti', 'Unit Sales:421377', 'Dollar Sales:5263317', 'Filter Chart', 'Exclude from Chart']
#         result_obj.verify_default_tooltip_values('MAINTABLE_wbody0', 'riser!s0!g0!mmarker!', expected_tooltip_list, 'Step 05: verify the default tooltip values')
        miscelaneousobj.verify_chart_title('MAINTABLE_wbody0_ft', 'Unit Sales, Dollar Sales BY Product', 'Step 05: Verify Chart Title')
        ...
        utillobj.take_screenshot(ele,'C2318022_Actual_step05', image_type='actual',x=1, y=1, w=-1, h=-1)
