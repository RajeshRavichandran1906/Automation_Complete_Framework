...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2234979
TestCase Name = Scatter diagram from Compound Report - Cache=ON, Cachemode=NOEXTRACT, Preview=ON
'''
import unittest
import time
...
class C2234979_TestClass(BaseTestCase):

    def test_C2234979(self):
        
        TestCase_ID='C2234979'
        ...
        """ 
        Step 01 : Execute the attached repro - IA-2969A.
        """
        utillobj.active_run_fex_api_login('IA-2969A.fex', 'S7074', 'mrid', 'mrpass')
