...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2318018
...
class C2318018_TestClass(BaseTestCase):

    def test_C2318018(self):
        ...
        """    2. Add fields Product, Dollar Sales.    """
        ...
        result_obj.verify_yaxis_title("TableChart_1", 'Dollar Sales', "Step 2b: Verify Y-Axis Title")
...
#         expected_tooltip_list=['Product:Espresso', 'Dollar Sales:3906243', 'Filter Chart', 'Exclude from Chart']
#         result_obj.verify_default_tooltip_values('MAINTABLE_wbody0', 'riser!s0!g5!mbar!', expected_tooltip_list, 'Step 3f: verify the default tooltip values', mouse_duration=2.5)
        miscelaneousobj.verify_chart_title('MAINTABLE_wbody0_ft', 'Dollar Sales BY Product', 'Step 03g: Verify Chart Title')
        ...
        element_css="#TableChart_1 svg.rootPanel>g>g path[class^='riser']"
        utillobj.synchronize_with_number_of_element(element_css, 2, 20)
        
        result_obj.verify_xaxis_title("TableChart_1","Dollar Sales", "Step 04a: Verify pie X-Axis Title", custom_css="text[class*='pieLabel']")
        ...
        utillobj.verify_chart_color("TableChart_1", "riser!s1!g0!mwedge", "bar_green", "Step 04c: Verify first bar color")
        result_obj.verify_riser_pie_labels_and_legends('TableChart_1', ['6.1M'], "Step 04d:",custom_css="text[class^='totalLabel!g']",same_group=True) 
        ...
        result_obj.verify_riser_pie_labels_and_legends('MAINTABLE_wbody0', ['46.2M'], "Step 05:",custom_css="text[class^='totalLabel!g']",same_group=True)
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0', 10, 'Step 5a: Verify number of Pie segments.')
        ...
        utillobj.verify_chart_color('MAINTABLE_wbody0', 'riser!s4!g0!mwedge', 'brick_red', 'Step 5c(1): Verify any one pie color.')
        utillobj.verify_chart_color('MAINTABLE_wbody0', 'riser!s6!g0!mwedge', 'periwinkle_gray', 'Step 5c(2): Verify any one pie color.')  
        miscelaneousobj.verify_chart_title('MAINTABLE_wbody0_ft', 'Dollar Sales BY Product', 'Step 5d: Verify pie Chart Title')
        ...
        result_obj.verify_riser_pie_labels_and_legends('MAINTABLE_wbody0', ['Dollar Sales'],"'Step 5h: Verify pie Chart labels'",custom_css="text[class^='pieLabel!g']",same_group=True)
...
#         result_obj.verify_default_tooltip_values('MAINTABLE_wbody0', 'riser!s0!g0!mwedge', expected_tooltip_list, 'Step 5i: verify the default tooltip values',default_move=True)
        utillobj.switch_to_default_content(pause=5)
