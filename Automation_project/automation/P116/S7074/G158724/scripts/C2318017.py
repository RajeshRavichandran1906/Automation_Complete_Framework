...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2318017
...
class C2318017_TestClass(BaseTestCase):

    def test_C2318017(self):
        ...
        xaxis_value="Dollar Sales"
        result_obj.verify_xaxis_title("TableChart_1", xaxis_value, "Step 04a: Verify pie X-Axis Title",custom_css="text[class*='pieLabel']")
#         result_obj.verify_riser_pie_labels_and_legends('TableChart_1', ['Dollar Sales'], "Step 04a:",custom_css="text[class*='pieLabel']",same_group=True) 
        ...
        utillobj.verify_chart_color("TableChart_1", "riser!s0!g0!mwedge", "bar_blue1", "Step 04c: Verify first bar color")
        
        """    5. Click the Run button.    """ 
        ribbonobj.select_top_toolbar_item('toolbar_run')
        utillobj.switch_to_frame(pause=2)
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0', 10, 'Step 5a: Expect to see the three PIE Chart Visible.')
        ...
        utillobj.verify_chart_color('MAINTABLE_wbody0', 'riser!s5!g0!mwedge', 'orange', 'Step 5c: Verify any one pie color.')  
