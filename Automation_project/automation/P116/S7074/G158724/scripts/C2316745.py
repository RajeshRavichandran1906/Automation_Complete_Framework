...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2316745
TestCase Name = Verify Bubble chart via Advance chart tool bar.
'''
import unittest
...
class C2316745_TestClass(BaseTestCase):
    def test_C2316745(self):
        ...
        expected_bubble_xval_list=['Biscotti', 'Capuccino', 'Coffee Grinder', 'Coffee Pot', 'Croissant', 'Espresso', 'Latte', 'Mug', 'Scone', 'Thermos','Biscotti', 'Capuccino', 'Coffee Grinder', 'Coffee Pot', 'Croissant', 'Espresso', 'Latte', 'Mug', 'Scone', 'Thermos','Biscotti', 'Capuccino', 'Coffee Grinder', 'Coffee Pot', 'Croissant', 'Espresso', 'Latte', 'Mug', 'Scone', 'Thermos']
        expected_bubble_yval_list=['0', '200K', '400K', '600K', '800K']
...
#         expected_bubble_tooltip_list=['Category:Gifts', 'Product:Coffee Grinder', 'Unit Sales:186534', 'Filter Chart', 'Exclude from Chart']
...
#         result_obj.verify_default_tooltip_values("MAINTABLE_wbody0", "riser!s1!g6!mbar!r0!c0!", expected_tooltip_list, "Step 04.11: Verify bar value")
        ...
        """    6. Select Bubble Chart and click OK.    """
        rollupobj.click_chart_menu_bar_items('MAINTABLE_wmenu0', 1)
        rollupobj.select_advance_chart('wall1', 'bubble')
        result_obj.verify_xaxis_title("MAINTABLE_wbody0", "Product", "Step 06.1a: Verify X-Axis Title")
        result_obj.verify_yaxis_title("MAINTABLE_wbody0", "Unit Sales", "Step 06.1b: Verify Y-Axis Title")
        result_obj.verify_riser_chart_XY_labels("MAINTABLE_wbody0", expected_bubble_xval_list, expected_bubble_yval_list, "Step 06.2: Verify XY labels")
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0', 10, "Step 06.3: Verify number of Bubbles", custom_css=".chartPanel .scrollCharts g circle[class*='marker']")
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g1!mmarker!r0!c0!", "bar_blue", "Step 06.4: Verify Series bar color")
...
#         result_obj.verify_default_tooltip_values("MAINTABLE_wbody0", "riser!s0!g0!mmarker!r0!c2!", expected_bubble_tooltip_list, "Step 06.10: Verify bar value")       
