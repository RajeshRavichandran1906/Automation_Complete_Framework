...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2235060
...
class C2235060_TestClass(BaseTestCase):

    def test_C2235060(self):
        
        Test_Case_ID="C2235060"
