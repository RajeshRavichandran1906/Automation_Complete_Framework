...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2316736
TestCase Name = Verify Curved Line Chart via Advance chart tool bar.
'''
import unittest
...
class C2316736_TestClass(BaseTestCase):

    def test_C2316736(self):
