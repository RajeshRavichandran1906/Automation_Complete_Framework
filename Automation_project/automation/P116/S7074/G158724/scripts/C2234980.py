...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2234980
TestCase Name = RScatter diagram from Compound Report - Cache=ON, Cachemode=NOEXTRACT, Preview=OFF
'''
import unittest
import time
...
class C2234980_TestClass(BaseTestCase):

    def test_C2234980(self):
        
        TestCase_ID='C2234980'
        ...
        """ 
        Step 01 :Execute the attached repro - IA-2969B
        """
        utillobj.active_run_fex_api_login('IA-2969B.fex', 'S7074', 'mrid', 'mrpass')
        ...
        """
        Step 02 : Hover over the point just above the 160k value on the X=axis, to verify the four fields participating.
        ...
        Transactions: 3
        """
        expected_tooltip=['Net Sales:  166,000.0', 'LAST_CONTACT:  6', 'Company Name:  Colorado Springs Utilities', 'Transactions:  3', 'Filter Chart', 'Exclude from Chart']
        miscelaneousobj.verify_active_chart_tooltip('MAINTABLE_wbody1_f','riser!s0!g442!mmarker!',expected_tooltip,'Step 01.5 : Verify circle tooltip')
