...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2318029
TestCase Name = Verify 3D Bars in others tab under Format menu.
...
class C2318029_TestClass(BaseTestCase):

    def test_C2318029(self):
       
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID="C2318029"
        driver = self.driver
        ...
        """
        Step 04 : Select Format > Other.From Select a chart pop up choose 3D Bars.Click OK.
        """
        ...
        """
        Expect to see the Clustered bar chart converted into the Preview pane for 3D Bars.
        ...
        ia_resultobj.verify_number_of_chart_segment('TableChart_1',24,'Step 04.2 : Verify no of 3D chart risers ',  custom_css="svg g>path[class^='riser']")
        result_obj.verify_riser_legends('TableChart_1',['Dollar Sales','Unit Sales'], 'Step 04.3 : Verify chart legends label')
        utillobj.verify_chart_color('TableChart_1',None, 'bar_green', 'Step 04.4 : Verify bar color',custom_css="g>path[class='riser!s1!g1!mbar!']:nth-child(11)")
        utillobj.verify_chart_color('TableChart_1',None, 'bar_blue1', 'Step 04.5 : Verify bar color',custom_css="g>path[class='riser!s0!g1!mbar!']:nth-child(11)")
        ...
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0 ',120,'Step 05.3 : Verify no of 3D chart risers',  custom_css="svg g>path[class^='riser']")
        ...
        utillobj.verify_chart_color('MAINTABLE_wbody0 ',None, 'pale_green', 'Step 05.5 : Verify bar color',custom_css="g>path[class='riser!s1!g6!mbar!']:nth-child(41)")
        utillobj.verify_chart_color('MAINTABLE_wbody0 ',None, 'lochmara', 'Step 05.6 : Verify bar color',custom_css="g>path[class='riser!s0!g6!mbar!']:nth-child(41)")
        miscelaneousobj.verify_active_chart_tooltip('MAINTABLE_wbody0','riser!s1!g6!mbar!',['878,063'],'Step 05.7 : Verify 3D chart tooltip value')
