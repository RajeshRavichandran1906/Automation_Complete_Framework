...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2318041
TestCase Name = Verify Horizontal Box Plot in others tab under Format menu..
'''
import unittest
import time
...
class C2318041_TestClass(BaseTestCase):

    def test_C2318041(self):
        ...
        ia_ribbonobj.select_other_chart_type('special', 'horizontal_boxplot', 5,ok_btn_click=True)
        time.sleep(8)
        parent_css="#TableChart_1 .chartPanel g line[class^='boxplotTopLine!s0!']"
        result_obj.wait_for_property(parent_css,2, expire_time=50)
