...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2318010
...
class C2318010_TestClass(BaseTestCase):

    def test_C2318010(self):
        """
            TESTCASE VARIABLES
        """
        ...
        utillobj.synchronize_with_number_of_element(parent_css, 20, 15)
        ...
        """    04 : Select Format > Other, From Select a chart pop up choose ''Horizontal Waterfall Chart'', Click OK    """
        ribbonobj.select_ribbon_item("Format", "Other")
        time.sleep(5)
        ia_ribbonobj.select_other_chart_type('bar', 'horizontal_waterfall_chart', 22, ok_btn_click=True)
        time.sleep(8)   
        ...
        expected_xval_list=['Capuccino', 'Espresso', 'Total']
        ...
        ia_resultobj.verify_number_of_chart_segment('TableChart_1', 3, 'Step 4d: Verify Number of riser', custom_css=".chartPanel rect[class^='riser']")
        utillobj.verify_chart_color('TableChart_1', 'riser!s0!g0!mbar', 'dark_cyan', 'Step 4e(i): Verify first series first riser Color')
        utillobj.verify_chart_color('TableChart_1', 'riser!s0!g2!mbar', 'desaturated_blue', 'Step 4e(ii): Verify second series second riser Color')
        ...
        utillobj.switch_to_frame(pause=2)
        parent_css="#MAINTABLE_wbody0 .chartPanel rect[class^='riser']"
        ...
        expected_xval_list=['Biscotti', 'Capuccino', 'Coffee Grinder', 'Coffee Pot', 'Croissant', 'Espresso', 'Latte', 'Mug', 'Scone', 'Thermos', 'Total']
        expected_yval_list=['0', '0.5M', '1M', '1.5M', '2M', '2.5M', '3M', '3.5M', '4M']
        result_obj.verify_riser_chart_XY_labels('MAINTABLE_wbody0', expected_xval_list, expected_yval_list, 'Step 05c: ')
       
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g3!mbar!", 'dark_cyan', 'Step 05e(i): Verify first bar Color')
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g8!mbar!", 'dark_cyan', 'Step 05e(ii): Verify any bar Color')
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g10!mbar!", 'desaturated_blue', 'Step 05e(iii): Verify last bar Color')
        miscelaneousobj.verify_chart_title('MAINTABLE_wbody0_ft', 'Unit Sales, Dollar Sales BY Product', 'Step 05f: Verify Chart Title')
        miscelaneousobj.verify_arChartToolbar('MAINTABLE_wmenu0', ['More Options','Column','Pie','Line','Scatter','Advanced Chart','Original Chart'],"Step 05g: Verify Chart toolbar")
        miscelaneousobj.verify_arChartToolbar('MAINTABLE_wmenu0', ['Aggregation'],"Step 05h: Verify Chart toolbar", custom_css='.arChartMenuBarContainer .tabPagingText1 td[title]')
        miscelaneousobj.verify_arChartToolbar('MAINTABLE_wmenu0', ['Sum'],"Step 05i: Verify Chart toolbar", custom_css=".arChartMenuBarContainer [id*='SUM']", text=True)
        time.sleep(2)
        utillobj.switch_to_default_content(pause=5)
