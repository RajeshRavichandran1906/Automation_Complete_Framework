...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2318006
TestCase Name = Verify Horizontal Clustered Bars in others tab under Format menu.
'''
import unittest
import time
...
class C2318006_TestClass(BaseTestCase):

    def test_C2318006(self):
