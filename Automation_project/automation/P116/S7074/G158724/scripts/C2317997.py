...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2317997
TestCase Name = Verify Vertical Stacked Bars in others tab under Format menu.
'''
import unittest
import time
...
class C2317997_TestClass(BaseTestCase):

    def test_C2317997(self):
        ...
        """ Step 5: Expect to see the Clustered bar chart converted into the Preview pane for Vertical Stacked bars.
        """
        ...
        """ Step 6: Click the Run button.
                    Expect to see the following Vertical Stacked Bar Chart.
        """
        ribbonobj.select_top_toolbar_item('toolbar_run')
        time.sleep(5)
        utillobj.switch_to_frame(pause=2)
