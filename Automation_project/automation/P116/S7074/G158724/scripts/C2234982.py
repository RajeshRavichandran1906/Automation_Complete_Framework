...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2234982
TestCase Name = Scatter diagram from Compound Report - Cache=ON, Cachemode=not set, Preview=OFF
'''
import unittest
import time
...
class C2234982_TestClass(BaseTestCase):

    def test_C2234982(self):
        
        TestCase_ID='C2234982'
        ...
        """ 
        Step 01 : Execute the attached repro - IA-2969D.
        """
        utillobj.active_run_fex_api_login('IA-2969D.fex', 'S7074', 'mrid', 'mrpass')
        ...
        Transactions: 3
        """
#         expected_tooltip_list=['Net Sales:166000.0', 'LAST_CONTACT:6', 'Company Name:Colorado Springs Utilities', 'Transactions:3', 'Filter Chart', 'Exclude from Chart']
