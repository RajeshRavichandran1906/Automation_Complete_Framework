...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2234981
TestCase Name = Scatter diagram from Compound Report - Cache=ON, Cachemode=not set, Preview=ON
'''
import unittest
import time
...
class C2234981_TestClass(BaseTestCase):

    def test_2234981(self):
        
        TestCase_ID='C2234981'
        ...
        """ 
        Step 01 : Execute the attached repro - IA-2969C.
        """
        utillobj.active_run_fex_api_login('IA-2969C.fex', 'S7074', 'mrid', 'mrpass')
