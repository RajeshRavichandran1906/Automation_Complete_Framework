...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2316888
TestCase Name = Verify that Radial fill is applied in the output
'''
import unittest
import time
...
class C2316888_TestClass(BaseTestCase):

    def test_C2316888(self):
        
        Test_Case_ID="C2316888"
        """
            TESTCASE VARIABLES
        """   
        ...
        time.sleep(5)
        """   
            Step 04. Select Gradient fill, then select 'Radial' for 'Direction'.
        """
        ribbon_obj.select_frame_background_options('Frame', gradient_fill=True, direction='Radial', btnOk=True)
        time.sleep(5)
        """
            Step 05:click run.       
        """ 
