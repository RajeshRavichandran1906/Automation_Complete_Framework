...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2316879
TestCase Name = Verify that Gradient left fill is applied in the output
'''
import unittest
import time
...
class C2316879_TestClass(BaseTestCase):

    def test_C2316879(self):
        
        Test_Case_ID="C2316879"
        """
            TESTCASE VARIABLES
        """   
        ...
        """   
            Step 04. Select Gradient fill, then select 'Gradient left' for 'Direction'.
        """
        ribbon_obj.select_frame_background_options('Frame', gradient_fill=True, direction='Gradient left', btnOk=True)
        time.sleep(5) 
