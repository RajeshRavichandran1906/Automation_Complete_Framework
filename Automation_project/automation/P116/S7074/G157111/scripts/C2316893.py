...
class C2316893_TestClass(BaseTestCase):

    def test_C2316893(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2316893'
        driver = self.driver
        ...
        """    4. Select Gradient fill, then select 'Radial Pie' for 'Direction'.     """
        driver.find_element_by_css_selector("#frameTwoDFillTypeGradient>input").click()
        time.sleep(2)
        utillobj.select_combobox_item("frameGradientDirectionComboBox", "Radial pie")
