...
class C2316898_TestClass(BaseTestCase):

    def test_C2316898(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2316898'
        driver = self.driver
        ...
        """
        Step 03: Right click on Bar in design area, and select Sort > Sort > Descending, Then Run the report
        """
        ...
        utillobj.take_screenshot(ele,'C2316898_Actual_step04', image_type='actual',x=1, y=1, w=-1, h=-1)
        result_obj._validate_page(elem1)
