...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2316885
TestCase Name = Verify that Gradient up left fill is applied in the output
'''
import unittest
import time
...
class C2316885_TestClass(BaseTestCase):

    def test_C2316885(self):
        
        Test_Case_ID="C2316885"
        """
            TESTCASE VARIABLES
        """   
        ...
        utillobj.synchronize_with_number_of_element(parent_css, 1, ribbon_obj.home_page_long_timesleep)
        ...
        utillobj.synchronize_with_visble_text(parent_css, 'Category', ribbon_obj.home_page_long_timesleep)
        ...
        utillobj.synchronize_with_visble_text(parent_css, 'UnitSales', ribbon_obj.home_page_long_timesleep)
        ...
        """   
            Step 04. Select Gradient fill, then select 'Gradient up left' for 'Direction'.
        """
        ribbon_obj.select_frame_background_options('Frame', gradient_fill=True, direction='Gradient up left', btnOk=True)    
