...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2316884
TestCase Name = Verify that Gradient down left fill is applied in the output.
'''
import unittest
import time
...
class C2316884_TestClass(BaseTestCase):

    def test_C2316884(self):
        
        Test_Case_ID="C2316884"
        """
            TESTCASE VARIABLES
        """   
        ...
        """   
            Step 04. Select Gradient fill, then select 'Gradient down left' for 'Direction'.
        """
        ribbon_obj.select_frame_background_options('Frame', gradient_fill=True, direction='Gradient down left', btnOk=True)
        time.sleep(5)
        """
            Step 05:click run.       
        """ 
