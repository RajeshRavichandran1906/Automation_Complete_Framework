...
class C2316890_TestClass(BaseTestCase):

    def test_C2316890(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2316890'
        driver = self.driver
        ...
        """    4. Select Gradient fill, then select 'Radial top right' for 'Direction'.    """
        driver.find_element_by_css_selector("#frameTwoDFillTypeGradient>input").click()
        time.sleep(2)
        utillobj.select_combobox_item("frameGradientDirectionComboBox", "Radial top right")
        ...
        style_obj.verify_Gradient_fill_bgcolor('MAINTABLE_wbody0', 'white', 'Trolley_Grey', 'Step 5.k')
