...
class C2316891_TestClass(BaseTestCase):

    def test_C2316891(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2316891'
        driver = self.driver
        ...
        """    4. Select Gradient fill, then select 'Radial bottom left' for 'Direction'.     """
        driver.find_element_by_css_selector("#frameTwoDFillTypeGradient>input").click()
        time.sleep(2)
        utillobj.select_combobox_item("frameGradientDirectionComboBox", "Radial bottom left")
