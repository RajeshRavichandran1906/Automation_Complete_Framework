...
class C2316892_TestClass(BaseTestCase):

    def test_C2316892(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2316892'
        driver = self.driver
        ...
        """    4. Select Gradient fill, then select 'Radial bottom right' for 'Direction'.     """
        driver.find_element_by_css_selector("#frameTwoDFillTypeGradient>input").click()
        time.sleep(2)
        utillobj.select_combobox_item("frameGradientDirectionComboBox", "Radial bottom right")
        
        """    5. Click OK. Click the Run button.    """
        driver.find_element_by_id("frameOkBtn").click()
        time.sleep(5)
        ...
        ia_stylingobj.verify_Gradient_fill_bgcolor("MAINTABLE_wbody0", 'white', 'Trolley_Grey', 'Step 05k')
