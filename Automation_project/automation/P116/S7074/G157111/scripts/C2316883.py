...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2316883
TestCase Name = Verify that Gradient up fill is applied in the output.
'''
import unittest
import time
...
class C2316883_TestClass(BaseTestCase):

    def test_C2316883(self):
        
        Test_Case_ID="C2316883"
        """
            TESTCASE VARIABLES
        """   
        ...
        """   
            Step 04. Select Gradient fill, then select 'Gradient up' for 'Direction'
        """
        ribbon_obj.select_frame_background_options('Frame', gradient_fill=True, direction='Gradient up', btnOk=True)
        time.sleep(5) 
        """
            Step 05:click run.       
        """ 
