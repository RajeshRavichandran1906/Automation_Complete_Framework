...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2316886
TestCase Name = Verify that Gradient down right fill is applied in the output
'''
import unittest
import time
...
class C2316886_TestClass(BaseTestCase):

    def test_C2316886(self):
        
        Test_Case_ID="C2316886"
        """
            TESTCASE VARIABLES
        """   
        ...
        """   
            Step 04.Select Gradient fill, then select 'Gradient down right' for 'Direction'.
        """
        ribbon_obj.select_frame_background_options('Frame', gradient_fill=True, direction='Gradient down right', btnOk=True)
        time.sleep(5)      
        """
            Step 05:click run.       
        """ 
