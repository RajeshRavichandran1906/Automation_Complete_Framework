...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2205172
...
class C2205172_TestClass(BaseTestCase):

    def test_C2205172(self):
        
        Test_Case_ID="C2205172"
        """
            TESTCASE VARIABLES
        """
        ...
        utillobj.verify_chart_color("TableChart_1", "riser!s0!g0!marea!r0!c0!", "bar_blue1", "Step 03.d: Verify  area color")
        ...
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g0!marea!r0!c0!", "bar_blue", "Step 04.d: Verify area color")
        ...
        """
            Step 05:Left-click and drag a box around Capuccino and Espresso points in the COFFEE Category.
            Step 06:Click Filter Chart option.
        """ 
        time.sleep(5)
        elem1=driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class='marker!s0!g1!mmarker!r0!c0!']")
        source_elem=utillobj.enable_marker_using_javascript(elem1)
        elem2=driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class='marker!s0!g5!mmarker!r0!c0!']")
        target_elem=utillobj.enable_marker_using_javascript(elem2)  
        time.sleep(3)
        utillobj.drag_drop_on_screen(sx_offset=source_elem['x']-20,sy_offset=source_elem['y']+20,tx_offset=target_elem['x']+15,ty_offset=target_elem['y']-35)
        time.sleep(1)
        ...
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0', 3, "Step 06.c: Verify number of Area")
        ...
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g0!marea!r0!c0!", "bar_blue", "Step 06.e: Verify  bar color")
        ...
        """
            Step 07:Hover on the Espresso point .
        """
        css="#MAINTABLE_wbody0 .chartPanel"
        move=driver.find_element_by_css_selector(css)
        utillobj.click_on_screen(move, 'start')
        time.sleep(5)
        parent_obj = driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class='marker!s0!g1!mmarker!r0!c0!")
        ...
        resobj.verify_default_tooltip_values("MAINTABLE_wbody0", "marker!s0!g1!mmarker!r0!c0!", expected_tooltip_list, "Step 07: Verify bar value",default_move=True)
        """
        ...
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0', 13, "Step 08.d: Verify number of Area")
        resobj.verify_visualization_row_column_header_labels('MAINTABLE_wbody0', 'columns', 'Category', ['Coffee','Food', 'Gifts'], "Step 08.e: Verify row header and value")
        utillobj.verify_chart_color("MAINTABLE_wbody0", "riser!s0!g0!marea!r0!c0!", "bar_blue", "Step 08.f: Verify  bar color") 
        
        """
            Step 09:Left-click and drag a box around the Coffee Pot and Mug points in the GIFTS Category.
            Step 10:Click Exclude from Chart option.
        """ 
        time.sleep(5)
        elem1=driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class='marker!s0!g7!mmarker!r0!c2!']")
        source_elem=utillobj.enable_marker_using_javascript(elem1)
        elem2=driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class='marker!s0!g3!mmarker!r0!c2!']")
        target_elem=utillobj.enable_marker_using_javascript(elem2)  
        time.sleep(3)
        utillobj.drag_drop_on_screen(sx_offset=source_elem['x']+25,sy_offset=source_elem['y']-55,tx_offset=target_elem['x']-20,ty_offset=target_elem['y']+25)
        time.sleep(1)
        ...
        expected_xval_list=['Capuccino', 'Espresso', 'Latte', 'Biscotti', 'Croissant', 'Scone', 'Coffee Grinder', 'Thermos']
        expected_yval_list=['0', '200K', '400K', '600K', '800K', '1,000K']
        resobj.verify_riser_chart_XY_labels("MAINTABLE_wbody0", expected_xval_list, expected_yval_list, "Step 10.b :Verify XY labels")
        ia_resultobj.verify_number_of_chart_segment('MAINTABLE_wbody0', 11, "Step 10.c: Verify number of Area")
