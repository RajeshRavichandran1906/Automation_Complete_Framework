...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2053829
TestCase Name = Verify user can edit/delete sort fields under Pivot table
'''
import unittest
import time
...
class C2053829_TestClass(BaseTestCase):

    def test_C2053829(self):
        ...
        """
        Step 05: Click Pivot tool option from the dropdown
        """
        time.sleep(3)
        ...
        """
        Step 06: Click X next to column name State.
        """
        toolsobj.pivot_tool_delete_column_items('pivottoolt1', 3, 0)
        column_3 = ['Across', 'Drag Column Here']
        toolsobj.pivot_tool_verify_columns('pivottoolt1', 3, column_3, 'Step 02.3: Verify Across tab')
        ...
        """
        toolsobj.pivot_tool_close('pivottoolt1', 'Ok')
        utillobj.verify_pivot_data_set('piv2', 'C2053828_Ds01.xlsx','Step 07: Verify that State column is no more available under Group By')
