...
Test Case =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2225405
'''
...
class C2225405_TestClass(BaseTestCase):

    def test_C2225405(self):
        ...
        """
        Step06: Click Expand option.
        Verify report shows the complete comment.
        """
        time.sleep(4)
        miscellaneousobj.select_menu_items('ITableData0', 0, 'Comments','Expand')
        time.sleep(5)
        miscellaneousobj.verify_expandable_comment_tooltip('ITableData0',0, 5,['comments added'], 'Step06.2: Verify Expandable Comment tooltip' ) 
        
        """
        Step07: Click Expand option again.
        Verify report hides the comment and shows the indicator.
        """
        time.sleep(4)
        miscellaneousobj.select_menu_items('ITableData0', 0, 'Comments','Expand')
        time.sleep(5)
        miscellaneousobj.verify_comment_field('ITableData0', 0, 5,'586298', 'Step 06: Verify Comment is added'  )    
        miscellaneousobj.verify_comment_tooltip('ITableData0',0, 5,['comments added'], 'Step 07: Verify Comment tooltip for 586298' ) 
