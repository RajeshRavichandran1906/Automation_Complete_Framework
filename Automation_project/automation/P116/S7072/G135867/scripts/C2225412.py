...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/C2225412
...
class C2225412_TestClass(BaseTestCase):

    def test_C2225412(self):
        ...
        """
        Step 4. Select cell value and click Remove Cell filter option on column value. Eg: Latte
        
        Verify all the values of the report are displayed.
            
        """
        
        miscelanousobj.select_field_menu_items('ITableData0', 2, 1,'Remove Cell Filter')
        time.sleep(2)
        miscelanousobj.verify_page_summary(0, '107of107records,Page1of2', 'Step 04.a: Verified the Page Summary')
        column_list=['Category', 'Product','Product ID','State','Unit Sales','Dollar Sales']
        miscelanousobj.verify_column_heading('ITableData0', column_list, 'Step 04.b: Verified Column Heading')
        utillobj.verify_data_set('ITableData0','I0r','AR-RP-001.xlsx','Step 04.c : Verify all the values of the report are displayed')
