...
class C2050428_TestClass(BaseTestCase):

    def test_C2050428(self):
        driver = self.driver
        ...
        """
        2. Select Dollar Sales and select 'Sort Ascending' filter
        Verify data under Dollar sales are sorted in ascending order and 
        ...
        utillobj.verify_data_set('ITableData0', 'I0r', 'C2050428_Ds01.xlsx', 'Step 02.1: Verify data under Dollar sales are sorted in ascending order.')
