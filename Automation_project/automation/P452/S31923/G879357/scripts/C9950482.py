...
class C9950482_TestClass(BaseTestCase):
    
    def test_C9950482(self):
        ...
        STEP_03 = """
            STEP 03 : Right click on 'Output' and Select 'convert' > Select 'Accordioin' option.
        """
        ...
        """
        Designer.ContextMenu.verify_options(['Run', 'Run In New Area'], '06')
        ...
        STEP_09 = """
            STEP 09 : Click 'Run in New Area' from Context menu.
        """
        Designer.ContextMenu.select('Run In New Area')
        ...
        """
        time.sleep(30)
        Designer.RunMode.PageCanvas.Containers.Accordion('Output').switch_to_frame('Discount by Region')
        ...
        """
        Designer.RunMode.PageCanvas.Containers.Accordion('Output').ToolBar.Options.click()
        Designer._utils.capture_screenshot("10", STEP_10)

        STEP_10_EXPECTED = """
            STEP 10 - Expected : Check the 'Delete Area' option is available.
        """
        Designer.ContextMenu.verify_options(['Refresh', 'Delete Area'], '10')
        Designer._utils.capture_screenshot("10 - Expected", STEP_10_EXPECTED, True)

        STEP_11 = """
            STEP 11 : Click on 'Delete Area' option.
        """
        Designer.ContextMenu.select('Delete Area')
        ...
        STEP_13 = """
            STEP 13 : Click 'Save' icon from toolbar and Enter 'C9950482' title text box > Click 'Save' button.
        """
        Designer.ToolBar.save('C9950482')
        ...
        STEP_15 = """
            ...
            https://machine.ibi.com:port/alias/run.bip?BIP_REQUEST_TYPE=BIP_RUN&BIP_folder=IBFS:/WFC/Repository/P452_S31923/G879357&BIP_item=c9950482
        """
        Designer.API.run_page('C9950482', credential_keys=('mriddev', 'mrpassdev'))
        ...
        Designer.RunMode.PageCanvas.Containers.Workspace('Workspace').Content.double_click(content_path)
        Designer._utils.wait_for_page_loads(30)
        Designer.RunMode.PageCanvas.Containers.Accordion("Output").switch_to_frame('Category Sales')
        PieChart.wait_for_text('Product Category', 120)
        ...
        """
        Designer.ContextMenu.verify_options(['Run', 'Run In New Area'], '17')
        ...
        STEP_20 = """
            STEP 20 : Click 'Run in New Area' from Context menu.
        """
        Designer.ContextMenu.select('Run In New Area')  
        ...
        STEP_21_EXPECTED = """
            STEP 21 - Expected : Check the 'Delete Area' option is available.
        """
        Designer.ContextMenu.verify_options(['Refresh', 'Delete Area'], '21')
        Designer._utils.capture_screenshot("21 - Expected", STEP_21_EXPECTED, True)

        STEP_22 = """
            STEP 22 : Click on 'Delete Area' option.
        """
        Designer.ContextMenu.select('Delete Area')
