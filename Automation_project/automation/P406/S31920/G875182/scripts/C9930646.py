...
class C9930646_TestClass(BaseTestCase):
    
    def test_C9930646(self):
        ...
        STEP_03 = """
            Step 03.00 : Right-click on 'V5 Context Menu Testing' > Click on 'Run'
        """
        ...
        STEP_03_01 = """
            Step 03.01 : Verify that 'V5 Context Menu Testing' portal run in a new tab with the URL:
        ...
        utils.verify_current_url("portal/P406_S31920/G875179/V5_Context_Menu_Testing", "Step 03.02 : Verify URL : http://machine_name:port/alias/portal/P406_S31920/G875179/V5_Context_Menu_Testing")
        utils.capture_screenshot("03.01", STEP_03_01, expected_image_verify = True)
        
        STEP_04 = """
            Step 04.00 : Close the 'V5 Context Menu Testing' portal run window.
        """
