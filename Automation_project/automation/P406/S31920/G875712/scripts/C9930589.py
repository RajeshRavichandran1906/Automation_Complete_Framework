...
class C9930589_TestClass(BaseTestCase):
    
    def test_C9930589(self):
        ...
        STEP_09 = """
            STEP 09 : Enter a valid 'User name' and 'Password' as 'admin' > Click on 'Sign in' button
        """
