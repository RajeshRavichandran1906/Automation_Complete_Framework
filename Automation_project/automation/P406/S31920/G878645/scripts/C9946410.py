"""-------------------------------------------------------------------------------------------
Author Name  : PM14587
Automated On : 04-September-2020
-------------------------------------------------------------------------------------------"""
...
class C9946410_TestClass(BaseTestCase):
    
    def test_C9946410(self):
        ...
        STEP_07 = """
            STEP 07 : Click on the 'Cancel' button to close the 'Change Password' dialog box
        """
        ...
        STEP_09 = """
            STEP 09 : Enter a valid 'User name' and the 'Password' as 'Pass1' > Click on 'Sign in' button
        """
        ...
        STEP_10 = """
            STEP 10 : Enter a valid 'User name' and a valid 'Password' i.e, 'admin' > Click on 'Sign in' button
        """
        HomePage.invoke_with_login('mridadm','mrpassadm')
        HomePage.Home._utils.capture_screenshot("10", STEP_10)

        STEP_10_EXPECTED = """
            STEP 10 - Expected : Verify 'WebFOCUS Homepage Paris' appears
        """
        HomePage.Banner.verify_top_bar_menus_title(['WebFOCUS Home'], "10.01", "asin")
