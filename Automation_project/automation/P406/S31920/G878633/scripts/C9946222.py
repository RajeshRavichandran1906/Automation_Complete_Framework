...
Automated On : 09 July 2020
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools.paris_home_page import ParisHomePage

class C9946222_TestClass(BaseTestCase):
    
    def test_C9946222(self):
        ...
        expected_url = actual_setup_url + 'portal/P406_S31920/~autodevuser204/Portal_Pages/V5Portal_Context'
        ...
        HomePage.ModalDailogs.V5Portal.Title.verify_text("V5Portal_Context", "03.02")
        HomePage.ModalDailogs.V5Portal.Name.verify_text("V5Portal_Context", "03.03")
