...
Automated on : 14-07-2020
----------------------------------------------------"""
from common.lib.basetestcase import BaseTestCase
from common.wftools.paris_home_page import ParisHomePage

class C9946257_TestClass(BaseTestCase):
    
    def test_C9946257(self):
        ...
        HomePage.NotifyPopup.verify_background_color('03.02')
#         HomePage.NotifyPopup.verify_transparent('03.03') pop up gets closing soon, transparent validated in the next case.
