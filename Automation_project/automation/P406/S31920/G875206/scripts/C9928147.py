...
class C9928147_TestClass(BaseTestCase):
    
    def test_C9928147(self):
        ...
        if active_element_same == self.driver.switch_to.active_element:
            status = True
        else:
            status = False
        ...
        STEP_06 = """
        Step 06 Enter 'C9928147' in the title
        Enter "This is Test blog" in the summary
        """
        HomePage.ModalDailogs.Blog.Title.enter_text('C9928147')
        ...
        HomePage.Workspaces.ContentArea.verify_files(['C9928147'], '07.02', 'asnotin')
        ...
        STEP_09 = """Enter 'C9928147' in the title
        ...
        STEP_11 = """
        Step 11 Hover over 'C9928147'
        """
        HomePage.Workspaces.switch_to_frame()
        retun_obj=home.get_domain_folder_item('C9928147')
        ...
        """
        HomePage.Workspaces.ContentArea.verify_file_summary('C9928147', "This is Test blog", "11.01")
        utils.capture_screenshot('11.00',STEP_11_01,expected_image_verify=True)
        
        STEP_12 = """Right click on 'C9928147' > Delete > Ok
        """
        HomePage.Workspaces.ContentArea.delete_file('C9928147')
