...
class C9928153_TestClass(BaseTestCase):
    
    def test_C9928153(self):
        ...
        HomePage.Workspaces.ContentArea.delete_file_if_exists('C9928153')
        ...
        STEP_06 = """
        Step 06 Enter title 'C9928153' and enter "www.ibi.com" in URL
        """
        HomePage.ModalDailogs.URL.Title.enter_text('C9928153')
        ...
        """
        HomePage.Workspaces.ContentArea.verify_files(["C9928153"],'07.01')
        utils.capture_screenshot('07.01',STEP_07_01,expected_image_verify=True)
        
        STEP_08 = """
        Right click on 'C9928153' > Edit
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('C9928153')
        ...
        STEP_09 = """Change the title as 'C9928153_1'
        """
        HomePage.ModalDailogs.URL.Title.enter_text('C9928153_1')
        ...
        STEP_10_01 ="""
        Verify that the title edited 'C9928153_1' is displayed in the Content area
        """
        HomePage.Workspaces.ContentArea.verify_files(["C9928153_1"],'10.01')
        utils.capture_screenshot('10.01',STEP_10_01,expected_image_verify=True)
        
        STEP_11 = """Right click on 'C9928153_1' > Delete > Ok
        """
        HomePage.Workspaces.ContentArea.delete_file('C9928153_1')
