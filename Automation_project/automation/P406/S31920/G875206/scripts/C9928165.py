...
class C9928165_TestClass(BaseTestCase):
    
    def test_C9928165(self):
        ...
        HomePage.Workspaces.ContentArea.delete_file_if_exists('C9928165')
        HomePage.Workspaces.ContentArea.delete_folder_if_exists('C9928165 Resources')
        ...
        Step_06 = """
            Step 06 : Select '1 Column' page template from Add Page dialog box
            Enter title 'C9928165' and Click 'Create'
            
        """
        vfour_misc.select_page_template(page_template='1 Column', Page_title='C9928165', Page_name='C9928165', btn_name="Create")
        utils.synchronize_with_number_of_element(navigator_css,2,45)
        utils.capture_screenshot('06.00',Step_06)
        
        Step_07_01="""verification - Verify 'C9928165' is displayed
        """ 
        vfour_portal_properties.verify_input_control('page','Title', 'textbox','Step 7.01: Verify Title value is shown', textbox_value='C9928165')
        ...
        Step_09_01  = """
        STEP 09.01 verification - Verify the created 'C9928165' is displayed in the content area    
        """
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.verify_files(["C9928165"],'09.01')
        utils.capture_screenshot('09.01',Step_09_01,expected_image_verify=True)
        
        Step_10 = """
        Right Click on 'C9928165' > Delete > Ok
        """
        HomePage.Workspaces.ContentArea.delete_file('C9928165')
        utils.capture_screenshot('10.00',Step_10)
        
        Step_10_01 = """Verification - 
        Verify the created 'C9928165' is not displayed in the content area
        """
        HomePage.Workspaces.ContentArea.verify_files(["C9928165"],'10.01',assert_type='asnotin')
