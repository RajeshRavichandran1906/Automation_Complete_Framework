...
class C9928152_TestClass(BaseTestCase):
    
    def test_C9928152(self):
        ...
        STEP_06 = """
            STEP 06 : Click on Application menu > Save > Enter title as 'C22837953' > Click Save
        """
