...
class C9928145_TestClass(BaseTestCase):
    
    def test_C9928145(self):
        ...
        HomePage.Workspaces.ContentArea.delete_file_if_exists('C9928145')
        HomePage.Workspaces.ContentArea.delete_folder_if_exists('C9928145 Resources')
        ...
        Step_04_01  = """
            Step 04.01 : Verification - Verify 'New Portal' dialog box opens with the following:
        ...
        Step_05 = """
            Step 05 : Enter title 'C9928145' > Create
        """
        HomePage.ModalDailogs.CollaborativePortal.Title.enter_text('C9928145')
        ...
        Step_07_01  = """
        STEP 07.01 verification - Verify the created 'C9928145' is displayed in the content area    
        """
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.verify_files(["C9928145"],'07.01')
        utils.capture_screenshot('07.01',Step_07_01,expected_image_verify=True)
        
        Step_08 = """
        Right Click on 'C9928145' > Delete > Ok
        """
        HomePage.Workspaces.ContentArea.delete_file('C9928145')
        utils.capture_screenshot('08.00',Step_08)
        
        Step_08_01 = """
        Verify the created 'C9928145' is not displayed in the content area
        """
        HomePage.Workspaces.ContentArea.verify_files(["C9928145"],'08.01',assert_type='asnotin')
