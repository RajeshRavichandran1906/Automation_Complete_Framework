...
class C9928170_TestClass(BaseTestCase):
    
    def test_C9928170(self):
        ...
        HomePage.Workspaces.ContentArea.delete_file_if_exists('C9928170')
        ...
        Step_05 = """
            Step 05 : Enter title as 'C9928170' in properties tab.
        """
        utils.set_text_to_textbox_using_keybord('C9928170', property_title_css)
        ...
        Step_10_01 = """
        Verify that 'C9928170' schedule is created
        """
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.verify_files(["C9928170"],'10.01')
        utils.capture_screenshot('10.01',Step_10_01,expected_image_verify=True)
    
        Step_11 = """
        Right click on 'C9928170' > Delete
        """
        HomePage.Workspaces.ContentArea.delete_file('C9928170')
        utils.capture_screenshot('11.00',Step_11)
        
        Step_11_01 = """
        Verify that 'C9928151' schedule gets deleted
        """
        HomePage.Workspaces.ContentArea.verify_files(["C9928170"],'11.01',assert_type="asnotin")
