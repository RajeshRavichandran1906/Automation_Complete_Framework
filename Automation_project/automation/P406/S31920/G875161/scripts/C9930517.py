...
class C9930517_TestClass(BaseTestCase):
    
    def test_C9930517(self):
        ...
        STEP_01 = """
        Step 01.Sign into WebFOCUS Home Page as Developers
        """
        ...
        """
        HomePage.ContextMenu.verify(['Deferred Status', 'Stop Requests', 'Session Viewer', 'ReportCaster Explorer', 'ReportCaster Status', 'Magnify Search Page', 'WebFOCUS Infographics'],'02.01')
        ...
        STEP_09  = """
        Click on the 'Utilities' icon > Click on 'Session Viewer'
        """
        HomePage.Banner.click_utilities()
        ...
        Verify the following 'Session Viewer' window gets displayed with the URL http://machine_name:port/alias/util/wfsessionviewer.jsp
        """
        core_utils.switch_to_new_window()
        utils.verify_current_url('util/wfsessionviewer.jsp',"Step 09.01 verify the session viewer URL")
        ...
        """
        core_utils.switch_to_new_window()
        utils.verify_current_url('rcex.rc',"Step 11.01 verify the session viewer URL")
        utils.verify_current_tab_name("TIBCO WebFOCUS Schedule Explorer",'Step 11.02 verify the window displayed with Report Caster Explorer')
        ...
        """
        core_utils.switch_to_new_window()
        utils.verify_current_url('rcc.rc',"Step 12.01 Report Caster Status URL")
        utils.verify_current_tab_name("TIBCO WebFOCUS Schedule Status",'Step 12.02 verify the window displayed with ReportCaster Status')
        ...
        """
        core_utils.switch_to_new_window()
        utils.verify_current_url('search',"Step 15.01 Magnify Search Page URL")
        ...
        utils.verify_current_tab_name('easel.ly | create and share visual ideas using infographics',"Step 17.01 webfocus infographics Page URL")
        utils.asequal(Present_Url,'https://webfocus.easel.ly/','Step 17.01 verify the infographics URl')
