...
class C9930335_TestClass(BaseTestCase):
    
    def test_C9930335(self):
        ...
        HomePage.MyWorkspace.select_item('URL_Context')
        ...
        run_sub_menu = ['Run in new window', 'Run deferred']
        schedule_sub_menu = ['Email', 'FTP', 'Printer', 'Report Library', 'Repository']
        HomePage.ContextMenu.verify(context_menu,'06.01')
        HomePage.ContextMenu.select('Run...')
        HomePage.ContextMenu.verify(run_sub_menu,'06.02')
        HomePage.ContextMenu.close(location='top_middle', y=-6)
        HomePage.MyWorkspace.right_click_on_item('TextEditor_Context')
        HomePage.ContextMenu.select('Schedule')
        HomePage.ContextMenu.verify(schedule_sub_menu,'06.03')
