...
Automated On : 24th March 2020
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools.paris_home_page import ParisHomePage

class C9944935_TestClass(BaseTestCase):
    
    def test_C9944935(self):
        ...
        """
        HomePage.Workspaces.ResourcesTree.expand("Workspaces->P406_S31920")
        ...
        STEP_05 = """
        Right-click on 'Edit Testing URL Action Tile' > Click on 'Edit'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('Edit Testing URL Action Tile')
        ...
        Inside the 'Title' entry box 'Edit Testing URL Action tile' is available
        ...
        HomePage.ModalDailogs.URL.Title.verify_text("Edit Testing URL Action Tile",'05.02')
        HomePage.ModalDailogs.URL.Name.verify_disabled('05.03')
        HomePage.ModalDailogs.URL.Name.verify_text('Edit_Testing_URL_Action_Tile','05.04')
        ...
        STEP_06 = """
        Change the URL into 'http://www.informationbuilders.com/news'
        """
        HomePage.ModalDailogs.URL.URL.enter_text("http://www.informationbuilders.com/news")
        HomePage.Home._utils.capture_screenshot('06.00', STEP_06)
        
        STEP_07 = """
        Change the URL to "http://www.informationbuilders.com/news" > Click Update
        """
        HomePage.ModalDailogs.URL.CancelButton.click()
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_08 = """
        Right-click on 'Edit Testing URL Action Tile' > Click on 'View in new window'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('Edit Testing URL Action Tile')
        ...
        STEP_08_01 = """
        Verify 'Press Room|Information Builders' site opens in a new window without any issues and it's URL as 'https://www.informationbuilders.com/press-room'
        """
        ...
        STEP_09 = """
        Close the 'Press Room|Information Builders' URL window
        """
