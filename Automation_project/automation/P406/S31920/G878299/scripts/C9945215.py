...
class C9945215_TestClass(BaseTestCase):
    
    def test_C9945215(self):
        ...
        TEST CASE VARIABLES
        """
        shortcut_report = 'ReportingObject_Context - Shortcut'
        ...
        STEP_06 = """
            ...
            Double click on 'ReportingObject' folder' folder
        """
        HomePage.ModalDailogs.Resources.NavigationBar.BreadCrumb.click_arrow('P406_S31920')
        HomePage.ContextMenu.select('G784912')
        time.sleep(2)
        HomePage.ModalDailogs.Resources.GridView.Folders.double_click('ReportingObject')
        HomePage.Home._utils.capture_screenshot('06.00', STEP_06)
        
        STEP_07 = """
            STEP 07 : 'Click on 'ReportingObject_Context'
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('ReportingObject_Context')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
        Verify the 'Title' = 'ReportingObject_Context' and 'Name' = ReportingObject_Context.fex'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('ReportingObject_Context','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('ReportingObject_Context.fex', '07.02')
        ...
        STEP_08_01 = """
        Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/ReportingObject/ReportingObject_Context'
        Title = ReportingObject_Context - Shortcut
        Summary should be empty
        Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/ReportingObject/ReportingObject_Context.fex','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('ReportingObject_Context - Shortcut','08.02')
        ...
        STEP_09_01 = """
        Verify that shortcut for an item ReportingObject_Context - Shortcut) is being created properly
        and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['ReportingObject_Context - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01,expected_image_verify=True)
        
        STEP_10 = """
        Right-click on 'ReportingObject_Context - Shortcut' item > Click on 'Edit'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('ReportingObject_Context - Shortcut')
        HomePage.ContextMenu.select('Edit')
        HomePage.Home._utils.capture_screenshot('10.00', STEP_10)
        
        STEP_10_01 = """
        Verify that 'ReportingObject_Context - Shortcut' opens without any error
        """
        HomePage.Home._core_utils.switch_to_new_window()
        HomePage.Home._utils.verify_current_tab_name("ReportingObject_Context - WebFOCUS Reporting Object",'Step 10.01 Verify it restored successfully without any error ')
        ...
        STEP_12 = """
        Right-click on 'ReportingObject_Context - Shortcut'' item > Click on 'Run'
        """
        ...
        STEP_12_01 = """
        Verify that 'ReportingObject_Context - Shortcut' runs without any error
        """
        ...
        HomePage.Home._utils.asequal('ReportingObject_Context - Shortcut',output_text,"Step:10.01 verify the title ")
        ...
        STEP_14 = """
        Right-click on 'ReportingObject_Context - Shortcut'' item > Click on 'Delete'
        """
        HomePage.Home._core_utils.switch_to_default_content()
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('ReportingObject_Context - Shortcut')
        HomePage.Home._utils.capture_screenshot('14.00', STEP_14)
        
        STEP_14_01 = """
        Verify that 'ReportingObject_Context - Shortcut'gets deleted and it is not displayed in the content area
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('ReportingObject_Context - Shortcut','14.01','asnotin')
