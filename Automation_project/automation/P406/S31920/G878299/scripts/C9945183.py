...
class C9945183_TestClass(BaseTestCase):
    
    def test_C9945183(self):
        ...
        TEST CASE VARIABLES
        """
        shortcut_report = 'URL_Context - Shortcut'
        ...
        STEP_07 = """
            STEP 07 : Click on 'URL_Context'
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('URL_Context')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
        Verify the 'Title' = 'URL_Context' and 'Name' = 'URL_Context.url'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('URL_Context','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('URL_Context.url', '07.02')
        ...
        STEP_08_01 = """
        Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/Images_URL_Blog_TextEditor/url_context.fex'
        Title = URL_Context - Shortcut
        Summary should be empty
        Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/Images_URL_Blog_TextEditor/URL_Context.url','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('URL_Context - Shortcut','08.02')
        ...
        STEP_09_01 = """
        Verify that shortcut for an item (URL_Context - Shortcut) is being created properly
        and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['URL_Context - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01,expected_image_verify=True)
        
        STEP_10 = """
        Right-click on 'URL_Context - Shortcut' item > Click on 'Run in a new window'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('URL_Context - Shortcut')
        HomePage.ContextMenu.select('View in new window')
        HomePage.Home._utils.capture_screenshot('10.00', STEP_10)
        
        STEP_10_01 = """
        Verify that 'URL_Context - Shortcut' run without any error
        """
        HomePage.Home._core_utils.switch_to_new_window()
        HomePage.Home._utils.verify_current_tab_name('Data and Analytics Company | ibi','Step 10.01 verify the url_context-shortcut run without any error')
        ...
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('URL_Context - Shortcut')
        HomePage.Home._utils.capture_screenshot('12.00', STEP_12)
        
        STEP_12_01 = """
        Verify that 'TextEditor_Context - Shortcut' item get deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('URL_Context - Shortcut','14.01','asnotin')
