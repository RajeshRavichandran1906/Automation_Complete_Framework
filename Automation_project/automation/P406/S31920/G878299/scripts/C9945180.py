...
class C9945180_TestClass(BaseTestCase):
    
    def test_C9945180(self):
        ...
        TEST CASE VARIABLES
        """
        shortcut_report = 'Blog_Context - Shortcut'
        ...
        STEP_07 = """
            STEP 07 : 'Click on 'Blog_Context''
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('Blog_Context')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
        Verify the 'Title' = 'Blog_Context' and 'Name' = 'Blog_Context.blog'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('Blog_Context','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('Blog_Context.blog', '07.02')
        ...
        Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/Images/URL/Blog/TextEditor/Blog_Context'
        Title = Blog_Context - Shortcut
        Summary should be empty
        Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/Images_URL_Blog_TextEditor/Blog_Context.blog','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('Blog_Context - Shortcut','08.02')
        ...
        STEP_09_01 = """
        Verify that shortcut for an item (Blog_Context - Shortcut) is being created properly
        and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['Blog_Context - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01,expected_image_verify=True)
        
        STEP_10 = """
        Right-click on 'Blog_Context - Shortcut' item > Click on 'Comments> View Comments'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('Blog_Context - Shortcut')
        HomePage.ContextMenu.select('Comments')
        HomePage.ContextMenu.select('View comments')
        HomePage.Home._utils.capture_screenshot('10.00', STEP_10)
        
        STEP_10_01 = """
        Verify that 'DF_Page - Shortcut' run without any error
        """
        HomePage.Home._core_utils.switch_to_new_window()
        HomePage.Home._utils.synchronize_until_element_is_visible('div.annotations_new', 90)
        HomePage.Home._utils.verify_element_text('div.annotations_new', 'Add comment...','step 10.01 verify that DF-page shortcut run without error')
        ...
        HomePage.Home._core_utils.switch_to_new_window()
        HomePage.Home._utils.synchronize_until_element_is_visible('div.annotations_new', 90)
        HomePage.Home._utils.verify_element_text('div.annotations_new', 'Add comment...','step 12.01 verify that DF-page shortcut run without error')
        ...
        STEP_14 = """
        Right-click on ''Blog_Context - Shortcut' item > Click on 'Delete'
        """
        HomePage.Home._core_utils.switch_to_default_content()
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('Blog_Context - Shortcut')
        HomePage.Home._utils.capture_screenshot('14.00', STEP_14)
        
        STEP_14_01 = """
        Verify that ''Blog_Context - Shortcut' item get deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('Blog_Context - Shortcut','14.01','asnotin')
