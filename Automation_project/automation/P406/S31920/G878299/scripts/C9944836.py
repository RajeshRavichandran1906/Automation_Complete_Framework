...
class C9944836_TestClass(BaseTestCase):
    
    def test_C9944836(self):
        ...
        """
            TEST CASE VARIABLES
        """
        report_css="#resultArea"
        case_id = global_var_obj.current_test_case
        shortcut_report = 'Document_Context - Shortcut'
        ...
        STEP_07 = """
            STEP 07 : Click on 'Document_Context'
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('Document_Context')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
            STEP 07.01 : Verify the 'Title' = 'Document_Context' and 'Name' = 'Document_Context.fex'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('Document_Context','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('Document_Context.fex', '07.02')
        ...
        STEP_08_01 = """
            ...
            Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/IA_Visualization/Document_Context.fex'
            Title = Document_Context - Shortcut
            Summary should be empty
            Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/IA_Visualization/Document_Context.fex','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('Document_Context - Shortcut','08.02')
        ...
        STEP_09_01 = """
            STEP 09.01 : Verify that shortcut for an item (Document_Context - Shortcut) is being created properly
            and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['Document_Context - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01)
        
        STEP_10 = """
            STEP 10 : Right-click on 'Document_Context - Shortcut' item > Click on 'Run'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('Document_Context - Shortcut')
        time.sleep(10)
        HomePage.ContextMenu.select('Run')
        HomePage.Home._utils.capture_screenshot('10.00', STEP_10)
        
        STEP_10_01 = """
            STEP 10.01 : Verify that 'Document_Context - Shortcut' run without any error
        """
        HomePage.RunWindow.verify_title('Document_Context - Shortcut', '10.01')
        HomePage.RunWindow.switch_to_frame()
        #report.create_html_report_dataset(DATA_SET_NAME1, table_css="table[id^='ITableData0']")
        report.verify_html_report_dataset(DATA_SET_NAME1, "STEP 10.01 : Verify that 'Document_Context - Shortcut' run without any error", table_css="table[id^='ITableData0']")
        ...
        STEP_12 = """
            STEP 12 : Edit 'Document_Context - Shortcut'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('Document_Context - Shortcut')
        time.sleep(10)
        ...
        HomePage.Home._utils.synchronize_with_number_of_element(report_css, 1, 150)
        ...
        STEP_14 = """
            STEP 14 : Right-click on 'Document_Context - Shortcut' item > Click on 'Delete'
        """
        HomePage.Home._core_utils.switch_to_default_content()
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('Document_Context - Shortcut')
        HomePage.Home._utils.capture_screenshot('14.00', STEP_14)
        
        STEP_14_01 = """
            STEP 14.01 : Verify that 'Document_Context - Shortcut' item get deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('Document_Context - Shortcut', '14.01', 'asnotin')
