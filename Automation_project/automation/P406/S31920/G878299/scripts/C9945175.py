...
class C9945175_TestClass(BaseTestCase):
    
    def test_C9945175(self):
        ...
        TEST CASE VARIABLES
        """
        shortcut_report = 'DF_Report - Shortcut'
        ...
        STEP_06 = """
            STEP 06 : Click on > (carot symbol) next to 'P406_S31920' 
            > Click on 'G784912' folder > Double click on 'Designer_Framework' folder
        """
        ...
        time.sleep(6)
        HomePage.ModalDailogs.Resources.GridView.Folders.double_click('Designer_Framework')
        HomePage.Home._utils.capture_screenshot('06.00', STEP_06)
        
        STEP_07 = """
            STEP 07 : 'Click on 'DF_Report'
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('DF_Report')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
        Verify the 'Title' = 'DF_Report' and 'Name' = 'df_report.fex'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('DF_Report','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('df_report.fex', '07.02')
        ...
        Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/Designer_Framework/df_report.fex'
        Title = DF_Report - Shortcut
        Summary should be empty
        Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/Designer_Framework/df_report.fex','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('DF_Report - Shortcut','08.02')
        ...
        STEP_09_01 = """
        Verify that shortcut for an item (DF_Report - Shortcut) is being created properly
        and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['DF_Report - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01,expected_image_verify=True)
        
        STEP_10 = """
        Right-click on 'DF_Report - Shortcut' item > Click on 'Run'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('DF_Report - Shortcut')
        HomePage.ContextMenu.select('Run')
        HomePage.Home._utils.capture_screenshot('10.00', STEP_10)
        
        STEP_10_01 = """
        Verify that 'DF_Report - Shortcut' run without any error
        """
        ...
        HomePage.Home._utils.asequal('DF_Report - Shortcut',output_text,"Step:10.01 verify the title ")
        ...
        HomePage.Home._utils.synchronize_until_element_is_visible('table[class="arGrid"]', 120)
        HomePage.Home._utils.verify_object_visible('table[class="arGrid"]', True,'Step 12.01 verify it restored sucessful')
        HomePage.Home._utils.capture_screenshot('12.01', STEP_12_01,expected_image_verify=True)
        
        STEP_13 = """
       Close Designer Framework tool
        """
        HomePage.Home._core_utils.switch_to_previous_window()
        HomePage.Home._utils.capture_screenshot('13.00', STEP_13)
        
        STEP_14 = """
        Right-click on 'DF_Report - Shortcut' item > Click on 'Delete'
        """
        HomePage.Home._core_utils.switch_to_default_content()
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('DF_Report - Shortcut')
        HomePage.Home._utils.capture_screenshot('14.00', STEP_14)
        
        STEP_14_01 = """
        Verify that 'DF_Report - Shortcut' item get deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('DF_Report - Shortcut','14.01','asnotin')
