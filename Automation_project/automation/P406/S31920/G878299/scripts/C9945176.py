...
class C9945176_TestClass(BaseTestCase):
    
    def test_C9945176(self):
        ...
        TEST CASE VARIABLES
        """
        shortcut_report = 'DF_Page - Shortcut'
        ...
        STEP_07 = """
            STEP 07 : 'Click on 'DF_Page'
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('DF_Page')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
        Verify the 'Title' = 'DF_Page' and 'Name' = 'df_page.fex'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('DF_Page','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('df_page', '07.02')
        ...
        Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/Designer_Framework/df_page.fex'
        Title = DF_Page - Shortcut
        Summary should be empty
        Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/Designer_Framework/df_page','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('DF_Page - Shortcut','08.02')
        ...
        STEP_09_01 = """
        Verify that shortcut for an item (DF_Page - Shortcut) is being created properly
        and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['DF_Page - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01,expected_image_verify=True)
        
        STEP_10 = """
        Right-click on 'DF_Page - Shortcut' item > Click on 'Run'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('DF_Page - Shortcut')
        ...
        HomePage.Home._utils.asequal('DF_Page - Shortcut',output_text,"Step:10.01 verify the title ")
        ...
        HomePage.Home._utils.synchronize_until_element_is_visible('.pd-container-content', 240)
        HomePage.Home._utils.verify_object_visible('.pd-container-content', True,'Step 12.01 verify it restored sucessful')
       ...
       Close Designer Framework tool
        ...
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('DF_Page - Shortcut')
        HomePage.Home._utils.capture_screenshot('14.00', STEP_14)
        
        STEP_14_01 = """
        Verify that 'DF_Report - Shortcut' item get deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('DF_Page - Shortcut','14.01','asnotin')
