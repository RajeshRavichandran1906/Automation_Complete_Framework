...
class C9945174_TestClass(BaseTestCase):
    
    def test_C9945174(self):
        ...
        TEST CASE VARIABLES
        """
        shortcut_report = 'DF_Chart - Shortcut'
        ...
        STEP_07 = """
            STEP 07 : 'Click on 'DF_Chart'
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('DF_Chart')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
        Verify the 'Title' = 'DF_Chart' and 'Name' = 'DF_Chart.fex'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('DF_Chart','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('df_chart.fex', '07.02')
        ...
        Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/Designer_Framework/DF_Chart.fex'
        Title = DF_Chart - Shortcut
        Summary should be empty
        Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/Designer_Framework/df_chart.fex','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('DF_Chart - Shortcut','08.02')
        ...
        STEP_09_01 = """
        Verify that shortcut for an item DF_Chart - Shortcut) is being created properly
        and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['DF_Chart - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01)
        
        STEP_10 = """
        Right-click on 'DF_Chart - Shortcut' item > Click on 'Run'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('DF_Chart - Shortcut')
        HomePage.ContextMenu.select('Run')
        HomePage.Home._utils.capture_screenshot('10.00', STEP_10)
        
        STEP_10_01 = """
        Verify that DF_Chart - Shortcut' run without any error
        """
        ...
        HomePage.Home._utils.asequal('DF_Chart - Shortcut',output_text,"Step:10.01 verify the title ")
        ...
        HomePage.Home._utils.synchronize_until_element_is_visible('.risers', 120)
        HomePage.Home._utils.verify_object_visible('.risers', True,'Step 12.01 verify it restored sucessful')
       ...
       Close Designer Framework tool
        ...
        STEP_14 = """
        Right-click on 'DF_Chart - Shortcut' item > Click on 'Delete'
        """
        HomePage.Home._core_utils.switch_to_default_content()
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('DF_Chart - Shortcut')
        HomePage.Home._utils.capture_screenshot('14.00', STEP_14)
        
        STEP_14_01 = """
        Verify that 'DF_Chart - Shortcut' item get deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('DF_Chart - Shortcut','14.01','asnotin')
