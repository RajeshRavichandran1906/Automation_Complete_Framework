...
class C9945181_TestClass(BaseTestCase):
    
    def test_C9945181(self):
        ...
        TEST CASE VARIABLES
        """
        shortcut_report = 'Image_Context - Shortcut'
        ...
        STEP_07 = """
            STEP 07 : 'Click on 'Image_Context''
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('Image_Context')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
        Verify the 'Title' = 'Image_Context' and 'Name' = 'Image_Context.gif'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('Image_Context','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('Image_Context.gif', '07.02')
        ...
        Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/Images/URL/Blog/TextEditor/Image_Context'
        Title = Image_Context- Shortcut
        Summary should be empty
        Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/Images_URL_Blog_TextEditor/Image_Context.gif','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('Image_Context - Shortcut','08.02')
        ...
        STEP_09_01 = """
        Verify that shortcut for an item Image_Context - Shortcut) is being created properly
        and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['Image_Context - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01,expected_image_verify=True)
        
        STEP_10 = """
        Right-click on 'Image_Context - Shortcut' item > Click on 'View'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('Image_Context - Shortcut')
        HomePage.ContextMenu.select('View')
        HomePage.Home._utils.capture_screenshot('10.00', STEP_10)
        
        STEP_10_01 = """
        Verify that Image_Context - Shortcut' opens without any error
        """
        ...
        HomePage.Home._utils.asequal('Image_Context - Shortcut',output_text,"Step:10.01 verify the title ")
        ...
        STEP_12 = """
        Right-click on 'Image_Context - Shortcut' item > Click on 'Delete'
        """
        HomePage.Home._core_utils.switch_to_default_content()
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('Image_Context - Shortcut')
        HomePage.Home._utils.capture_screenshot('12.00', STEP_12)
        
        STEP_12_01 = """
        Verify that 'Image_Context - Shortcut' item get deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('Image_Context - Shortcut','12.01','asnotin')
