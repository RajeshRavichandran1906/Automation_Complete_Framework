...
class C9945190_TestClass(BaseTestCase):
    
    def test_C9945190(self):
        ...
        TEST CASE VARIABLES
        """
        shortcut_report = 'DistributionList_Context - Shortcut'
        ...
        STEP_07 = """
            STEP 07 : 'Click on 'DistributionList_Context'''''
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('DistributionList_Context')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
        Verify the 'Title' = 'DistributionList_Context' and 'Name' = 'DistributionList_Context.adr'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('DistributionList_Context','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('DistributionList_Context.adr', '07.02')
        ...
        STEP_08_01 = """
        Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/Schedule/DistributionList_Context'
        Title = DistributionList_Context - Shortcut
        Summary should be empty
        Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/Schedule/DistributionList_Context.adr','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('DistributionList_Context - Shortcut','08.02')
        ...
        STEP_09_01 = """
        Verify that shortcut for an item (DistributionList_Context - Shortcut) is being created properly
        and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['DistributionList_Context - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01,expected_image_verify=True)
        
        STEP_10 = """
        Edit 'DistributionList_Context - Shortcut'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('DistributionList_Context - Shortcut')
        ...
        HomePage.Home._utils.verify_current_tab_name("DistributionList_Context- TIBCO WebFOCUS Schedule Distribution List",'Step 10.01 Verify it restored successfully without any error ')
        HomePage.Home._utils.capture_screenshot('10.01', STEP_10_01,expected_image_verify=True)
        
        STEP_11 = """
        Close Distribution List tool
        """
        HomePage.Home._core_utils.switch_to_previous_window()
        HomePage.Home._utils.capture_screenshot('11.00', STEP_11)
        
        STEP_12 = """
        Right-click on 'DistributionList_Context ' item > Click on 'Delete'
        """
        HomePage.Home._core_utils.switch_to_default_content()
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('DistributionList_Context - Shortcut')
        HomePage.Home._utils.capture_screenshot('12.00', STEP_12)
        
        STEP_12_01 = """
        Verify that 'DistributionList_Context - Shortcut' item get deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('DistributionList_Context - Shortcut','12.01','asnotin')
