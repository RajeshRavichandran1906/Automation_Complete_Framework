...
class C9945169_TestClass(BaseTestCase):
    
    def test_C9945169(self):
        ...
        shortcut_report = 'Alert_Context - Shortcut'
        ...
        HomePage.Workspaces.ContentArea.delete_file_if_exists('Alert_Context - Shortcut')
        ...
        """
        HomePage.Home._utils.synchronize_with_visble_text(".open-dialog-resources div[data-ibx-type='breadCrumbTrail']", "Shortcut", 10)
        ...
        STEP_07 = """
            STEP 07 : Click on 'Alert_Context'
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('Alert_Context')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
            STEP 07.01 : Verify the 'Title' = 'Alert_Context' and 'Name' = 'Alert_Context.fex'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('Alert_Context','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('Alert_Context.fex', '07.02')
        ...
        STEP_08_01 = """
            ...
            Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/IA_Visualization/Alert_Context.fex'
            Title = Alert_Context - Shortcut
            Summary should be empty
            Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/IA_Visualization/Alert_Context.fex','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('Alert_Context - Shortcut','08.02')
        ...
        STEP_09_01 = """
            STEP 09.01 : Verify that shortcut for an item (Alert_Context - Shortcut) is being created properly
            and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['Alert_Context - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01)
        
        STEP_10 = """
            STEP 10 : Right-click on 'Alert_Context - Shortcut' item > Click on 'Run'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('Alert_Context - Shortcut')
        time.sleep(25)
        HomePage.ContextMenu.select('Run')
        HomePage.Home._utils.capture_screenshot('10.00', STEP_10)
        
        STEP_10_01 = """
            STEP 10.01 : Verify that 'Alert_Context - Shortcut' run without any error
        """
        HomePage.RunWindow.verify_title('Alert_Context - Shortcut', '10.01')
        HomePage.RunWindow.switch_to_frame()
        #report.create_html_report_dataset(DATA_SET_NAME1)
        report.verify_html_report_dataset(DATA_SET_NAME1, "STEP 10.01 : Verify that 'Alert_Context - Shortcut' run without any error")
        ...
        STEP_12 = """
            STEP 12 : Edit 'Alert_Context - Shortcut'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('Alert_Context - Shortcut')
        time.sleep(20)
        ...
        HomePage.Home._utils.as_List_equal(aa_tool_values, alert_tree_item, msg)
        HomePage.Home._utils.capture_screenshot('12.01', STEP_12_01,expected_image_verify=True)
        
        STEP_13 = """
            STEP 13 : Close Alert Assist tool
        """
        HomePage.Home._core_utils.switch_to_previous_window()
        HomePage.Home._utils.capture_screenshot('13.00', STEP_13)
        
        STEP_14 = """
            STEP 14 : Right-click on 'Alert_Context - Shortcut' item > Click on 'Delete'
        """
        HomePage.Home._core_utils.switch_to_default_content()
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('Alert_Context - Shortcut')
        HomePage.Home._utils.capture_screenshot('14.00', STEP_14)
        
        STEP_14_01 = """
            STEP 14.01 : Verify that 'Alert_Context - Shortcut' item get deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('Alert_Context - Shortcut', '14.01', 'asnotin')
