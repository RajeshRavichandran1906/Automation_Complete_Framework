...
class C9945172_TestClass(BaseTestCase):
    
    def test_C9945172(self):
        ...
        TEST CASE VARIABLES
        """
        shortcut_report = 'Visual_Context - Shortcut'
        ...
        STEP_06 = """
            ...
            > Click on 'G784912' folder > Double click on 'IA/Visualization' folder
        """
        ...
        STEP_07 = """
            STEP 07 : Click on 'Visual_Context'
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('Visual_Context')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
        Verify the 'Title' = 'Visual_Context' and 'Name' = 'Visual_Context.fex'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('Visual_Context','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('Visual_Context.fex', '07.02')
        ...
        Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/IA_Visualization/Visual_Context.fex'
        Title = Visual_Context - Shortcut
        Summary should be empty
        Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/IA_Visualization/Visual_Context.fex','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('Visual_Context - Shortcut','08.02')
        ...
        STEP_09_01 = """
        Verify that shortcut for an item (Visual_Context - Shortcut) is being created properly
        and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['Visual_Context - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01)
        
        STEP_10 = """
        Right-click on 'Visual_Context - Shortcut' item > Click on 'Run'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('Visual_Context - Shortcut')
        HomePage.ContextMenu.select('Run')
        HomePage.Home._utils.capture_screenshot('10.00', STEP_10)
        
        STEP_10_01 = """
        Verify that 'Visual_Context - Shortcut' run without any error
        """
        ...
        HomePage.Home._utils.asequal('Visual_Context - Shortcut',output_text,"Step :12.01 verify the title ")
        ...
        HomePage.Home._utils.synchronize_until_element_is_visible("#MAINTABLE_wbody1 rect[class*='riser']",90)
        HomePage.Home._utils.verify_object_visible("#MAINTABLE_wbody1 rect[class*='riser']",True,'Step 12.01 :Verify it restored successfully without any error ')
        ...
        STEP_14 = """
        Right-click on 'Visual_Context - Shortcut' item > Click on 'Delete'
        """
        HomePage.Home._core_utils.switch_to_default_content()
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('Visual_Context - Shortcut')
        HomePage.Home._utils.capture_screenshot('14.00', STEP_14)
        
        STEP_14_01 = """
        Verify that 'Visual_Context - Shortcut' item get deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('Visual_Context - Shortcut','14.01','asnotin')
