...
class C9945216_TestClass(BaseTestCase):
    
    def test_C9945216(self):
        ...
        TEST CASE VARIABLES
        """
        shortcut_report = 'V4_Portal_Context - Shortcut'
        ...
        STEP_07 = """
            STEP 07 : 'Click on 'V4_portal_Context''
        """
        HomePage.ModalDailogs.Resources.GridView.Files.click('V4_Portal_Context')
        HomePage.Home._utils.capture_screenshot('07.00', STEP_07)
        
        STEP_07_01 = """
        Verify the 'Title' = 'V4_portal_Context' and 'Name' = 'V4_portal_Context.prtl'
        """
        HomePage.ModalDailogs.Resources.Title.verify_text('V4_Portal_Context','07.01')
        HomePage.ModalDailogs.Resources.Name.verify_text('V4_Portal_Context.prtl', '07.02')
        ...
        STEP_08_01 = """
        Target path = 'IBFS:/WFC/Repository/P406_S31920/G784912/Portal/Pages/V4_Portal_Context'
        Title = V4_Portal_Context - Shortcut
        Summary should be empty
        Both 'Cancel' and 'OK' buttons get enabled
        """
        HomePage.ModalDailogs.Shortcut.TargetPath.verify_text('IBFS:/WFC/Repository/P406_S31920/G784912/Portal_Pages/V4_Portal_Context.prtl','08.01')
        HomePage.ModalDailogs.Shortcut.Title.verify_text('V4_Portal_Context - Shortcut','08.02')
        ...
        STEP_09_01 = """
        Verify that shortcut for an item (V4_Portal_Context - Shortcut) is being created properly
        and showing in the content area and the correct shortcut icon is showing as expected
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files(['V4_Portal_Context - Shortcut'],'09.01')
        HomePage.Home._utils.capture_screenshot('09.01', STEP_09_01,expected_image_verify=True)
        
        STEP_10 = """
        Edit 'V4_Portal_Context - Shortcut'
        """
        HomePage.Workspaces.ContentArea.right_click_on_file('V4_Portal_Context - Shortcut')
        ...
        HomePage.Home._utils.verify_current_tab_name("Portal Designer",'Step 10.01 Verify it restored successfully without any error ')
        ...
        STEP_12 = """
        Run 'V4_Portal_Context - Shortcut
        """
        ...
        STEP_12_01 = """
        Verify it run successfully without any error
        """
        HomePage.Home._core_utils.switch_to_new_window()
        HomePage.Home._utils.verify_current_tab_name("V4_Portal_Context",'Step 12.01  Verify it run successfully without any error')
        HomePage.Home._utils.capture_screenshot('12.01', STEP_12_01)
        
        STEP_13 = """
        Close portal run window
        """
        HomePage.Home._core_utils.switch_to_previous_window()
        HomePage.Home._utils.capture_screenshot('13.00', STEP_13)
        
        STEP_14 = """
        Delete 'V4_Portal_Context - Shortcut'
        """
        HomePage.Home._core_utils.switch_to_default_content()
        HomePage.Workspaces.switch_to_frame()
        HomePage.Workspaces.ContentArea.delete_file('V4_Portal_Context - Shortcut')
        HomePage.Home._utils.capture_screenshot('14.00', STEP_14)
        
        STEP_14_01 = """
        Verify that 'V4_Portal_Context - Shortcut' item gets deleted
        """
        HomePage.Workspaces.ContentArea.verify_shortcut_files('V4_Portal_Context - Shortcut','14.01','asnotin')
