...
class C9928211_TestClass(BaseTestCase):
    
    def test_C9928211(self):
        ...
        STEP_05 = """
            STEP 05.00 : Click on the drop-down in the search box > Choose Users in the drop-down list.
        """
        ...
        STEP_06 = """
            STEP 06.00: Enter 'autodevuser204' in the 'Enter users' search box.
        """
        ...
        STEP_06_01 = """
            STEP 06.01 : Verify users contains with the name dev ('autodevuser204') appears with its description and email address if we added
        """
