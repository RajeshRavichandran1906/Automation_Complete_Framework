...
class C9928213_TestClass(BaseTestCase):
    
    def test_C9928213(self):
        ...
        STEP_05 = """
            STEP 05.00 : Click on drop-down in the search box > Users/Groups (By default selected) in the drop-down list
        """
        ShareWithOther.SearchTextBox.click_dropdown_button()
        HomePage.ContextMenu.select('Users/Groups')
        utils.capture_screenshot("05.00", STEP_05)
        
        STEP_06 = """
            STEP 06.00: Enter 'adv' in the 'Enter users/groups' search box.
        """
        ShareWithOther.SearchTextBox.enter_text("adv")
        ShareWithOther.UserGroupResults.wait_for_visible()
        utils.capture_screenshot("06.00", STEP_06)
        
        STEP_06_01 = """
            STEP 06.01 : Verify users and groups with the name contains 'adv' appears as same in the screenshot:
        """
        ShareWithOther.UserGroupResults.verify_name_contains_searched_text("adv", "06.01")
