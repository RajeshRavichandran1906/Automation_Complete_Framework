...
class C9928082_TestClass(BaseTestCase):
    
    def test_C9928082(self):
        ...
        STEP_06 = """
            STEP 06.00 : Click on drop-down in the search box
        """
        ShareWithOther.SearchTextBox.click_dropdown_button()
        utils.capture_screenshot("06.00", STEP_06)
        
        STEP_06_01 = """
            STEP 06.01 : Verify Users, Groups and Users/groups (By default checked) are appears
        """
        ...
        STEP_07 = """
            STEP 07.00 : Click on Users in the drop-down list.
        """
        HomePage.ContextMenu.select(expected_menu[0])
        utils.capture_screenshot("07.00", STEP_07)
        
        STEP_07_01 = """
            STEP 07.01 : Verify Users is checked, 'Enter users' appears in the search box and the drop-down lists still appear
        """
        ...
        STEP_08_01 = """
            STEP 08.01 : Verify Groups is checked, 'Enter groups' appears in the search box and the drop-down lists still appear
        """
        ...
        STEP_09 = """
            STEP 09.00 : Click on Groups in the drop-down list
        """
        HomePage.ContextMenu.select(expected_menu[2])
        utils.capture_screenshot("09.00", STEP_09)
        
        STEP_09_01 = """
            STEP 09.01 : Verify Users/Groups is checked, 'Enter users/groups' appears in the search box and the drop-down lists still appear
        """
        ...
        STEP_10 = """
            STEP 10.00 : Click Cancel button to close the Share with Others window.
        """
        ...
        STEP_11 = """
           STEP 11.00 : Close the portal run window
        """
