...
class C9946423_TestClass(BaseTestCase):
    
    def test_C9946423(self):
        ...
        STEP_05 = """
            STEP 05 : Click on 'New Password' entry box > Enter 'New Password' as 'adv' (valid password)
        """
        HomePage.ModalDailogs.ChangePassword.NewPassword.enter_text(old_password)
        HomePage.Home._utils.capture_screenshot("05", STEP_05)

        STEP_06 = """
            STEP 06 : Click on 'Confirm New Password' entry box > Enter 'Confirm New Password' as 'Pass'
        """
        HomePage.ModalDailogs.ChangePassword.ConfirmNewPassword.enter_text(old_password)
        HomePage.Home._utils.capture_screenshot("06", STEP_06)

        STEP_06_EXPECTED = """
            STEP 06 - Verify that alert prompt message does not appears
        """
