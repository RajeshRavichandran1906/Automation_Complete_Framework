...
class C9927919_TestClass(BaseTestCase):
    
    def test_C9927919(self):
        ...
        expcted_tab = ['General', 'Advanced', 'Server']
        ...
        old_homepage.verify_property_dialog_enable_disable('Allow personal pages', 'check_box', False, 'Step 05.03: Verify Allow personal pages is Disabled', tab_name='Advanced')
        ...
        utils.capture_screenshot("05.02", STEP_05_01,expected_image_verify=True)
        ...
        """
        old_homepage.verify_selected_tab_in_property_dialog("Server", "Step 06.01: propery tab verification")
        old_homepage.verify_property_dialog_enable_disable('Assign Server', 'check_box', False, 'Step 06.02: Verify Assign Server is Disabled', tab_name='Server')
        old_homepage.verify_property_dialog_enable_disable('EDASERVE', 'check_box', False, 'Step 06.03: Verify EDASERVE is Disabled', tab_name='Server')
        old_homepage.verify_property_dialog_enable_disable('Assign Application Path', 'check_box', False, 'Step 06.04: Verify Assign Application Path is disabled', tab_name='Server')
        utils.capture_screenshot("06.00",STEP_06_01)
        
        STEP_07 = """
        Click Cancel to close the properties dialog box
        """
        old_homepage.select_property_dialog_save_cancel_button("Cancel")
        utils.synchronize_until_element_disappear(tab_css, 60)
