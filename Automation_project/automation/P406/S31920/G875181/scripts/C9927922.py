...
class C9927922_TestClass(BaseTestCase):
    
    def test_C9927922(self):
        ...
        STEP_04 = """
            STEP 04 : Right-click on 'V5 Context Menu Testing' from the resource tree > Click Edit
        """
        ...
        """
            STEP 04_01 : Verify that 'Edit Portal' dialog box opens with the following options:
            ...
            11.URL as 'http://machinename:port/alias/P406_S31920/G8751...' is read only
        ...
        utils.capture_screenshot("04.01", STEP_04, expected_image_verify = True)
        
        STEP_05 = """
            STEP 05 : Click X button to close the Edit Portal dialog.
        """
