...
class C9927948_TestClass(BaseTestCase):
    
    def test_C9927948(self):
        ...
        old_homepage.verify_property_dialog_value('Title', 'text_value', 'V5 Context Menu Testing','Step 02.03: Verify title', user_name='autoadmuser59')
        old_homepage.verify_property_dialog_value('Name', 'text_value', '2340005557','Step 02.04: Verify name', user_name='autoadmuser59')
        old_homepage.verify_property_dialog_value('Summary', 'text_area' , '', 'Step 02.05: Verify Summary')
        expected_path= 'IBFS:/WFC/UserInfo/autoadmuser59/Favorites/2340005557'
        ...
        old_homepage.verify_property_dialog_value('Owner', 'text', "autoadmuser59","Step 02.09 :Verify the Owner tab")
        ...
        utils.asequal(actual_output, "Tuesday, December 10, 2019 3:07:35 AM EST by autoadmuser59", msg)
        ...
        STEP_03 = """
            STEP 03.00 : Click the advanced tab
        """
        ...
        old_homepage.verify_property_dialog_value('Sort order', 'text_value', '','Step 03.02 : Verify sort order', user_name='autoadmuser59', tab_name = 'Advanced')
        old_homepage.verify_property_dialog_value('Menu Icon', 'text_value', '', 'Step 03.03 : Verify menu icon', user_name='autoadmuser59', tab_name = 'Advanced')
        old_homepage.verify_property_dialog_value('Tags', 'text_value', '', 'Step 03.04 : Verify Tags',  user_name='autoadmuser59', tab_name = 'Advanced')
