...
class C9946417_TestClass(BaseTestCase):
    
    def test_C9946417(self):
        ...
        HomePage.Home._core_utils.update_config_file("mrpassdev", new_password)
        ...
        STEP_16_EXPECTED = """
            ...
            'The passwords you entered do not match' error message appears with the red background-color
            'Old Password' text box is in grey border-color
            'New Password' and 'Confirm New Password' text boxes highlighted in red border-color
        """
        ...
        """
        HomePage.ModalDailogs.ChangePassword.ChangePasswordButton.click()
        HomePage.Home._core_utils.update_config_file("mrpassdev", old_password)
