"""-------------------------------------------------------------------------------------------
Author Name  : PM14587
Automated On : 31-August-2020
-------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools.paris_home_page import ParisHomePage

class C9945089_TestClass(BaseTestCase):
    
    def test_C9945089(self):
        ...
        STEP_03_EXPECTED = """
            STEP 03 - Expected : Verify 'Help -' open in a new window without any issues
        """
        ...
        STEP_10 = """
            STEP 10 : Click 'X' to Close the 'About WebFOCUS' dialog.
        """
        HomePage.ModalDailogs.AboutWebFOCUS.close()
