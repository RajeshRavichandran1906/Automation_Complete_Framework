...
class C9927975_TestClass(BaseTestCase):
    
    def test_C9927975(self):
        ...
        STEP_03 = """
            Step 03.00 : From the Resource Tree > Right click on "P406_S31920" workspace.
        """
        ...
        STEP_05_01 = """
            ...
            Properties.
        """ 
        expected_menus = ['Expand', 'Paste Ctrl+V', 'Delete DEL', 'Refresh', 'Unshare', 'Share with...', 'Properties']
        ...
        STEP_06 = """
            Step 06.00 : From the Resource Tree > Right click on "G784912" folder under "P406_S31920" workspace.
        """
        ...
        STEP_06_01 = """
            ...
            Properties.
        """
        expected_menus = ['Expand', 'Copy Ctrl+C', 'Refresh', 'Properties']
