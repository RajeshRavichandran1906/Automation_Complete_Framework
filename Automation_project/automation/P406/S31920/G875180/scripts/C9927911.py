...
class C9927911_TestClass(BaseTestCase):
    
    def test_C9927911(self):
        ...
        old_homepage.verify_property_dialog_tab_list(['General','Advanced'], "Step 4.2: tab list verification")
        old_homepage.verify_property_dialog_value('Title', 'text_value', "V5 Context Menu Testing","Step 4.3:Verify the title tab")
        old_homepage.verify_property_dialog_value('Name', 'text_value', "V5_Context_Menu_Testing","Step 4.4:Verify the Name tab")
        old_homepage.verify_property_dialog_enable_disable('Name', 'text_value', False, "Step 4.5: Verify Name - is disable.")
        old_homepage.verify_property_dialog_value('Summary', 'text_area',"","Step 4.6:Verify the Summary tab")
        old_homepage.verify_property_dialog_value('Path', 'text_value', "IBFS:/WFC/Repository/P406_S31920/G875179/V5_Context_Menu_Testing","Step 4.7:Verify the Path tab")
        old_homepage.verify_property_dialog_value('Owner','text',"-","Step 4.8:Verify the Owner tab")
        old_homepage.verify_created_modified_accessed_time_stamp_format('Created','admin',"step 4.9 verify the created tab value")
        old_homepage.verify_created_modified_accessed_time_stamp_format('Modified','autoadmuser59',"step 4.10 verify the Modified tab value")
        old_homepage.verify_created_modified_accessed_time_stamp_format('Accessed','autoadmuser59',"step 4.11 verify the Accessed tab value")
        old_homepage.verify_property_dialog_enable_disable('Publish', 'radiobutton_value', False, "Step 4.12: Verify Publish - is enabled.")
        old_homepage.verify_property_dialog_value('Publish','radiobutton_value','Yes',"Step 4.13: Verify Publish - is available")
        old_homepage.verify_property_dialog_enable_disable('Show', 'radiobutton_value', False, "Step 4.14: Verify Publish - is enabled.")
        old_homepage.verify_property_dialog_value('Show','radiobutton_value','Yes',"Step 4.13: Verify Show - is enabled.")
        old_homepage.verify_property_dialog_save_cancel_button_enable_disable('Save', 'disable', "Step 04.15: Verify save button disabled")
        old_homepage.verify_property_dialog_save_cancel_button_enable_disable('Cancel', 'enable', "Step 04.16: Verify cancel button enabled")
        ...
        old_homepage.verify_property_dialog_enable_disable('Allow personal pages', 'check_box', 'Allow personal pages', 'Step 5.3: Verify Allow personal pages is Disabled', tab_name='Advanced')
