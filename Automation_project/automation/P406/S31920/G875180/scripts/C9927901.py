...
class C9927901_TestClass(BaseTestCase):
    
    def test_C9927901(self):
        ...
        STEP_05_01 = """
            Step 05.00 : Hover over the 'Customization' menu.
        ...
        STEP_06_01 = """
            Step 06.00 : Hover over the 'Security' Menu.
            Step 06.01 : Verification - Verify the following context menu:
        """
        HomePage.Workspaces.ContentArea.right_click_on_folder("V5 Context Menu Testing")
