...
class C9927905_TestClass(BaseTestCase):
    
    def test_C9927905(self):
        ...
        STEP_04_01 = """
            ...
            Title as 'V5 Context Menu Testing'
            Name as 'V5_Context_Menu_Testing'
            Alias as empty
            Banner toggle button is on
            Show portal title in banner checkbox is checked
            Logo is enabled with the text Not Selected and Browse button is on the right of the logo
            ...
            Theme is "Designer 2018" 11.URL as 'http://machinename:port/alias/portal/P406_S31920/G8751...' and it is disabled
