...
class C9927903_TestClass(BaseTestCase):
    
    def test_C9927903(self):
        ...
        STEP_04 = """
            Step 04.00 : Double click on 'V5 Context Menu Testing' in the content area.
        """
        HomePage.Workspaces.ContentArea.double_click_on_folder("V5 Context Menu Testing")
