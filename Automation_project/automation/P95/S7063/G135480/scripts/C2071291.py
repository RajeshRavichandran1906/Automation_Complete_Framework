...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2071291
...
class C2071291_TestClass(BaseTestCase):

    def test_C2071291(self):
        ...
        chart_obj.verify_active_chart_tooltip('MAINTABLE_wbody0_f', 'riser!s0!g0!mbar!', alfa_romeo_tooltip, msg='Step 7.1: Verify alfa romeo tooltip')
