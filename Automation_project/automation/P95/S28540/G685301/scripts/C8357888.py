...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8357888
...
class C8357888_TestClass(BaseTestCase):

    def test_C8357888(self):
        ...
        Test case variables
        """
        x_label1 = ['ALFA ROMEO', 'AUDI', 'BMW', 'DATSUN', 'JAGUAR', 'JENSEN', 'MASERATI', 'PEUGEOT', 'TOYOTA', 'TRIUMPH']
        x_label = ['ALFA ROM...', 'AUDI', 'BMW', 'DATSUN', 'JAGUAR', 'JENSEN', 'MASERATI', 'PEUGEOT', 'TOYOTA', 'TRIUMPH']
        ...
        chart_obj.verify_x_axis_label_in_preview(x_label1, msg='Step 4.1 verify the x axis labels')
        ...
        Expect to see the following Active Report Preview pane Tooltip.
        """
        ...
        if Global_variables.browser_name == 'firefox':
            ...
            active_chart_obj.verify_x_axis_label_in_run_window(x_label, msg='Step 8.1: Verify x axis labels')
        else:
            active_chart_obj.verify_x_axis_label_in_run_window(x_label, msg='Step 8.1: Verify x axis labels')
        
        active_chart_obj.verify_y_axis_label_in_run_window(y_label, msg='Step 8.2: Verify y axis labels')
        active_chart_obj.verify_chart_title(chart_title, msg='Step 8.3: Verify Chart title', parent_css = '#MAINTABLE_wbody0_ft')
        active_chart_obj.verify_number_of_risers_in_run_window('rect', 1, 10, msg='Step 8.4: Verify number of risers')
        ...
        util_obj.asequal(riser_mixed_color, observed_riser_color, "Step 8.5: Verify Riser color")
