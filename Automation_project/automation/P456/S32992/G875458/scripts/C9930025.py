...
class C9930025_TestClass(BaseTestCase):
    
    def test_C9930025(self):
        ...
        STEP_03 = """
            STEP 03 : In Resources tree, Expand Workspaces and Select "abc_1"
        """
        HomePage.Workspaces.ResourcesTree.select('abc_1')
        ...
        STEP_05_01 = """
            STEP 05.01 : Verify that "abc_1" folder should displayed under Application Folder
        """
