...
class C9930029_TestClass(BaseTestCase):
    
    def test_C9930029(self):
        ...
        STEP_03 = """
            STEP 03 : In Resources tree, Expand Workspaces -> My Workspace"
        """
        HomePage.Workspaces.ResourcesTree.select('Workspaces->My Workspace')
