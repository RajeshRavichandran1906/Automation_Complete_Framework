...
class C9930080_TestClass(BaseTestCase):
    
    def test_C9930080(self):
        ...
        STEP_03 = """
            STEP 03 : In Resources tree, Expand Workspaces and Select "abc_4"
        """
        HomePage.Workspaces.ResourcesTree.select('abc_4')
