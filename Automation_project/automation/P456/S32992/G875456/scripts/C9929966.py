...
class C9929966_TestClass(BaseTestCase):
    
    def test_C9929966(self):
        ...
        STEP_01 = """
            STEP 01 : Sign in to WF cloud environment using "abc_3@ibi.com" user
        """
        ...
        STEP_03 = """
            STEP 03 : In Resources tree, Expand Workspaces and Select "abc_3"
        """
