...
class C9945705_TestClass(BaseTestCase):
    
    def test_C9945705(self):
        ...
        expected_status_attrib = {'_jt': 'IBFSScmStatusObject', 'contentStatus': 'CHANGED', 'metadatsStatus': 'CHANGED', 'status': 'CHANGED'}
