...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2350327
TestCase Name = Verify uploaded pdf file properties
'''
...
class C2350327_TestClass(BaseTestCase):

    def test_C2350327(self):
        """
        TESTCASE VARIABLES
        """
        ...
        """ Step 3: Right click on P242_S10674_G171304/Uploaded Files/Readme and select Properties from the menu.
        ...
        """ Step 5: Click on Advanced tab.
                    Verify Thumbnail (Default is selected - PDF Embedded, Link radio buttons), Tags, Sort Order, Default Width, Default Height are enabled. 
