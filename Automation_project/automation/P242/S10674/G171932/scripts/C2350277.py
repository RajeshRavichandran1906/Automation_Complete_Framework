...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2350277
TestCase Name = Verify access list properties
'''
...
class C2350277_TestClass(BaseTestCase):

    def test_C2350277(self):
        """
        TESTCASE VARIABLES
        """
        ...
        proj_sub_folder_item='Access List'
        ...
        burst_value_css=".caster-entry:not(.caster-detail-name)"
        ...
        """ Step 3: Right click on P242_S10674_G171304/Report Caster/Access List and select Properties from the menu.
                    Verify only General, Advanced and Library Access List Details tabs appears.
        """
        ...
        expected_value_list=['General', 'Advanced', 'Library Access List Details']
        wf_mainobj.verify_property_dialog_value('General', 'tab_value', "Step 3: Verify only General, Advanced and Library Access List Details tabs appears.", property_value=expected_value_list)
        
        """ Step 4: Explore General Properties.
                    Verify View All, Title, Summary, Publish and Show are enabled. Verify dates appear. Tool is accesslist. No Owner. Save button is disabled.
        ...
        wf_mainobj.verify_property_dialog_value('Tool', 'text', "Step 4.10: Verify Tool as : 'accesslist'", property_value='accesslist')
        ...
        """ Step 5: Click on Advanced tab.
                    Verify Thumbnail (Default is selected - Access List thumbnail, Embedded, Link radio buttons), Sort Order enabled.
        """
        ...
        """ Step 6: Click on Access list details tab.
                    Verify Burst Value is No.
        """
        wf_mainobj.edit_property_dialog_value('Library Access List Details', 'tab_value', 'Library Access List Details')
        burst_value_obj=wf_mainobj.get_property_dialog_rows_object("Burst Value:", '6')
        burst_value=burst_value_obj.find_element_by_css_selector(burst_value_css).text.strip()
        utillobj.asequal(burst_value, 'No', "Step 6.1: Verify Burst Value is No.")
