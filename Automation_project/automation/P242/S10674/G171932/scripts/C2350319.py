...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2350319
...
class C2350319_TestClass(BaseTestCase):

    def test_C2350319(self):
        """
        TESTCASE VARIABLES
        """
        ...
        proj_sub_folder_item='Excel Spreadsheet'
        ...
        """ Step 3: Right click on P242_S10674_G171304/Uploaded Files/Excel Spreadsheet and select Properties from the menu.
        ...
        """ Step 4: Explore General tab.
                    Verify View All, Title, Summary, Publish and Show are enabled and Tool is blank. No owner. Save is disabled unless user makes change.
        ...
        wf_mainobj.verify_property_dialog_value('Tool', 'text', "Step 4.7: Verify Tool is blank.", property_value='')
        ...
        """ Step 5: Click on Advanced tab.
                    Verify Thumbnail (Default is selected - Excel document, Embedded, Link radio buttons), Tags, Sort Order, 
                    Default Width, Default Height are enabled. Load in iframe is disabled.
