...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2350326
TestCase Name = Verify uploaded png image properties
'''
...
class C2350326_TestClass(BaseTestCase):

    def test_C2350326(self):
        """
        TESTCASE VARIABLES
        """
        ...
        proj_sub_folder_item='PNG image file'
        ...
        """ Step 3: Right click on 'P242_S10674_G171304/Uploaded Files/PNG image file' and select Properties from the menu.
        ...
        """ Step 5: Click on Advanced tab.
                    Verify Thumbnail (Embedded is selected - PNG, Embedded, Link radio buttons), Tags, Sort Order, Default Width, Default Height are enabled. 
        ...
        utillobj.verify_regional_picture_using_sikuli('png_image_file.png', "Step 5.2.1: Verify Default is selected - JPG image.", parent_element=properties_advanced_item_elem)
