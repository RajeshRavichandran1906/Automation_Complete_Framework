...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2350216
TestCase Name = Verify V4/Collaborative portal properties
'''
...
class C2350216_TestClass(BaseTestCase):

    def test_C2350216(self):
        """
        TESTCASE VARIABLES
        """
        ...
        proj_sub_folder="{0}->Portals->V4 Portals".format(proj_id)
        proj_sub_folder_item='V4 Portal'
        ...
        """ Step 3: Right click on P242_S10674_G171304/Portals/V4 Portals/V4 Portal and select Properties from the menu.
        ...
        """ Step 5: Click on Advanced tab.
                    Verify Thumbnail (Default is selected - V4 portal thumbnail, Embedded, Link radio buttons), Tags, Sort Order enabled. 
        ...
        utillobj.verify_regional_picture_using_sikuli('v4_portal.png', "Step 5.2.1: Verify Default is selected - V4 portal thumbnail.", parent_element=properties_advanced_item_elem)
