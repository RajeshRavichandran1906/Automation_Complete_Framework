...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2350320
TestCase Name = Verify uploaded gif image properties
'''
...
class C2350320_TestClass(BaseTestCase):

    def test_C2350320(self):
        """
        TESTCASE VARIABLES
        """
        ...
        proj_sub_folder_item='GIF image file'
        ...
        """ Step 3: Right click on P242_S10674_G171304/Uploaded Files/GIF image file and select Properties from the menu.
        ...
        """ Step 5: Click on Advanced tab.
                    Verify Thumbnail (Embedded is selected - Default, Embedded, Link radio buttons), Tags, Sort Order, Default Width, Default Height are enabled.
