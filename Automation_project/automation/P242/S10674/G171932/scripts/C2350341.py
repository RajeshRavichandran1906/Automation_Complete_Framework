...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2350341
TestCase Name = Verify URL properties
'''
...
class C2350341_TestClass(BaseTestCase):

    def test_C2350341(self):
        """
        TESTCASE VARIABLES
        """
        ...
        proj_sub_folder="{0}->URLs".format(proj_id)
        proj_sub_folder_item='url1'
        ...
        """ Step 3: Click on 'URLs' folder from under domains tree.
        """
        """ Step 4: Right click on P242_S10674_G171304/URLs/url1 and select Properties from the menu.
        ...
        """ Step 5: Explore General tab.
                    Verify View All, Title, Summary, Publish and Show are enabled and Tool is url. No owner. Save button is disabled.
        ...
        wf_mainobj.verify_property_dialog_value('Tool', 'text', "Step 4.10: Verify Tool is url.", property_value='url')
        ...
        """ Step 6: Click on Advanced tab.
                    Thumbnail (Default is selected - URL, Embedded, Link radio buttons), Tags, Sort Order, Default Width, Default Height are enabled. 
        ...
        wf_mainobj.verify_property_dialog_enable_disable('Load in iframe', 'radiobutton_value', 'No', "Step 5.7: Verify Load in iframe - is disabled.", tab_name='Advanced')
