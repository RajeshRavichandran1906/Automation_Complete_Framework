...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2350217
TestCase Name = Verify V4/Collaborative portal page properties
'''
...
class C2350217_TestClass(BaseTestCase):

    def test_C2350217(self):
        """
        TESTCASE VARIABLES
        """
        ...
        proj_sub_folder="{0}->Portals->V4 Portals->V4 Portal Resources".format(proj_id)
        proj_sub_folder_item='Page1'
        ...
        """ Step 3: Right click on P242_S10674_G171304/Portals/V4 Portals/V4 Portal Resources/Page1 and select Properties from the menu.
        ...
        """ Step 4: Explore General tab.
                    View All, Title, Summary, Publish and Show are enabled. Verify dates appear. No Owner. Save is disabled unless user makes change.
        ...
        """ Step 5: Click on Advanced tab.
                    Verify Thumbnail (Default is selected - V4 portal page thumbnail, Embedded, Link radio buttons), Tags, Sort Order enabled. 
