...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2350323
TestCase Name = Verify uploaded ms word document properties
'''
...
class C2350323_TestClass(BaseTestCase):

    def test_C2350323(self):
        """
        TESTCASE VARIABLES
        """
        ...
        proj_sub_folder_item='Microsoft Word document'
        ...
        """ Step 3: Right click on P242_S10674_G171304/Uploaded Files/Microsoft Word Document and select Properties from the menu.
        ...
        """ Step 5: Click on Advanced tab.
                    Verify Thumbnail (Default is selected - MS Word, Embedded, Link radio buttons), Tags, Sort Order, Default Width, Default Height are enabled. 
