...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2350328
TestCase Name = Verify uploaded svg image properties
'''
...
class C2350328_TestClass(BaseTestCase):

    def test_C2350328(self):
        """
        TESTCASE VARIABLES
        """
        ...
        proj_sub_folder_item='SVG image file'
        ...
        """ Step 3: Right click on 'P242_S10674_G171304/Uploaded Files/SVG image file' and select Properties from the menu.
        ...
        """ Step 5: Click on Advanced tab.
                    Verify Thumbnail (Embedded is selected - SVG, Embedded, Link radio buttons), Tags, Sort Order, Default Width, Default Height are enabled. 
        ...
        default_radiobutoon_obj=radio_optoins_elems[expected_thumbnail_radiobutton_options.index('Embedded')].find_element_by_css_selector("[class^='ibx-radio-button']")
        ...
        utillobj.asequal('checked', default_radiobutoon_status, "Step 5.2: Verify Embedded is selected - Default.")
        properties_advanced_item_elem=self.driver.find_element_by_css_selector(advanced_tab_css)
        utillobj.verify_regional_picture_using_sikuli('svg_image_file.png', "Step 5.2.1: Verify Default is selected - JPG image.", parent_element=properties_advanced_item_elem)
