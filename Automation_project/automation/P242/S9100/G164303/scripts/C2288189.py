...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2288189'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C2288189_TestClass(AS_BaseTestCase):
    def test_C2288189(self):
        ...
        as_utilobj.verify_picture_using_sikuli("step5_C2288189.png","Step 05: Verified that Field tab is displayed instead of layout tab")
        time.sleep(2)
        ...
        as_utilobj.verify_picture_using_sikuli("step7_C2288189.png","Step 07: Verified that layout tab is displayed")
