...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2288547'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C2288547_TestClass(AS_BaseTestCase):
    def test_C2288547(self):
        ...
        as_utilobj.verify_picture_using_sikuli("step3_C2288547.png","Step 03: Verify that Field Alias is shown in Object inspector")
        time.sleep(1)
