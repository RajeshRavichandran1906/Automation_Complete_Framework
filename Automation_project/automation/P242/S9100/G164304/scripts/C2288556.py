...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2288556'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C2288556_TestClass(AS_BaseTestCase):
    def test_C2288556(self):
        ...
        files=["car.mas"]
        click_items=["Reporting","Report","COUNTRY","CAR","Source","Design","No","Active Report"]
        combo_box_id=["20797"]
        ...
        verify_msg_1="Step 03: Verify Default Report Format: Active Report"
        verify_image_1="step3_C2288556.png"
        ...
        '''Step 01: Click on AS Menu->Options, click on Reporting
                    Default Report Format, select Active Report from the drop down list
                    Click OK'''
