...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2287620'''
...
class C2287620_TestClass(AS_BaseTestCase):
    def test_C2287620(self):
        ...
        as_utilobj.select_home_button(move_x=285,move_y=174)
        time.sleep(1)
        keys.hotkey("delete")
        keys.hotkey("enter")
        ...
        keys.typewrite(("TABLE SET PAGE-NUM NOLEAD"),interval=0.25)
        time.sleep(1)
        ...
        keys.typewrite(("ON TABLE SET PAGE-NUM NOLEAD"),interval=0.25)
