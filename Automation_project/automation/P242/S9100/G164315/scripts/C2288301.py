...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2288301'''

from common.lib.as_basetestcase import AS_BaseTestCase
import unittest, time
from common.lib import as_utility

class C2288301_TestClass(AS_BaseTestCase):
    def test_C2288301(self):
        ...
        as_utilobj.select_component_by_right_click(right_click_folder='New_Folder1',click="New",click_sub_menu='Procedure')
        time.sleep(4)
        ...
        as_utilobj.select_component_by_right_click(right_click_folder='New_Folder1',click="New",click_sub_menu='Procedure via Text Editor')
        time.sleep(2)
        ...
        as_utilobj.select_component_by_right_click(right_click_folder='New_Folder1',click="New",click_sub_menu='Report')
        time.sleep(3)
         
        as_utilobj.Verify_Current_Dialog_Opens("Select Data Source","Step 05: Verified data source dialog invoked for report")
        time.sleep(2)
           
        '''Step 06 & 07: Select ibisamp and Select car.mas and click Finish'''
        ...
        as_utilobj.select_component_by_right_click(right_click_folder='New_Folder1',click="New",click_sub_menu='SQL Report')
        time.sleep(2) 
        ...
        as_utilobj.select_component_by_right_click(right_click_folder='New_Folder1',click="New",click_sub_menu='Chart')
        time.sleep(8)
          
        as_utilobj.Verify_Current_Dialog_Opens("Select Data Source","Step 11: Verified Select data source dialog invoked for chart")
        time.sleep(2) 
        
        '''Step 12&13: Select ibisamp and Select car.mas and click Finish'''
