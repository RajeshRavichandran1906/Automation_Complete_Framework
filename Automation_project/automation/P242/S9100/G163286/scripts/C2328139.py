...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2328139'''
...
class C2328139_TestClass(AS_BaseTestCase):
    def test_C2328139(self):
        ...
        enable_display_command_lines=['down','down','down']
        ...
        verify_browser_text=["0 NUMBER OF RECORDS SELECTED=        5  LINES=      5","0 NUMBER OF RECORDS SELECTED=        5  LINES=      5","0 LINES OF MATCH OUTPUT     =        5"]
        verify_webfocus_report="WebFOCUS Report"
        verify_msg_1="Step 01: Verify Results display in browser/viewer"
        verify_msg_2="Step 02: Verify FOCUS commands executed along with display command lines - "
        ...
        '''Step 01: In Environments Tree, navigate to Domains
                    ...
                    Click on drop down icon next to the run icon and select Display command lines
                    Click Run''' 
        ...
        as_utilobj.click_element_using_ui(split_button_with_offset=locators.run_splitbutton,x=run_drop_down[0],y=run_drop_down[1],send_keys=enable_display_command_lines)
        time.sleep(2)
