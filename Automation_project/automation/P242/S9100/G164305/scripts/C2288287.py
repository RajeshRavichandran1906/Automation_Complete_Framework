...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2288287'''
...
class C2288287_TestClass(AS_BaseTestCase):
    def test_C2288287(self):
        ...
        '''Step 01: Click on AS Menu and click Options, click OK
                    Click HTML Page
                    Under Form Type->Form Settings
                    Change "Number of columns" to 2, click OK
                    Click OK'''
        ...
        as_utilobj.select_element_appstudio_options(edit_element="23143",write="2")
        time.sleep(2)
        ...
        '''Step 03: Click on Report and draw a report container on canvas
                    Right click within the report container and select "Import existing report"
                    Navigate to CC - AppStudio-AS Files and double click on l'''
        ...
        as_utilobj.select_file_in_dialogs("OK",select_file="MultipleParameters.fex")
        time.sleep(3)
          
        as_utilobj.Verify_Current_Dialog_Opens("New Parameters","Step 03: Verified that new parameters window invoked with fields")
        time.sleep(2)
        ...
        as_utilobj.verify_picture_using_sikuli("step4_C2288287.png","Step 04: Verified that CarTwoParm.fex been invoked in HTML canvas")
        time.sleep(1)
        ...
        as_utilobj.verify_picture_using_sikuli("step5_C2288287.png","Step 5.2: Verified that report displays in browser with two columns")
        time.sleep(2)
        ...
        as_utilobj.verify_picture_using_sikuli("step6_C2288287.png","Step 06: Verified that Number of columns values are restored to '4'")
