...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2288285'''
...
class C2288285_TestClass(AS_BaseTestCase):
    def test_C2288285(self):
        ...
        '''Step 01: Click on AS Menu and click Options, click OK
                    Click HTML Page
                    Under 'Form Type' select 'Multiple layer' 
                    Click OK'''
         
        as_utilobj.select_application_menu_options(options=True)
        time.sleep(1)
            
        as_utilobj.select_element_appstudio_options(list_item="HTML Page",radio_button="23514")
        time.sleep(2)
        ...
        '''Step 03: Click on Report and draw a report container on canvas
                    right click within the report container and select "Import existing report"
                    Navigate to CC - AppStudio-AS Files and double click on CarTwoParms.fex'''
        ...
        as_utilobj.select_file_in_dialogs("OK",select_file="CarTwoParms.fex")
        time.sleep(3)
          
        as_utilobj.Verify_Current_Dialog_Opens("New Parameters","Step 03: Verified that new parameters window opened for CarTwoParm.fex")
        time.sleep(2)
        ...
        as_utilobj.verify_picture_using_sikuli("step4_C2288285.png","Step 04: Verified that CarTwoParm.fex been invoked in html canvas")
        time.sleep(1)
        ...
        as_utilobj.verify_picture_using_sikuli("step5_C2288285.png","Step 5.2: Verified that report displays in browser with one form")
        time.sleep(2)
