...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2288280'''
...
class C2288280_TestClass(AS_BaseTestCase):
    def test_C2288280(self):
        ...
        '''Step 01: Click on AS menu->Options
                    Click HTML Page
                    In Grid Settings, set Width to 100
                    Click OK'''
        
        as_utilobj.select_application_menu_options(options=True)
        time.sleep(1)
          
        as_utilobj.select_element_appstudio_options(list_item="HTML Page",edit_element="15002",write="100")
        time.sleep(2)
        ...
        as_utilobj.verify_picture_using_sikuli("step2_C2288280.png","Step 02: Verified that html page invoked in grid settings assigned")
        time.sleep(1)
