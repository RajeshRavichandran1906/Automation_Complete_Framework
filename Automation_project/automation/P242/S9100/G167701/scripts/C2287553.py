...
class C2287553_TestClass(AS_BaseTestCase):
    def test_C2287553(self):
        ...
        as_utilobj.Verify_Element("C2287553.txt","Step 05: Verify: Displayed filename/title in the panel matches actual filename/title for Text Doc",available=True)
        time.sleep(1)   
        ...
        as_utilobj.Verify_Element("C2287553CS.css","Step 08: Verify: Displayed filename/title in the panel matches actual filename/title FOR CSS",available=True)
        time.sleep(1) 
