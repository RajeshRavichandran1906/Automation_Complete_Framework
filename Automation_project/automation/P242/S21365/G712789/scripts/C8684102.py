...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/8684102
...
class C8684102_TestClass(BaseTestCase):

    def test_C8684102(self):
        ...
        """
        EXPECTED_CONTEXT_MENU = ['Open', 'Create Report', 'Create InfoAssist Chart', 'Open in Text Editor', 'Edit in Windows Associated Tool', 'Refresh Synonym', 'Sample Data', 'Impact Analysis', 'Print', 'Check', 'Edit Access File as Text', 'New', 'Duplicate', 'Copy', 'Rename', 'Delete', 'Properties']
