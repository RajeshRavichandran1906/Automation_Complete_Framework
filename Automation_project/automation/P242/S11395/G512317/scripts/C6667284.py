...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2288550'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C6667284_TestClass(AS_BaseTestCase):
    def test_C6667284(self):
        ...
        files=["car.mas"]
        click_items=["Reporting","Report","Show Field List","(COUNTRY)","Show Field Tree","A10"]
        check_box_id=["20790","20793"]
        dialog_buttons=["OK","OK"]  
        key_pattern_1=['down','down','right'] 
        offset_values=[400,829]
        sleep=[1,2,3,4,5,6,7,8,9] 
        verify_msg_1="Step 03: Verify that data formats is shown in Object Inspector"
        
        as_utilobj.select_home_button()
        
        '''Step 01: Open AS Options dialog box-> click on Reporting
                    Uncheck "Display the field name"
                    Check "Display the data formats"
                    Click OK'''
        ...
        as_utilobj.select_element_appstudio_options(list_item=click_items[0],check_box=check_box_id[1])
        time.sleep(sleep[0])
        ...
        '''Step 03: Right click on Object inspector-> select Show Field List
                    Right click on Object Inspector-> select Show Field Tree'''
        ...
        as_utilobj.click_element_using_ui(text_click=click_items[5])
        
        as_utilobj.Verify_Element(click_items[5],verify_msg_1,available=True)
