...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667300'''
...
class C6667300_TestClass(AS_BaseTestCase):
    def test_C6667300(self):
        ...
        verify_image_1="step3_C6667300.png"
        verify_image_2="step4_C6667300.png"
        ...
        as_utilobj.select_file_in_dialogs(component_locators.ok_button,tree_path=select_folders[0],select_file=files[1])
        time.sleep(sleep[5])
