...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667281'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C6667281_TestClass(AS_BaseTestCase):
    def test_C6667281(self):
        ...
        as_utilobj.select_element_appstudio_options(check_box="20794")
        time.sleep(2)
        ...
        as_utilobj.verify_picture_using_sikuli("step3_C6667281.png","Step 03: Verify that Field Alias is shown in Object inspector")
        time.sleep(1)
        ...
        '''Step 04: Right click on Object Inspector-> select Show Field Tree
                    ...
                    UnCheck "Display the field alias"'''
