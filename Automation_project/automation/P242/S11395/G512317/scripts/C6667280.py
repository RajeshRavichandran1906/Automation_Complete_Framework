...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667280'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C6667280_TestClass(AS_BaseTestCase):
    def test_C6667280(self):
        ...
        as_utilobj.Verify_Element("(COUNTRY)","Step 03: Verified view of fields name appears in Object Inspector",available=True)
