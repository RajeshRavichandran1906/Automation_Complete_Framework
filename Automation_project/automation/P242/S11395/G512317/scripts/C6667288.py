...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667288'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C6667288_TestClass(AS_BaseTestCase):
    def test_C6667288(self):
        ...
        verify_msg_1="Step 03: Verify Alias fieldname"
        verify_image_1="step3_C6667288.png"
        ...
        '''Step 01: Click on AS Menu->Options, click on Reporting
                    Authoring mode select radio button for Alias fieldname
                    Click OK'''
