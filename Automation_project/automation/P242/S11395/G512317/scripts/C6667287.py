...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667287'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C6667287_TestClass(AS_BaseTestCase):
    def test_C6667287(self):
        ...
        verify_msg_1="Step 03: Verify syntax in Object Inspector-Unqualified fieldname"
        verify_image_1="step3_C6667287.png"
        ...
        '''Step 01: Click on AS Menu->Options, click on Reporting
                    Authoring mode select radio button for Unqualified fieldname
                    Click OK'''
          
        as_utilobj.select_application_menu_options(options=True)
        time.sleep(sleep[0])
               
        as_utilobj.select_element_appstudio_options(list_item=click_items[0],radio_button=radio_button_id[1])
        time.sleep(sleep[0]) 
        ...
        '''Step 05: Click on AS Menu->Options, click on Reporting
                    Authoring Mode select radio button for Qualified fieldname
                    Click OK'''
        
        as_utilobj.select_application_menu_options(options=True)
        time.sleep(sleep[0])
              
        as_utilobj.select_element_appstudio_options(list_item=click_items[0],radio_button=radio_button_id[0])
        time.sleep(sleep[0]) 
