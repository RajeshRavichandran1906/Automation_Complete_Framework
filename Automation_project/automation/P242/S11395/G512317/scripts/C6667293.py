...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667293'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C6667293_TestClass(AS_BaseTestCase):
    def test_C6667293(self):
        ...
        files=["car.mas"]
        click_items=["Reporting","Report","COUNTRY","CAR","Source","Design","No","Excel XLS"]
        combo_box_id=["20797"]
        ...
        verify_msg_1="Step 03: Verify Report Format: Excel XLS"
        verify_image_1="step3_C6667293.png"
        ...
        '''Step 01: Click on AS Menu->Options, click on Reporting
                    Default Report Format, select Excel XLS from the drop down list
                    Click OK'''
