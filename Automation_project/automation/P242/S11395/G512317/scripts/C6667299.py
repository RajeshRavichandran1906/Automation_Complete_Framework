...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667299'''
...
class C6667299_TestClass(AS_BaseTestCase):
    def test_C6667299(self):
        ...
        verify_image_1="step3_C6667299.png"
        ...
        as_utilobj.select_file_in_dialogs(component_locators.ok_button,tree_path=select_folders[0],select_file=files[0])
        time.sleep(15)
