...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667273'''
...
class C6667273_TestClass(AS_BaseTestCase):
    def test_C6667273(self): 
        ...
        as_utilobj.verify_element_using_ui("Step 01: Verified that folder name been changed to ThisIsAnExampleOfALongFolderName",tree_item="ThisIsAnExampleOfALongFolderName",available=True)
        time.sleep(1)         
        ...
        as_utilobj.verify_element_using_ui("Step 02: Verified that Sub folder name been changed to ThisIsAnExampleOfALongSubFolderName",tree_item="ThisIsAnExampleOfALongSubFolderName",available=True)
        time.sleep(1)  
             
        '''Step 03: Right click on ThisIsAnExampleOfALongFolderName->New Report
                    EDASERVE Applications->ibisamp
                    Click empdata.mas and click OK
        ...
        as_utilobj.select_file_in_dialogs("OK",tree_path="ibisamp",select_file="empdata.mas")
        time.sleep(7)
        ...
        as_utilobj.verify_element_using_ui("Step 03: Verified that report been saved as thisisalongfilenamesoicantesthowmanycharactersicanwrite",tree_item="thisisalongfilenamesoicantesthowmanycharactersicanwrite",available=True)
        time.sleep(1)  
