...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667303'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C6667303_TestClass(AS_BaseTestCase):
    def test_C6667303(self):
        ...
        as_utilobj.verify_picture_using_sikuli("step2_C6667303.png","Step 02: Verified field ribbon is activated")
        time.sleep(1)
        ...
        as_utilobj.verify_picture_using_sikuli("step3_C6667303.png","Step 03: Verified layout ribbon is activated")
        time.sleep(1)
        ...
        as_utilobj.verify_picture_using_sikuli("step4_C6667303.png","Step 04: Verified layout ribbon is still activated")
        time.sleep(1)
