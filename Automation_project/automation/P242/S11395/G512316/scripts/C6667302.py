...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667302'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C6667302_TestClass(AS_BaseTestCase):
    def test_C6667302(self):
        ...
        as_utilobj.verify_picture_using_sikuli("step2_C6667302.png","Step 02: Verified Sort Down highlighted")
           
        as_utilobj.click_element_using_ui(tree_item="SALES")
        time.sleep(1)
           
        as_utilobj.verify_picture_using_sikuli("step3_C6667302.png","Step 03: Verified Aggregate is highlighted")
        ...
        as_utilobj.verify_picture_using_sikuli("step5_C6667302.png","Step 05: Verified Detail highlighted")
          
        as_utilobj.click_element_using_ui(tree_item="SALES")
        time.sleep(1)
          
        as_utilobj.verify_picture_using_sikuli("step6_C6667302.png","Step 06: Verified Detail is highlighted")
