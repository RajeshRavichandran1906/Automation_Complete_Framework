...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667315'''

from common.lib.as_basetestcase import AS_BaseTestCase
import time,unittest
from common.lib import as_utility

class C6667315_TestClass(AS_BaseTestCase):
    def test_C6667315(self):
        ...
        as_utilobj.verify_picture_using_sikuli("step1_C6667315.png","Step 1.2: The OK button is disabled. The file name field is empty. The Public folder is selected in the left tree.")
        time.sleep(1)
        ...
        as_utilobj.verify_picture_using_sikuli("step2_C6667315.png","Step 02: Verify master files displayed inside the file list when ibisamp selected")
        time.sleep(2)
        ...
        as_utilobj.verify_picture_using_sikuli("step3_C6667315.png","Step 03: Verify OK button becomes enabled and file name field is populated with car.mas.")
        time.sleep(2)
        ...
        as_utilobj.verify_picture_using_sikuli("step1_C6667315.png","Step 04: Verify OK button becomes disabled and file name field is cleared")
        time.sleep(2)
        ...
        as_utilobj.verify_picture_using_sikuli("step6_C6667315.png","Step 6.2: Verify OK button is disabled. The file name field is empty. The baseapp folder is selected in the left tree.")
        time.sleep(1)
        ...
        as_utilobj.verify_picture_using_sikuli("step8_C6667315.png","Step 08: Verify Finish button becomes enabled; the file name field is populated with car.mas")
        time.sleep(2)
        ...
        as_utilobj.verify_picture_using_sikuli("step6_C6667315.png","Step 09: Verify Finish button becomes disabled, and the filename field is cleared.")
        time.sleep(2)
