...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2222589
TestCase Name = Verify Euro currency symbols is applied
'''
import unittest
import time
...
class C2222589_TestClass(BaseTestCase):

    def test_C2222589(self):
        
        Test_Case_ID = "C2222589"
        driver = self.driver
        ...
        """ 2. Select "Euro" as the currency.                 """
        """ 3. Click "Apply" and click ok                     """
        ribbonobj.select_ribbon_item('Home', 'style')
        time.sleep(2)
        ia_stylingobj.set_report_style(currency='EUR', btn_apply=True, btn_ok=True)
        ...
        """ 5. Click Save in the toolbar > Save As C2222589 > click Save        """
        time.sleep(2)
