...
class C6461071_TestClass(BaseTestCase):
        
    def test_C6461071(self):
        ...
        '''
        Step 02: Expand "Dimensions" >> "Product".
        Step 03: Expand "Model" >> "Model Details"
        '''
        step_no = '2'
        for parent_node_name in ['Product', 'Model Details']:
