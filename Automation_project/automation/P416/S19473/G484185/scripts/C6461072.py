...
class C6461072_TestClass(BaseTestCase):
        
    def test_C6461072(self):
        ...
        Step 03: Expand "Geography,Store" & "Geography,Customer".
        '''
        step_no = '2'
        for parent_node_name in ['Filters and Variables', 'Geography, Store', 'Geography, Customer']:
