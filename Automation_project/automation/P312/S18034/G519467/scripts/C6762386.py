...
TestSuite = http://172.19.2.180/testrail/index.php?/suites/view/18034&group_by=cases:section_id&group_id=519467&group_order=asc
TestCase = http://172.19.2.180/testrail/index.php?/cases/view/6762386
...
class C6762386_TestClass(BaseTestCase):

    def test_C6762386(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C6762386'
        ...
        """
        Step 07. Add Dimensions/Sales_Related/Transaction Date.Simple/Sale,Year to Row
        """
        ...
        """
        Step 08. Add Dimensions/Sales_Related/Transaction Date.Simple/Sale,Quarter to Column
        """
        ...
        """
        Step 10. Verify 2012:Stereo systems tool tip.
        """
...
#         visual.verify_tooltip("riser!s6!g1!mbar!r5!c0!", expected_tooltip_list,'Step 11: Verify 2016:NorthAmerica Tooltip')
        """
        Step 11. Add Sale,Year to Filter
        """
        ...
        """
        Step 13. Drill down to Sale Month for any product category(2012:Stereo systems).
        """
        time.sleep(20)
        ...
        """
        Step 14. Verify sale quarter drilldown to sale month
        """
   
        visual.verify_x_axis_title(['Product Category', 'Store Business Region', 'Store Business Region', 'Store Business Region'], msg='Step 14.1')
        
        expected_xaxis_label=['EMEA', 'EMEA', 'EMEA']
        visual.verify_x_axis_label(expected_xaxis_label, msg='Step 14.2')
        expected_zaxis_label=['Accessories']
        visual.verify_z_axis_label(expected_zaxis_label, msg='Step 14.3')
        visual.verify_number_of_risers('#MAINTABLE_wbody1_f rect', 1, 3, msg='Step 14.4')
        expected_label_list=['Sale Year', '2011']
        visual.verify_rows_label(expected_label_list, msg='Step 14.5 Verify row labels')
        expected_label_list=['Sale Month', '1', '2', '3', 'Gross Profit', '67.6K', '72.7K', '77.7K', '82.7K', '87.8K']
        visual.verify_column_label(expected_label_list, msg='Step 14.6 Verify column labels')
        visual.verify_chart_color_using_get_css_property("[class*='riser!s0!g0!mbar!r0!c0!']", "light_yellow", msg='Step 14.7')
        ...
        """
        Step 16. Verify each bar riser tooltip
        """
        ...
        """
        Step 17. Drill Up on Sale, Month for any product category
        """
        ...
        """
        Step 18. Verify it should not showing any Filter Slider prompt.
        """
        ...
        """
        Step 19. Click Run in the toolbar 
        """
        ...
        """
        Step 22: Click "Save" in the toolbar > Type C2108833   > Click "Save" in the Save As dialog
        """
    
        visual.save_as_visualization_from_menubar(Test_Case_ID)
        
        """
        Step 23: Logout of the IA API using the following URL: http://machine:port/ibi_apps/service/wf_security_logout.jsp
        """
        time.sleep(4)
