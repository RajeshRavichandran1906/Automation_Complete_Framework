...
class C2348440_TestClass(BaseTestCase):


    def test_C2348440(self):
        ...
        """    3. Change format to Floating Point > OK     """
        """    4. Enter '2000.5' for bin width    """
        """    5. Click 'OK'(2x)    """
        metaobj.create_bin("REVENUE_US_BIN_1", bin_format_btn=True, field_type='Floating point',ok_btn=True, bin_width='2000.5')
        
        """    6. Right click bin field > Edit Bin    """
        utillobj.synchronize_with_visble_text("[id^='QbMetaDataTree']", 'REVENUE_US_BIN_1', 190)
        metaobj.datatree_field_click('Dimensions->REVENUE_US_BIN_1', 1, 1, "Edit Bins...")
        
        """    7. Verify Value 2000.5 shows in bin width    """
        metaobj.verify_bin(verify_bin_width='2000.5', verify_bin_format_edit='F7.2', msg='Step 07.01')
