...
class C2348433_TestClass(BaseTestCase):

    def test_C2348433(self):
        ...
        """    4. Enter alphabet value in bin width input (ex. aAbxZ)    """
        text_box = utillobj.validate_and_get_webdriver_object("#qbBinWidthTextField", 'TextField')
        utillobj.set_text_to_textbox_using_keybord('aAbxZ', text_box_elem=text_box)
        time.sleep(3)
