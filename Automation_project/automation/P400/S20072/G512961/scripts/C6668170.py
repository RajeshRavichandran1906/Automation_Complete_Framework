...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6668170
TestCase Name = Alpha Format - change length to larger AnV value
'''
...
class C6668170_TestClass(BaseTestCase):

    def test_C6668170(self):
        ...
        """ Step 3: Change Length from 25 to 35, click on the box next to Variable length, click OK
        """
        data_form_obj.modify_length_value_using_keybord_input_inside_dataformat_dialog('35')
        ...
        data_formobj.verify_output_format_value('A35V', '3')
        
        """ Step 4: Insert A35V into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('A35V')
        data_formobj.click_show_data_format_button()
        data_formobj.verify_data_format_dialog_is_visible('4')
        data_formobj.verify_selected_datatype('alpha', '4.1')
        data_form_obj.verify_length_inside_dataformat_dialog('35', '4.2')
