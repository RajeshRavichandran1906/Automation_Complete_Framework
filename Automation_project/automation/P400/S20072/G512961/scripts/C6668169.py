...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6668169
TestCase Name = Alpha Format - change length to smaller value
'''
...
class C6668169_TestClass(BaseTestCase):

    def test_C6668169(self):
        ...
        """ Step 2: Insert A5 into the Format to parse (input) and click Show data format
            """
        data_formobj.set_text_to_format_to_parse_input_box('A5')
        ...
        data_form_obj.verify_length_inside_dataformat_dialog('5', '2.2')
        data_form_obj.verify_variable_length_checkbox_inside_dataformat_dialog('Variable length', False, '2.3')
        
        """ Step 3: Change Length from 25 to 5, click OK
        """
        ...
        data_formobj.verify_output_format_value('A5', '3')
        
        """ Step 4: Insert A5 into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('A5')
        data_formobj.click_show_data_format_button()
