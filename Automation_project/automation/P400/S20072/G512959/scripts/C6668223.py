...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6668223
TestCase Name = Date YYMD format to MDYY format, dot separator
'''
...
class C6668223_TestClass(BaseTestCase):

    def test_C6668223(self):
        ...
        """ Step 3: Click the crop down for Date format select 12/31/2018, click the drop down for Date separator and select dot, Click on OK
        """
