...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6668188
TestCase Name = Date YYMD format, default '/' separator
'''
...
class C6668188_TestClass(BaseTestCase):

    def test_C6668188(self):
