...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6668220
TestCase Name = Date YYMD format to MDYY format, dash separator
'''
...
class C6668220_TestClass(BaseTestCase):

    def test_C6668220(self):
        ...
        """ Step 3: Click the crop down for Date format select 12/31/2018, click the drop down for Date separator and select dash, Click on OK
        """
        date_formobj.select_date_format('12/31/2018')
        date_formobj.select_date_separator("'-' (dash)")
        data_formobj.close_data_format_dialog_using_ok_button()
        data_formobj.verify_output_format_value('MDYY-', '3')
        
        """ Step 4: Insert MDYY- into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('MDYY-')
        data_formobj.click_show_data_format_button()
        ...
        date_formobj.verify_date_separator("'-' (dash)", '4.3')
