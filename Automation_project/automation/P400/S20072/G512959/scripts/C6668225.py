...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6668225
TestCase Name = Date YYMD format to DMYY format, default '/' separator
'''
...
class C6668225_TestClass(BaseTestCase):

    def test_C6668225(self):
        ...
        """ Step 3: Under Date format select 31/12/2018, Click on OK
        """
        ...
        """ Step 4: Insert DMYY into the Format to parse (input) and click Show data format
                    The expected results is correct, current screen is not
        """
