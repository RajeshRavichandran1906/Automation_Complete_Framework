...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6668193
TestCase Name = Date YYMD format to MDYY format, default '/' separator
'''
...
class C6668193_TestClass(BaseTestCase):

    def test_C6668193(self):
        ...
        """ Step 3: Under Date format select 12/31/2018, Click on OK
        """
        ...
        date_formobj.verify_date_separator("'/' (slash)", '4.3')
        time.sleep(3)
