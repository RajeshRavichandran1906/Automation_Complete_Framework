...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6668228
TestCase Name = Date YYMD format to DMYY format, dash separator
'''
...
class C6668228_TestClass(BaseTestCase):

    def test_C6668228(self):
        ...
        """ Step 3: Click on drop down for Date format select 31/12/2018, 
                    click on drop down for Date separator and select dash, Click on OK
        """
