...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6668189
TestCase Name = Date YYMD format, dash separator
'''
...
class C6668189_TestClass(BaseTestCase):

    def test_C6668189(self):
        ...
        """ Step 3: Under Date separator select (dash), Click on OK
        """
