...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6668431
TestCase Name = I8YYMD Formatted field
'''
...
class C6668431_TestClass(BaseTestCase):

    def test_C6668431(self):
        ...
        """ Step 2: Insert I8YYMD into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('I8YYMD')
        data_formobj.click_show_data_format_button()
        data_formobj.verify_data_format_dialog_is_visible('2')
        
        """ Step 3: should display as a Custom date format
        """
        data_formobj.verify_selected_datatype('custom', '3')
        custom_formobj.verify_format('I8YYMD', '3.1')
        
        """ Step 4: Click on OK
                    Output format should be I8YYMD
        """
        data_formobj.close_data_format_dialog_using_ok_button()
        data_formobj.verify_output_format_value('I8YYMD', '4')
        time.sleep(3)
