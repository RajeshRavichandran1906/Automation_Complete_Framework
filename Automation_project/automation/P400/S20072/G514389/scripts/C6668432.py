...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6668432
TestCase Name = A8YYMD Formatted field
'''
...
class C6668432_TestClass(BaseTestCase):

    def test_C6668432(self):
        ...
        """ Step 2: Insert A8YYMD into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('A8YYMD')
        ...
        custom_formobj.verify_format('A8YYMD', '3.1')
        
        """ Step 4: Click OK
        """
        data_formobj.close_data_format_dialog_using_ok_button()
        data_formobj.verify_output_format_value('A8YYMD', '4')
        time.sleep(3)
