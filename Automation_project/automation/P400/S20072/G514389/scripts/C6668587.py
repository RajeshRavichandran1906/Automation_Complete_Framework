...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6668587
TestCase Name = Time Formatted field
'''
...
class C6668587_TestClass(BaseTestCase):

    def test_C6668587(self):
        ...
        """ Step 2: Insert HHIS into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('HHIS')
        ...
        custom_formobj.verify_format('HHIS', '3.1')
        
        """ Step 4: Click OK
        """
        data_formobj.close_data_format_dialog_using_ok_button()
        data_formobj.verify_output_format_value('HHIS', '4')
        time.sleep(3)
