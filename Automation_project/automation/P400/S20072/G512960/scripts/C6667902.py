...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667902
TestCase Name = Integer Format to Currency Format, dollar, floating, leading zero
'''
...
class C6667902_TestClass(BaseTestCase):

    def test_C6667902(self):
        ...
        """Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Dollar($), click on the Floating button under Symbol position, click on box to left of Show leading zero, click OK
        """
        ...
        """Step 4: Insert D9.2L:D into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D9.2L:D')
        data_formobj.click_show_data_format_button()
        ...
        numeric_formobj.verify_currency_symbol('Dollar', '5.5')
