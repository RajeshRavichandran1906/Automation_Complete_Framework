...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667809
TestCase Name = Integer Format to Decimal Format, Negative Bracket, 1000 separator, leading zero
'''
...
class C6667809_TestClass(BaseTestCase):

    def test_C6667809(self):
        ...
        """Step 3: Click on Type 11.11 tab, click on right box with brackets under Negative number, 
                   click on box next to Show 1000 separator, click on box next to Show leading zero, click OK
        """
        ...
        data_formobj.verify_output_format_value('D12.2BL', '3')
        
        """ Step 4: Insert D12.2BCL into the Format to parse (input) and click Show data format
        """
