...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667805
TestCase Name = Integer Format to Smaller Decimal Format
'''
...
class C6667805_TestClass(BaseTestCase):

    def test_C6667805(self):
        ...
        """Step 3: Click on Type 11.11, change Max length to 6, change Decimal place to 3, click OK
        """
        numeric_formobj.select_numeric_type('decimal')
        numeric_formobj.modify_max_length_value('6')
        numeric_formobj.modify_decimal_place_value('3')
        data_formobj.close_data_format_dialog_using_ok_button()
        data_formobj.verify_output_format_value('D6.3c', '3')
        
        """ Step 4: Insert D6.3 into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D6.3')
        data_formobj.click_show_data_format_button()
        ...
        numeric_formobj.verify_max_length('6', '4.3')
        numeric_formobj.verify_decimal_place('3', '4.4')
