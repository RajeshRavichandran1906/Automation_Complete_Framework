...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6668060
TestCase Name = Integer Format to Currency Format, euro, floating, leading zero
'''
...
class C6668060_TestClass(BaseTestCase):

    def test_C6668060(self):
        ...
        """Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Euro, click on the Floating button under Symbol position, click on box to left of Show leading zero, click OK
        """
        ...
        """Step 4: Insert D9.2L:E into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D9.2L:E')
        data_formobj.click_show_data_format_button()
