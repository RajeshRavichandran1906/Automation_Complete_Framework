...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667870
TestCase Name = Integer Format to Currency Format
'''
...
class C6667870_TestClass(BaseTestCase):

    def test_C6667870(self):
        ...
        """ Step 2: Enter I9 into Format to parse (input) and click Show data format
        """
        ...
        """ Step 3: Click on Type $ tab, click OK to accept all defaults.
        """

        numeric_formobj.select_numeric_type('currency')
        data_formobj.close_data_format_dialog_using_ok_button()
        data_formobj.verify_output_format_value('D9.2c:C', '3')
              
        """Step 5: Insert D9.2:C into the Format to parse (input) and click Show data format
        """
        ...
        numeric_formobj.verify_symbol_position_disabled('5.6',checkbox_state='disable')
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show 1000 separator', False, '5.7')
