...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667879
TestCase Name = Integer Format to Currency Format, locale, fixed, leading zero
'''
...
class C6667879_TestClass(BaseTestCase):

    def test_C6667879(self):
        ...
        """ Step 3: Click on Type $ tab, click on box next to Show leading zero, click OK
        """
        ...
        """ Step 4: full value of output format is D9.2L:C(CURRENCY_DISPLAY='LEFT_FIXED',CURRENCY_ISO_CODE='default')
        """
        data_formobj.verify_output_format_value('D9.2L:C(CURRENCY_DISPLAY=\'LEFT_FIXED\',CURRENCY_ISO_CODE=\'default\')', '4')
              
        """Step 5: Insert D9.2L:C into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D9.2L:C')
        data_formobj.click_show_data_format_button()
