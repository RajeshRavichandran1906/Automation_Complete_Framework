...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667901
TestCase Name = Integer Format to Currency Format, dollar, floating, 1000 separator, leading zero
'''
...
class C6667901_TestClass(BaseTestCase):

    def test_C6667901(self):
        ...
        """ Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Dollar($), click on Floating button under Symbol position, click on box next to Show 1000 separator, click on box next to Show leading zero, click OK
        """
        ...
        data_formobj.verify_output_format_value("D9.2CL:D", '3')
        
        """ Step 4: Insert D9.2CL:D into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box("D9.2CL:D")
        data_formobj.click_show_data_format_button()
        ...
        numeric_formobj.verify_symbol_position('4.8', 'Floating')
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show 1000 separator', True, '4.9')
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show leading zero', True, '4.10')
        data_formobj.close_data_format_dialog_using_ok_button()
        time.sleep(3)
