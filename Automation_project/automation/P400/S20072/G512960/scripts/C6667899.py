...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667899
TestCase Name = Integer Format to Currency Format, dollar, floating
'''
...
class C6667899_TestClass(BaseTestCase):

    def test_C6667899(self):
        ...
        """ Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Dollar($), click on Floating button under Symbol position, click OK
        """
        ...
        data_formobj.verify_output_format_value("D9.2c:D", '3')
