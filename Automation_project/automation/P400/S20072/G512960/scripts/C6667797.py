...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667797
TestCase Name = Integer Format to Smaller Variable Length Alpha Format (AnV)
'''
...
class C6667797_TestClass(BaseTestCase):

    def test_C6667797(self):
        ...
        """ Step 3: Click on Data type Abc tab, change Length from 100 to 7, click on the box next to Variable Length and click OK
        """
        ...
        data_formobj.verify_output_format_value('A7V', '3')
        
        """ Step 4: Insert A7V into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('A7V')
        data_formobj.click_show_data_format_button()
