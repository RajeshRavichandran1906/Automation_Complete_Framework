...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667897
TestCase Name = Integer Format to Currency Format, locale, floating, leading zero
'''
...
class C6667897_TestClass(BaseTestCase):

    def test_C6667897(self):
        ...
        """ Step 3: Click on Type $ tab, click on Floating button under Symbol position, click on box next to Show leading zero, click OK
        """
        ...
        """
        data_formobj.verify_output_format_value("D9.2L:C(CURRENCY_DISPLAY='LEFT_FLOAT',CURRENCY_ISO_CODE='default')", '4')
        
        """ Step 5: Insert D9.2L:C(CURRENCY_DISPLAY='LEFT_FLOAT',CURRENCY_ISO_CODE='default') into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box("D9.2L:C(CURRENCY_DISPLAY='LEFT_FLOAT',CURRENCY_ISO_CODE='default')")
        data_formobj.click_show_data_format_button()
        ...
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show 1000 separator', False, '5.9')
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show leading zero', True, '5.10')
        data_formobj.close_data_format_dialog_using_ok_button()
        time.sleep(3)
