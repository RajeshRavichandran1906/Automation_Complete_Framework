...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667876
TestCase Name = Integer Format to Currency Format, locale, fixed, 1000 separator
'''
...
class C6667876_TestClass(BaseTestCase):

    def test_C6667876(self):
        ...
        """ Step 3: Click on Type $ tab, click on box next to Show 1000 separator, click OK
        """
        ...
        """ Step 4: full value of output format is D9.2C:C(CURRENCY_DISPLAY='LEFT_FIXED',CURRENCY_ISO_CODE='default')
        """
        data_formobj.verify_output_format_value('D9.2C:C(CURRENCY_DISPLAY=\'LEFT_FIXED\',CURRENCY_ISO_CODE=\'default\')', '4')
              
        """Step 5: Insert D9.2C:C into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D9.2C:C')
        data_formobj.click_show_data_format_button()
        ...
        numeric_formobj.verify_symbol_position('5.6', expected_selected_value='Fixed')
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show 1000 separator', True, '5.7')
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show leading zero', False, '5.8')
