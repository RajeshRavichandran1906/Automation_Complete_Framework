...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667919
TestCase Name = Integer Format to Currency Format, euro, floating, 1000 separator
'''
...
class C6667919_TestClass(BaseTestCase):

    def test_C6667919(self):
        ...
        """Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Euro, click on Floating button under Symbol position, click on box next to Show 1000 separator, click OK
        """
