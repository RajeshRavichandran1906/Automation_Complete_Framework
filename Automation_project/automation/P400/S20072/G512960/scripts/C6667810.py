...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667810
TestCase Name = Integer Format to Decimal Format, Negative Bracket, leading zero
'''
...
class C6667810_TestClass(BaseTestCase):

    def test_C6667810(self):
        ...
        """Step 3: Click on the Type 11.11 tab, click on the box on the right with brackets under Negative number, click on box next to Show leading zero, click OK
        """
        ...
        data_formobj.verify_output_format_value('D12.2BcL', '3')
        
        """ Step 4: Insert D12.2BL into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D12.2BcL')
        data_formobj.click_show_data_format_button()
        ...
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show 1000 separator', False, '4.6')
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show leading zero', True, '4.7')
        time.sleep(3)
