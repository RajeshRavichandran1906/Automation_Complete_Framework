...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667801
TestCase Name = Integer Format to Decimal Format(default values)
'''
...
class C6667801_TestClass(BaseTestCase):

    def test_C6667801(self):
        ...
        """Step 3: Click on type 11.11, click OK
        """
        numeric_formobj.select_numeric_type('decimal')
        data_formobj.close_data_format_dialog_using_ok_button()
        data_formobj.verify_output_format_value('D12.2c', '3')
        
        """ Step 4: Insert D12.2 into the Format to parse (input) and click Show data format
        """
