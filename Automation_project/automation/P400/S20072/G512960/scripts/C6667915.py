...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667915
TestCase Name = Integer Format to Currency Format, euro, fixed, 1000 separator, leading zero
'''
...
class C6667915_TestClass(BaseTestCase):

    def test_C6667915(self):
        ...
        """Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Euro, click on box next to Show 1000 separator, click on box next to Show leading zero, click OK
        """
        ...
        """Step 4: Insert D9.2CL:e into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D9.2CL:e')
        data_formobj.click_show_data_format_button()
