...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667866
TestCase Name = Integer Format to Decimal Format, leading zero
'''
...
class C6667866_TestClass(BaseTestCase):

    def test_C6667866(self):
        ...
        """Step 3: Click on Type 11.11 tab, click on box next to Show leading zero, click OK
        """
        ...
        data_formobj.verify_output_format_value('D12.2cL', '3')
        
        """ Step 4: Insert D12.2L into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D12.2cL')
        data_formobj.click_show_data_format_button()
