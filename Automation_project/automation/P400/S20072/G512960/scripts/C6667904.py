...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667904
TestCase Name = Integer Format to Currency Format, dollar, fixed, 1000 separator, leading zero
'''
...
class C6667904_TestClass(BaseTestCase):

    def test_C6667904(self):
        ...
        """ Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Dollar($), click on box next to Show 1000 separator, click on box next to Show leading zero, click OK
        """
