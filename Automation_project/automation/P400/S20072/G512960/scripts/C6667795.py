...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667795
TestCase Name = Integer Format to Same Length Alpha Format
'''
...
class C6667795_TestClass(BaseTestCase):

    def test_C6667795(self):
        ...
        """ Step 3: Click on the Data type Abc tab, change the Length from 100 to 9, click OK
        """
        ...
        data_formobj.verify_output_format_value('A9', '3')
        
        """ Step 4: Insert A9 into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('A9')
        data_formobj.click_show_data_format_button()
