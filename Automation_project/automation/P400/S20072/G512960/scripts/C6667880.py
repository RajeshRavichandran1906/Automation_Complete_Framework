...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667880
TestCase Name = Integer Format to Currency Format, locale, floating
'''
...
class C6667880_TestClass(BaseTestCase):

    def test_C6667880(self):
        ...
        """Step 3: Click on Type $ tab, click on floating button under Symbol postion, click OK
        """
        ...
        """ Step 4: full value of output format is D9.2:C(CURRENCY_DISPLAY='LEFT_FLOAT',CURRENCY_ISO_CODE='default')
        """
        data_formobj.verify_output_format_value('D9.2:C(CURRENCY_DISPLAY=\'LEFT_FLOAT\',CURRENCY_ISO_CODE=\'default\')', '4')
              
        """Step 5: Insert D9.2:C(CURRENCY_DISPLAY='LEFT_FLOAT',CURRENCY_ISO_CODE='default') into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D9.2:C(CURRENCY_DISPLAY=\'LEFT_FLOAT\',CURRENCY_ISO_CODE=\'default\')')
        data_formobj.click_show_data_format_button()
