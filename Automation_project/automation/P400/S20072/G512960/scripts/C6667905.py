...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667905
TestCase Name = Integer Format to Currency Format, dollar, fixed, leading zero
'''
...
class C6667905_TestClass(BaseTestCase):

    def test_C6667905(self):
        ...
        """ Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Dollar($), click on box next to Show leading zero, click OK
        """
