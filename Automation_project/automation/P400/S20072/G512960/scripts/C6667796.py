...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667796
TestCase Name = Integer Format to Larger Variable Length Alpha Format (AnV)
'''
...
class C6667796_TestClass(BaseTestCase):

    def test_C6667796(self):
        ...
        """ Step 3: Click on Data type Abc tab, change Length from 100 to 25, click on the box next to Variable Length and click OK
        """
        data_formobj.select_datatype('alpha')
        alp_formobj.modify_length_value_using_keybord_input_inside_dataformat_dialog('25')
        ...
        data_formobj.verify_output_format_value('A25V', '3')
        
        """ Step 4: Insert A25V into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('A25V')
        data_formobj.click_show_data_format_button()
        data_formobj.verify_data_format_dialog_is_visible('4.1')
        data_formobj.verify_selected_datatype('alpha', '4.2')
        alp_formobj.verify_length_inside_dataformat_dialog('25', '4.3')
