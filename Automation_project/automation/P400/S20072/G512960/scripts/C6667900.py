...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667900
TestCase Name = Integer Format to Currency Format, dollar, floating, 1000 separator
'''
...
class C6667900_TestClass(BaseTestCase):

    def test_C6667900(self):
        ...
        """ Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Dollar($), click on Floating button under Symbol position, 
                    click on box nex to Show 1000 separator, click OK
        """
        ...
        data_formobj.verify_output_format_value("D9.2:D", '3')
        
        """ Step 4: Insert D9.2C:D into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box("D9.2:D")
        data_formobj.click_show_data_format_button()
