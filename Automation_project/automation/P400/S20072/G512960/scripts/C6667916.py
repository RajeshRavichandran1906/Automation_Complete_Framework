...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667916
TestCase Name = Integer Format to Currency Format, euro, fixed, leading zero
'''
...
class C6667916_TestClass(BaseTestCase):

    def test_C6667916(self):
        ...
        """Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Euro, click on box next to Show leading zero, click OK
        """
