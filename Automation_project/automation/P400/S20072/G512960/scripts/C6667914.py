...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667914
TestCase Name = Integer Format to Currency Format, euro, fixed, 1000 separator
'''
...
class C6667914_TestClass(BaseTestCase):

    def test_C6667914(self):
        ...
        """Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Euro, click on button next to Show 1000 separator, click OK
        """
        ...
        data_formobj.verify_output_format_value("D9.2:e", '3')
               
        """Step 4: Insert D9.2C:e into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D9.2:e')
        data_formobj.click_show_data_format_button()
