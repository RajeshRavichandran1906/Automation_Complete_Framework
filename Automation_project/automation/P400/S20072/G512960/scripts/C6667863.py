...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667863
TestCase Name = Integer Format to Decimal Format, 1000 separator, leading zero
'''
...
class C6667863_TestClass(BaseTestCase):

    def test_C6667863(self):
        ...
        """Step 3: Click on Type 11.11 tab, click on box next to Show 1000 separator, click on box next to Show leading zero, click OK
        """
        ...
        data_formobj.verify_output_format_value('D12.2L', '3')
        
        """ Step 4: Insert D12.2CL into the Format to parse (input) and click Show data format
        """
