...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667913
TestCase Name = Integer Format to Currency Format, euro, fixed
'''
...
class C6667913_TestClass(BaseTestCase):

    def test_C6667913(self):
        ...
        """Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Euro, click OK
        """
        ...
        numeric_formobj.verify_currency_symbol( 'Euro', '5.5')
