...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667903
TestCase Name = Integer Format to Currency Format, dollar, fixed, 1000 separator
'''
...
class C6667903_TestClass(BaseTestCase):

    def test_C6667903(self):
        ...
        """ Step 3: Click on Type $ tab, click on drop down under Currency symbol and select Dollar($), click on button next to Show 1000 separator, click OK
        """
