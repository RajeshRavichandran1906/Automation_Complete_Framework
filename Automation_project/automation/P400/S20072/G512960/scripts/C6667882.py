...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667882
TestCase Name = Integer Format to Currency Format, locale, floating, 1000 separator, leading zero
'''
...
class C6667882_TestClass(BaseTestCase):

    def test_C6667882(self):
        ...
        """ Step 3: Click on Type $ tab, click on Floating button under Symbol position, click on box next to Show 1000 separator, 
        ...
        """
        data_formobj.verify_output_format_value("D9.2CL:C(CURRENCY_DISPLAY='LEFT_FLOAT',CURRENCY_ISO_CODE='default')", '4')
        
        """ Step 5: Insert D9.2CL:C(CURRENCY_DISPLAY='LEFT_FLOAT',CURRENCY_ISO_CODE='default') into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box("D9.2CL:C(CURRENCY_DISPLAY='LEFT_FLOAT',CURRENCY_ISO_CODE='default')")
        data_formobj.click_show_data_format_button()
