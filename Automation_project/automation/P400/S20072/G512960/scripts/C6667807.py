...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667807
TestCase Name = Integer Format to Decimal Format, 1000 separator
'''
...
class C6667807_TestClass(BaseTestCase):

    def test_C6667807(self):
        ...
        """Step 3: Click Type 11.11 tab, click on box next to Show 1000 separator, click OK
        """
        ...
        """ Step 4: Insert D12.2C into the Format to parse (input) and click Show data format
        """
