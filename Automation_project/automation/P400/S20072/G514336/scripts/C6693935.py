...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6693935
TestCase Name = Percent, leading zero
'''
...
class C6693935_TestClass(BaseTestCase):

    def test_C6693935(self):
        ...
        """ Step 3: Click on checkbox next to Show 1000 separator
        """
        ...
        data_formobj.verify_output_format_value('D12.2cL%', '4')
        
        """ Step 5: Replace D12.2c% with D12.2cL% into Format to parse (input) and click Show data format
        """
