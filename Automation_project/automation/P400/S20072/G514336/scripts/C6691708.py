...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6691708
TestCase Name = Percent, Negative Bracket, 1000 separator, leading zero
'''
...
class C6691708_TestClass(BaseTestCase):

    def test_C6691708(self):
        ...
        """ Step 3: Select the negative bracket box (123) under Negative number, click on checkbox next to Show 1000 separator, click on checkbox next to Show leading zero
        """
        numeric_formobj.select_negative_numbers('(123)')
        #numeric_formobj.select_checkbox_inside_numeric_dataformat_dialog("Show 1000 separator", True)
        ...
        data_formobj.verify_output_format_value('D12.2BL%', '4')
        
        """ Step 5: Replace D12.2% with D12.2BCL% into Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D12.2BL%')
        data_formobj.click_show_data_format_button()
        ...
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show 1000 separator', True, '5.6')
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show leading zero', True, '5.7')
        time.sleep(3)
