...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6691706
TestCase Name = Percent, Negative Bracket, 1000 separator
'''
...
class C6691706_TestClass(BaseTestCase):

    def test_C6691706(self):
        ...
        """ Step 3: Select the negative bracket box (123) under Negative number, click on checkbox next to Show 1000 separator
        """
        ...
        data_formobj.verify_output_format_value('D12.2Bc%', '4')
        
        """ Step 5: Replace D12.2% with D12.2BC% into Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D12.2Bc%')
        data_formobj.click_show_data_format_button()
