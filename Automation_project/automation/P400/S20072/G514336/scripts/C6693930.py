...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6693930
TestCase Name = Percent, 1000 separator, leading zero
'''
...
class C6693930_TestClass(BaseTestCase):

    def test_C6693930(self):
        ...
        """
        data_formobj.set_text_to_format_to_parse_input_box('D12.2c%')
        ...
        """ Step 3: Click on checkbox next to Show 1000 separator, click on checkbox next to Show leading zero
        """
        ...
        data_formobj.verify_output_format_value('D12.2L%', '4')
        
        """ Step 5: Replace D12.2c% with D12.2L% into Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('D12.2L%')
        data_formobj.click_show_data_format_button()
