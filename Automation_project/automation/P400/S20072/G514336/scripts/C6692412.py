...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6692412
TestCase Name = Percent, 1000 separator
'''
...
class C6692412_TestClass(BaseTestCase):

    def test_C6692412(self):
        ...
        data_formobj.verify_output_format_value('D12.2%', '4')
        
        """ Step 5: Replace D12.2c% with D12.2% into Format to parse (input) and click Show data format
        """
