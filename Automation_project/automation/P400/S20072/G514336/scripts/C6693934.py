...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6693934
TestCase Name = Percent, Negative Bracket, leading zero
'''
...
class C6693934_TestClass(BaseTestCase):

    def test_C6693934(self):
        ...
        """ Step 2: Enter D12.2c% into Format to parse (input) and click Show data format
        """
        ...
        """ Step 3: Select the negative bracket box (123) under Negative number, click on checkbox next to Show leading zero
        """
        ...
        data_formobj.verify_output_format_value('D12.2BcL%', '4')
        
        """ Step 5: Replace D12.2% with D12.2BL% into Format to parse (input) and click Show data format
        """
