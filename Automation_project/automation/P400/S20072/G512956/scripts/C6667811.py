...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6667811
TestCase Name = Integer Format Negative Bracket, leading zero
'''
...
class C6667811_TestClass(BaseTestCase):

    def test_C6667811(self):
        ...
        """ Step 3: Click on the box with brackets under Negative number, click on the box next to Show leading zero, click OK
        """
        ...
        data_formobj.verify_output_format_value('I9BL', '3')
        
        """ Step 4: Insert I9BL into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('I9BL')
        data_formobj.click_show_data_format_button()
