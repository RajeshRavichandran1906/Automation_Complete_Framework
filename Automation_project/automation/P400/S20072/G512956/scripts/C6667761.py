...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6667761
TestCase Name = Integer Format Min. length
'''
...
class C6667761_TestClass(BaseTestCase):

    def test_C6667761(self):
        ...
        """ Step 3: Change Max Length to 1 and click OK
        """
        numeric_formobj.modify_max_length_value('1')
        data_formobj.close_data_format_dialog_using_ok_button()
        data_formobj.verify_output_format_value('I1', '3')
        
        """ Step 4: Replace I9 with I1 into Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('I1')
        data_formobj.click_show_data_format_button()
        ...
        numeric_formobj.verify_max_length('1', '4.3')
