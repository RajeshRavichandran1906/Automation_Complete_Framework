...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6667770
TestCase Name = Integer Format leading zero
'''
...
class C6667770_TestClass(BaseTestCase):

    def test_C6667770(self):
        ...
        """ Step 3: Click on the box next to Show leading zero, click OK
        """
        ...
        data_formobj.verify_output_format_value('I9L', '3')
        
        """ Step 4: Insert I9L into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('I9L')
        data_formobj.click_show_data_format_button()
