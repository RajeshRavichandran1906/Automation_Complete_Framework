...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6667769
TestCase Name = Integer Format 1000 separator, leading zero
'''
...
class C6667769_TestClass(BaseTestCase):

    def test_C6667769(self):
        ...
        """ Step 3: Click on the box next to Show 1000 separator, click on the box next to show leading zero, click OK
        """
        ...
        data_formobj.verify_output_format_value('I9CL', '3')
        
        """ Step 4: Insert I9CL into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('I9CL')
        data_formobj.click_show_data_format_button()
