...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6667766
TestCase Name = Integer Format Negative Bracket, 1000 separator
'''
...
class C6667766_TestClass(BaseTestCase):

    def test_C6667766(self):
        ...
        """ Step 3: Click on the (123) box under Negative number to select brackets, click on the box next to Show 1000 separator and click OK
        """
        ...
        data_formobj.verify_output_format_value('I9BC', '3')
        
        """ Step 4: Insert I9BC into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('I9BC')
        data_formobj.click_show_data_format_button()
