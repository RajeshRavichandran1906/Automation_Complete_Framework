...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6667765
TestCase Name = Integer Format Negative Bracket
'''
...
class C6667765_TestClass(BaseTestCase):

    def test_C6667765(self):
        ...
        """ Step 3: Click on the (123) box under Negative number to select brackets and click OK
        """
        numeric_formobj.select_negative_numbers('(123)')
        data_formobj.close_data_format_dialog_using_ok_button()
        data_formobj.verify_output_format_value('I9B', '3')
        
        """ Step 4: Replace I9 with I9B in the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('I9B')
        data_formobj.click_show_data_format_button()
