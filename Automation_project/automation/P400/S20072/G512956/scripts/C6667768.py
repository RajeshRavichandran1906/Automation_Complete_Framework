...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6667768
TestCase Name = Integer Format 1000 separator
'''
...
class C6667768_TestClass(BaseTestCase):

    def test_C6667768(self):
        ...
        """ Step 3: Click on the box next to the show 1000 separator, click OK
        """
        ...
        data_formobj.verify_output_format_value('I9C', '3')
        
        """ Step 4: Insert I9C into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('I9C')
        data_formobj.click_show_data_format_button()
