...
@author: BM13368
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/6667764
Testcase Name : Integer Format Max. length
'''
import unittest
from common.lib.basetestcase import BaseTestCase
from common.wfcomponent import dataformatdialog

class C6667764_TestClass(BaseTestCase):

    def test_C6667764(self):
        """
        TESTCASE Object's
        """
        ...
        """
            Step 2:Insert I7 into the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('I7')
        ...
        numeric_formobj.verify_max_length('7', '2.3')
        ...
        """
            Step 3:Use the spinner to select the Max Length to the largest posible value, click OK
        """
        numeric_formobj.select_value_in_numeric_max_length_dropdown(11)
        data_formobj.close_data_format_dialog_using_ok_button()
        data_formobj.verify_output_format_value('I11', '3')
        
        """
            Step 4:Replace I7 with I11 in the Format to parse (input) and click Show data format
        """
        data_formobj.set_text_to_format_to_parse_input_box('I11')
        data_formobj.click_show_data_format_button()
        ...
        numeric_formobj.verify_max_length('11', '4.3')
        numeric_formobj.verify_negative_numbers('4.4', expected_selected_value='-123')
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show 1000 separator', False, '4.5')
        numeric_formobj.verify_checkbox_inside_numeric__dataformat_dialog('Show leading zero', False, '4.6')
