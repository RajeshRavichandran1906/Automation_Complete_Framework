...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2048991
...
class C2048991_TestClass(BaseTestCase):
    
    def test_C2048991(self):
        
        Test_Case_ID = "C2048991"
        driver = self.driver
        ...
        """Step 03: Select "Stock" > "Stock Hi-Lo Open-Close with Volume" > "OK"."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('stock', 'stock_high_low_open_close_volume', 4, ok_btn_click=True)
