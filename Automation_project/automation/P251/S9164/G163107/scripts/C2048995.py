...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2048995
...
class C2048995_TestClass(BaseTestCase):
    
    def test_C2048995(self):
        
        Test_Case_ID = "C2048995"
        driver = self.driver
        ...
        """Step 03: Select "Stock" > "Open-Hi-Lo-Close Candle Stock Chart with Volume" > "OK"."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        time.sleep(5)
        ia_ribbobj.select_other_chart_type('stock', 'stock_candlestick_high_low_open_close_volume', 6, ok_btn_click=True)
