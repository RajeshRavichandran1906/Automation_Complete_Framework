...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2048990
...
class C2048990_TestClass(BaseTestCase):
    
    def test_C2048990(self):
        
        Test_Case_ID = "C2048990"
        driver = self.driver
        ...
        """Step 03: Select "Stock" > "Stock Hi-Lo Open-Close" > 'OK'"""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('stock', 'stock_high_low_open_close', 3, ok_btn_click=True)
        
        """Step 04: Drag Cost of Goods from High to Low bucket."""
        ...
        """Step 05: Right click "Sale Unit(s)" > Delete."""
        metaobj.querytree_field_click("Sale Unit(s)", 1, 1, "Delete")
        time.sleep(5) 
        
        """Step 06: Drag and drop "Revenue Per,SQ. Ft." over 'Open'"""
        metaobj.drag_drop_data_tree_items_to_query_tree("Revenue Per,Sq. Ft.", 1, "Open", 0)
        time.sleep(5)
        
        """Step 07: Drag and drop "Revenue Local Per SQ. M." over "Close"."""
        metaobj.drag_drop_data_tree_items_to_query_tree("Revenue Local Per SQ. M.", 1, "Close", 0)
        time.sleep(5)
        
        """Step 08: Verify the following chart is displayed."""
        time.sleep(5)     
#         ele=driver.find_element_by_css_selector("#resultArea")
        #utillobj.take_screenshot(ele,Test_Case_ID+'_Actual_Step08', image_type='actual')  
