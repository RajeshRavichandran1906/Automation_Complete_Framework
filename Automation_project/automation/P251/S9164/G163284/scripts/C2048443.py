...
Verify 3D Connected Series Area is working properly.
...
class C2048443_TestClass(BaseTestCase):
    
    def test_C2048443(self):
        
        Test_Case_ID = "C2048443"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2048443.fex&tool=chart"""
        
        utillobj.infoassist_api_edit('C2048443', 'chart', 'S6940', mrid='mrid', mrpass='mrpass')#application will login with fex
        ...
        """Step 03: Select "3D" > " 3D Connected Series Area" > "OK". """
