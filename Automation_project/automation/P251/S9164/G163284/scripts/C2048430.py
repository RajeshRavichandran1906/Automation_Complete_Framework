...
Verify 3D Pyramid is working properly.
...
class C2048430_TestClass(BaseTestCase):
    
    def test_C2048430(self):
        
        Test_Case_ID = "C2048430"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2048430.fex&tool=chart"""
        
        utillobj.infoassist_api_edit('C2048430', 'chart', 'S6940', mrid='mrid', mrpass='mrpass')#application will login with fex
        ...
        """Step 03: Select "3D" > "3D Pyramid" > "OK". """
        
        ribbonobj.select_ribbon_item('Format', 'Other')
        time.sleep(4)
        ia_ribbobj.select_other_chart_type('threed', 'threed_pyramid', 4, ok_btn_click=True )
