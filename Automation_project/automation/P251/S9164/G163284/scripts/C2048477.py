...
Verify 3D Connected Group Area is working properly.
...
class C2048477_TestClass(BaseTestCase):
    
    def test_C2048477(self):
        
        Test_Case_ID = "C2048477"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2048477.fex&tool=chart"""
        
        utillobj.infoassist_api_edit('C2048477', 'chart', 'S6940', mrid='mrid', mrpass='mrpass')#application will login with fex
        ...
        """Step 03: Select "3D" > " 3D Connected Group Area" > "OK". """
        ribbonobj.select_ribbon_item('Format', 'Other')
        time.sleep(4)
        ia_ribbobj.select_other_chart_type('threed', 'threed_connected_group_area', 11, ok_btn_click=True )
