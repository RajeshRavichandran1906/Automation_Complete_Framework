...
Verify 3D Smooth Surface with Sides is working properly.
...
class C2048927_TestClass(BaseTestCase):
    
    def test_C2048927(self):
        
        Test_Case_ID = "C2048927"
        driver = self.driver
        ...
        utillobj.infoassist_api_edit('C2048927', 'chart', 'S6940', mrid='mrid', mrpass='mrpass')#application will login with fex
        ...
        """Step 03: Select "3D" > " 3D Smooth Surface with Sides" > "OK".. """
        
        ribbonobj.select_ribbon_item('Format', 'Other')
        time.sleep(4)
        ia_ribbobj.select_other_chart_type('threed', 'threed_smooth_surface_with_sides', 17, ok_btn_click=True )
