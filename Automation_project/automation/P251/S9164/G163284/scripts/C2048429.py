...
class C2048429_TestClass(BaseTestCase):
    
    def test_C2048429(self):
        
        Test_Case_ID = "C2048429"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2048429.fex&tool=chart"""
        
        utillobj.infoassist_api_edit('C2048429', 'chart', 'S6940', mrid='mrid', mrpass='mrpass')#application will login with fex
        ...
        """Step 03: Select "3D" > "3D Connected Group Ribbon" > "OK". """
        
        ribbonobj.select_ribbon_item('Format', 'Other')
        time.sleep(4)
        ia_ribbobj.select_other_chart_type('threed', 'threed_connected_group_ribbon', 3, ok_btn_click=True )
        time.sleep(6)
