...
Verify 3D Surface with Sides is working properly.
...
class C2048924_TestClass(BaseTestCase):
    
    def test_C2048924(self):
        
        Test_Case_ID = "C2048924"
        driver = self.driver
        ...
        utillobj.infoassist_api_edit('C2048924', 'chart', 'S6940', mrid='mrid', mrpass='mrpass')#application will login with fex
        ...
        """Step 03: Select "3D" > " 3D Surface with Sides" > "OK". """
        
        ribbonobj.select_ribbon_item('Format', 'Other')
        time.sleep(4)
        ia_ribbobj.select_other_chart_type('threed', 'threed_surface_with_sides', 14, ok_btn_click=True )
