...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2036022
'''
import unittest
...
class C2036022_TestClass(BaseTestCase):

    def test_C2036022(self):
        
        Test_Case_ID = "C2036022"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2036022.fex&tool=chart"""
        ...
        """Step 03: Select "Line" > "Horizontal Percent Line" > "OK"."""
        ribbonobj.select_ribbon_item('Format', 'Other')
        utillobj.synchronize_until_element_is_visible(chart_dialog, resultobj.home_page_medium_timesleep)
        ia_ribbobj.select_other_chart_type('line', 'horizontal_percent_line', 14, ok_btn_click=True)
