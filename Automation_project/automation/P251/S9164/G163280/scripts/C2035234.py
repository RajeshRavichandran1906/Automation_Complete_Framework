...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2035234
'''
...
class C2035234_TestClass(BaseTestCase):

    def test_C2035234(self):
        
        Test_Case_ID = "C2035234"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2035234.fex&tool=chart"""
        ...
        """Step 03: Select "Line" > "Horizontal Dual-Axis Absolute Line" > "OK"..."""
        time.sleep(5)  
