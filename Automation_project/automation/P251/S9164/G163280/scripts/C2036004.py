...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2036004
'''
...
class C2036004_TestClass(BaseTestCase):

    def test_C2036004(self):
        
        Test_Case_ID = "C2036004"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2036004.fex&tool=chart"""
        ...
        """Step 03: Select "Line" > "Horizontal Bi-Polar Absolute Line" > "OK"."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('line', 'horizontal_bi_polar_absolute_line', 12, ok_btn_click=True) 
        time.sleep(5) 
