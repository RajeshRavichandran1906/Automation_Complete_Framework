...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2036172
...
class C2036172_TestClass(BaseTestCase):
    
    def test_C2036172(self):
        
        Test_Case_ID = "C2036172"
        driver = self.driver
        ...
        """Step 03: Select "Area" > "Vertical Bi-Polar Stacked Area" > "OK"."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('area', 'area_stacked_bipolar', 4, ok_btn_click=True) 
