...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2036173
...
class C2036173_TestClass(BaseTestCase):
    
    def test_C2036173(self):
        
        Test_Case_ID = "C2036173"
        driver = self.driver
        ...
        """Step 03: Select "Area" > "Vertical Percent Area" > "OK"."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('area', 'area_percent', 5, ok_btn_click=True) 
