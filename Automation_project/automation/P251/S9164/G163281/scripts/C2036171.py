...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2036171
'''
...
class C2036171_TestClass(BaseTestCase):

    def test_C2036171(self):
        
        Test_Case_ID = "C2036171"
        driver = self.driver
        ...
        """Step 03: Select "Area" > "Vertical Bi-Polar Absolute Area" > "OK"."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('area', 'area_absolute_bipolar', 3, ok_btn_click=True) 
        time.sleep(5) 
