...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2036174
...
class C2036174_TestClass(BaseTestCase):
    
    def test_C2036174(self):
        
        Test_Case_ID = "C2036174"
        ...
        """Step 03: Select "Area" > "Horizontal Absolute Area" > "OK"."""
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('area', 'area_absolute_horizontal', 6, ok_btn_click=True) 
