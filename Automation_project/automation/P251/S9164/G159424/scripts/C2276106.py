...
class C2276106_TestClass(BaseTestCase):

    def test_C2276106(self):
        ...
        """
        Step 3:Double click COUNTRY,SEATS.
        Fields added into query pane and canvas updated.
        """
        chart_obj.double_click_on_datetree_item("COUNTRY",1)
        chart_obj.wait_for_visible_text("#queryTreeColumn", "COUNTRY", chart_obj.chart_long_timesleep)
        chart_obj.double_click_on_datetree_item("SEATS",1)
        chart_obj.wait_for_visible_text("#queryTreeColumn", "SEATS", chart_obj.chart_long_timesleep)
        chart_obj.verify_x_axis_title_in_preview(['COUNTRY'] ,msg="Step:3.1")
        chart_obj.verify_y_axis_title_in_preview(['SEATS'],msg="Step:3.2")
        chart_obj.verify_number_of_risers(".groupPanel .risers",1,1,msg="Step:3.3")
        chart_obj.verify_y_axis_label_in_preview(['0', '5', '10', '15', '20', '25', '30', '35', '40'],msg="Step:3.4")
        chart_obj.verify_x_axis_label_in_preview(['ENGLAND', 'FRANCE', 'ITALY', 'JAPAN', 'W GERMANY'],msg="Step:3.5")
        ...
        time.sleep(5)
        chart_obj.select_or_verify_marker_tooltip_in_run_window("marker!s0!g0!mmarker!",  verify_tooltip_list=['COUNTRY:ENGLAND', 'SEATS:13'], msg="Step:4.5", parent_css="#jschart_HOLD_0")
