...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050102
...
class C2050102_TestClass(BaseTestCase):
    
    def test_C2050102(self):
        
        Test_Case_ID = "C2050102"
        driver = self.driver
        ...
        """Step 03: Select "Special" > "Pyramid Chart" > "OK"."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('special', 'pyramid', 7, ok_btn_click=True)
