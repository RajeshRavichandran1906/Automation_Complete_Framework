...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050099
...
class C2050099_TestClass(BaseTestCase):
    
    def test_C2050099(self):
        
        Test_Case_ID = "C2050099"
        driver = self.driver
        ...
        """Step 03: Select "Special" > "Horizontal Box plot Chart" > "OK"."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('special', 'horizontal_boxplot', 5, ok_btn_click=True)
