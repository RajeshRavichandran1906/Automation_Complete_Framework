...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050026
...
class C2050026_TestClass(BaseTestCase):
    
    def test_C2050026(self):
        
        Test_Case_ID = "C2050026"
        driver = self.driver
        ...
        """Step 03: Select "Special" > "Pareto Chart" > "OK".."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('special', 'pareto', 3, ok_btn_click=True)
