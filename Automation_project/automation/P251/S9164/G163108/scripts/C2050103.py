...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2050103
...
class C2050103_TestClass(BaseTestCase):
    
    def test_C2050103(self):
        
        Test_Case_ID = "C2050103"
        driver = self.driver
        ...
        """Step 03: Select "Special" > "Heat Map" > "OK"."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('special', 'spectral', 8, ok_btn_click=True)
        
        """Step 04: Drag and drop "Sale,Year" over "Across (Groups)"."""
        metaobj.drag_drop_data_tree_items_to_query_tree("Sale,Year", 1, "Across (Groups)", 0)
        time.sleep(5)
