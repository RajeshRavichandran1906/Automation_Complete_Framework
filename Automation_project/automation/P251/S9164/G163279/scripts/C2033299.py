...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2033299
'''
...
class C2033299_TestClass(BaseTestCase):

    
    def test_C2033299(self):
        
        Test_Case_ID = "C2033299"
        driver = self.driver
        ...
        Step03: Select "Vertical Bi-Polar Stacked Bars" > "OK".
        """
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('bar', 'vertical_bi_ploar_stacked_bars', 13, ok_btn_click=True)
        
        """
        Step04: Drag and drop "Days,Delayed" over "Y2 Measure".
        """
        metaobj.drag_drop_data_tree_items_to_query_tree('Days,Delayed', 1, 'Y2 Measure',0)
