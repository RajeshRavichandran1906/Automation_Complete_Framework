...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2033654
'''
...
class C2033654_TestClass(BaseTestCase):

    
    def test_C2033654(self):
        
        Test_Case_ID = "C2033654"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2033654.fex&tool=chart
        """
        ...
        Step03: Select "Horizontal Percent Bars" > "OK".
        """
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('bar', 'horizontal_percent_bars', 20, ok_btn_click=True)
