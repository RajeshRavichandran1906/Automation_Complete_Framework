...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2033334
'''
...
class C2033334_TestClass(BaseTestCase):

    
    
    def test_C2033334(self):
        
        Test_Case_ID = "C2033334"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2033299.fex&tool=chart
        """
        ...
        Step03: Select "Horizontal Dual-Axis Stacked Bars" > "OK".
        """
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('bar', 'horizontal_dual_axis_stacked_bars', 17, ok_btn_click=True, pg_dn=1)
