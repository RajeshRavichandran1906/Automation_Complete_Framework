...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2033656
'''
...
class C2033656_TestClass(BaseTestCase):

    
    def test_C2033656(self):
        
        Test_Case_ID = "C2033656"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2033656.fex&tool=chart
        """
        ...
        Step03: Select "Horizontal Histogram" > "OK".
        """
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('bar', 'horizontal_histogram', 21, ok_btn_click=True, starting_visibility_index=8, pg_dn=1)
...
#         utillobj.take_screenshot(ele,Test_Case_ID+'_Actual_step06'+'_'+browser, image_type='actual',x=1, y=1, w=-1, h=-1)  
        
        """
        Step07: Click "IA" > "Save"
        Step08: Close the window
