...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2033281
'''
...
class C2033281_TestClass(BaseTestCase):

  
    def test_C2033281(self):
        
        Test_Case_ID = "C2033281"
        driver = self.driver
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2033281.fex&tool=chart
        """
        ...
        Step03: Select "Multi-Y" (4) > "OK".
        """
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('bar', 'multi_y4', 8, ok_btn_click=True)
        
        """
        Step04: Drag and drop "Gross Profit" over "Y4 Measure"..
        """
        metaobj.drag_drop_data_tree_items_to_query_tree('Gross Profit', 1, 'Y4 Measure',0)
