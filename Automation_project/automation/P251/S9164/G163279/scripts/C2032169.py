...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2032169
'''
import unittest
import time
...
class C2032169_TestClass(BaseTestCase):

    def test_C2032169(self):
        
        Test_Case_ID = "C2032169"
        driver = self.driver
        ...
        http://domain.ibi.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2032169.fex&tool=chart
        """
        ...
        Step03: Select "Vertical Waterfall Bars" > "OK".
        """
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('bar', 'vertical_waterfall_chart', 4, ok_btn_click=True)
