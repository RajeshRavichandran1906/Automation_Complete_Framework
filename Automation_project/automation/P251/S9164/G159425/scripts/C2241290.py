...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2241290
Suite : Bar Chart Verify NOPRINT for Matrix - Columns is working properly (HTML5)
'''
...
class C2241290_TestClass(BaseTestCase):

    def test_C2241290(self):
        ...
        riser_css = 'riser!s0!g0!mbar!r0!c2'
        fexname = '{0}_Base'.format(g_var.current_test_case)
        
        """
        Step 1: Edit C2241290_Base.fex using API (edit the domain, port and alias of the URL - do not use the URL as is):
                http://domain:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FP251_S9164%2FG159425%2FC2241290_Base.fex
        """
        ...
        """
        chart_obj.verify_y_axis_title_in_preview(['SALES'], msg='Step 2')
        chart_obj.verify_y_axis_label_in_preview(['0', '20K', '40K', '60K', '80K', '100K'], msg='Step 2.1')
        chart_obj.verify_x_axis_label_in_preview(['JAGUAR', 'JENSEN', 'TRIUMPH', 'PEUGEOT', 'ALFA ROMEO', 'MASERATI', 'DATSUN', 'TOYOTA', 'AUDI', 'BMW'], msg='Step 2.2')
        ...
        """
        chart_obj.verify_y_axis_title_in_run_window(['SALES'], msg='Step 4')
        chart_obj.verify_y_axis_label_in_run_window(['0', '20K', '40K', '60K', '80K', '100K'], msg='Step 4.1')
        chart_obj.verify_x_axis_label_in_run_window(['JAGUAR', 'JENSEN', 'TRIUMPH', 'PEUGEOT', 'ALFA ROMEO', 'MASERATI', 'DATSUN', 'TOYOTA', 'AUDI', 'BMW'], msg='Step 4.2')
        ...
        """
        chart_obj.verify_tooltip_in_run_window(riser_css, ['CAR:ALFA ROMEO', 'SALES:30200'], 'Step 6: Verify "COUNTRY" is not displayed in tooltip.')
