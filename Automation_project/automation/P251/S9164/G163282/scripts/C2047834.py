...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2047834
...
class C2047834_TestClass(BaseTestCase):
    
    def test_C2047834(self):
        
        Test_Case_ID = "C2047834"
        driver = self.driver
        ...
        """Step 03: Select "Pie" > "Pie" (groups)> "OK"."""
        time.sleep(5)  
