...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2047831
TestCase Name = Verify Ring Pie-Bar Chart is working properly (82xx)
'''
...
class C2047831_TestClass(BaseTestCase):

    def test_C2047831(self):
        
        Test_Case_ID = "C2047831"
        driver = self.driver
        ...
        """ 1. Launch the IA API with chart in edit mode (edit the domain, port and alias of the URL - do not use the URL as is):
               http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS6940Chart_Type_PDF_Charts_Part_1_Test_Suite_%2FC2047831.fex&tool=chart
        """
        ...
        """ 3. Select "Pie" > "Ring Pie-Bar Chart" > "OK".    """
        ia_ribbobj.select_other_chart_type('pie', 'pie_bar_ring', 3, ok_btn_click=True)
