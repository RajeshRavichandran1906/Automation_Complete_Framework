...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2047837
...
class C2047837_TestClass(BaseTestCase):
    
    def test_C2047837(self):
        
        Test_Case_ID = "C2047837"
        driver = self.driver
        ...
        """Step 03: Select "Pie" > "Ring Pie" (groups)> "OK".."""
        time.sleep(5)  
