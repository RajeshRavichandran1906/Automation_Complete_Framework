...
http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2047838
...
class C2047838_TestClass(BaseTestCase):
    
    def test_C2047838(self):
        
        Test_Case_ID = "C2047838"
        driver = self.driver
        ...
        """Step 03: Select "Pie" > "Multi Proportional Pie" (groups)> "OK"."""
        time.sleep(5)  
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbobj.select_other_chart_type('pie', 'pie_multi_proportional', 7, ok_btn_click=True) 
