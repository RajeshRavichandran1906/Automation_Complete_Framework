...
#         
        ...
        resultobj.wait_for_property("#pfjTableChart_1 [class*='riser!s3!g2!mmarker!']", 1,expire_time=120)
...
#         resultobj.verify_riser_legends(parentcss, expected_label_list, msg)
        ...
        visualization_resultarea.Visualization_Resultarea.wait_for_property(self, "#jschart_HOLD_0 [class*='riser!s3!g2!mmarker!']", 1,expire_time=120)
...
#         resultobj.verify_riser_legends(parentcss, expected_label_list, msg)
        expected_title_list=['Customer Continent']
        resultobj.verify_riser_pie_labels_and_legends(parentcss1, expected_title_list, 'Step 6.2. Verify Legend title', custom_css="text[class^='legend-title']", same_group=True)
        time.sleep(5)
        utillobj.verify_chart_color(parentcss1, "riser!s3!g2!mmarker!", 'pale_yellow', 'Step 6.3a Verify map color')
        utillobj.verify_chart_color(parentcss1, "riser!s2!g2!mmarker!", 'dark_green', 'Step 6.3b Verify map color')
        ...
        elem1="#jschart_HOLD_0 [class^='riser!s2!g2!mmarker!']"
