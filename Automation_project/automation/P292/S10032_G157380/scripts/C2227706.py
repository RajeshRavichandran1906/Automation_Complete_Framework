...
#         driver.implicitly_wait(35) #Intializing common implicit wait for throughout the test
        ...
        resultobj.wait_for_property(parent_css, 1)
        propertyobj.select_or_verify_show_prompt_item(1, 'true', verify=True, verify_type=True, msg="Step07: Verify 2014 is checked in filter prompt")

        """
        Step11: Double-click "Store Name", from Store Dimension
        """
        time.sleep(4)
        metaobj.datatree_field_click("Store Name",2,2)
