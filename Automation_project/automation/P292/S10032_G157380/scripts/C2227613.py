...
class C2227613_TestClass(BaseTestCase):
    ...
    def test_C2227613(self):
        ...
        resultobj.create_lasso('MAINTABLE_wbody1','rect', 'riser!s0!g0!mcellFill!r1!c0!', target_tag='rect', target_riser='riser!s0!g0!mcellFill!r3!c0!')
        ...
        expected_tooltip=['Product Category:Camcorder', 'Cost of Goods:$104,866,857.00', 'Filter Chart', 'Exclude from Chart']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1","riser!s0!g0!mcellFill!r0!c0!",expected_tooltip, "Step 05.3: verify the default tooltip values")
        time.sleep(5)
        ...
        expected_tooltip=['Product Category:Camcorder', 'Cost of Goods:$104,866,857.00', 'Filter Chart', 'Exclude from Chart']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1","riser!s0!g0!mcellFill!r0!c0!",expected_tooltip, "Step 06.3: verify the default tooltip values")
        time.sleep(5)
...
#         iarunobj.create_table_data_set('#MAINTABLE_wbody2 table table', "C2227613.xlsx")
        ...
        expected_tooltip=['Product Category:Camcorder', 'Cost of Goods:$104,866,857.00', 'Filter Chart', 'Exclude from Chart']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1","riser!s0!g0!mcellFill!r0!c0!",expected_tooltip, "Step 13.3: verify the default tooltip values")
        time.sleep(5)
