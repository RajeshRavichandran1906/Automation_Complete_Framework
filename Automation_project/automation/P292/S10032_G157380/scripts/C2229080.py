...
#         
        ...
        time.sleep(5)
        metaobj.drag_drop_data_tree_items_to_query_tree('Store,Store Latitude', 1, 'Layer', 0,ty_offset=5)
        ...
        time.sleep(4)
        metaobj.drag_drop_data_tree_items_to_query_tree('Store,Country', 1, 'Layer', 0,ty_offset=5)
        time.sleep(5)
