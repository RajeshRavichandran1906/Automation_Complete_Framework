...
class C2227601_TestClass(BaseTestCase):
    ...
    def test_C2227601(self):
        ...
        resultobj.create_lasso('MAINTABLE_wbody1','rect', 'riser!s0!g1!mbar', target_tag='rect', target_riser='riser!s1!g3!mbar')
        ...
        if browser == 'Firefox':
            ...
            action = ActionChains(driver)
            action.move_to_element(move_riser).perform()
        resultobj.create_lasso('MAINTABLE_wbody1','rect', 'riser!s0!g0!mbar', target_tag='rect', target_riser='riser!s1!g1!mbar')
        resultobj.select_or_verify_lasso_filter(select='Filter Chart')
