...
class C2227656_TestClass(BaseTestCase):
    ...
    def test_C2227656(self):
        ...
        """
        Step 11: Click Save
        Step 12: Save as "C2158172" > Click Save
        """
        time.sleep(2)
        ...
        """
        Step 14: Reopen fex using IA API: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS8979%2FC2158172.fex&tool=idis
        """
        ...
        """
        Step 21: Reopen fex using IA API: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS8979%2FC2158172.fex&tool=idis
        """
