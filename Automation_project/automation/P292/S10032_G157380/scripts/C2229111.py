...
class C2229111_TestClass(BaseTestCase):
    ...
    def test_C2229111(self):
        ...
        bkcolor=bkele.get_attribute("fill").strip()
        ...
        utillobj.default_left_click(object_locator=pagefooting)
        
        quicktext=self.driver.find_element_by_css_selector('#QuickText')
        ...
        val=actual_popup_list[1]
        menu_items[actual_popup_list.index(val)].click()
        time.sleep(2)
        ...
        utillobj.asequal(head_foot[1].text.strip(),footer_txt, 'Step 18.2 Verify Footer displayed in the map')
        ...
        utillobj.asequal(head_foot[1].text.strip(),footer_txt, 'Step 23.5 Verify Footer displayed in the map')
        ...
        utillobj.asequal(head_foot[1].text.strip(),footer_txt, 'Step 25.5 Verify Footer displayed in the map')
        utillobj.infoassist_api_logout()
