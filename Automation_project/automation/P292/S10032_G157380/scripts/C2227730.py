...
class C2227730_TestClass(BaseTestCase):
    ...
    def test_C2227730(self):
        ...
        """
        time.sleep(8)
        metaobj.datatree_field_click("AMERICA_REGIONS", 1, 1,"Add To Query", 'Rows')
        time.sleep(4)
        ...
        """
        time.sleep(5)
        metaobj.datatree_field_click("4_StatesPopRanges", 1, 1,"Add To Query", 'Horizontal Axis')
        time.sleep(4)
        ...
        """
        time.sleep(5)
        metaobj.datatree_field_click("Quantity,Sold", 1, 1,"Add To Query", 'Vertical Axis')
        time.sleep(4)
