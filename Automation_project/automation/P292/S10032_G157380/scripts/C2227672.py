...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227672
Test case Name =  Filter Aggregation - Maximum
'''
...
class C2227672_TestClass(BaseTestCase):

    def test_C2227672(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227672'
...
#         driver.implicitly_wait(35) #Intializing common implicit wait for throughout the test
        ...
        Step05: Click "Aggregation" dropdown menu > Select "Maximum"
        """
        time.sleep(4)
        ...
        utillobj.select_any_combobox_item(elem,'Maximum',verify=True,expected_combobox_list=combo, msg="Step05: Verify list of agregation functions")
        ...
        utillobj.asequal(d['text'],'Maximum',"Step06: Verify Aggregation in Filter dialog")
        time.sleep(5)       
        elem1=driver.find_element_by_css_selector("#avfFromValue input")
        d=utillobj.get_attribute_value(elem1, "int_value")
        utillobj.asequal(d['int_value'],"92","Step06: Verify From in Filter dialog")
        time.sleep(5)      
        elem1=driver.find_element_by_css_selector("#avfToValue input")
        d=utillobj.get_attribute_value(elem1, "int_value")
        utillobj.asequal(d['int_value'],"13000","Step06: Verify To in Filter dialog")
        ...
        """
        time.sleep(5)
        metaobj.verify_filter_pane_field('MAX (Cost of Goods)',1,"Step08: Verify 'MAX(Cost of Goods)' appears in filter pane")
        parent_css= "#ar_Prompt_1 span[id$='s_min']"
        resultobj.wait_for_property(parent_css, 1)
        propertyobj.verify_slider_range_filter_prompts('#ar_Prompt_1','min',92,'int',msg="Step09: Verify filter prompt range values-min")
        ...
        Step12: Hover over riser for value "Flat Panel TV"
        Step13: Verify "Cost of Goods" value > $59,077,345.00
        """
        ...
        propertyobj.verify_slider_range_filter_prompts('#LOBJ1_cs','min',92,'int',msg="Step11: Verify filter prompt range values-min")
        propertyobj.verify_slider_range_filter_prompts('#LOBJ1_cs','max',13000,'int',msg="Step11: Verify filter prompt range values-max")
        ...
        time.sleep(5)
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1", "riser!s0!g6!mbar", bar, "Step 12: Verify bar value")
        ...
        resultobj._validate_page(elem1)
        time.sleep(3)
        metaobj.verify_filter_pane_field('MAX (Cost of Goods)',1,"Step19: Verify 'MAX(Cost of Goods)' appears in filter pane")
        propertyobj.verify_slider_range_filter_prompts('#ar_Prompt_1','min',92,'int',msg="Step19: Verify filter prompt range values-min")
