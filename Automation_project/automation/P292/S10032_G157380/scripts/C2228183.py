...
class C2228183_TestClass(BaseTestCase):
    ...
    def test_C2228183(self):
        ...
        """ Step 1: Create new chart with wf_retail_lite.
        """
        utillobj.infoassist_api_login('chart','new_retail/wf_retail_lite','P292/S10032_chart_1', 'mrid', 'mrpass')
        ...
        time.sleep(1)
        resultobj.wait_for_property("#TableChart_1 path", 27, expire_time=25) 
        ...
        resultobj.wait_for_property("#queryTreeColumn table tr:nth-child(7)", 0, expire_time=25, string_value='Brand', with_regular_exprestion=True)
        ...
        time.sleep(2)
        metaobj.drag_and_drop_query_items('Brand', 'Horizontal Axis', trg_y=3)
        resultobj.wait_for_property("#queryTreeColumn table tr:nth-child(8)", 0, expire_time=25, string_value='Brand', with_regular_exprestion=True)
        ...
        time.sleep(1)
        resultobj.wait_for_property("#queryTreeColumn table tr:nth-child(7)", 0, expire_time=25, string_value='Sale,Year/Quarter', with_regular_exprestion=True)
        
        """ Step 8: Drag Model to Detail.
        """
        metaobj.drag_drop_data_tree_items_to_query_tree('Model', 1, 'Detail', 0)
        time.sleep(1)
        resultobj.wait_for_property("#queryTreeColumn table tr:nth-child(13)", 0, expire_time=25, string_value='Model', with_regular_exprestion=True)
        
        """ Step 9: Drag Product,Category to Color BY.
        """
        metaobj.drag_drop_data_tree_items_to_query_tree('Product,Category', 1, 'Color', 0)
        time.sleep(1)
        resultobj.wait_for_property("#queryTreeColumn table tr:nth-child(15)", 0, expire_time=25, string_value='Product,Category', with_regular_exprestion=True)
        
        """ Step 10: Drag Gross Profit to Size.
        """
        metaobj.drag_drop_data_tree_items_to_query_tree('Gross Profit', 1, 'Size', 0)
        time.sleep(1)
        resultobj.wait_for_property("#queryTreeColumn table tr:nth-child(12)", 0, expire_time=25, string_value='GrossProfit', with_regular_exprestion=True)
        ...
        """ Step 14: Save the chart and close IA.
        """
        ...
        """ Step 15: Right click in tree > Run.
        """
        utillobj.active_run_fex_api_login(Test_Case_ID+'.fex', 'S10032_chart_1', 'mrid', 'mrpass')
        resultobj.wait_for_property("#jschart_HOLD_0 text", 69, expire_time=25)
        
        """ Step 16: Verify the following chart displays.
        """
        xlabel=['Audio Technica', 'AudioVox', 'Audiovox', 'BOSE', 'Canon', 'Denon', 'GPX', 'Grado', 'Harman Kardon', 'JVC', 'LG', 'Logitech', 'Magnavox', 'Niles Audio', 'Onkyo', 'Panasonic', 'Philips', 'Pioneer', 'Polaroid', 'Polk Audio', 'Roku', 'Samsung', 'Sanyo', 'Sennheiser', 'Sharp', 'Sony', 'SuperSonic', 'Thomson Grass Valley', 'Tivax', 'Toshiba', 'Yamaha', 'Brand', 'Sale Year/Quarter']
        ylabel=['2011 Q1', '2011 Q2', '2011 Q3', '2011 Q4', '2012 Q1', '2012 Q2', '2012 Q3', '2012 Q4', '2013 Q1', '2013 Q2', '2013 Q3', '2013 Q4', '2014 Q1', '2014 Q2', '2014 Q3', '2014 Q4', '2015 Q1', '2015 Q2', '2015 Q3', '2015 Q4', '2016 Q1', '2016 Q2', '2016 Q3', '2016 Q4']
        expected_legend_list=['Product Category', 'Accessories', 'Camcorder', 'Computers', 'Media Player', 'Stereo Systems', 'Televisions', 'Video Production', 'Gross Profit', '722.3K', '361.2K', '0K']
        actual_tooltip=['Brand:Audio Technica', 'Sale Year/Quarter:2013 Q1', 'Gross Profit:$54,401.91', 'Product Category:Accessories', 'Model:Audio Technica ATHW5000']
        verify_chart(2580, xlabel, ylabel, '16', expected_legend_list, tooltip=actual_tooltip)
