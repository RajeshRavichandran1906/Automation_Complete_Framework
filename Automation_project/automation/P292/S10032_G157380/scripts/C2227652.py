...
#         resultobj.wait_for_property(parent_css, 1)
        ...
        time.sleep(5)
        metaobj.datatree_field_click("Sale,Day", 1, 1,"Add To Query", 'Rows')
        parent_css="#MAINTABLE_wbody1 svg g text[class*='mgroupLabel']"
        resultobj.wait_for_property(parent_css, 21)
        parent_css= "#MAINTABLE_wbody1 svg g text[class*='yaxis-labels']"
        ...
        """
        time.sleep(4)
        metaobj.datatree_field_click("Sale,Day", 1, 1,"Filter")        
        time.sleep(6)
        ...
        bar=['Sale Day:15', 'Product Subcategory:Blu Ray', 'Cost of Goods:$5,980,755.00', 'Filter Chart', 'Exclude from Chart', 'Drill up to', 'Drill down to Model']
        ...
        bar=['Sale Day:15', 'Product Subcategory:Blu Ray', 'Cost of Goods:$5,980,755.00', 'Filter Chart', 'Exclude from Chart', 'Drill up to', 'Drill down to Model']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1", "riser!s0!g0!mbar!r0!c0", bar, "Step12: Verify bar value")
        ...
        bar=['Sale Day:15', 'Product Subcategory:Blu Ray', 'Cost of Goods:$5,980,755.00', 'Filter Chart', 'Exclude from Chart', 'Drill up to', 'Drill down to Model']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1", "riser!s0!g0!mbar!r0!c0", bar, "Step18: Verify bar value")
        time.sleep(5)
