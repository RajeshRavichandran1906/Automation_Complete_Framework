...
class C2227688_TestClass(BaseTestCase):
    ...
    def test_C2227688(self):
        ...
        """
        time.sleep(4)
        metaobj.datatree_field_click('Cost of Goods,Local Currency', 1, 1, 'Filter')
        time.sleep(5)
...
#         if browser in ['IE', 'Chrome']:
        ...
        utillobj.take_screenshot(ele,'C2227688_Actual_step18', image_type='actual',x=1, y=1, w=-1, h=-1)
