...
class C2227662_TestClass(BaseTestCase):
    ...
    def test_C2227662(self):
        ...
        """
        Step 12: Click Save
        Step 13: Save as "C2158198" > Click Save
        """
        time.sleep(2)
        ...
        """
        Step 15: Reopen fex using IA API: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS8979%2FC2158198.fex&tool=idis
        """
