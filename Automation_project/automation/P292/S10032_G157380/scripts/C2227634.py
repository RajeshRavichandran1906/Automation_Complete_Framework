...
#         driver.implicitly_wait(35) #Intializing common implicit wait for throughout the test
        ...
        """
        time.sleep(4)
        obj_cell_css = self.driver.find_element_by_css_selector("#iaMetaDataBrowser img[src*='search_cancel']")
...
#         time.sleep(3)
#         metaobj.expand_field_tree('2014', click_opt=0, x_offset=35)
#         time.sleep(2)
#         pyautogui.press('enter')
#         time.sleep(3)
#           
#         """
#         Step06: Verify a message is displayed > click OK
#         """        
#         obj=self.driver.find_element_by_css_selector("[id*='BiOptionPane'] div[id*='BiLabel']")
#         print(obj.text)
#         utillobj.asequal(obj.text,"Only metadata fields can be dropped into this bucket.", "Step06: Verify message is displayed")
#         time.sleep(2)
...
#         time.sleep(2)
        ...
        """
        time.sleep(2)
        metaobj.expand_field_tree('2014', click_opt=1, x_offset=35)
        time.sleep(2)
        ...
        metaobj.verify_data_pane_field('2014', '1', 1, "Step045: Verify value 1 in 2014")
        metaobj.verify_data_pane_field('2014', '2', 2, "Step045: Verify value 2 in 2014")
        metaobj.verify_data_pane_field('2014', '3', 3, "Step045: Verify value 3 in 2014")
        metaobj.verify_data_pane_field('2014', '4', 4, "Step045: Verify value 4 in 2014")
