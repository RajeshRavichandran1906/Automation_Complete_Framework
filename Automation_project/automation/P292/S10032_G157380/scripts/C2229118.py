...
class C2229118_TestClass(BaseTestCase):
    ...
    def test_C2229118(self):
        ...
        utillobj.verify_chart_color('TableChart_1', 'riser!s0!g7!mstate!', color='persian_red', msg='Step 04 : Verify the persian red color')
        utillobj.verify_chart_color('TableChart_1', 'riser!s0!g41!mstate!', color='elf_green', msg='Step 04 : Verify the elf_green color')
        utillobj.verify_chart_color('TableChart_1', 'riser!s0!g4!mstate!', color='burnt_sienna', msg='Step 04 : Verify the burnt_sienna color')
        expected_legend_list=['Cost of Goods', '0M', '60M', '119.8M', '179.6M', '239.5M']
        ia_resultobj.verify_color_scale_esri_maps('TableChart_1', expected_legend_list, "Step 04 : Verify the lables and legends")
        """        
        ...
        parent_css='#TableChart_1'
        resobj.wait_for_property(parent_css,1,expire_time=20)
        utillobj.verify_chart_color('TableChart_1', 'riser!s0!g7!mregion!', color='persian_red', msg='Step 05 : Verify the persian red color')
        utillobj.verify_chart_color('TableChart_1', 'riser!s0!g41!mregion!', color='elf_green', msg='Step 05 : Verify the elf_green color')
        utillobj.verify_chart_color('TableChart_1', 'riser!s0!g4!mregion!', color='burnt_sienna', msg='Step 05 : Verify the burnt_sienna color')
        expected_legend_list=['Cost of Goods', '0M', '60M', '119.8M', '179.6M', '239.5M']
        ia_resultobj.verify_color_scale_esri_maps('TableChart_1', expected_legend_list, "Step 05 : Verify the lables and legends")
        ...
        parent_css='#TableChart_1'
        resobj.wait_for_property(parent_css,1,expire_time=20)
        utillobj.verify_chart_color('TableChart_1', 'riser!s0!g41!mstate!', color='bar_blue', msg='Step 06: Verify the bar_blue color in bubble map')
        expected_title_list=['Cost of Goods']
        expected_label_list=['Cost of Goods']
        
        resobj.verify_riser_pie_labels_and_legends('TableChart_1', expected_title_list, 'Step 06 Verify Legend title', custom_css="text[class^='sizeLegend-title']", same_group=True)
        resobj.verify_riser_pie_labels_and_legends('TableChart_1', expected_label_list, msg='Step 06 : ', custom_css="text[class^='legend-labels']", same_group=True)
        """        
        ...
        parent_css="div[id='TableChart_1'] circle[class='riser!s0!g41!mmarker!']"
        resobj.wait_for_property(parent_css,1,expire_time=20)
        utillobj.verify_chart_color('TableChart_1', 'riser!s0!g41!mmarker!', color='bar_blue', msg='Step 07 : Verify the bar_blue color in bubble map')
        expected_title_list=['Cost of Goods']
        expected_label_list=['Cost of Goods']
        resobj.verify_riser_pie_labels_and_legends('TableChart_1', expected_title_list, 'Step 07 : Verify Legend title', custom_css="text[class^='sizeLegend-title']", same_group=True)
        resobj.verify_riser_pie_labels_and_legends('TableChart_1', expected_label_list, msg='Step 07 : ', custom_css="text[class^='legend-labels']", same_group=True)
        """        
