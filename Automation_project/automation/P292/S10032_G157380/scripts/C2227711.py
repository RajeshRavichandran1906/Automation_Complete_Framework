...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227711
...
class C2227711_TestClass(BaseTestCase):

    def test_C2227711(self):
        ...
        utillobj.click_on_screen(parent_elem, 'middle', click_type=1)
        time.sleep(6)
        resultobj.select_or_verify_lasso_filter(verify=['1 point','Filter Chart','Exclude from Chart', 'Group Product,Category Selection'],msg='Step 09: Expect to see the Right-click options appear')
        ...
        utillobj.take_screenshot(ele,'C2227711_Actual_step11', image_type='actual',x=1, y=1, w=-1, h=-1)       
        time.sleep(5) 
