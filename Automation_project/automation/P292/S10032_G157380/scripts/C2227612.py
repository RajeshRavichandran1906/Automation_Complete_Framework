...
class C2227612_TestClass(BaseTestCase):
    ...
    def test_C2227612(self):
        ...
        time.sleep(2)
        expected_tooltip=['Customer Business Region:EMEA', 'Cost of Goods:$109,228,523.00', 'Product Category:Stereo Systems', 'Filter Chart', 'Exclude from Chart', 'Drill down to']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1","riser!s0!g4!mmarker!r0!c0!",expected_tooltip, "Step 05e: verify the default tooltip values")
        ...
        time.sleep(2)
        expected_tooltip=['Customer Business Region:EMEA', 'Cost of Goods:$109,228,523.00', 'Product Category:Stereo Systems', 'Filter Chart', 'Exclude from Chart', 'Drill down to']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1","riser!s0!g3!mmarker!r0!c0!",expected_tooltip, "Step 08e: verify the default tooltip values")
        """
        ...
        time.sleep(8)
        expected_tooltip=['Customer Business Region:EMEA', 'Cost of Goods:$109,228,523.00', 'Product Category:Stereo Systems', 'Filter Chart', 'Exclude from Chart', 'Drill down to']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1","riser!s0!g3!mmarker!r0!c0!",expected_tooltip, "Step 09e: verify the default tooltip values")
        time.sleep(5)
        ...
        time.sleep(2)
        expected_tooltip=['Customer Business Region:EMEA', 'Cost of Goods:$109,228,523.00', 'Product Category:Stereo Systems', 'Filter Chart', 'Exclude from Chart', 'Remove Filter', 'Drill down to']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1","riser!s0!g1!mmarker!r0!c0!",expected_tooltip, "Step 11e: verify the default tooltip values")
        time.sleep(20)
        ...
        time.sleep(2)
        expected_tooltip=['Customer Business Region:EMEA', 'Cost of Goods:$109,228,523.00', 'Product Category:Stereo Systems', 'Filter Chart', 'Exclude from Chart', 'Drill down to']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1","riser!s0!g3!mmarker!r0!c0!",expected_tooltip, "Step 16e: verify the default tooltip values")
        time.sleep(5)
