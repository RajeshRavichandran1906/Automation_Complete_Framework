...
class C2227621_TestClass(BaseTestCase):
    ...
    def test_C2227621(self):
        ...
        resultobj.select_default_tooltip_menu("MAINTABLE_wbody1", "marker!s0!g2!mmarker",'Drill down to Product Subcategory',wait_time=0,default_move=True)
        ...
        time.sleep(5)
        parent_elem=self.driver.find_element_by_css_selector("[class*='eventPanel']")
        utillobj.click_on_screen(parent_elem, 'offset',x_offset=0,y_offset=0)
        time.sleep(5)
        ...
        utillobj.click_on_screen(parent_elem, 'middle',javascript_marker_enable = True)
        utillobj.synchronize_with_number_of_element(parent_elem, 1, 25)
        resultobj.select_default_tooltip_menu("MAINTABLE_wbody1", "marker!s0!g0!mmarker",'Drill down to Model',wait_time=0,default_move=True)
        ...
        utillobj.click_on_screen(parent_elem, 'bottom_middle',javascript_marker_enable = True)
