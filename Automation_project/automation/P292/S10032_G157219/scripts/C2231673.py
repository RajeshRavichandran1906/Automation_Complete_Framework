...
class C2231673_TestClass(BaseTestCase):
    ...
    def test_C2231673(self):
        ...
        """
        metaobj.drag_drop_data_tree_items_to_query_tree('Customer,Business,Region',1,'Coordinated',0,target_cord='middle')
        ...
        """
        metaobj.drag_drop_data_tree_items_to_query_tree('Customer,Country',1,'By',0,target_cord='middle')
        ...
        metaobj.verify_data_pane_field('Customer', 'BUSINESS_REGION_1', 1,'Step 10.2')
