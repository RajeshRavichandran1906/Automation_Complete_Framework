...
class C2227565_TestClass(BaseTestCase):
    ...
    def test_C2227565(self):
        ...
        """
        ia_resultobj.verify_autolink("TableChart_1","ENGLAND",5,"Step12: Verify Report preview with hyperlinks")
        ...
        ia_runobj.verify_autolink_tooltip_values("table[summary='Summary']",2,1, expected_tooltip_list, "Step15:Verify drilldown at run time")
        ...
        utillobj.asequal(True, drill1, "Step17: Verify IBI page is displayed")
        time.sleep(2)
        self.driver.close()
        time.sleep(3)
