...
class C2235379_TestClass(BaseTestCase):
    ...
    def test_C2235379(self):
        ...
        """
        utillobj.infoassist_api_login('report','new_retail/wf_retail_lite','P292/S10032_infoassist_5', 'mrid', 'mrpass')
        ...
        resultobj.wait_for_property("#TableChart_1  div[class^='x']", 9, expire_time=10) 
        time.sleep(4)
          
        metaobj.datatree_field_click("Cost of Goods", 2, 1)
        resultobj.wait_for_property("#TableChart_1  div[class^='x']", 18, expire_time=10) 
        time.sleep(4)
        ...
        utillobj.select_or_verify_bipop_menu(current_date)
        ...
        if browser == 'IE':
            ...
            print(text_value)
            utillobj.asequal(text_value,syntax,"Step 08: Verify syntax displayed in the dialog")
            time.sleep(1)
        ...
        resultobj.verify_report_titles_on_preview(2, 4, "TableChart_1", coln_list, "Step 11.1: Verify report titles")
#         ia_resultobj.create_report_data_set('TableChart_1', 7, 2, Test_Case_ID+"_Ds01.xlsx", no_of_cells=4)
        ia_resultobj.verify_report_data_set('TableChart_1', 7, 2, Test_Case_ID+"_Ds01.xlsx", 'Step 11.2: Verify report dataset', no_of_cells=4)
        ia_resultobj.verify_report_header_footer_property('TableChart_1', 1, font_color='matterhorn1', text_value='Report Header for test case C2235379', font_name='Arial',font_size='14pt', bold=True,msg='Step 11.3:')
        ia_resultobj.verify_report_header_footer_property('TableChart_1', 2, font_color='matterhorn1', text_value='Cost of Goods by Product', font_name='Arial', font_size='12pt',bold=True,msg='Step 11.4:')
        ia_resultobj.verify_report_header_footer_property('TableChart_1', 3, font_color='matterhorn1', text_value=current_date, font_name='Arial',font_size='12pt', msg='Step 11.5:')
        ia_resultobj.verify_report_header_footer_property('TableChart_1', 4, font_color='matterhorn1', text_value='Report Footer for test case C2235379', font_name='Arial',font_size='10pt', msg='Step 11.6:')
...
#         ia_runobj.create_table_data_set("table[summary='Summary']", Test_Case_ID+"_Ds02.xlsx" )
        ia_runobj.verify_table_data_set("table[summary='Summary']", Test_Case_ID+"_Ds02.xlsx" , 'Step 13: Verify report dataset', desired_no_of_rows=12)
        ...
        """
        coln_list = ['ProductCategory', 'Cost of Goods']
        resultobj.verify_report_titles_on_preview(2, 4, "TableChart_1", coln_list, "Step 17.1: Verify report titles")
        ia_resultobj.verify_report_data_set('TableChart_1', 7, 2, Test_Case_ID+"_Ds01.xlsx", 'Step 17.2: Verify report dataset', no_of_cells=4)
        ia_resultobj.verify_report_header_footer_property('TableChart_1', 1, font_color='matterhorn1', text_value='Report Header for test case C2235379', font_name='Arial',font_size='14pt', bold=True,msg='Step 17.3:')
        ia_resultobj.verify_report_header_footer_property('TableChart_1', 2, font_color='matterhorn1', text_value='Cost of Goods by Product', font_name='Arial', font_size='12pt',bold=True,msg='Step 17.4:')
        ia_resultobj.verify_report_header_footer_property('TableChart_1', 3, font_color='matterhorn1', text_value=current_date, font_name='Arial',font_size='12pt', msg='Step 17.5:')
        ia_resultobj.verify_report_header_footer_property('TableChart_1', 4, font_color='matterhorn1', text_value='Report Footer for test case C2235379', font_name='Arial',font_size='10pt', msg='Step 17.6:')
