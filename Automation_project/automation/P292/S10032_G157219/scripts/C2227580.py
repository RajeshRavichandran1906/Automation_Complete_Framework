...
class C2227580_TestClass(BaseTestCase):
    ...
    def test_C2227580(self):
        ...
        for i in range(1,5) :
            ...
            utillobj.switch_to_default_content(2)
        utillobj.take_screenshot(parent_tab,Test_Case_ID+'_Actual_Step_08','actual')
        ...
        status0=True if actual_y_gap in range(180,220) else False
        ...
        for i in range(1,5) :
            ...
            utillobj.switch_to_default_content(2)
        utillobj.take_screenshot(parent_tab,Test_Case_ID+'_Actual_Step_10','actual')
