...
class C2231277_TestClass(BaseTestCase):
    ...
    def test_C2231277(self):
        ...
        iaresultobj.verify_number_of_chart_segment("TableChart_1",41, 'Step 06.3: Verify number of risers displayed', custom_css="svg g>path[class^='riser!s']")
        time.sleep(2)
        ...
        time.sleep(5)
        iaresultobj.verify_number_of_chart_segment("jschart_HOLD_0",41, 'Step 08.04: Verify number of risers displayed', custom_css="svg g>path[class^='riser!s']")
        ...
        time.sleep(5)
        iaresultobj.verify_number_of_chart_segment("jschart_HOLD_0",41, 'Step 11.04: Verify number of risers displayed', custom_css="svg g>path[class^='riser!s']")
        ...
        """
        iaresultobj.verify_number_of_chart_segment("TableChart_1",41, 'Step 14.2: Verify number of risers displayed', custom_css="svg g>path[class^='riser!s']")
