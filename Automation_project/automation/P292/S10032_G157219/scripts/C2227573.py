...
class C2227573_TestClass(BaseTestCase):
    ...
    def test_C2227573(self):
        ...
        coln_list = ['COUNTRY', 'CAR', 'DEALER_COST', 'RETAIL_COST', 'TOTAL']
        ia_resultobj.verify_row_total_report_titles_on_preview(5, 5, "TableChart_1", coln_list, "Step 6.1: Verify Canvas column titles")
