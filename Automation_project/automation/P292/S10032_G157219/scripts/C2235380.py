...
class C2235380_TestClass(BaseTestCase):
    ...
    def test_C2235380(self):
        ...
        propertyobj.select_or_verify_show_prompt_item(1, '[All]', verify=True, verify_type=True, msg="Step 13.7: Verify [All] is checked in filter prompt")
        ...
        propertyobj.select_or_verify_show_prompt_item(1, '[All]', verify=True, verify_type=True, msg="Step 25.6: Verify [All] is checked in filter prompt")
