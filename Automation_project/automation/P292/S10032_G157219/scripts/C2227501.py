...
class C2227501_TestClass(BaseTestCase):
    ...
    def test_C2227501(self):
        ...
        resultobj.verify_number_of_pie_segments("jschart_HOLD_0", 1, 10, "Step 15:03: Verify number pie chart segments")
        labels_list=['SALES']
        ...
        """
        utillobj.verify_chart_color("jschart_HOLD_0", "riser!s0!g0!mwedge!", "bar_blue", "Step 20:01: Verify pie chart color")
        utillobj.verify_chart_color("jschart_HOLD_0", "riser!s2!g0!mwedge!", "dark_green", "Step 20:02: Verify second pie chart slice color")
        resultobj.verify_number_of_pie_segments("jschart_HOLD_0", 1, 10, "Step 20:03: Verify number pie chart segments")
        labels_list=['SALES']
        resultobj.verify_riser_pie_labels_and_legends('jschart_HOLD_0', labels_list,"'Step 20:04: Verify pie Chart labels'",custom_css="text[class^='pieLabel!g']",same_group=True)
        expected_tooltip_list=['CAR:ALFA ROMEO', 'SALES:30200  (14.49%)']
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "riser!s0!g0!mwedge!", expected_tooltip_list, "Step 20:05: Verify pie slice tooltip value")
        resultobj.verify_riser_legends('jschart_HOLD_0',['CAR', 'ALFA ROMEO', 'AUDI', 'BMW', 'DATSUN', 'JAGUAR', 'JENSEN', 'MASERATI', 'PEUGEOT', 'TOYOTA', 'TRIUMPH'], 'Step 20:06: Verify chart legends')
        expected_datalabel=['14%', '4%', '39%', '21%', '6%', '17%']
        resultobj.verify_data_labels("jschart_HOLD_0", expected_datalabel, "Step 20:07: Verify the data lables in the pie chart", custom_css="svg > g.chartPanel text[class*='mdataLabels']")
        ...
        resultobj.verify_number_of_pie_segments("TableChart_1", 1, 10, "Step 24:03: Verify number pie chart segments")
        labels_list=['SALES']
