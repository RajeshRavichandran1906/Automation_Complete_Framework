...
class C2298488_TestClass(BaseTestCase):
    ...
    def test_C2298488(self):
        ...
        ia_ribbonobj.create_join("new_retail->training.mas", new_join=False)
        time.sleep(3)
        ...
        time.sleep(2)
        metaobj.verify_data_pane_field('Measures/Properties',"EXPENSES",2,"Step 06a")
        metaobj.verify_data_pane_field('Measures/Properties',"Define_1",3,"Step 06b")
        ...
        resultobj.wait_for_property(parent_css, 1, expire_time=15)
        time.sleep(2)
        metaobj.verify_data_pane_field('Measures/Properties',"EXPENSES",2,"Step 12a")
        metaobj.verify_data_pane_field('Measures/Properties',"Define_1",3,"Step 12b")
