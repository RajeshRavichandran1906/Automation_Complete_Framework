...
class C2227557_TestClass(BaseTestCase):
    ...
    def test_C2227557(self):
        ...
        resultobj.verify_xaxis_title("TableChart_1", xaxis_value, "Step 04:a(i) Verify X-Axis Title")
        expected_xval_list=['Accessories', 'Camcorder', 'Computers', 'Media Player', 'Stereo Systems', 'Televisions', 'Video Production']
        expected_yval_list=['0', '50M', '100M', '150M', '200M', '250M', '300M', '350M']
        resultobj.verify_riser_chart_XY_labels("TableChart_1", expected_xval_list, expected_yval_list, "Step04.b:Verify XY labels")
        resultobj.verify_number_of_riser("TableChart_1", 1, 14, 'Step04.c: Verify the total number of risers displayed on preview')
        utillobj.verify_chart_color("TableChart_1", "riser!s0!g0!mbar!", "bar_blue", "Step04.d: Verify first bar color")
        legend=['Cost of Goods', 'Revenue']
        resultobj.verify_riser_legends("TableChart_1", legend, "Step 04.e: Verify legend Title")
        time.sleep(5)
        ...
        """
        utillobj.select_or_verify_bipop_menu(expected_ticked_list=['Document1'],msg='Step 06.a:')
        utillobj.select_or_verify_bipop_menu(verify='true',expected_popup_list=['Chart1', 'Document1'],msg='Step 06.b:')
        ...
        resultobj.wait_for_property(parent_css, 7)
        xaxis_value="Product Category"
        resultobj.verify_xaxis_title("TableChart_1", xaxis_value, "Step 13:a(i) Verify X-Axis Title")
        expected_xval_list=['Accessories', 'Camcorder', 'Computers', 'Media Player', 'Stereo Systems', 'Televisions', 'Video Production']
        expected_yval_list=['0', '50M', '100M', '150M', '200M', '250M', '300M', '350M']
        resultobj.verify_riser_chart_XY_labels("TableChart_1", expected_xval_list, expected_yval_list, "Step 13:b:Verify XY labels")
        resultobj.verify_number_of_riser("TableChart_1", 1, 14, 'Step 13.c: Verify the total number of risers displayed on preview')
        utillobj.verify_chart_color("TableChart_1", "riser!s0!g0!mbar!", "bar_blue", "Step 13.d: Verify first bar color")
        legend=['Cost of Goods', 'Revenue']
        resultobj.verify_riser_legends("TableChart_1", legend, "Step 13.e: Verify legend Title")
        time.sleep(10)
        ele=driver.find_element_by_css_selector("#TableChart_1")
        utillobj.take_screenshot(ele,'C2227557_Actual_step13', image_type='actual',x=1, y=1, w=-1, h=-1)
