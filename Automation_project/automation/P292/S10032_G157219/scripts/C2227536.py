...
class C2227536_TestClass(BaseTestCase):
    ...
    def test_C2227536(self):
        ...
        utillobj.infoassist_api_login('document','new_retail/wf_retail_lite','P292/S10032_1', 'mrid', 'mrpass')
        ...
        resultobj.verify_report_titles_on_preview(1, 2, "TableChart_1", coln_list, "Step 2a: Verify column titles")
        ...
        utillobj.select_or_verify_bipop_menu(expected_ticked_list=['Landscape'], msg='Step 04a: Landscape - ')
        
        """ 5. Click the "Size" button > Verify default Page Size is "Letter" """
        ribbonobj.select_ribbon_item("Layout", "Size")
        utillobj.select_or_verify_bipop_menu(expected_ticked_list=['Letter'], msg='Step 04a: Letter - ')
        ...
        ribbonobj.select_ribbon_item("Layout", "Orientation")
        utillobj.select_or_verify_bipop_menu(expected_ticked_list=['Landscape'], msg='Step 11a: Landscape - ')
        ribbonobj.select_ribbon_item("Layout", "Size")
        utillobj.select_or_verify_bipop_menu(expected_ticked_list=['Large Size (34x44 Inches)'], msg='Step 11b: Large Size (34x44 Inches) - ')
