...
#         ia_resultobj.create_across_report_data_set('TableChart_1', 3, 8, 10, 8, Test_Case_ID+"_Ds05.xlsx")
        ...
        utillobj.click_on_screen(table_css_obj, 'top_middle', 1)
        time.sleep(1)  
        """ 
        ...
        self.driver.find_element_by_css_selector("div[id^='QbDialog'] [class*='active'] #sapOkBtn").click()
        time.sleep(5)
        ...
        utillobj.click_on_screen(page_canvas_obj, 'top_middle', 1)
        time.sleep(1)
