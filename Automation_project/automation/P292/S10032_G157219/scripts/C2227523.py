...
class C2227523_TestClass(BaseTestCase):
    ...
    def test_C2227523(self):
        ...
        ia_resultobj.verify_report_data_set('TableChart_1', 2, 2, "C2227523_Ds02.xlsx", 'Step 06:02: Verify report dataset')
        """
        ...
        """
        metaobj.drag_and_drop_query_items('SALES', 'Parameter1', trg_y=5)
        ...
        """
        metaobj.verify_query_pane_field('By', 'DEALER_COST', 1, "Step 18 : Verify DEALER_COST is disabled under neath By query bucket", color='Trolley_Grey', font_style='italic')
        """
        ...
        """
        metaobj.verify_query_pane_field('By', 'DEALER_COST', 1, "Step 27 : Verify DEALER_COST is disabled under neath By query bucket", color='Trolley_Grey', font_style='italic')
        metaobj.verify_query_pane_field('By', 'CAR', 2, "Step 27 : Verify CAR is added underneath By query bucket")
        ia_resultobj.verify_report_data_set('TableChart_1', 2, 2, "C2227523_Ds04.xlsx", 'Step 27:01: Verify report dataset')
