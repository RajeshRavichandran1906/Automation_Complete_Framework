...
class C2241554_TestClass(BaseTestCase):
    ...
    def test_C2241554(self):
        ...
        resultobj.wait_for_property("#pfjTableChart_1 text[class='legend-labels!s0!']", 1,60,string_value='Series0')
        ...
        resultobj.wait_for_property("#queryTreeColumn table[class='bi-tree-view-table']>tbody>tr:nth-child(7)", 1,20,string_value='Cost of Goods')
        metaobj.datatree_field_click('Product,Category',2,1)
        resultobj.wait_for_property("#queryTreeColumn table[class='bi-tree-view-table']>tbody>tr:nth-child(9)", 1,20,string_value='Product,Category')
        time.sleep(3)
        ...
        resultobj.wait_for_property("#pfjTableChart_1 text[class='xaxisOrdinal-title']", 1,20,string_value='Product Category')
        time.sleep(2)
