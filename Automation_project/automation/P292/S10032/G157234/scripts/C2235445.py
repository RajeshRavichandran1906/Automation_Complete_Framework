...
class C2235445_TestClass(BaseTestCase):
    ...
    def test_C2235445(self):
        ...
        """
        utillobj.wf_logout() #changed logout func due to alert issue
        """ 
        ...
        ia_resultobj.create_across_report_data_set("TableChart_1", 2, 2, 7, 2, Test_Case_ID+"_Ds04.1.xlsx")
        ia_resultobj.verify_across_report_data_set("TableChart_1", 2, 2, 7, 2, Test_Case_ID+"_Ds04.1.xlsx", "Step 13.02: Verofy report dataset")
