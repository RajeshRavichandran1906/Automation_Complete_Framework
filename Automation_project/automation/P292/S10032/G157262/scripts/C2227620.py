...
class C2227620_TestClass(BaseTestCase):
    def test_C2227620(self):
        ...
        visual = visualization.Visualization(driver)
...
#         utillobj.infoassist_api_edit('C2227620','idis','S10032_visual_3',mrid='mrid',mrpass='mrpass')  
        parent_css="#MAINTABLE_wbody1 text[class*='mgroupLabel']"
        resultobj.wait_for_property(parent_css, 7)
        """
        Step10: Click Run
...
#         utillobj.click_on_screen(parent_elem, 'middle',javascript_marker_enable=True,mouse_duration=2.5,x_offset=10,y_offset=20)
        ...
        """ 
        time.sleep(5) 
        tooltip_css="#MAINTABLE_wbody1_f_tdgchart-tooltip:not([style*='hidden']) li.tdgchart-tooltip-pad:last-child span[style]"
