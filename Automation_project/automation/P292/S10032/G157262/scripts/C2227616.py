...
class C2227616_TestClass(BaseTestCase):
    def test_C2227616(self):
        ...
        time.sleep(5)
        bar=['Customer Business Sub Region:East', 'Cost of Goods:$11,455,431.00', 'Product Category:Media Player', 'Filter Chart', 'Exclude from Chart', 'Go up to Customer Business Region', 'Drill down to']
        ...
        time.sleep(5)
        bar=['Customer Business Sub Region:Canada', 'Cost of Goods:$16,190,913.00', 'Product Category:Media Player', 'Filter Chart', 'Exclude from Chart', 'Go up to Customer Business Region', 'Drill down to']
