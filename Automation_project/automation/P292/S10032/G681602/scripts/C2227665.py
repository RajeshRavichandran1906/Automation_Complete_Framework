...
class C2227665_TestClass(BaseTestCase):
    ...
    def test_C2227665(self):
        ...
        """
        Step 18: Click Save
        Step19: Click Save in the toolbar > Save as "C2227665" > Click Save
        """
        time.sleep(2)
        ...
        """
        Step 21: Reopen fex using IA API: http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227665.fex
        """
