...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227662
Test case Name =  Prompt Type - edit type from Multiple to Dropdown (Single Select)
'''
...
class C2227662_TestClass(BaseTestCase):

    def test_C2227662(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227662'
...
#         metaobj.datatree_field_click("Product,Category", 1, 1,"Filter")
        ...
        utillobj.take_screenshot(ele,'C2227662_Actual_step10', image_type='actual',x=1, y=1, w=-1, h=-1) 
        ...
        """
        Step 12: Click Save
        Step 13: Click Save in the toolbar > Save as "C2227662" > Click Save
        """
        time.sleep(2)
        ...
        """
        Step 15: Reopen fex using IA API: http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227662.fex
        """
