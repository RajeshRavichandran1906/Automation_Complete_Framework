...
class C2227670_TestClass(BaseTestCase):
    ...
    def test_C2227670(self):
        ...
        """
        Step15: Click Save
        Step16: Save as "C2227670" > Click Save
        """
        time.sleep(2)
        ...
        """
        Step18: Reopen fex using IA API: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227670.fex&tool=idis
        """
