...
#         utillobj.infoassist_api_edit('a', 'chart', 'P292/S10032', mrid='mrid', mrpass='mrpass')
        ...
        utillobj.synchronize_with_number_of_element("[id^='QbDemographicLayersDlg']", 1, 90, 1)
        ...
        expected_label_list_cr=['Series 0','Series 1','Series 2','Series 3','Series 4']
        ...
        utillobj.synchronize_with_number_of_element(parentcss, 1, 90, 1)
