...
#         utillobj.infoassist_api_edit('a', 'chart', 'P292/S10032', mrid='mrid', mrpass='mrpass')
        ...
        resultobj.verify_data_labels("pfjTableChart_1", expected_xval_list_cr, "Step 02:c(iii):Verify XY labels", data_label_length=3,custom_css="svg > g text[class^='xaxis'][class*='labels']")
