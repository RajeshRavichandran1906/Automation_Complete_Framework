...
'''
import unittest
from common.pages import visualization_resultarea, visualization_ribbon,visualization_metadata,define_compute,wf_map
...
class C2229085_TestClass(BaseTestCase):

    def test_C2229085(self):
        ...
        TESTCASE VARIABLES
        """
        Test_Case_ID = "C2229085"
        Test_fex_name="C2229085"
...
#         
        ...
        element_css="#fname"
        utillobj.synchronize_with_number_of_element(element_css, 1, 30, pause_time=1)
        time.sleep(5)
        ...
        time.sleep(5)
        utillobj.synchronize_with_number_of_element("div[id^='QbDialog']", 1, 30, 1)
        
        wfmapobj.set_geo_role(role_name='Country', store_as='Name', btn_click='Ok')
      

        """    10. Verify the map is updated    """
        defcss="pfjTableChart_1 [class*='riser!s0!g4!mmarker!']"
        utillobj.synchronize_with_number_of_element(defcss, 1, 90, 1)
