...
class C2235628_TestClass(BaseTestCase):
    ...
    def test_C2235628(self):
        ...
        """
            ...
            Step 02:Launch MyReport (Report mode) using below API link
...
#         utillobj.invoke_webfocu('mrid', 'mrpass')
        utillobj.infoassist_api_edit(Restore_fex, 'Report', 'P292/S10032_infoassist_4', mrid='mrid', mrpass='mrpass')
        ...
        ia_resultarea_obj.verify_report_data_set("TableChart_1", 10, 2, Test_Case_ID+"_Ds01.xlsx","Step 03.03: Verify report preview data")
        """ 
        ...
        """
        utillobj.synchronize_with_number_of_element("#TableChart_1 div[class^='x']", 22, 30)
        ...
        time.sleep(5)
        parent_css="#TableChart_2 svg>g text[class='xaxisOrdinal-title']"
        resultobj.wait_for_property(parent_css, 1)
        
        """ 
            Step 19:Verify successful restore
        """
        resultobj.verify_xaxis_title("TableChart_2", 'CAR', "Step 19.01: Verify X-Axis Title")
        expected_yval_list=['0', '20K', '40K', '60K', '80K', '100K']
        expected_xval_list=['ALFA ROMEO', 'AUDI','BMW', 'DATSUN', 'JAGUAR', 'JENSEN', 'MASERATI', 'PEUGEOT', 'TOYOTA','TRIUMPH']
        resultobj.verify_riser_chart_XY_labels("TableChart_2", expected_xval_list, expected_yval_list, 'Step 19.02: X and Y axis labels',x_axis_label_length=1)
        resultobj.verify_number_of_riser('TableChart_2',1,10, 'Step 19.03: Verify Number chart segment')
        resultobj.verify_yaxis_title("TableChart_2", 'SALES', "Step 19.04: Verify X-Axis Title")
