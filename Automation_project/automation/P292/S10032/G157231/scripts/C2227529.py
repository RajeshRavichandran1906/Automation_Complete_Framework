...
#         ia_resultobj.create_report_data_set('TableChart_1 ', 18, 5, 'C2227529_Ds01.xlsx')
        ...
        """    10. Click "OK".    """
        elem="#Prompt_1 div[id*='BiResizeHandle']"
        utillobj.synchronize_with_number_of_element(elem, 8, 20)
        parent=driver.find_elements_by_css_selector("#Prompt_1 div[id*='BiResizeHandle']")
        utillobj.click_on_screen(parent[0], 'middle', x_offset=10)
        time.sleep(1)
        utillobj.click_on_screen(parent[0], 'middle', click_type=1, x_offset=10) 
        time.sleep(2)
...
#         time.sleep(5)
        ...
        """    16. Click > "OK".    """
        elem="#Prompt_2 div[id*='BiResizeHandle']"
        utillobj.synchronize_with_number_of_element(elem, 8, 20)
        parent=driver.find_elements_by_css_selector("#Prompt_2 div[id*='BiResizeHandle']")
        utillobj.click_on_screen(parent[0], 'middle', x_offset=10)
        time.sleep(1)
        utillobj.click_on_screen(parent[0], 'middle', click_type=1, x_offset=10) 
        time.sleep(2)
...
#         time.sleep(5)
        ...
        """    22. Click "OK"    """
        elem="#Prompt_3 div[id*='BiResizeHandle']"
        utillobj.synchronize_with_number_of_element(elem, 8, 20)
        parent=driver.find_elements_by_css_selector("#Prompt_3 div[id*='BiResizeHandle']")
        utillobj.click_on_screen(parent[0], 'middle', x_offset=10)
        time.sleep(1)
        utillobj.click_on_screen(parent[0], 'middle', click_type=1, x_offset=10) 
        time.sleep(2)
...
#         time.sleep(3)
        ...
        parent=driver.find_element_by_css_selector("#Prompt_1")
        utillobj.click_on_screen(parent, 'middle', click_type=0)
        elem="#Prompt_1 div[id*='BiResizeHandle']"
        utillobj.synchronize_with_number_of_element(elem, 8, 20)
        parent=driver.find_elements_by_css_selector("#Prompt_1 div[id*='BiResizeHandle']")
        utillobj.click_on_screen(parent[0], 'middle', x_offset=10)
...
#         time.sleep(3)
        ...
        utillobj.synchronize_with_number_of_element("#gridAvailableADP div[class$='content'] table tr>td:nth-child(1)", 4, 120)
        ...
        utillobj.click_on_screen(item_list[0], coordinate_type='middle', click_type=0)
        time.sleep(1)
        local_keyboard.press('ctrl')
        time.sleep(1)
        utillobj.click_on_screen(item_list[1], coordinate_type='middle', click_type=0)
        time.sleep(1)
