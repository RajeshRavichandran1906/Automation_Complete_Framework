...
class C2227532_TestClass(BaseTestCase):
    ...
    def test_C2227532(self):
        ...
        resultobj.wait_for_property("#iaCanvasCaptionLabel", 1, expire_time=15, string_value='Document')  
        ...
        page2_css="#iaPagesMenuBtn div[class='bi-button-label']"
        utillobj.synchronize_with_visble_text(page2_css, visble_element_text='Page2', expire_time=20)
        utillobj.verify_object_visible(page2_css, True, "Step 08a: Verify Page changed to 'Page 2'")
        ...
        """    9. Click "Chart" icon.    """
        ribbonobj.select_ribbon_item("Insert", "Chart")
        utillobj.synchronize_with_number_of_element('#TableChart_3', 1, 20)
        ...
        iaresult.select_or_verify_document_page_menu('Page 1', default_page_name='Page 2')
        time.sleep(4)
...
#         resultobj.verify_default_tooltip_values("MAINTABLE_wbody1", "riser!s0!g2!mbar!", expected_tooltip_list, "Step 15m: Verify bar value")
        ...
        page2_css = driver.find_element_by_css_selector("#IBILAYOUTDIV0TABS .arDashboardBarButton[id^='iLay']")
        ...
        utillobj.synchronize_with_number_of_element('#MAINTABLE_wbody2', 1, 10)
...
#         resultobj.verify_default_tooltip_values("MAINTABLE_wbody2", "riser!s0!g2!mbar!", expected_tooltip_list, "Step 17j: Verify bar value")
        ...
        resultobj.wait_for_property("#" + page1_chart_id + " text[class^='xaxis'][class$='title']", 1, expire_time=50, string_value='CAR')
