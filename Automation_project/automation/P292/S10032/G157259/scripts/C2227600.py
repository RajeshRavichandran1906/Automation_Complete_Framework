...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227600
TestCase Name = Run time 'Exclude from Chart'
'''
...
class C2227600_TestClass(BaseTestCase):

    def test_C2227600(self):
        ...
        """
        Step 06: Hover over "Stereo Systems" > Select "Exclude from Chart"
        """
        raiser="[id^='MAINTABLE_1'] [class*='riser!s0!g4!mbar']"
        elem1=(By.CSS_SELECTOR, raiser)
        resultobj._validate_page(elem1) 
        time.sleep(6)        
        resultobj.select_default_tooltip_menu('MAINTABLE_wbody1', "riser!s0!g4!mbar", "Exclude from Chart")
        time.sleep(5)
        ...
        expected_xval_list=['Accessories', 'Camcorder', 'Computers', 'Media Player', 'Televisions', 'Video Production']
        ...
        time.sleep(5)
        bar=['Product Category:Accessories', 'Cost of Goods:$89,753,898.00', 'Filter Chart', 'Exclude from Chart', 'Remove Filter', 'Drill down to Product Subcategory']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1", "riser!s0!g0!mbar", bar, "Step 07.d: Verify bar value")
        time.sleep(20)
        ele=driver.find_element_by_css_selector("div[id*='ibi$container$inner$HBOX_1']")
        utillobj.take_screenshot(ele,'C2227600_Actual_step07', image_type='actual',x=1, y=1, w=-1, h=-1)
