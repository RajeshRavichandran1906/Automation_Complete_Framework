...
class C2227606_TestClass(BaseTestCase):
    ...
    def test_C2227606(self):
        ...
        visual.create_lasso_using_action_chain("path[class*='riser!s5!g0!mwedge']", "path[class*='riser!s0!g1!mwedge']")
        ...
        if browser == 'Firefox':
            ...
            action = ActionChains(driver)
            action.move_to_element(move_riser).perform()
        visual.create_lasso_using_action_chain("path[class*='riser!s2!g0!mwedge']", "path[class*='riser!s1!g1!mwedge']")
        resultobj.select_or_verify_lasso_filter(select='Filter Chart')
