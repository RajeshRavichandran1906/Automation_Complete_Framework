...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227605
'''
import unittest
...
class C2227605_TestClass(BaseTestCase):
    def test_C2227605(self):
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227605'
        ...
        time.sleep(5)
        resultobj.select_or_verify_lasso_filter(verify=['9 points','Filter Chart','Exclude from Chart'],msg='Step 05: Expect to see the options')
        ...
        utillobj.take_screenshot(ele,'C2227605_Actual_step08', image_type='actual',x=1, y=1, w=-1, h=-1)
        ...
        utillobj.drag_drop_on_screen(sx_offset=sx,sy_offset=sy,tx_offset=tx,ty_offset=ty)
        time.sleep(5)
        resultobj.select_or_verify_lasso_filter(verify=['6 points','Filter Chart','Exclude from Chart'],msg='Step 10: Expect to see the options')
        resultobj.select_or_verify_lasso_filter(select='Filter Chart')
        ...
        utillobj.click_on_screen(parent_elem, 'bottom_left',javascript_marker_enable=True,mouse_duration=2.5)
        time.sleep(1)
        ...
        Step19: Click Save in the toolbar > Save as "C2227605" > Click Save
        """
        elem1=(By.CSS_SELECTOR, "#applicationButton img")
        resultobj._validate_page(elem1)
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227605.fex
        """
