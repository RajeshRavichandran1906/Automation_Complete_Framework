...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227604
'''
import unittest
...
class C2227604_TestClass(BaseTestCase):
    def test_C2227604(self):
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227604'
        ...
        time.sleep(5)
        resultobj.select_or_verify_lasso_filter(verify=['8 points','Filter Chart','Exclude from Chart'],msg='Step 05: Expect to see the options')
        ...
        utillobj.drag_drop_on_screen(sx_offset=sx,sy_offset=sy,tx_offset=tx,ty_offset=ty)
        time.sleep(5)
        resultobj.select_or_verify_lasso_filter(verify=['4 points','Filter Chart','Exclude from Chart'],msg='Step 10: Expect to see the options')
        resultobj.select_or_verify_lasso_filter(select='Filter Chart')
        ...
        Step17: Click Save in the toolbar > Save as "C2227604" > Click Save
        """
        elem1=(By.CSS_SELECTOR, "#applicationButton img")
        resultobj._validate_page(elem1)
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227604.fex
        """
