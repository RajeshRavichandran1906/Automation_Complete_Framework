...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227500
'''
import unittest, time
from common.lib.basetestcase import BaseTestCase
from common.pages import wf_administration_console,visualization_resultarea,wf_mainpage
from common.lib import utillity

class C2227500_TestClass(BaseTestCase):

    def test_C2227500(self):
        ...
        """
        item_checked=['Allow User Override','Excel 2000 Format','Excel 2000 Formula','Excel 2007 Format','Excel 2007 Formula','HTML Format','InfoMini Run Immediate','Other Chart Types','Pages on Demand','PDF Format','PowerPoint 2007 Format','Stack Measures']
