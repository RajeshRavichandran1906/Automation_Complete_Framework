...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227499
'''
...
class C2227499_TestClass(BaseTestCase):

    def test_C2227499(self):
        
        """   
                TESTCASE VARIABLES 
        """
        TestCase_ID = "C2227499"
        driver=self.driver
        ...
        utillobj.infoassist_api_login('Chart','ibisamp/CAR','P292/S10032_infoassist_4', 'mrid01', 'mrpass01')
        ...
        """
            Step 13:Click "Save" > save as "C2227499" > Click Save
        """
        ...
        """
        utillobj.infoassist_api_edit(TestCase_ID,'Chart','P292/S10032_infoassist_4',mrid='mrid01',mrpass='mrpass01')
        time.sleep(8)
