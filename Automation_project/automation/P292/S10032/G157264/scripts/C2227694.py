'''
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227694
'''
import unittest
import time
...
class C2227694_TestClass(BaseTestCase):
    def test_C2227694(self):
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227694'
        expected_field_value="WF_RETAIL_LITE.WF_RETAIL_SALES.REVENUE_US * - 1"
        ...
        """    20. Click "IA" > "Save" > Save As "C2227694".    """
        time.sleep(2)
        ...
        """    23. Reopen fex using IA API: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227694.fex&tool=idis   """
