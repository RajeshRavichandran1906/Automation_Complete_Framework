'''
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2250722
'''
import unittest
import time
...
class C2250722_TestClass(BaseTestCase):
    def test_C2250722(self):
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2250722'
        ...
        """    12. Click "Save" > save as "C2250722" > Click "Save"   """
        time.sleep(2)
        ...
        """    14. Reopen fex using IA API: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2250722.fex&tool=idis    """
        ...
        """    23. Reopen fex using IA API: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2250722.fex&tool=idis    """
        utillobj.infoassist_api_edit(Test_Case_ID,'idis','S10032_visual_3',mrid='mrid',mrpass='mrpass')
        time.sleep(20)
        elem1=(By.CSS_SELECTOR, "#applicationButton img")
        resultobj._validate_page(elem1)
