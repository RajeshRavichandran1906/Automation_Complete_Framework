...
class C2227723_TestClass(BaseTestCase):
    def test_C2227723(self):
        ...
        time.sleep(5)
        utillobj.synchronize_with_number_of_element("#MAINTABLE_wbody1 [class*='riser!s0!g2!mbar!']", 1 , 190)
        ...
        utillobj.synchronize_with_number_of_element("#TableChart_1 svg>g>text.title", 1, 190)
        ...
        utillobj.synchronize_with_number_of_element("#MAINTABLE_wbody1 .legend text" ,2, 190)
