...
class C2227716_TestClass(BaseTestCase):
    ...
    def test_C2227716(self):
        ...
        Step07: Drag "Gross Profit" to "Measure" under "Revenue"
        """
        time.sleep(5)
        metaobj.drag_drop_data_tree_items_to_query_tree("Product,Category", 1, 'Rows', 0)
        time.sleep(4)
        metaobj.datatree_field_click("Revenue", 2, 1)
        time.sleep(4)
        metaobj.drag_drop_data_tree_items_to_query_tree("Gross Profit", 1, 'Revenue', 0)
        time.sleep(4)
        ...
        """
        Step09: Click "IA" > "Save" > "C2227716" > "Save"
        """        
        ...
        """
        Step11: Log on to WF: http://machine:port/ibi_apps/
        Step12: Highlight "C2227716" > Right mouse click > Verify Edit options
        ...
        """
        Step15: Logout:http://machine:port/alias/service/wf_security_logout.jsp
        """
        time.sleep(2)
