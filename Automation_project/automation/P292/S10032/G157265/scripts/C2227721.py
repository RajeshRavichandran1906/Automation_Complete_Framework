...
class C2227721_TestClass(BaseTestCase):
    ...
    def test_C2227721(self):
        ...
        """
        Step 01: Restore C2227721_base.fex using IA API:(edit the domain, port and alias of the URL - do not use the URL as is):
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227721_base.fex
        """
        utillobj.infoassist_api_edit('C2227721_base','idis','S10032_visual_3',mrid='mrid',mrpass='mrpass')
        ...
        prompt_css = "#ar_Prompt_1 tbody tbody tr"
        visual_obj.wait_for_number_of_element(prompt_css,3,120)
        ...
        utillobj.verify_chart_color("MAINTABLE_wbody1", "riser!s0!g0!mbar!r0!c0", "bar_blue1", "Step01.c: Verify first bar color")
        time.sleep(5)
        ...
        utillobj.verify_chart_color("TableChart_2", "riser!s0!g0!mbar", "bar_blue1", "Step07.c: Verify first bar color")
        time.sleep(5)
        ...
        time.sleep(4)
        parent_css="#TableChart_3 path[class^='riser!s1!g0!mwedge!']"
        resultobj.wait_for_property(parent_css, 1) 
...
#         utillobj.infoassist_api_edit(Test_Case_ID,'idis','S10032_visual_3',mrid='mrid',mrpass='mrpass')
        ...
        utillobj.verify_chart_color("TableChart_3", "riser!s0!g0!mwedge", "bar_blue1", "Step13.d(i) Verify first bar color")
        ...
        utillobj.verify_chart_color("MAINTABLE_wbody3", "riser!s0!g0!mwedge", "bar_blue1", "Step16.d(i) Verify first bar color")
        ...
        utillobj.verify_chart_color("MAINTABLE_wbody2", "riser!s0!g0!mbar", "bar_blue1", "Step16.c: Verify first bar color")
        time.sleep(5)
        ...
        utillobj.verify_chart_color("MAINTABLE_wbody1", "riser!s0!g0!mbar!r0!c0", "bar_blue1", "Step16.c: Verify first bar color")
        time.sleep(5)
        expected=['Store Front','Web']
        ...
        elem=self.driver.find_element_by_css_selector("#TableChart_3 text[class^='pieLabel!g0!mpieLabel!']")
        d=utillobj.get_attribute_value(elem,'dom_visible_text')
        utillobj.asequal(d['dom_visible_text'],'Gross Profit',"Step21.1.a: Verify X-axis label")
           
        time.sleep(5)
        metaobj.verify_filter_pane_field('Product,Category',2,"Step21.1.b: Verify filter pane")
        resultobj.verify_number_of_pie_segments("TableChart_3", 1, 3, 'Step21.1.c(i): Verify the total number of pie segments displayed on pie Chart')
        utillobj.verify_chart_color("TableChart_3", "riser!s0!g0!mwedge", "bar_blue1", "Step21.1.d(i) Verify first bar color")
        legend=['Product Ca', 'Camcorder', 'Computers', 'Video Production']
        resultobj.verify_riser_legends("TableChart_3", legend, "Step21.1.e: Verify Legends Title")
        time.sleep(2)
        expected_tooltip=['Product Category:Camcorder', 'Gross Profit:$49,598,845.24  (49.08%)', 'Filter Chart', 'Exclude from Chart', 'Drill down to Product Subcategory']
        resultobj.verify_default_tooltip_values("TableChart_3","riser!s0!g0!mwedge",expected_tooltip, "Step21.1.f:: verify the default tooltip values")       
        
        parent_css="#TableChart_2 svg g text[class*='mgroupLabel']"
        resultobj.wait_for_property(parent_css, 3)
                   
        xaxis_value="Product Category"
        resultobj.verify_xaxis_title("TableChart_2", xaxis_value, "Step21.2.a: Verify X-Axis Title")
        resultobj.verify_yaxis_title("TableChart_2", "Gross Profit", "Step21.2.b: Verify Y-Axis Title")
        expected_xval_list=['Camcorder', 'Computers','Video Production']
        expected_yval_list=['0','10M','20M','30M','40M','50M','60M']
        resultobj.verify_riser_chart_XY_labels("TableChart_2", expected_xval_list, expected_yval_list, "Step21.2.c:Verify XY labels")
        resultobj.verify_number_of_riser("TableChart_2", 1, 3, 'Step21.2.d: Verify the total number of risers displayed on preview')
        utillobj.verify_chart_color("TableChart_2", "riser!s0!g0!mbar", "bar_blue1", "Step21.2.e: Verify first bar color")
        time.sleep(5)
              
        bar=['Product Category:Camcorder', 'Gross Profit:$49,598,845.24', 'Filter Chart', 'Exclude from Chart', 'Drill down to Product Subcategory']
        resultobj.verify_default_tooltip_values("TableChart_2", "riser!s0!g0!mbar", bar, "Step21.2.f: Verify bar value")
        
        time.sleep(3)
        expected_xval_list=['Camcorder','Computers','Video Production']
        expected_yval_list=['0','5M','10M','15M','20M','25M','30M','35M','40M']
        resultobj.verify_riser_chart_XY_labels("TableChart_1", expected_xval_list, expected_yval_list, "Step21.3.a:Verify XY labels")
        resultobj.verify_number_of_riser("TableChart_1", 1,6, 'Step21.3.b: Verify the total number of risers displayed on preview')
        utillobj.verify_chart_color("TableChart_1", "riser!s0!g0!mbar!r0!c0", "bar_blue1", "Step21.3.c: Verify first bar color")
        time.sleep(5)
        expected=['Store Front','Web']
        resultobj.verify_visualization_row_column_header_labels("TableChart_1", 'Columns','Store Type', expected,"Step21.3.d Verify Column header")
             
        bar=['Store Type:Store Front', 'Product Category:Camcorder', 'Gross Profit:$34,471,375.27', 'Filter Chart', 'Exclude from Chart', 'Drill down to Product Subcategory']
        resultobj.verify_default_tooltip_values("TableChart_1", "riser!s0!g0!mbar!r0!c0", bar, "Step21.3.e Verify bar value")
        time.sleep(5)
