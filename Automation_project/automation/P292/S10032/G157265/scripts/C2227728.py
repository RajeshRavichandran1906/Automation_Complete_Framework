...
class C2227728_TestClass(BaseTestCase):
    def test_C2227728(self):
        ...
        metaobj.drag_drop_data_tree_items_to_query_tree("Discount", 1, 'Vertical Axis', 0)
        time.sleep(8)
        ...
        metaobj.drag_drop_data_tree_items_to_query_tree("Gross Profit", 1, 'Horizontal Axis', 0)
        time.sleep(8)
        ...
        utillobj.synchronize_with_number_of_element("#MAINTABLE_wbody1 svg>g path[class^='series']", 7, 190)
