...
class C2228159_TestClass(BaseTestCase):
    ...
    def test_C2228159(self):
        ...
        utillobj.synchronize_with_number_of_element(parent_css, 20, 35)
        ...
        self.driver.close()
        """  
            Step 11:Click Save in the toolbar > Save as "C2228159" > Click Save
        """
        ...
        """  
            ...
            http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2228159.fex
        """
        utillobj.infoassist_api_edit(Test_Case_ID, 'chart', 'P292/S10032_chart_1', mrid='mrid', mrpass='mrpass')
        parent_css="#TableChart_1 svg > g.chartPanel text[class*='mdataLabels']"
        utillobj.synchronize_with_number_of_element(parent_css, 20, 65)
