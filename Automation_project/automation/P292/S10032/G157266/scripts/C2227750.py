...
class C2227750_TestClass(BaseTestCase):

    def test_C2227750(self):
...
#         utillobj.create_data_set('ITableData0','I0r','C2227750_Ds01.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227750_Ds01.xlsx', 'Step 03.2: Verify that report returns 29 of 107 records')
...
#         utillobj.create_data_set('ITableData0','I0r','C2227750_Ds02.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227750_Ds02.xlsx', 'Step 04.2: Verify Sales column is not visible. ')
...
#         utillobj.create_data_set('ITableData0','I0r','C2227750_Ds03.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227750_Ds03.xlsx', 'Step 05.2: Verify Dealer_Cost column is not visible')
...
#         utillobj.create_data_set('ITableData0','I0r','C2227750_Ds04.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227750_Ds04.xlsx', 'Step 06.2: Verify Sales column is visible.')
...
#         utillobj.create_data_set('ITableData0','I0r','C2227750_Ds05.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227750_Ds05.xlsx', 'Step 07.2: Verify Sales column is visible.')
