...
class C2227781_TestClass(BaseTestCase):

    def test_C2227781(self):
        ...
        utillobj.capture_screenshot('04.01', step4_1, expected_image_verify=True)
...
#         expected_tooltip_list=['Unit Sales:630K', 'X:Croissant']
#         resultobj.verify_default_tooltip_values("wall1", "riser!s0!g4!mbar!", expected_tooltip_list, "Step 05.8: Verify bar value")
        utillobj.capture_screenshot('05.01', step5_1, expected_image_verify=True)
...
#         expected_tooltip_list=['Biscotti', 'Unit Sales:421K', '11.4% of 3.7M']
#         resultobj.verify_default_tooltip_values('wall1', 'riser!s0!g0!mwedge!', expected_tooltip_list, 'Step 06.9: verify the default tooltip values')
        time.sleep(2)
        utillobj.capture_screenshot('06.01', step6_1, expected_image_verify=True)
...
#         expected_tooltip_list=['Unit Sales', 'X:Coffee Pot', 'Y:191K']
#         resultobj.verify_default_tooltip_values('wall1', 'riser!s0!g3!mmarker!', expected_tooltip_list, 'Step 07.2: verify the default tooltip values',attribute_type='stroke')
        ...
        utillobj.capture_screenshot('07.01', step7_1, expected_image_verify=True)
...
#         iarun.create_table_data_set('#ITableData1','C2227781_001.xlsx')
        iarun.verify_table_data_set('#ITableData1','C2227781_001.xlsx','Step 08.1: Verify C2227778_001.xlsx output')
        ...
        utillobj.capture_screenshot('08.01', step8_1, expected_image_verify=True)
        ...
        utillobj.capture_screenshot('09.01', step9_1, expected_image_verify=True)
