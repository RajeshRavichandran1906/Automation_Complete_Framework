...
TestCase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2227747
...
class C2227747_TestClass(BaseTestCase):

    def test_C2227747(self):
        """
        TESTCASE VARIABLES
        """
        ...
        """
            ...
            http://machine:port/{alias}/run.bip?BIP_REQUEST_TYPE=BIP_RUN&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FP292_S10032_G157266%252FAHTMLOFF&BIP_item=AHTML_JSCHART.fex
        """
        ...
        result_obj.verify_number_of_risers("#MAINTABLE_wbody0_f path", 1, 5, "Step 05:01: Verify number of risers")
