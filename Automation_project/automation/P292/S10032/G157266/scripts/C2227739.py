...
class C2227739_TestClass(BaseTestCase):
    ...
    def test_C2227739(self):
        ...
        utillobj.verify_chart_color("MAINTABLE_wbody1", "riser!s0!g4!mbar!r0!c1!", "bar_blue", "Step 05.08: Verify  riser color")
        resobj.verify_yaxis_title("MAINTABLE_wbody1", "Sequence#", "Step 05.09: Verify yaxis title")
        
        miscelaneous_obj.verify_arChartToolbar('MAINTABLE_wmenu1', ['More Options','Advanced Chart','Original Chart'],"Step 05.10: Verify Chart toolbar")
        miscelaneous_obj.verify_arChartToolbar('MAINTABLE_wmenu1', ['Aggregation'],"Step 05.11: Verify Chart toolbar", custom_css='.arChartMenuBarContainer .tabPagingText1 td[title]')
        miscelaneous_obj.verify_arChartToolbar('MAINTABLE_wmenu1', ['Sum'],"Step 05.12: Verify Chart toolbar", custom_css=".arChartMenuBarContainer [id*='SUM']", text=True)
        expected_label_list=['Category : Product','Coffee','Food','Gifts']
        visual.verify_column_label(expected_label_list, msg="Step 05.13:")
