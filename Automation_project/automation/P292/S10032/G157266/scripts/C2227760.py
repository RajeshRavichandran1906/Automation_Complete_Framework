...
@author: BM13368
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/2227760&group_by=cases:section_id&group_id=157266&group_order=asc
...
class C2227760_TestClass(BaseTestCase):

    def test_C2227760(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227760'
...
#         iarun_obj.create_table_data_set(table_css, Test_Case_ID+"_Ds01.xlsx")
        iarun_obj.verify_table_data_set(table_css, Test_Case_ID+"_Ds01.xlsx", "Step 03:01::Verify first report data")
        table_css="#ITableData1"
#         iarun_obj.create_table_data_set(table_css, Test_Case_ID+"_Ds02.xlsx")
        iarun_obj.verify_table_data_set(table_css, Test_Case_ID+"_Ds02.xlsx", "Step 03:02::Verify second report data")

        table_css="#ITableData2"
#         iarun_obj.create_table_data_set(table_css, Test_Case_ID+"_Ds03.xlsx")
        iarun_obj.verify_table_data_set(table_css, Test_Case_ID+"_Ds03.xlsx", "Step 03:03::Verify thrid report data")
        table_css="#ITableData3"
#         iarun_obj.create_table_data_set(table_css, Test_Case_ID+"_Ds04.xlsx")
        iarun_obj.verify_table_data_set(table_css, Test_Case_ID+"_Ds04.xlsx", "Step 03:04::Verify fourth report data")
