...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227737
...
class C2227737_TestClass(BaseTestCase):

    def test_C2227737(self):
        ...
        """    2. Expand folder P292_S10032_G157266, Execute the following URL: http://machine:port/{alias}/run.bip?BIP_REQUEST_TYPE=BIP_RUN&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FP292_S10032_G157266%252FAHTML_OFF&BIP_item=AHTML_OFF_001a.fex    """
