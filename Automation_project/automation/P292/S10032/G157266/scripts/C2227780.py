...
#         resultobj.verify_number_of_pie_segments('wbody2_f', 1, 3, 'Step 09.4 : Verify number of pie chart segments')
        risers = self.driver.find_elements_by_css_selector('#wbody2_f [class*="riser!"]')
        utillobj.asequal(3, len(risers), 'Step 09.04 : Verify number of pie segments displayed')
...
#         resultobj.verify_number_of_pie_segments('wbody2_f', 1, 10, 'Step 10.4 : Verify number of pie chart segments')
        risers = self.driver.find_elements_by_css_selector('#wbody2_f [class*="riser!"]')
        utillobj.asequal(10, len(risers), 'Step 10.04 : Verify number of pie segments displayed')
...
#         resultobj.verify_number_of_pie_segments('wbody2_f', 2, 10, 'Step 11.4 : Verify number of pie chart segments')
        risers = self.driver.find_elements_by_css_selector('#wbody2_f [class*="riser!"]')
        utillobj.asequal(10, len(risers), 'Step 11.04 : Verify number of pie segments displayed')
