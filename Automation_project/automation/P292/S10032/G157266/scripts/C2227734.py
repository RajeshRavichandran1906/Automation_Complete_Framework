...
class C2227734_TestClass(BaseTestCase):

    def test_C2227734(self):
...
#         utillobj.create_pivot_data_set('piv1', 'C2227734_Ds01.xlsx')
        utillobj.verify_pivot_data_set('piv1', 'C2227734_Ds01.xlsx','Step 04.2: Verify pivot data')
...
#         utillobj.create_pivot_data_set('piv1', 'C2227734_Ds02.xlsx')
        utillobj.verify_pivot_data_set('piv1', 'C2227734_Ds02.xlsx','Step 05.2: Verify pivot data')
...
#         utillobj.create_pivot_data_set('piv1', 'C2227734_Ds03.xlsx')
        utillobj.verify_pivot_data_set('piv1', 'C2227734_Ds03.xlsx','Step 06.2: Verify pivot data')
...
#         utillobj.create_pivot_data_set('piv1', 'C2227734_Ds04.xlsx')
        utillobj.verify_pivot_data_set('piv1', 'C2227734_Ds04.xlsx','Step 07.2: Verify pivot data')
...
#         utillobj.create_pivot_data_set('piv1', 'C2227734_Ds05.xlsx')
        utillobj.verify_pivot_data_set('piv1', 'C2227734_Ds05.xlsx','Step 08.2: Verify pivot data')
