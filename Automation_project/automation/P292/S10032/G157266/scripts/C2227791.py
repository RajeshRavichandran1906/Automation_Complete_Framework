...
class C2227791_TestClass(BaseTestCase):

    def test_C2227791(self):
        ...
        utillobj.verify_data_set('ITableData0','I0r','C2227791_Ds02.xlsx', 'Step 04.4: Verify that report containing 10 rows of State MA.')
#         utillobj.create_data_set('ITableData0','I0r','C2227791_Ds02.xlsx')
        ...
        utillobj.verify_data_set('ITableData0','I0r','C2227791_Ds03.xlsx', 'Step 05.4: Verify that report now with 8 records, eliminating Coffee Grinder and Coffee Pot from the first Filter.')
#         utillobj.create_data_set('ITableData0','I0r','C2227791_Ds03.xlsx')
        ...
        utillobj.verify_data_set('ITableData0','I0r','C2227791_Ds04.xlsx', 'Step 06.4: Verify that report now with 5 rows, eliminating Unit Sales of 19698 and above form the first two Filters.')
#         utillobj.create_data_set('ITableData0','I0r','C2227791_Ds04.xlsx')
        ...
        utillobj.verify_data_set('ITableData0','I0r','C2227791_Ds05.xlsx', 'Step 07.2: Expect to see 71 rows. Scroll to the last page of the report to verify that Coffee Grinder and Coffee Pot are still not shown for Category Gifts')
#         utillobj.create_data_set('ITableData0','I0r','C2227791_Ds05.xlsx')
        ...
        utillobj.verify_data_set('ITableData0','I0r','C2227791_Ds06.xlsx', 'Step 07.2: Expect to see 73 rows, with Coffee Grinder and Coffee Pot added. Scroll to the last page of the report to verify that Coffee Grinder and Coffee Pot are now shown shown for Category Gifts')
