...
class C2227742_TestClass(BaseTestCase):

    def test_C2227742(self):
        
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID='C2227742'
        ...
        """
        if obrowser == "IE":
            expected_menu_list=['Sort Ascending', 'Sort Descending', 'Filter', 'Calculate', 'Chart', 'Rollup', 'Pivot (Cross Tab)', 'Visualize','Hide Column', 'Grid Tool', 'Chart/Rollup Tool', 'Pivot Tool', 'Show Records', 'Comments', 'Send as E-mail', 'Save Changes', 'Export', 'Print', 'Window', 'Restore Original']
        else :    
            expected_menu_list=['Sort Ascending', 'Sort Descending', 'Filter', 'Calculate', 'Chart', 'Rollup', 'Pivot (Cross Tab)', 'Visualize', 'Hide Column', 'Grid Tool', 'Chart/Rollup Tool', 'Pivot Tool', 'Show Records', 'Comments', 'Save Changes','Export', 'Print', 'Window', 'Restore Original']
            
        miscelanousobj.verify_menu_items('ITableData0',5,None,expected_menu_list,'Step 04.1 : Verify option available for Dollar Sales.')
