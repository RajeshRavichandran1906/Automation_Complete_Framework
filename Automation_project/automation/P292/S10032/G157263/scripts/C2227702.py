...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227702
'''
...
class C2227702_TestClass(BaseTestCase):

    def test_C2227702(self):
        """
        TESTCASE VARIABLES
        """
        ...
        utillobj.take_screenshot(ele,'C2227702_Actual_step06', image_type='actual',x=1, y=1, w=-1, h=-1)
