...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227707
...
class C2227707_TestClass(BaseTestCase):

    def test_C2227707(self):
        ...
        time.sleep(4)
        utillobj.select_or_verify_bipop_menu('Add To Query', verify='true', expected_popup_list=['Sum', 'Add To Query', 'Filter'], msg='Step 02:')
        ...
        Step 10: Save as "C2164825" > Click Save
        """
        time.sleep(2)
        ...
        utillobj.take_screenshot(ele,'C2227707_Actual_step13', image_type='actual',x=1, y=1, w=-1, h=-1)       
        time.sleep(5)
