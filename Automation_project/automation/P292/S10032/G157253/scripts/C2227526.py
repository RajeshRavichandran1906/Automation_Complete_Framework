...
class C2227526_TestClass(BaseTestCase):
    ...
    def test_C2227526(self):
        ...
        ia_ribbobj.select_or_verify_output_type(launch_point='bottom_tool_bar', expected_output_list=list1, msg="Step 05:01: Verify output formats.", item_select_path='Active Report')
        time.sleep(1)
