...
class C2227632_TestClass(BaseTestCase):
    ...
    def test_C2227632(self):
        ...
        parent_css= "#MAINTABLE_wbody1 svg g text[class*='yaxis-labels']"
        resultobj.wait_for_property(parent_css, 7)
        #metaobj.select_data_field("Filters and Variables")
        metadataobj.collapse_data_field_section("Product,Category->Product")
        
        time.sleep(4)
        metaobj.drag_drop_data_tree_items_to_filter("Filters and Variables->Accessories", 1)
