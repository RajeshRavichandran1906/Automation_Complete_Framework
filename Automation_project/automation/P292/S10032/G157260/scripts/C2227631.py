...
class C2227631_TestClass(BaseTestCase):
    ...
    def test_C2227631(self):
        ...
        """
        time.sleep(5)
        metaobj.drag_drop_data_tree_items_to_filter("Filters and Variables->Product Filter", 1)
        time.sleep(2)
        ...
        """ 
        metaobj.datatree_field_click("Filters and Variables->Product Filter", 2, 1)
        time.sleep(2)
