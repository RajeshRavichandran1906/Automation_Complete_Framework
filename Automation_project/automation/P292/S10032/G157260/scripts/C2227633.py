...
#         utillobj.default_left_click(object_locator=obj_cell_css)
        ...
        resultobj.wait_for_property(parent_css, 7)
        time.sleep(6)
#         metaobj.drag_drop_data_tree_items_to_filter("Sales_Related->Transaction Date, Components->Values->2014->2014 Q2", 1) can't use, because image icon is referring child field
