...
class C2511622_TestClass(BaseTestCase):

    def test_C2511622(self):
...
#         iarun.create_table_data_set('#ITableData0', 'AHTML_001.xlsx')
        iarun.verify_table_data_set('#ITableData0', 'AHTML_001.xlsx', 'Step 03.2 : Verify the report is generated')
