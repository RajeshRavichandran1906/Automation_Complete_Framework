...
TestCase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2511625
'''
...
class C2511625_TestClass(BaseTestCase):

    def test_C2511625(self):
        
        """
        Test case variable
        """
        Test_Case_ID = "C2511625"
        ...
        """
            ...
            Step 02:Navigate to folder: P292_S10032_G19334
        ...
        """
        utillobj.infoassist_api_login_('report', 'baseapp/wf_retail_lite', 'mrid01', 'mrpass01')
        utillobj.synchronize_with_number_of_element("#singleReportCaptionLabel img[src*='preview']", 1, 85)
...
#         ia_resultobj.create_across_report_data_set("TableChart_1", 2, 2, 7, 2, Test_Case_ID+"_Ds01.xlsx")
        ...
        utillobj.verify_checked_class_property(web_element, "Step 04.01: TOC is selected")
