...
from common.pages import visualization_resultarea, active_miscelaneous, active_tools
from common.lib import utillity
from common.wftools import active_report

class C2511589_TestClass(BaseTestCase):

    def test_C2511589(self):
        
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2511589'
...
#         utillobj.create_data_set('ITableData0','I0r',Test_Case_ID+'_Ds01.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds01.xlsx', 'Step 05.1 : Verify Product column is no longer displayed on the report.')
...
#         utillobj.create_data_set('ITableData0','I0r',Test_Case_ID+'_Ds02.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds02.xlsx', "Step 08.1: Verify expect to see the report, with new column order of Product ID, Product, then Category, State, Unit Sales & Dollar Sales")
...
#         utillobj.create_data_set('ITableData0','I0r',Test_Case_ID+'_Ds03.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds03.xlsx', "Step 09.1: Verify expect to see the report now in State order, even though the columns are Product ID, Product, State..")
...
#         utillobj.create_data_set('ITableData0','I0r',Test_Case_ID+'_Ds04.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', Test_Case_ID+'_Ds04.xlsx', "Step 09.1: 'Step 10.1 : Verify expect to see the report now with State displayed first, as a true sort column, with duplicate values suppressed.")
