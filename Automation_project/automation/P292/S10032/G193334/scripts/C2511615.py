...
class C2511615_TestClass(BaseTestCase):

    def test_C2511615(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2511615'
        ...
        http://machine:port/{alias}/run.bip?BIP_REQUEST_TYPE=BIP_RUN&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FP292_S10032_G193334%252FAHTMLON&BIP_item=AHTMLTAB_2.fex
        """
...
#         ia_runobj.create_table_data_set(table_css, Test_Case_ID+"_Ds01.xlsx")
        utillobj.verify_table_data(table_css, Test_Case_ID+"_Ds01.xlsx")
        
#         ia_runobj.verify_table_data_set(table_css, Test_Case_ID+"_Ds01.xlsx", msg='Step 3.5 : Verify the table 1')
        table_css="#ITableData1"
#         ia_runobj.create_table_data_set(table_css, Test_Case_ID+"_Ds02.xlsx")
        ia_runobj.verify_table_data_set(table_css, Test_Case_ID+"_Ds02.xlsx", msg='Step 3.6 : Verify the table 2')
        table_css="#ITableData2"
#         ia_runobj.create_table_data_set(table_css, Test_Case_ID+"_Ds03.xlsx")
        ia_runobj.verify_table_data_set(table_css, Test_Case_ID+"_Ds03.xlsx", msg='Step 3.7 : Verify the table 3')
        table_css="#ITableData3"
#         ia_runobj.create_table_data_set(table_css, Test_Case_ID+"_Ds04.xlsx")
...
#         utillobj.create_pivot_data_set('piv2', Test_Case_ID+"_Ds00.xlsx")
        ...
        miscelanousobj.move_active_popup("2", "580", "470")
        ...
        Click OK button
        """
        act_toolobj.chart_rollup_tool_drag_drop_items('charttool1', 'Columns', 'CAR', 1, 'Group By', 0)
        act_toolobj.chart_rollup_tool_drag_drop_items('charttool1', 'Columns', 'RETAIL_COST', 1, 'Measure', 0)
        act_toolobj.chart_rollup_tool_drag_drop_items('charttool1', 'Columns', 'DEALER_COST', 1, 'Measure', 1)
        time.sleep(2)
...
#         act_toolobj.chart_rollup_tool_close('charttoolt1', 'Ok')
        time.sleep(7)
        ...
        """ 
#         rollupobj.create_new_item(0, 'Stacked', popup_id='wall2')
        click_item=self.driver.find_element_by_css_selector("#wmenu2 #cpop2")
        core_utillobj.left_click(click_item)
        select_stacked_item=self.driver.find_element_by_css_selector("#t1_cpop2_0_3.arMenu")
        ...
        elem = self.driver.find_element_by_css_selector("#dt1_0_0[style*='block'] table tr#t1_0_0_20")
        core_utillobj.left_click(elem)
        time.sleep(10)
        ...
        table_css="#ITableData0"
        utillobj.verify_table_data(table_css, Test_Case_ID+"_Ds01.xlsx")
#         ia_runobj.verify_table_data_set(table_css, Test_Case_ID+"_Ds01.xlsx", msg='Step 10.1 : Verify the table 1')
        table_css="#ITableData1"
        ...
        chart_title=self.driver.find_element_by_css_selector("#wall2").is_displayed()
        utillobj.asequal(False, chart_title, "Step 10.5:Verify Bar chart removed")
