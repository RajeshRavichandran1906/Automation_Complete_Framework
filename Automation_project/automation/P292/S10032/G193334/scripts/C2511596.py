...
class C2511596_TestClass(BaseTestCase):

    def test_C2511596(self):
        ...
        """
            Verify 'Unit Sales BY Product, State' appears as the report heading.
            Also verify that Unit Sales are summed, the Aggregation icon displays the Sum value.
        """
...
#         miscelanousobj.verify_popup_appears('wall1', 'Unit Sales by Product, State', 'Step 04.1:Verify Unit Sales By Category, Product appears as the Report Heading.')
#         utillobj.create_pivot_data_set('piv1', 'C2511596_Ds01.xlsx')
#         utillobj.verify_pivot_data_set('piv1', Test_Case_ID+'_Ds01.xlsx','Step 04.2: Verify pivot data')
#         pivobj.verify_pivot_menu('wall1', 'Step 04.3: Verify pivot toolbar menus')
...
#         utillobj.create_pivot_data_set('piv1', 'C2227735_Ds02.xlsx')
        utillobj.verify_pivot_data_set('piv1', Test_Case_ID+'_Ds02.xlsx','Step 05.1: Verify pivot data')
...
#         utillobj.create_pivot_data_set('piv1', 'C2227735_Ds03.xlsx')
        utillobj.verify_pivot_data_set('piv1', Test_Case_ID+'_Ds03.xlsx','Step 06.1: Verify pivot data')
