...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2511608
TestCase Name = Report-Chart: Verify that user can add column on X-Axis(82xx)
'''
...
class C2511608_TestClass(BaseTestCase):

    def test_C2511608(self):
        
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID='C2511608'
        ...
        if obrowser == "IE":
            Expected_main_menu_list=['New', 'Group By (X)', 'Add (Y)', 'Export to', 'Top', 'Chart/Rollup Tool', 'Restore Original']
        else :    
        ...
        """    2. Expand folder P292_S10032_G193334
        ...
        rollobj.create_new_item(0, 'Group By (X)->Product ID', verify_main_menu_list=Expected_main_menu_list, msg="Step 05a: ")
