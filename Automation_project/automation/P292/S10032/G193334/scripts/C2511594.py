...
class C2511594_TestClass(BaseTestCase):

    def test_C2511594(self):
...
#         utillobj.create_pivot_data_set('piv1', 'C2227733_Ds01.xlsx')
        utillobj.verify_pivot_data_set('piv1', Test_Case_ID+'_Ds01.xlsx','Step 04.1: Verify pivot data')
        ...
        utillobj.synchronize_with_number_of_element("#piv1 > tbody > tr:nth-child(1) > td > table > tbody", 1, miscelanousobj.chart_medium_timesleep)
...
#         utillobj.create_pivot_data_set('piv1', 'C2227733_Ds04.xlsx')
        utillobj.verify_pivot_data_set('piv1', Test_Case_ID+'_Ds04.xlsx','Step 07.1: Verify pivot data')
...
#         utillobj.create_pivot_data_set('piv1', 'C2227733_Ds05.xlsx')
        utillobj.verify_pivot_data_set('piv1', Test_Case_ID+'_Ds05.xlsx','Step 08.1: Verify pivot data')
