...
class C2511584_TestClass(BaseTestCase):

    def test_C2511584(self):
...
#         iarun.create_table_data_set('#ITableData1','C2227778_001.xlsx')
        iarun.verify_table_data_set('#ITableData1',Test_Case_ID+'_001.xlsx','Step 05.1: Verify C2227778_001.xlsx output')
...
#         iarun.create_table_data_set('#ITableData1','C2227778_002.xlsx')
        iarun.verify_table_data_set('#ITableData1',Test_Case_ID+'_002.xlsx','Step 06.1: Verify C2227778_002.xlsx output')
