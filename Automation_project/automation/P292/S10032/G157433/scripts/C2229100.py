...
#         time.sleep(5)
        ...
        utillobj.synchronize_with_number_of_element(parent_css2, 33, 120) 
        time.sleep(2)
...
#         time.sleep(5)
        ...
        """
        parent_css2="#MAINTABLE_wbody1 path[class^='riser']"
        utillobj.synchronize_with_number_of_element(parent_css2, 32, 120) 
        time.sleep(2)
...
#         time.sleep(5)
        ...
        """
        parent_css2="#MAINTABLE_wbody1 path[class^='riser']"
        utillobj.synchronize_with_number_of_element(parent_css2, 31, 120)
        time.sleep(2)
