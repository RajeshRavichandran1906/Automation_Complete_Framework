...
class C2229094_TestClass(BaseTestCase):
    ...
    def test_C2229094(self):
        ...
        utillobj.synchronize_with_number_of_element('#fldCreatorCancelBtn', 1, 120)
        ...
        """
        time.sleep(5)
        metaobj.datatree_field_click('Dimensions->Countries', 2, 1)
        ...
        """
        time.sleep(3)
        utillobj.synchronize_with_number_of_element('#geoRoleCancelBtn', 1, 120)
        ...
        iaresultobj.verify_number_of_chart_segment("MAINTABLE_wbody1", 34, 'Step 11.b: Verify number of bubble displayed', custom_css="svg g>circle[class^='riser!s']")
        time.sleep(2)
...
#         time.sleep(5)
        ...
        '''Updating the no of risers to 34 as per Mathiyarasi's email on 24-Apr-2018. 
        She says "The mentioned below difference is expected for Unified ON settings. If we try the same using Unified =Off,  it will display 1 known value."
        '''
        iaresultobj.verify_number_of_chart_segment("MAINTABLE_wbody1", 34, 'Step 13.b: Verify number of bubble displayed', custom_css="svg g>circle[class^='riser!s']")
        ...
        print ('**** Tooltip Verification point fails with decimal value: QA-2238 ****')
        ...
        iaresultobj.verify_number_of_chart_segment("MAINTABLE_wbody1", 34, 'Step 21.b: Verify number of bubble displayed', custom_css="svg g>circle[class^='riser!s']")
        time.sleep(2)
