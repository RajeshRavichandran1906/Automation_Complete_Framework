...
#         resultobj.wait_for_property(parent_css2, 33) 
        ...
        time.sleep(20)
        utillobj.save_file_from_browser('C2229099_actual_'+browser)        
        time.sleep(10)  
        utillobj.verify_excel_sheet_dynamic_values('C2229099_base_'+browser+'.xlsx', 'C2229099_actual_'+browser+'.xlsx', 'Sheet1', 'Step 07: Verify the excel spreadsheet contains the data from the fields', starting_row=0, no_of_rows=10)
        time.sleep(2)
        if browser != 'IE':
