...
#             x = 106
        ...
        utillobj.synchronize_with_number_of_element(parent_css, 2, 120)
        ...
        utillobj.synchronize_with_number_of_element(parent_css, 922, 120)
        ...
        time.sleep(2)
        iaresultobj.verify_number_of_chart_segment("MAINTABLE_wbody1", 53, 'Step03.a: Verify number of risers displayed', custom_css="path[class^='riser']")
...
#         time.sleep(5)
        ...
        try:
            ...
            utillobj.synchronize_with_number_of_element(css, 1, 120)
        ...
        utillobj.synchronize_with_number_of_element(parent_css2, x, 120)
        layer1="div[class^='TableOfContentsButton UIButton']"
        layerbutton=driver.find_element_by_css_selector(layer1)
        utillobj.click_on_screen(layerbutton, coordinate_type='middle')
        try:
