...
class C2231276_TestClass(BaseTestCase):
    ...
    def test_C2231276(self):
        ...
        ia_ribbobj.verify_slicer_group(1, group1, "Step 05: Verify product Group has been added to Group1")
...
#         ia_resultobj.create_report_data_set("TableChart_1", 3, 3, 'C2231276_Ds03.xlsx', no_of_cells=6)
        ...
        """
        coln_list = ["ProductCategory", "ProductSubcategory", "Model"]
        resultobj.verify_report_titles_on_preview(3, 6, "TableChart_1", coln_list, "Step 38:01: Verify column titles")
        ia_resultobj.verify_report_data_set("TableChart_1", 3, 3, "C2231276_Ds03.xlsx", "Step 38.02 verify data set", no_of_cells=6)
        ...
        if status != True:
            print("IA-4076: Request saved from InfoMini application does not show InfoMini option enabled when opened in IA")
        ...
        """
        utillobj.active_run_fex_api_login(Test_Case_ID_IM+".fex", "S10032_infoassist_4", 'mrid', 'mrpass')
...
#         utillobj.synchronize_with_number_of_element(parent_css, 1, 30)
        ...
        """
#         ia_runobj.create_table_data_set("table[summary='Summary']", "C2231276_Ds08.xlsx")
