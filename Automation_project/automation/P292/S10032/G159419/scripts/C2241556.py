...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2241556
...
class C2241556_TestClass(BaseTestCase):

    def test_C2241556(self):
        
        Test_Case_ID = "C2241556"
        driver = self.driver
...
#         ia_resultobj.create_across_report_data_set('TableChart_1', 2, 1, 7, 1, Test_Case_ID+'_DataSet_01.xlsx')
        ...
        """
            Step 04:Click "Save" > save as "C2241556" > Click "Save" in the dialog
        """
        time.sleep(6)
        ...
        """
            Step 05:Launch InfoMini:
                    http://machine:port/ibi_apps/run.bip?BIP_REQUEST_TYPE=BIP_RUN&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FS10032&BIP_item=C2241556.fex
        """
        time.sleep(3)
