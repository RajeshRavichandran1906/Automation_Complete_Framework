...
class C2046818_TestClass(AS_BaseTestCase):
    
    def test_C2046818(self):
        ...
        hcanvas.verify_web_object_visible("#multisourcetreecontrol1_2_11:checked", True, 'Step 1.5 Verify 100 LS 2 DOOR AUTO is checked')
        ...
        hcanvas.verify_object_exist(val_text, True, 'Step 5. Verify Selected Value: ENGLAND,FRANCE,ITALY,JAPAN,W GERMANY msgbox displayed')
        ...
        hcanvas.verify_object_exist(val_text, True, 'Step 6. Verify Display Selected Value: ENGLAND,FRANCE,ITALY,JAPAN,W GERMANY msgbox displayed')
