...
class C2231275_TestClass(BaseTestCase):
    ...
    def test_C2231275(self):
        ...
        """
        defcomp_obj.enter_define_compute_parameter("NEWSITE", 'A25', 'Dimensions->SITE', 1)
        ...
        """
        defcomp_obj.enter_define_compute_parameter("NEWEXPENSES", 'D12.2', 'Measures/Properties->EXPENSES', 1)
