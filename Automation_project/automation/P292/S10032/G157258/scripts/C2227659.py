...
#         metaobj.datatree_field_click("Product,Category", 1, 1,"Filter")
        ...
        """
        Step 16: Click Save in the toolbar > Save as "C2227659" > Click Save
        """
        time.sleep(2)
        ...
        """
        Step 18: Reopen fex using IA API: http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227659.fex
        """
