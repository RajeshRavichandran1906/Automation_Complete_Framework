...
class C2227643_TestClass(BaseTestCase):
    ...
    def test_C2227643(self):
        ...
        """
        metaobj.drag_drop_data_tree_items_to_filter('Revenue Per,Sq. Ft.', 1)
        time.sleep(5)
        ...
        Step08: Save as "C2227643" > Click Save
        ...
        http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227643.fex&tool=idis
