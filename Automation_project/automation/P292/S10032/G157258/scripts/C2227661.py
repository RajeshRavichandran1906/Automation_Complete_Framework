...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227661
Test case Name =  Prompt operator menu 'Not Equals'
'''
...
class C2227661_TestClass(BaseTestCase):

    def test_C2227661(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227661'
...
#         metaobj.datatree_field_click("Product,Category", 1, 1,"Filter")
        ...
        """
        Step 05: Uncheck "All"
        Step 06: Check off values: Camcorder, Stereo Systems, Video Production.
        Step 07: Click OK
        """
        
        l=['[All]','Camcorder', 'Stereo Systems', 'Video Production']
        ...
        expected_xval_list=['Camcorder', 'Stereo Systems', 'Video Production']
        ...
        Step 10: Select "Not Equals"
        """
        parent_css="#resultArea div[id^='BoxLayoutFilterBox']"
        resultobj.wait_for_property(parent_css, 1)
        propertyobj.change_prompt_options("1","Not Equals")
        ...
        expected_xval_list=['Accessories', 'Computers', 'Media Player', 'Televisions']
        ...
        """
        Step 13: Verify output with no prompt
        """
        ...
        utillobj.take_screenshot(ele,'C2227661_Actual_step13', image_type='actual',x=1, y=1, w=-1, h=-1)
        ...
        """
        Step 15: Click Save in the toolbar > Save as "C2227661" > Click Save
        """
        time.sleep(2)
        ...
        """
        Step 17: Reopen fex using IA API: http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227661.fex
        """
        ...
        time.sleep(5)
        bar=['Product Category:Accessories', 'Cost of Goods:$89,753,898.00', 'Filter Chart', 'Exclude from Chart', 'Drill down to Product Subcategory']
        resultobj.verify_default_tooltip_values("MAINTABLE_wbody1", "riser!s0!g0!mbar", bar, "Step 18: Verify bar value")
        time.sleep(5)
        
        
        """
        Step 19: Click Prompt menu in the upper right corner
        Step 20: Select "Equals"
        """
        parent_css="#resultArea div[id^='BoxLayoutFilterBox']"
        resultobj.wait_for_property(parent_css, 1)
        ...
        resultobj.verify_number_of_riser("MAINTABLE_wbody1", 1, 3, 'Step 21.b: Verify the total number of risers displayed on preview')
