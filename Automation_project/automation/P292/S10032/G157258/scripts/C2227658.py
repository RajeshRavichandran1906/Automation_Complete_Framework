...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2227658
Test case Name =  Hide Title  
'''
...
class C2227658_TestClass(BaseTestCase):

    def test_C2227658(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227658'
...
#         metaobj.datatree_field_click("Product,Category", 1, 1,"Filter")
        ...
        Step 07: Select "Hide Title"
        """
        parent_css="#resultArea div[id^='BoxLayoutFilterBox']"
        resultobj.wait_for_property(parent_css, 1)
        propertyobj.select_or_verify_prompt_options("1", hide_title = True, msg = 'Step07')
        ...
        utillobj.take_screenshot(ele,'C2227658_Actual_step10', image_type='actual',x=1, y=1, w=-1, h=-1) 
        ...
        """
        Step 12: Click Save in the toolbar > Save as "C2227658" > Click Save
        """
        time.sleep(2)
        ...
        """
        Step 14: Reopen fex using IA API: http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC2227658.fex
        """
        ...
        resultobj.verify_number_of_riser("MAINTABLE_wbody1", 1, 7, 'Step 18.b: Verify the total number of risers displayed on preview')
