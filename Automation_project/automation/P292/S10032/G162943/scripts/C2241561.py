...
class C2241561_TestClass(BaseTestCase):
    ...
    def test_C2241561(self):
        ...
        utillobj.synchronize_with_number_of_element(domain,1,20)
        time.sleep(5)
        ...
        """
        legacymainobj.select_repository_menu('P292_S10032_G157398 (Folder Name is P292 - Remain as is due to HTML pages)->S10032_infoassist_5', 'New->URL')
        time.sleep(6)
        ...
        """
        legacymainobj.select_repository_menu('P292_S10032_G157398 (Folder Name is P292 - Remain as is due to HTML pages)->S10032_infoassist_5', 'New->Collaborative Portal')
        time.sleep(6)
        ...
        """
        Step 09: Expand the folder ""P292_S10032_G157398 (Folder Name is P292 - Remain as is due to HTML pages)" > S10032_infoassist_5 folder" > Drag "Launch IA API from Portal" into Portal
        """
        portalcanvasobj.dragdrop_repository_item_to_canvas('P292_S10032_G157398 (Folder Name is P292 - Remain as is due to HTML pages)->S10032_infoassist_5->Launch IA API from Portal', 'column', 1, 'start', tx_offset=20, ty_offset=20)
        time.sleep(15)
        ...
        """
        legacymainobj.select_repository_menu('P292_S10032_G157398 (Folder Name is P292 - Remain as is due to HTML pages)->S10032_infoassist_5->C2241561', 'Run')
        time.sleep(6)
