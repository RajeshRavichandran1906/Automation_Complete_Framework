...
class C2270315_TestClass(BaseTestCase):
    ...
    def test_C2270315(self):
        ...
        """
        wf_mainpageobj.select_repository_menu("P292_S10032_G157398 (Folder Name is P292 - Remain as is due to HTML pages)->S10032_infoassist_5", "New->URL")
        ...
        """
        wf_mainpageobj.create_portal("P292_S10032_G157398 (Folder Name is P292 - Remain as is due to HTML pages)->S10032_infoassist_5", "C2270315")
        ...
        """
            ...
            Verify the Portal,
        """
        portal_canvas.dragdrop_repository_item_to_canvas('P292_S10032_G157398 (Folder Name is P292 - Remain as is due to HTML pages)->S10032_infoassist_5->Open an existing Reporting Object to report from', 'column', 1)
        time.sleep(8)
        ...
        wf_mainpageobj.select_repository_menu('P292_S10032_G157398 (Folder Name is P292 - Remain as is due to HTML pages)->S10032_infoassist_5->C2270315', 'Run')
        time.sleep(6)
