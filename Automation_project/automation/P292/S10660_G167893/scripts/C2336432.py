...
class C2336432_TestClass(BaseTestCase):
    ...
    def test_C2336432(self):
        ...
        """  
            ...
            PARTITION_AGGR ( WF_RETAIL_LITE.WF_RETAIL_SALES.COGS_US , WF_RETAIL_LITE.WF_RETAIL_TIME_SALES.TIME_QTR , -1 , C , AVE )
        """
        text_strings = "PARTITION_AGGR ( WF_RETAIL_LITE.WF_RETAIL_SALES.COGS_US , WF_RETAIL_LITE.WF_RETAIL_TIME_SALES.TIME_QTR , -1 , C , AVE )"
...
#         ia_run_obj.create_table_data_set("table[summary='Summary']", Test_Case_ID+"_Ds01.xlsx")
        ...
        coln_list = ['ProductCost of Goods', 'SaleCategoryRollingAverage', 'SaleQuarterProduct', 'MonthSale']
        resultobj.verify_report_titles_on_preview(4, 12, "TableChart_1", coln_list, "Step 17:01: Verify column titles")
        """ 
