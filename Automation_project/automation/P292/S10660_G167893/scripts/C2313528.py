...
class C2313528_TestClass(BaseTestCase):
    ...
    def test_C2313528(self):
        ...
        """
        ia_ribbobj.procedure_setting_dialog_input("Decimal Notation", "checkbox", "checked")
        ia_ribbobj.procedure_setting_dialog_input("Decimal Notation", "radoibutton", "checked")
        ...
        ia_resultobj.verify_across_report_data_set('TableChart_1',2,2,7,2,Test_Case_ID+'_DataSet_03.xlsx','Step 03: Verify report')
