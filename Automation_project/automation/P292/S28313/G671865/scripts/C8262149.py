...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/8262149
'''
...
class C8262149_TestClass(BaseTestCase):
    
    def test_C8262149(self):
        """
        Test_case variables
        """
        ...
        designer_portal_obj_2=designer_portal.Three_Level(self.driver)
        designer_canvas_obj=designer_portal.Canvas(self.driver)
        
        util_obj = utillity.UtillityMethods(self.driver)
        domains_css = ".right-main-panel .toolbar"
        portal_css = "div[title*='V5 Personal Portal_Nav-2'] .ibx-label-text"
        portal_name="V5 Personal Portal_Nav-2"
        expected_item_list=['V5 Personal Portal_Nav-2']
        ...
        """
        Step 3.1: Verify 'V5 Personal Portal_Nav-2' opens in a new tab.

        """
        util_obj.switch_to_window(1)
        actual_page_title = self.driver.title
        expected_page_title = 'V5 Personal Portal_Nav-2'
        util_obj.asequal(expected_page_title, actual_page_title, "Step 3.1. Verify 'V5 Personal Portal_Nav-2' opens in a new tab.")
        
        """
        Step 4. Under My Pages > click + sign.
        """
        designer_portal_obj_2.click_new_page_from_left_navigation_bar()
        ...
        designer_canvas_obj.verify_all_containers_title(expected_containers_title, 'Step 5.1. Verify page is loaded with 7 panels')
