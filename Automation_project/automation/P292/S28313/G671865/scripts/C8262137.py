...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8262137
'''
import unittest
...
class C8262137_TestClass(BaseTestCase):
    
    def test_C8262137(self):
        """
        Test_case variables
        """
        ...
        Pd_filter_window = ".pd-filter-window.pop-modal .ibx-dialog-main-box"
