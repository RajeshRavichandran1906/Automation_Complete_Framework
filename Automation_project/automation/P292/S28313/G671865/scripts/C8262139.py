...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8262139
'''
import unittest
...
class C8262139_TestClass(BaseTestCase):
    
    def test_C8262139(self):
        """
        Test_case objects
        """
        ...
        """
        page_preview_obj.select_multiple_options_from_filter_dropdown('Select North America', 'North America', model_window=True)
        
        """
        Step 5: Click Category > dropdown > choose Camcorder.
        """
        page_preview_obj.select_multiple_options_from_filter_dropdown('Category:', 'Camcorder', model_window=True)
        ...
        page_preview_obj.switch_to_container_frame('Category Sales', 1)
