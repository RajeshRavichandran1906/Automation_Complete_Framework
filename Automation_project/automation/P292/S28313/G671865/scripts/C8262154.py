...
@author: KK14897
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8262154
...
class C8262154_TestClass(BaseTestCase):
    
    def test_C8262154(self):
        ...
        portal_obj.verify_page_delete_dialog_message("Are you sure you want to delete 'Change Page base' ?","Step 4.1")
        ...
        portal_obj.verify_specific_item_not_in_left_navigation_bar(['Change Page base'], 'Step 5')
