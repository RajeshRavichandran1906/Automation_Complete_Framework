...
Test Case Title =  Adding optional slider range control to the Pagel
'''
...
class C8320627_TestClass(BaseTestCase):

    def test_C8320627(self):
...
#         pd_design.create_html_report_data_set(DATA_SET_NAME1)
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 04.08 : Verify report added to the page successfully.')
        ...
        pd_design.verify_filter_slider_values(FILTER_CONTRTOL_NAME, EXPECTED_SLIDER_VALUES_CELL_1, msg='Step 05.03 : Verify Slider values for cell 1')
        pd_design.verify_filter_slider_values(FILTER_CONTRTOL_NAME, EXPECTED_SLIDER_VALUES_CELL_2, msg='Step 05.04 : Verify Slider values for cell 2', filter_control_position=2)
        ...
        pd_design.verify_filter_slider_values(FILTER_CONTRTOL_NAME, EXPECTED_SLIDER_VALUES_CELL_1, msg='Step 07.06 : Verify Slider values for cell 1')
        pd_design.verify_filter_slider_values(FILTER_CONTRTOL_NAME, EXPECTED_SLIDER_VALUES_CELL_2, msg='Step 07.07 : Verify Slider values for cell 2', filter_control_position=2)
...
#         pd_design.create_html_report_data_set(DATA_SET_NAME2)
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME2, 'Step 07.12 : Verify report added to the page successfully.')
        pd_preview.switch_to_default_page()
        ...
        pd_design.verify_filter_slider_values(FILTER_CONTRTOL_NAME, EXPECTED_SLIDER_VALUES_CELL_1, msg='Step 10.04 : Verify Slider values for cell 1')
        pd_design.verify_filter_slider_values(FILTER_CONTRTOL_NAME, EXPECTED_SLIDER_VALUES_CELL_2, msg='Step 10.05 : Verify Slider values for cell 2', filter_control_position=2)
        ...
        pd_run.verify_html_report_data_set(DATA_SET_NAME1, 'Step 10.09 : Verify page runs successfully without error')
