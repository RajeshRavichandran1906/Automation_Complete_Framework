...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/8262079
TestCase Name = Run PGX for Container Theme and Grid style
'''
...
class C8262079_TestClass(BaseTestCase):

    def test_C8262079(self):
        ...
        """
        Step 04: Double click on 'container theme and grid styling1'
        """
        ...
        """
        page_designer_run_obj.verify_filter_grid_style_color("Sea_Serpent", step_num="06.01" ,model_window=True)
        ...
        expected_label_list=['Category:', 'Product Model:']
        page_designer_run_obj.verify_filter_control_labels(expected_label_list, msg="Step 07.03 : Verify filter lables in grid container", grid_container_title="Panel 2")
        page_designer_run_obj.verify_container_style_color("Category Sales", "curious_blue", step_num="07.04")
        page_designer_run_obj.verify_container_style_color("Panel 2", "fern2", step_num="07.05")
        page_designer_run_obj.verify_container_style_color("Panel 3", "curious_blue", step_num="07.06")
        """
