...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/8262074
TestCase Name = Restore PGX grids/Modal Page filter styling
'''
...
class C8262074_TestClass(BaseTestCase):

    def test_C8262074(self):
        ...
        """
        Step 04: Right click on 'grids and Page filter_styling1' > Edit.
        """
        ...
        page_designer_run_obj.verify_container_style_color("Panel 2", "curious_blue", step_num="04.04")
