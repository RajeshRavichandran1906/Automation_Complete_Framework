...
@author: Varun
Testcase Name : Verify Explorer/Portal Properties sections displays as capitalization standards
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261747
'''
...
class C8261747_TestClass(BaseTestCase):
    
    def test_C8261747(self):
        ...
        check_list = ['Thumbnail','Sort order','Language','Load in iframe','Default width','Default height']
        ...
        for item in check_list:
            main_page_obj.verify_label_in_property_dialog('Advanced', item, "03.0"+str(check_list.index(item)+1))
