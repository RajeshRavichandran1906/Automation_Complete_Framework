...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261568
'''
...
class C8261568_TestClass(BaseTestCase):
    
    def test_C8261568(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_visble_text('div.files-box-files', ITEM_NAME, 30, 1)
