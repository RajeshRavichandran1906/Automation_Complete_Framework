...
@author: Robert
Testcase Name : Test Remove Favorites using Developers 
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261567
'''
...
class C8261567_TestClass(BaseTestCase):
    
    def test_C8261567(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_visble_text(crumb_box_css, workspace, 30, 1)
        ...
        util_obj.synchronize_with_visble_text(".content-box", 'Portal for Context Menu Testing', main_page_obj.chart_medium_timesleep)
