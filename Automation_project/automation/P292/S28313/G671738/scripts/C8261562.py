...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261562
'''
...
class C8261562_TestClass(BaseTestCase):
    
    def test_C8261562(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_visble_text(breadcrumb_css, 'Workspaces', 190)
