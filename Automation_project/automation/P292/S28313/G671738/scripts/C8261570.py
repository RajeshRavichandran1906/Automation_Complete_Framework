...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/8261570
...
class C8261570_TestClass(BaseTestCase):

    def test_C8261570(self):
        ...
        utils.synchronize_with_visble_text(".toolbar", 'Workspaces', 10)
