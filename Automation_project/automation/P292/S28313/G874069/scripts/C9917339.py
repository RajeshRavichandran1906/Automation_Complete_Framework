...
Testcase title: Context Menu:Verify Homepage Context menu for items underneath My_Content Folder as Admin.
---------------------------------------------------------------"""
...
class C9917339_TestClass(BaseTestCase):
    
    def test_C9917339(self):
        ...
        portal_expected_menu = ['Run', 'Edit', 'Customizations', 'Manage Alias', 'Cut Ctrl+X', 'Copy Ctrl+C', 'Delete DEL', 'Add to Favorites', 'Security', 'Share', 'Share with...', 'Properties']
