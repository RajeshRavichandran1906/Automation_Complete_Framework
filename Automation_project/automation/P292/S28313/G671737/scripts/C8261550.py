...
Test Case Link  =  http://172.19.2.180/testrail/index.php?/cases/view/8261550
...
class C8261550_TestClass(BaseTestCase):
    
    def test_C8261550(self):
        ...
        utils.synchronize_with_number_of_element(WfMainPageLocators.CONTENT_ICON_CSS, 1, wf_home_page_obj.home_page_long_timesleep)
        wf_home.select_content_from_sidebar()
        utils.synchronize_with_number_of_element(WfMainPageLocators.REPOSITORY_TREE_CSS, 1, wf_home_page_obj.home_page_medium_timesleep)
        wf_home.select_option_from_crumb_box('Domains')
        
        """    3. Click on Portal View from the sidebar    """
        wf_home.select_portals_from_sidebar()
        utils.synchronize_with_visble_text(File_box_css, 'Portal for Context Menu Testing', wf_home_page_obj.home_page_medium_timesleep)
