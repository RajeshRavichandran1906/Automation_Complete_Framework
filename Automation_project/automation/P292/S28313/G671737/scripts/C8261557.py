...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261557
'''
...
class C8261557_TestClass(BaseTestCase):
    
    def test_C8261557(self):
        """
        Test_case variables
        """
        ...
        main_page_obj.verify_crumb_box(workspaces+'->{0}'.format(folder_path), "Step 04.02 : Verify that place where the portal was created (Domains > P292_S19901 > G513445)")
