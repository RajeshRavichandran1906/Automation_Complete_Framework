...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/8261556
'''
...
class C8261556_TestClass(BaseTestCase):
    
    def test_C8261556(self):
        """
        Test_class objects
        """
        ...
        util_obj.synchronize_with_visble_text(crumbbox_css, 'Portals', main_page_obj.home_page_medium_timesleep)
        ...
        util_obj.synchronize_with_number_of_element(Vfive_Designer.title_textbox_input_css, 1,main_page_obj.home_page_medium_timesleep)
        portal_obj.title_textbox_in_new_or_edit_portal_dialog(verify_value=portal_value, step_number='4.1')
        ...
        portal_obj.url_textbox_in_new_or_edit_portal_dialog(verify_value=portal_url_path, readonly_mode=True, step_number='4.16')
