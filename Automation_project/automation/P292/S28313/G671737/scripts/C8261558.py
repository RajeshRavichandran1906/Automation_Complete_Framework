...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261558
'''
...
class C8261558_TestClass(BaseTestCase):
    
    def test_C8261558(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_visble_text(WfMainPageLocators.content_area_css,'Portal for Context Menu Testing',190)
