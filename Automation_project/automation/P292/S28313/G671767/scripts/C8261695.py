...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261695
'''
...
class C8261695_TestClass(BaseTestCase):
    
    def test_C8261695(self):
        """
        Test_case variables
        """
        ...
        def verify_users_dropdown(verify_value=None,dropdownlist=None,msg=None):
            core_util_obj.python_click_with_offset(share_dialog_location['x'], share_dialog_location['y'])
        ...
        share_dialog_location=core_util_obj.get_web_element_coordinate(util_obj.validate_and_get_webdriver_object(pop_top_css,"Share_dialog_css"))
        core_util_obj.python_click_with_offset(share_dialog_location['x'], share_dialog_location['y'])
