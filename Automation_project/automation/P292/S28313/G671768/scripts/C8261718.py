...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/8261718
'''
...
class C8261718_TestClass(BaseTestCase):
    
    def test_C8261718(self):
        """
        Test_case variables
        """
        ...
        Verify side and top navigation bars appears as below
        """
