...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261723
'''
...
class C8261723_TestClass(BaseTestCase):
    
    def test_C8261723(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_visble_text(content_css, "Content", 60)
        ...
        folder_name_list=['v5-navigation-test2']
