...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261584
'''
import unittest
...
class C8261584_TestClass(BaseTestCase):
    
    def test_C8261584(self):
        """
        Test_case variables
        """
        ...
        main_page_obj.verify_action_bar_tab_specific_options(['Folder','Page'], 'Step 6.1: Verify Folder and Page buttons are present ')
        ...
        util_obj.synchronize_with_visble_text(action_bar_css, 'Action Bar', 60)
        main_page_obj.verify_action_bar_tab_specific_options(['Folder','Portal Page'], 'Step 9.1: Verify Folder and Page buttons are present ')
        ...
        util_obj.synchronize_with_visble_text(action_bar_css, 'Action Bar', 60)
        main_page_obj.verify_action_bar_tab_specific_options(['Folder','Text Editor'], 'Step 12.1: Verify Folder and Text Editor buttons are present ')
