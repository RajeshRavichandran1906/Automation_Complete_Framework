...
@author: varun
Testcase Name : Verify action Bar Report option for Dev User
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261597
'''
import unittest
...
class C8261597_TestClass(BaseTestCase):
    
    def test_C8261597(self):
        """
        Test_case objects
        """
...
#         util_obj.synchronize_with_visble_text(cluster_box_css, cluster_text,base_obj.chart_medium_timesleep)
        util_obj.synchronize_with_visble_text('#TableChart_1','Drag and drop fields onto the', main_page_obj.home_page_medium_timesleep)
