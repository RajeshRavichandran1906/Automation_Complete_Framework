...
@author: Vpriya
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261614
...
class C8261614_TestClass(BaseTestCase):


    def test_C8261614(self):
        """
        TESTCASE_OBJECTS
        """
        ...
        util_obj.synchronize_with_visble_text(WfMainPageLocators.content_area_css,'Data', Global_variables.mediumwait)
        ...
        util_obj.synchronize_with_number_of_element(".fa-search",1,60)
