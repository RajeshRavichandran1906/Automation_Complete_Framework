...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261602
'''
import unittest
...
class C8261602_TestClass(BaseTestCase):
    
    def test_C8261602(self):
        """
        Test_case objects
        """
        ...
        """
        Step 8: Right Click on 'C6667549' > Delete > Ok
        ...
        main_page_obj.verify_items_in_grid_view(expected_list, "asnotin","Step 8.1")
