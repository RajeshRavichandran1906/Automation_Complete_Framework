...
@author: Vpriya
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/8788369
Testcase Name : Verify action Bar Schedule for Admin User
'''
...
class C8788369_TestClass(BaseTestCase):
    
    def test_C8788369(self):
        ...
        util_obj.synchronize_with_visble_text(schedule_tab_css,'Schedule', base_obj.home_page_long_timesleep)
        ...
        """
        Step 5: Enter title as 'C8788369' in properties tab.
        """
        util_obj.set_text_to_textbox_using_keybord(testcase_ID, property_title_css)
        ...
        util_obj.set_text_to_textbox_using_keybord('se.automation@amtexsystems.com', '#DistributeEmailPane_mailToTextField')
        util_obj.set_text_to_textbox_using_keybord('se.automation@amtexsystems.com', '#DistributeEmailPane_mailReplyTextField')
        ...
        Verify that 'C8788369' schedule is created
        """
        ...
        util_obj.wait_for_page_loads(10)
        util_obj.synchronize_with_visble_text(content_box_css, testcase_ID, main_page_obj.home_page_medium_timesleep)
        main_page_obj.verify_items_in_grid_view([testcase_ID], 'asin', 'Step 10.1: Verify schedule in the content area')
        
        """
        Step 11: Right click on 'C8788369' > Delete
        Verify that 'C8788369' schedule gets deleted
        """
        main_page_obj.right_click_folder_item_and_select_menu(testcase_ID, delete_btn)
        ...
        main_page_obj.verify_items_in_grid_view([testcase_ID],'asnotin', 'Step 11.1: Verify saved schedule not in content area')
