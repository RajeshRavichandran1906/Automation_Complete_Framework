...
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/8261549
'''
...
class C8261549_TestClass(BaseTestCase):
    
    def test_C8261549(self):
        ...
        expected_path = "IBFS:/WFC/Repository/{0}_{1}/{2}/Portal_for_Context_Menu_Testing".format(project_id, suite_id, group_id)
        ...
        main_page_obj.verify_property_dialog_value('Path', 'text_value', expected_path, "Step 4.5:Verify the Path tab")
        ...
        radio_optoins_elems = util_obj.validate_and_get_webdriver_objects(radio_button_css, 'Thumbnail Radio button', parent_object=thumbnail_row_obj)
