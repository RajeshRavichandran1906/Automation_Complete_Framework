...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/8261529
'''
...
class C8261529_TestClass(BaseTestCase):
    
    def test_C8261529(self):
        """
        Test_case variables
        """
        ...
        """
        main_page_obj.expand_repository_folder('{0}_{1}->{2}'.format(project_id, suite_id, group_id))
        ...
        portal_obj.title_textbox_in_new_or_edit_portal_dialog(verify_value='Portal for Context Menu Testing', step_number='04.01')
        ...
        portal_obj.url_textbox_in_new_or_edit_portal_dialog(verify_value='portal/{0}_{1}/{2}/Portal_for_Context_Menu_Testing'.format(project_id, suite_id, group_id), readonly_mode=True, step_number='04.16')
