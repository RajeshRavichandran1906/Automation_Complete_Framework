...
Testcase ID : 172.19.2.180/testrail/index.php?/cases/view/8261539
'''
...
class C8261539_TestClass(BaseTestCase):
    
    def test_C8261539(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_visble_text(WfMainPageLocators.content_area_css, 'Portal for Context Menu Testing', Global_variables.mediumwait)
