...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261535
'''
...
class C8261535_TestClass(BaseTestCase):
    
    def test_C8261535(self):
        """
        Test_case variables
        """
        ...
        util_obj.verify_current_tab_name(Tab_name,'Step 04.00 : Verify the current tab name')
        util_obj.verify_current_url('portal/P292_S19901/G513445/Portal_for_Context_Menu_Testing','Step 04.01 : Verify the current url of the portal')
