...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/8261530
'''
...
class C8261530_TestClass(BaseTestCase):
    
    def test_C8261530(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_number_of_element(tab_css, 3, main_page_obj.home_page_short_timesleep)
        ...
        main_page_obj.verify_selected_tab_in_property_dialog("Advanced", "Step 5.1: property tab verification")
