...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8261534
'''
...
class C8261534_TestClass(BaseTestCase):
    
    def test_C8261534(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_number_of_element(WfMainPageLocators.ACTION_BAR_CSS,1,2)
