...
@author: BM13368
Testcase Name : Verify folders are reflects in run mode as developer user
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/8262122
'''
import unittest
...
class C8262122_TestClass(BaseTestCase):
    
    def test_C8262122(self):
        """
        CLASS OBJECTS
        """
