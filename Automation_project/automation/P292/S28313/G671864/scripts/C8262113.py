...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8262113
'''
...
class C8262113_TestClass(BaseTestCase):
    
    def test_C8262113(self):
        ...
        designer_obj.delete_portal_if_exists('V5 Personal Portal')
