...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8262131
'''
...
class C8262131_TestClass(BaseTestCase):
    
    def test_C8262131(self):
        """
        Test_case variables
        """
        ...
        labels_css=Vfive_Designer.containers_css
        table_data = "td.x2"
