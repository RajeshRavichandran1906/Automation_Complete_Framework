...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8262132
'''
...
class C8262132_TestClass(BaseTestCase):
    
    def test_C8262132(self):
        ...
        util_obj.wait_for_page_loads(25, pause_time=2)
