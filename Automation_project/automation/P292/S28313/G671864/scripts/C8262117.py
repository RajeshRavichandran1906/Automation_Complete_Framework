...
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/8262117
'''
import unittest
...
class C8262117_TestClass(BaseTestCase):
    
    def test_C8262117(self):
        """
        Test_case variables
        """
        ...
        active_report_obj.verify_active_report_dataset('C8262117.xlsx', 'Step 7.2: Verify data inside container 2', table_css='table[summary]')
