...
class C8262120_TestClass(BaseTestCase):
    
    def test_C8262120(self):
        ...
        portal_obj.verify_page_delete_dialog_message("Are you sure you want to delete 'Content testing' ?","Step 04.01 : Verify Are you sure you want to delete 'Content testing' ?")
        ...
        portal_obj.verify_pages_not_displayed_under_the_folder_in_left_sidebar('My Pages','Content testing','Step 05.01 : Verify Content testing is deleted')
        ...
        main_page_obj.expand_repository_folders_and_verify('Domains->P292_S19901->G513510->V5 Personal Portal->My Pages->My Content', ['Content testing'], "Step 07.01 : Verify Content testing Page is deleted",comparion_type='asnotin')
