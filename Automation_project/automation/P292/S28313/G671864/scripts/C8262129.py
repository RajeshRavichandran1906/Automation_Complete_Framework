...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8262129
'''
import unittest
...
class C8262129_TestClass(BaseTestCase):
    
    def test_C8262129(self):
        ...
        util_obj.wait_for_page_loads(10, pause_time=1)
