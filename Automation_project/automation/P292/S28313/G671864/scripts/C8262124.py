...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/8262124
'''
...
class C8262124_TestClass(BaseTestCase):
    
    def test_C8262124(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_visble_text("[class*='pvd-portal-title']", "V5 Personal Portal", 50)
