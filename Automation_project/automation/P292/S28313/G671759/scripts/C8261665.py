...
@author: Niranjan
Testcase Name : Create page with Grid 3-3-3 templates and keep Page Theme by default
Testcase link : http://172.19.2.180/testrail/index.php?/cases/view/8261665
'''
import unittest
...
class C8261665_TestClass(BaseTestCase):
    
    def test_C8261665(self):
        ...
        expected_theme = 'Designer 2018'
        expected_page_heading = ['Page Heading']
        expected_header_button = ['Refresh']
        expected_panel_list = ['Panel 1','Panel 2','Panel 3','Panel 4','Panel 5','Panel 6','Panel 7','Panel 8','Panel 9']
        ...
        """
        Step 4: Choose Grid 3-3-3 template
        """
        ...
        time.sleep(5)
        page_designer_obj.verify_setting_tab_properties('Page Style', ['Theme=Designer 2018', 'Margin=off', 'Maximum width=off'], 'Step 6.1 : Verify Designer 2018 theme has been selected', property_tab_name='style')
        
        """
        Step 7: Click save;
        Enter 'Page Grid 3-3-3' and click save button
        """
        page_designer_obj.save_page_from_toolbar('Page Grid 3-3-3')
        ...
        """
        Step 9: Right click on 'Page Grid 3-3-3' and click Run
        Verify page appears as below
        """
        main_page_obj.right_click_folder_item_and_select_menu('Page Grid 3-3-3', 'Run')
