...
@author: Niranjan
Testcase Name : Create page with blank templates and keep Page Theme by default
Testcase link : http://172.19.2.180/testrail/index.php?/cases/view/8261662
'''
import unittest
...
class C8261662_TestClass(BaseTestCase):
    
    def test_C8261662(self):
        ...
        """
        Step 7: Click save;
        Enter 'Page Blank' and click on save button
        """
        page_designer_obj.save_page_from_toolbar('Page Blank')
        ...
        """
        Step 9: Right click on 'Page Blank' and click Run
        Verify page appears as below
        """
        main_page_obj.right_click_folder_item_and_select_menu('Page Blank', 'Run')
