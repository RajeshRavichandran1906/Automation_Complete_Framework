...
Testcase title: Context Menu:Verify Homepage Context menu for Portal & Pages as Advanced User.
---------------------------------------------------------------"""
...
class C9925892_TestClass(BaseTestCase):
    
    def test_C9925892(self):
        ...
        portal_expected_menu = ['Run', 'Remove my customizations', 'Copy Ctrl+C', 'Add to Favorites', 'Properties']
        
        """ Page_contex_menu"""
        
        page_expected_menu = ['Copy Ctrl+C', 'Properties']
