...
class C8261577_TestClass(BaseTestCase):
    ...
    def test_C8261577(self):
        ...
        General_tab_css = '[data-ibx-type="homePropertyPage"] [role="tab"]:nth-child(1)'
        ...
        """
        util_obj.synchronize_with_visble_text(General_tab_css, 'General', main_page_obj.home_page_medium_timesleep)
        ...
        try:
            ...
            status = "Intent Phrases found"
        except:
            status = 'Intent Phrases not found'
        
        util_obj.asequal('Intent Phrases not found',status,"Step 5:Verify the 'Intent Phrases' property is not available under Properties section.-passed")
