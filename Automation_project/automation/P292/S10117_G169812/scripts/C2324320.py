...
class C2324320_TestClass(BaseTestCase):
    ...
    def test_C2324320(self):
        ...
        time.sleep(2)
        portal_properties.edit_input_control('page', 'Freeze Column', 'checkbox', checkbox_input='check', msg='Step 6: ')
        time.sleep(2)
        ...
        """ Step 10: Add a panel container as well.
                     Drag accordion report from the BIP_V4_Portal folder there.
        """
        time.sleep(2)
        portal_canvas.select_column(1)
        time.sleep(2)
        ...
        time.sleep(2)
        item_path=BIP_Portal_Path+"->Accordion_report"
        portal_canvas.dragdrop_repository_item_to_canvas(item_path, "Panel", "Panel 2", ty_offset=-35)
        time.sleep(5)
        ...
        time.sleep(2)
        portal_canvas.verify_accordian_panel_title('Panel 3', ['Area 1', 'Area 2', 'New Area'], "Step 12: Verify Area 2 was created.")
        panel_3_obj = portal_canvas.get_panel_obj('Panel 3')
        actual_text = panel_3_obj.text.strip().replace(' ','').split('\n')
        expected_text = ['Panel3', 'Area1', 'Area2', 'S10117', 'BIP_V4_Portal', 'BIP_V4_Portal_upload', 'NewArea']
        utillobj.as_List_equal(actual_text, expected_text, "Step 12.1: Verify Area 2 was created with the domain.")
        ...
        portal_canvas.dragdrop_repository_item_to_canvas(item_path, "Panel", "Panel 4", ty_offset=-35)
        time.sleep(5)
        ...
        portal_canvas.select_page_in_navigation_bar('Two_Col_placeholder_easy')
        time.sleep(2)
        portal_properties.edit_input_control('page', 'Lock Page', 'checkbox', checkbox_input='uncheck', msg='Step 16: ')
        time.sleep(2)
        portal_canvas.select_column(1)
        time.sleep(2)
        portal_properties.edit_input_control('page', 'Freeze Column', 'checkbox', checkbox_input='check', msg='Step 16.1: ')
        time.sleep(2)
        ...
        try:
            ...
            status = False
        utillobj.asequal(status, True, "Step 18: Verify that a + sign appears in that column1 area.")
        time.sleep(1)
        ...
        utillobj.asequal(statu_x, True, "Step 19: Verify that the new panel is on top")
        utillobj.asequal(statu_y, True, "Step 19.1: Verify that the new panel is on top")
        ...
        time.sleep(2)
        portal_canvas.select_easy_selector_path('Retail Samples->Portal->Small Widgets', launch_point='property_tab', button='OK', 
                                                section='column', item_name='Show Easy Selector', control='checkbox', checkbox_input='check', msg='Step 20.1:')
        status = False
        try:
            column_elem1 = portal_canvas.get_column_obj(1)
            status = column_elem1.find_element_by_css_selector("[class*='bip'][class*='easy'][class*='selector'][class*='image']").is_displayed()
            ...
            status = False
        utillobj.asequal(status, True, "Step 20.2: Verify that a + sign appears in that column1 area.")
        time.sleep(1)
        portal_canvas.select_column(2)
        time.sleep(2)
        portal_ribbon.select_ribbon_item('Insert', 'Insert_EasySelector')
        ...
        statu_y = bool(y_location in range(200,230))
        utillobj.asequal(statu_x, True, "Step 20.3: Verify that the new panel is on top")
        utillobj.asequal(statu_y, True, "Step 20.4 Verify that the new panel is on top")
        ...
        time.sleep(2)
        portal_canvas.verify_panel_caption('Category Sales', "Step 21: Verify Category Sales added in Panel 1.")
        portal_canvas.verify_panel_caption('Regional Sales Trend', "Step 21.1: Verify Regional Sales Trend added in Panel 1.")
        ...
        panelobj =  portal_canvas.get_panel_obj('Accordion_report')
        ...
        if x_loc == x_loc1 and  y_loc == y_loc1:
            ...
            stats_x = False
        utillobj.asequal(True, stats_x, "Step 25: Verify that you get the no drop icon as you should NOT be able to do that.")
        status=False
        try:
            ...
            status=True
        utillobj.asequal(True, status, "Step 25.2: Verify that you dont get the normal panel outline into column 1 and that the panels dont adjust their positions.")
        ...
        utillobj.asequal(True, col_status, "Step 26: Verify that you get the no drop icon as you should NOT be able to do that.")
          
        """ Step 27: Try to drag panel 2 into column 2
                     Verify that you can't move that panel out of column 1
        """
        panel2_obj = portal_canvas.get_panel_obj('Accordion_report')
        ...
        time.sleep(5)
        panel2_obj1 = portal_canvas.get_panel_obj('Accordion_report')
        ...
        utillobj.asequal(True, statu_y, "Step 29: Verify that the change did take place.")
        ...
        if x_loc == x_loc1 and  y_loc == y_loc1:
            ...
            stats_x = False
        utillobj.asequal(True, stats_x, "Step 31: Verify that you can't drag it out Area 1 into column 1.")
        ...
        utillobj.asequal(expected_panel_text, actual_panel_text, "Step 31.1: Verify that you can drag it out Area 1 into column 1.")
        ...
        if x_loc == x_loc1 and y_loc == y_loc1:
            ...
            stats_x = False
        utillobj.asequal(True, stats_x, "Step 33: Verify that you can't move those in column 1 around.")
        ...
        panel_elems = col_obj.find_elements_by_css_selector("[class*='bip-container'] [id^='BiDockPanel'] [id^='BiLabel'][class*='bip-title-bar']")
        col_status = 'cd7' not in [elem.text.strip() for elem in panel_elems]
        utillobj.asequal(True, col_status, "Step 34: Verify that you get the no drop icon as you should NOT be able to do that.")
        ...
        time.sleep(3)
        portal_canvas.verify_panel_caption('Discount by Region', "Step 36: Verify that a new panel has been added.")
        ...
        time.sleep(3)
        portal_canvas.verify_panel_caption('Regional Profit by Category', "Step 37: Verify that a new panel has been added.")
        ...
        statu_y = False
        statu_y = bool(y_loc1 in range(70, 100))
        utillobj.asequal(True, statu_y, "Step 37.1: Verify that the change did take place.")
        ...
        time.sleep(3)
        portal_canvas.verify_panel_caption('Average Cost v Sales', "Step 38: Verify Panel Repalced in column 1.")
        time.sleep(1)
        ...
        btn_css="[id*='dlgIbfsOpenFile'] [class*='active'] [id*='IbfsOpenFileDialog'][id*='_btnOK']"
        driver.find_element_by_css_selector(btn_css).click()
        portal_canvas.verify_panel_caption('Discount by Region', "Step 38.1: Verify Panel Repalced in column 1.")
        ...
        y_loc1 = int(panel1_obj1.location['y'])
        statu_y = bool(y_loc1 in range(70, 100))
        utillobj.asequal(True, statu_y, "Step 40: Verify that the change did take place.")
        
        portal_canvas.select_page_in_navigation_bar('two_column_page')
        time.sleep(3)
        
        ''' Verification in two_column_page for panel 1  in lock column '''
        portal_canvas.verify_panel_caption('Panel 1', 'Step 401: Verify "Panel 1" title in two_column_page visible.')
        panel1_obj = portal_canvas.get_panel_obj('Panel 1')
        panel1_obj_x_loc = panel1_obj.location['x']
        panel1_obj_y_loc = panel1_obj.location['y']
         
        ''' Verification in two_column_page for Accordion_report  in lock column '''
        portal_canvas.verify_panel_caption('Accordion_report', 'Step 40.2: Verify "Accordion_report" title in two_column_page visible.')
        accordion_report_obj = portal_canvas.get_panel_obj('Accordion_report')
        accordion_report_obj_x_loc = accordion_report_obj.location['x']
        accordion_report_obj_y_loc = accordion_report_obj.location['y']
         
        ''' Verification in two_column_page for Category Sales  in Unlock column '''
        portal_canvas.verify_panel_caption('Category Sales', 'Step 40.3: Verify "Category Sales" title in two_column_page visible.')
        ...
        portal_canvas.verify_panel_caption('Area 1', 'Step 40.4: Verify "Area 1" title in two_column_page visible.')
        ...
        portal_canvas.verify_panel_caption('Panel 3', 'Step 40.5: Verify "Panel 3" title in two_column_page visible.')
        panel3_obj = portal_canvas.get_panel_obj('Panel 3')
        ...
        portal_canvas.verify_panel_caption('Category Sales', 'Step 40.6: Verify "Category Sales" title in Two_Col_placeholder_easy visible.')
        ...
        portal_canvas.verify_panel_caption('Average Cost v Sales', 'Step 40.7: Verify "Average Cost v Sales" title in Two_Col_placeholder_easy visible.')
        ...
        portal_canvas.verify_panel_caption('Regional Profit by Category', 'Step 40.8: Verify "Regional Profit by Category" title in Two_Col_placeholder_easy visible.')
        ...
        portal_canvas.verify_panel_caption('Discount by Region', 'Step 40.9: Verify "Discount by Region" title in Two_Col_placeholder_easy visible.')
        ...
        """ Step 41: Click close and rerun the portal
                     Verify that the changes are still there for the unlocked columns.
        ...
        ''' Verification in two_column_page for panel 1  in lock column '''
        portal_canvas.verify_panel_caption('Panel 1', 'Step 41: Verify "Panel 1" title in two_column_page visible.')
        panel1_obj = portal_canvas.get_panel_obj('Panel 1')
        ...
        if panel1_obj_x_loc == panel1_obj_x_loc1 and panel1_obj_y_loc == panel1_obj_y_loc1:
            ...
            status_panel1 = False
        utillobj.asequal(True, status_panel1, 'Step 41.1: Verify Panel 1 still there without any changes in two_column_page.')
         
        ''' Verification in two_column_page for Accordion_report  in lock column '''
        portal_canvas.verify_panel_caption('Accordion_report', 'Step 41.2: Verify "Accordion_report" title in two_column_page visible.')
        accordion_report_obj = portal_canvas.get_panel_obj('Accordion_report')
        accordion_report_obj_x_loc1 = accordion_report_obj.location['x']
        accordion_report_obj_y_loc1 = accordion_report_obj.location['y']
        accordion_report_status = False
        if accordion_report_obj_x_loc == accordion_report_obj_x_loc1 and accordion_report_obj_y_loc == accordion_report_obj_y_loc1:
            accordion_report_status = True
        else:
            accordion_report_status = False
        utillobj.asequal(True, accordion_report_status, 'Step 41.3: Verify Accordion_report still there without any changes in two_column_page.')
         
        ''' Verification in two_column_page for Category Sales  in Unlock column '''
        portal_canvas.verify_panel_caption('Category Sales', 'Step 41.4: Verify "Category Sales" title in two_column_page visible.')
        category_sales_obj = portal_canvas.get_panel_obj('Category Sales')
        ...
        if category_sales_obj_x_loc1 > panel1obj_actualwidht and category_sales_obj_y_loc == category_sales_obj_y_loc1:
            ...
            category_sales_status = False
        utillobj.asequal(True, category_sales_status, 'Step 41.5: Verify Category Sales still there without any changes in two_column_page.')
         
        ''' Verification in two_column_page for Area 1  in Unlock column '''
        portal_canvas.verify_panel_caption('Area 1', 'Step 41.6: Verify "Area 1" title in two_column_page visible.')
        area1_obj = portal_canvas.get_panel_obj('Area 1')
        ...
        if area1_obj_x_loc1 > panel1obj_actualwidht and area1_obj_y_loc == area1_obj_y_loc1:
            ...
            area1_status = False
        utillobj.asequal(True, area1_status, 'Step 41.7: Verify Category Sales still there without any changes in two_column_page.')
         
        ''' Verification in two_column_page for Panel 3  in Unlock column '''
        portal_canvas.verify_panel_caption('Panel 3', 'Step 41.8: Verify "Panel 3" title in two_column_page visible.')
        panel3_obj = portal_canvas.get_panel_obj('Panel 3')
        ...
        if panel3_obj_x_loc1 > panel1obj_actualwidht and panel3_obj_y_loc == panel3_obj_y_loc1:
            ...
            panel3_status = False
        utillobj.asequal(True, panel3_status, 'Step 41.9: Verify Panel 3 still there without any changes in two_column_page.')
        ...
        actual_panel_text = [elem.text.strip() for elem in panel_text]
        expected_panel_text = ['Panel 1', 'Accordion_report']
        utillobj.asequal(expected_panel_text, actual_panel_text, "Step 41.10: Verify column 1 panel still there without any changes in two_column_page.")
        ...
        actual_panel_text = [elem.text.strip() for elem in panel_text]
        expected_panel_text = ['Category Sales', 'Area 1', 'Panel 3']
        utillobj.asequal(expected_panel_text, actual_panel_text, "Step 41.11: Verify column 2 panel still there without any changes in two_column_page.")
        ...
        ''' Verification in Two_Col_placeholder_easy for Category Sales  in lock column '''
        portal_canvas.verify_panel_caption('Category Sales', 'Step 41.12: Verify "Category Sales" title in Two_Col_placeholder_easy visible.')
        category_sales_obj1 = portal_canvas.get_panel_obj('Category Sales')
        ...
        if category_sales_obj1_x_loc == category_sales_obj1_x_loc1 and category_sales_obj1_y_loc == category_sales_obj1_y_loc1:
            ...
            category_sales_status = False
        utillobj.asequal(True, category_sales_status, 'Step 41.13: Verify Category Sales still there without any changes in Two_Col_placeholder_easy.')
         
        ''' Verification in Two_Col_placeholder_easy for Average Cost v Sales  in lock column '''
        portal_canvas.verify_panel_caption('Average Cost v Sales', 'Step 41.14: Verify "Average Cost v Sales" title in Two_Col_placeholder_easy visible.')
        average_cost_v_sales_obj1 = portal_canvas.get_panel_obj('Average Cost v Sales')
        ...
        if average_cost_v_sales_x_loc == average_cost_v_sales_x_loc1 and average_cost_v_sales_y_loc == average_cost_v_sales_y_loc1:
            ...
            average_cost_v_sales_status = False
        utillobj.asequal(True, average_cost_v_sales_status, 'Step 41.15: Verify Average Cost v Sales still there without any changes in Two_Col_placeholder_easy.')
         
        ''' Verification in Two_Col_placeholder_easy for Regional Profit by Category  in Unlock column '''
        portal_canvas.verify_panel_caption('Regional Profit by Category', 'Step 41.16: Verify "Regional Profit by Category" title in Two_Col_placeholder_easy visible.')
        regional_profit_by_category_obj1 = portal_canvas.get_panel_obj('Regional Profit by Category')
        ...
        if regional_profit_by_category_x_loc1 > panel2obj_actualwidht and regional_profit_by_category_y_loc == regional_profit_by_category_y_loc1:
            ...
            regional_profit_by_category_status = False
        utillobj.asequal(True, regional_profit_by_category_status, 'Step 41.17: Verify Regional Profit by Category still there without any changes in two_column_page.')
         
        ''' Verification in Two_Col_placeholder_easy for Discount by Region  in Unlock column '''
        portal_canvas.verify_panel_caption('Discount by Region', 'Step 41.18: Verify "Discount by Region" title in Two_Col_placeholder_easy visible.')
        discount_by_region_obj1 = portal_canvas.get_panel_obj('Discount by Region')
        ...
        if discount_by_region_obj1_x_loc1 > panel2obj_actualwidht and discount_by_region_obj1_y_loc == discount_by_region_obj1_y_loc1:
            ...
            discount_by_region_obj1_status = False
        utillobj.asequal(True, discount_by_region_obj1_status, 'Step 41.19: Verify Discount by Region still there without any changes in Two_Col_placeholder_easy.')
        
        panel1_obj1 = portal_canvas.get_column_obj(1)
        panel_text = panel1_obj1.find_elements_by_css_selector("[class*='bip-container'] [id^='BiDockPanel'] [id^='BiLabel'][class*='bip-title-bar']")
        actual_panel_text = [elem.text.strip() for elem in panel_text]
        expected_panel_text = ['Category Sales', 'Average Cost v Sales']
        utillobj.asequal(expected_panel_text, actual_panel_text, "Step 41.20: Verify column 1 panel still there without any changes in Two_Col_placeholder_easy.")
        
        panel1_obj1 = portal_canvas.get_column_obj(2)
        panel_text = panel1_obj1.find_elements_by_css_selector("[class*='bip-container'] [id^='BiDockPanel'] [id^='BiLabel'][class*='bip-title-bar']")
        actual_panel_text = [elem.text.strip() for elem in panel_text]
        expected_panel_text = ['Discount by Region', 'Regional Profit by Category']
        utillobj.asequal(expected_panel_text, actual_panel_text, "Step 41.21: Verify column 2 panel still there without any changes in Two_Col_placeholder_easy.")
        ...
        """ Step 43: Sign Out from WebFOCUS
        """
        time.sleep(5)
