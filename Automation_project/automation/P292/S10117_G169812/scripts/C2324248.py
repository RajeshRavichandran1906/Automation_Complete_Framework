...
class C2324248_TestClass(BaseTestCase):
    ...
    def test_C2324248(self):
        ...
        """
#         utillobj.invoke_bip_portal('BIP_V4_Portal/BIP_Responsive', 'mrid03', 'mrpass03', mode='edit')
        ...
        miscelanousobj.verify_page_summary('0','113of113records,Page1of5', "Step 11.1: Verify 'Sales Metrics YTD' Drag and Droped in Responsive panel.")
        ...
        resultobj.wait_for_property(parent_css, 1, expire_time=50, string_value="Page 1", with_regular_exprestion=True)
        time.sleep(15)
        ...
        utillobj.switch_to_frame(pause=2,frame_css="[class*='iframe'][name^='Panel_1_1']",frame_height_value=0)
        miscelanousobj.verify_page_summary('0','113of113records,Page1of5', "Step 13.1: Verify 'Sales Metrics YTD' Drag and Droped in Responsive panel.")
        utillobj.switch_to_default_content(pause=5)
        ...
        """ Step 17: Multi select Analytical Dashboard and Regional Analysis panels
        """
        ...
        """ Step 18: Click on responsive Item properties button in the properties section
        """
        portal_properties.edit_input_control('panel', 'Responsive Properties', 'button')
        
        """ Step 19: Set width 300px to 440px, height from 220 to 440, max width from 350 to 620px click apply then OK
        """
        ...
        for text in textbox_option:
            portal_properties.manage_responsive_properties_popup(text, 'textbox', textbox_value=textbox_option[text], 
                                                                 msg="Step 19."+str(count)+": Verify Responsive Properties PopUp "+text+" Value is "+textbox_option[text]+" Displayed.")
            count += 1
        ...
        portal_misobj.verify_difference(panel_temp_w, panel_temp_w2, 125, 272, 'Greater_than' , "Step 19: Verify 'Analytical Dashboard' is Changes took place.")
        portal_misobj.verify_difference(panel_temp_w1, panel_temp_w3, 125, 272, 'Greater_than' , "Step 19.1: Verify 'Regional Analysis' is Changes took place.")
        
        
        """ Step 20: Save and exit
        """
        portal_ribbon.select_tool_menu_item('menu_Save')
        portal_ribbon.select_tool_menu_item('menu_Exit')
        utillobj.switch_to_window(0)
