...
class C2324317_TestClass(BaseTestCase):
    ...
    def test_C2324317(self):
        ...
        """ Step 7: Replace Category Sales with Regional Sales Trend by dragging the report from F8 into the existing container and choose Replace Content
                    Verify that the report shows
        """
        ...
        """ Step 9: Close the portal
            Step 10: If you got an error in step 8 Remove customization of the portal and it will become usable again.
        """
        portal_run.select_or_verify_portal_menu_bar_item(select='Close')
        parent_css = "#PortalResourcevBOX table tr td"
        resultobj.wait_for_property(parent_css, 1, expire_time=50, string_value="Domains", with_regular_exprestion=True)
