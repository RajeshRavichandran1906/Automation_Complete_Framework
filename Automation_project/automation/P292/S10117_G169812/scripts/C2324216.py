...
from common.pages import visualization_resultarea, wf_mainpage, vfour_portal_canvas, vfour_portal_ribbon, wf_legacymainpage
...
class C2324216_TestClass(BaseTestCase):
    ...
    def test_C2324216(self):
        ...
        time.sleep(3)
        time.sleep(2)
        #textbox_option = {'Panel Title':'Panel 1', 'Height':'400'}
        ...
        time.sleep(2)
        #textbox_option = {'Easy Selector Title':'Panel 2', 'Height':'400'}
        textbox_option = {'Height':'400'}
        combobox_option = {'Height Unit':'px'}
        checkbox_option = {'Move':'check', 'Resize':'check', 'Minimize':'check', 'Maximize':'check', 'Refresh':'check', 'Hide':'uncheck', 
                           'Delete':'check', 'Show Comments':'uncheck', 'Freeze Container':'uncheck', 'Hide Panel':'uncheck'}
        ...
        """
        portal_canvas.scroll_panel(10000, 0, 'up')
        portal_canvas.select_panel('Panel 3')
        time.sleep(2)
        #textbox_option = {'Accordion Title':'Panel 3', 'Height':'400'}
        textbox_option = {'Height':'400'}
        combobox_option = {'Height Unit':'px'}
        checkbox_option = {'Move':'check', 'Resize':'check', 'Minimize':'check', 'Maximize':'check', 'Refresh':'check', 'Hide':'uncheck', 
                           'Delete':'check', 'Show Comments':'uncheck', 'Freeze Container':'uncheck', 'Hide Panel':'uncheck'}
        ...
        time.sleep(2)
        #textbox_option = {'Tab Title':'Panel 4', 'Height':'400'}
        textbox_option = {'Height':'400'}
        combobox_option = {'Height Unit':'px'}
        checkbox_option = {'Move':'check', 'Resize':'check', 'Minimize':'check', 'Maximize':'check', 'Refresh':'check', 'Hide':'uncheck', 
                           'Delete':'check', 'Show Comments':'uncheck', 'Freeze Container':'uncheck', 'Hide Panel':'uncheck'}
        ...
        time.sleep(2)
        #textbox_option = {'Responsive title':'Panel 5', 'Height':'400'}
        textbox_option = {'Height':'400'}
        combobox_option = {'Height Unit':'px'}
        checkbox_option = {'Move':'check', 'Resize':'check', 'Minimize':'check', 'Maximize':'check', 'Refresh':'check', 'Hide':'uncheck', 
                           'Delete':'check', 'Show Comments':'uncheck', 'Freeze Container':'uncheck', 'Hide Panel':'uncheck'}
        ...
        time.sleep(2)
        #textbox_option = {'Panel Title':'Panel 6'}
        checkbox_option = {'Move':'check', 'Resize':'check', 'Minimize':'check', 'Maximize':'check', 'Refresh':'check', 'Hide':'uncheck', 
                           'Delete':'check', 'Show Comments':'uncheck', 'Freeze Container':'uncheck', 'Hide Panel':'uncheck'}
        count = 1
        '''for text in textbox_option:
        ...
        time.sleep(2)
        #textbox_option = {'Accordion Title':'Panel 7'}
        checkbox_option = {'Move':'check', 'Resize':'check', 'Minimize':'check', 'Maximize':'check', 'Refresh':'check', 'Hide':'uncheck', 
                           'Delete':'check', 'Show Comments':'uncheck', 'Freeze Container':'uncheck', 'Hide Panel':'uncheck'}
        count = 1
        '''for text in textbox_option:
        ...
        time.sleep(2)
        #textbox_option = {'Tab Title':'Panel 8'}
        checkbox_option = {'Move':'check', 'Resize':'check', 'Minimize':'check', 'Maximize':'check', 'Refresh':'check', 'Hide':'uncheck', 
                           'Delete':'check', 'Show Comments':'uncheck', 'Freeze Container':'uncheck', 'Hide Panel':'uncheck'}
        count = 1
        '''for text in textbox_option:
        ...
        time.sleep(2)
        #textbox_option = {'Easy Selector Title':'Panel 9'}
        checkbox_option = {'Move':'check', 'Resize':'check', 'Minimize':'check', 'Maximize':'check', 'Refresh':'check', 'Hide':'uncheck', 
                           'Delete':'check', 'Show Comments':'uncheck', 'Freeze Container':'uncheck', 'Hide Panel':'uncheck'}
        count = 1
        '''for text in textbox_option:
