...
class C2324329_TestClass(BaseTestCase):
    ...
    def test_C2324329(self):
        ...
        time.sleep(1)
        wf_mainpageobj.select_menu('P292->S10117->BIP_V4_Portal->lock column portal', 'Publish')
        ...
        """
        wf_mainpageobj.select_menu('P292->S10117->BIP_V4_Portal->lock column portal', 'Properties')
        path="IBFS:/WFC/Repository/P292/S10117/BIP_V4_Portal"
        ...
        """
        wf_mainpageobj.select_menu('P292->S10117->BIP_V4_Portal->lock column portal Resources->two_column_page', 'Properties')
        path="IBFS:/WFC/Repository/P292/S10117/BIP_V4_Portal/lock_column_portal_Resources"
