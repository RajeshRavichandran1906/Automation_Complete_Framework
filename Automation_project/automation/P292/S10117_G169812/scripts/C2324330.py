...
from common.pages import visualization_resultarea, wf_mainpage, vfour_portal_canvas, wf_legacymainpage, vfour_portal_run, vfour_portal_ribbon, vfour_miscelaneous, ia_resultarea
...
class C2324330_TestClass(BaseTestCase):
    ...
    def test_C2324330(self):
        ...
        """ Step 1: Sign back in as WF Developer if you are not already
        """
        ...
        verify_panel_data('Panel 2', 'S10117', '6.1')
        ...
        verify_panel_data('Panel 4', 'S10117', '6.6')
        ...
        """ Step 8: Click another page layout that is already there and give it the same name and title
                    ...
                    Verify that you get an error message stating that the page is already in the portal 
        """
        location_text='/Repository/P292/S10117/BIP_V4_Portal/Pages_Folder'
        ...
        time.sleep(2)
        verify_panel_data('Panel 1', 'P292', '11')
        ...
        portal_canvas.select_page_in_navigation_bar('Page_designer1')
        verify_panel_data('Panel 2', 'S10117', '11.1')
        expected_legend= ['Product Category', 'Accessories', 'Camcorder', 'Computers', 'Media Player', 'Stereo Systems', 'Televisions', 'Video Production']
        ...
        verify_panel_data('Panel 4', 'S10117', '11.6')
        
        portal_canvas.select_page_in_navigation_bar('Linked_Page1')
        verify_panel_data('Panel 1', 'P292', '11.7')
        ...
        verify_panel_data('Panel 1', 'S10117', '13')
        ...
        portal_canvas.verify_page_in_navigation_bar('Page_designer1', "Step 15: Verify 'Page_designer1' in Navigation bar.", page_order_list=expected_list)
         
        portal_canvas.select_page_in_navigation_bar('Page_designer1')
        verify_panel_data('Panel 2', 'S10117', '15.1')
        expected_legend= ['Product Category', 'Accessories', 'Camcorder', 'Computers', 'Media Player', 'Stereo Systems', 'Televisions', 'Video Production']
        verify_panel_frame_data('legend', 'Panel_1', expected_legend, '15.2')
        
        portal_canvas.select_page_in_navigation_bar('Page_designer_fluid')
        verify_panel_data('Panel 1', 'Retail Samples', '15.3')
        verify_panel_data('Panel 2', 'Area 1', '15.4')
        portal_canvas.verify_panel_image('honda_integra', 'honda_integra', 'Step 15.5: Verify Honda car displayed.')
        verify_panel_data('Panel 4', 'S10117', '15.6')
        
        portal_canvas.select_page_in_navigation_bar('Linked_Page1')
        verify_panel_data('Panel 1', 'P292', '15.7')
        
        portal_canvas.select_page_in_navigation_bar('Two_Col_placeholder_easy')
        expected_legend= ['Product Category', 'Accessories', 'Camcorder', 'Computers', 'Media Player', 'Stereo Systems', 'Televisions', 'Video Production']
        verify_panel_frame_data('legend', 'Panel_1', expected_legend, '15.8')
        expected_legend= ['EMEA', 'North America', 'Oceania', 'South America']
        verify_panel_frame_data('legend', 'Panel_2', expected_legend, '15.9')
        
        portal_canvas.select_page_in_navigation_bar('Linked_Page2')
        verify_panel_data('Panel 1', 'S10117', '15.10')
        ...
        """ Step 17: Sign Out from WebFOCUS
        """
        time.sleep(3)
