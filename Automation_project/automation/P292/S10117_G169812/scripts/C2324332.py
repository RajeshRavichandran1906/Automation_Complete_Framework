...
from common.pages import visualization_resultarea, wf_mainpage, vfour_portal_canvas, wf_legacymainpage, ia_resultarea, vfour_portal_properties, vfour_portal_run, vfour_portal_ribbon, vfour_miscelaneous
...
class C2324332_TestClass(BaseTestCase):
    ...
    def test_C2324332(self):
        ...
        time.sleep(2)
        verify_panel_data('Panel 2', 'Domains', '9')
        ...
        """
        item_path_list=[BIP_Portal_Path+"->Accordion_report", BIP_Portal_Path+"->IA_Chart1", BIP_Portal_Path+"->babydeer"]
        ...
        verify_panel_data('Panel 2', 'Domains', '18.4')
        verify_panel_data('Panel 3', 'Area 1', '18.5')
        verify_panel_data('Panel 3', portal_name, '18.6')
        
        ''' Column 2 assertion '''
        verify_column_data(2, ['Panel 4', 'Accordion_report'], '18.7')
        ...
        """ Step 22: Close and rerun the portal
        ...
        verify_panel_data('Panel 2', 'Domains', '22.4')
        verify_panel_data('Panel 3', 'Area 1', '22.5')
        verify_panel_data('Panel 3', portal_name, '22.6')
        
        ''' Column 2 assertion '''
        verify_column_data(2, ['Panel 4', 'Accordion_report'], '22.7')
        ...
        """ Step 23: Close the portal
        """
        portal_run.select_or_verify_portal_menu_bar_item(select='Close')
        utillobj.synchronize_with_visble_text(welcome_page_parent_css, 'Domains', 50)
        
        """ Step 24: Edit the portal
        """
        wf_mainpageobj.select_repository_menu(BIP_Portal_Path+'->'+portal_name, 'Edit')
        utillobj.switch_to_window(1)
        utillobj.synchronize_with_number_of_element(edit_page_parent_css, 1, 50)
        
        """ Step 25: Unlock the page and freeze all columns
        """
        ...
        """ Step 26: Save and run the portal
        """
        portal_ribbon.bip_save_and_exit('Yes')
        utillobj.switch_to_window(0, pause=9)
        utillobj.synchronize_with_visble_text(welcome_page_parent_css, 'Domains', 50)
        ...
        verify_panel_data('Panel 2', 'Domains', '26.4')
        verify_panel_data('Panel 3', 'Area 1', '26.5')
        verify_panel_data('Panel 3', portal_name, '26.6')
        
        ''' Column 2 assertion '''
        verify_column_data(2, ['Panel 4', 'Accordion_report'], '26.7')
        ...
        """ Step 27: Click the + sign for panel 1 and choose the Regional Sales trend then click OK
                     ...
                     Pick another report
                     Close and rerun the portal
                     Verify that now the changes are saved cause only the column is frozen.
        """
        portal_canvas.select_easy_selector_item('Panel 1', 'Regional Sales Trend', button='Add')
        time.sleep(1)
        portal_canvas.verify_panel_caption('Regional Sales Trend', 'Step 27: Verify Regional Sales Trend added in Panel 1')
        expected_legend= ['EMEA', 'North America', 'Oceania', 'South America']
        verify_panel_frame_data('legend', 'Panel_1', expected_legend, '27.1')
        
        portal_canvas.select_easy_selector_item('Panel 4', 'Discount by Region', button='Add')
        time.sleep(1)
        portal_canvas.verify_panel_caption('Discount by Region', 'Step 27.2: Verify Discount by Region added in Panel 1')
        verify_panel_frame_data('riser', 'Panel_4', 16, '27.3')
        
        portal_run.verify_column_panel_title_menubar_button(3, 'Category Sales', verify=False, select_menu_opt='Replace')
        portal_canvas.select_easy_selector_item('Category Sales', 'Regional Profit by Category', option='frame', button='Add')
        verify_panel_frame_data('riser', 'Panel_6', 28, '27.4')
        
        portal_run.select_or_verify_portal_menu_bar_item(select='Close')
        utillobj.synchronize_with_visble_text(welcome_page_parent_css, 'Domains', 50)
        wf_mainpageobj.select_repository_menu(BIP_Portal_Path+'->'+portal_name, 'Run')
        utillobj.synchronize_with_number_of_element(run_page_parent_css, 1, 50)
        portal_canvas.verify_page_in_navigation_bar('Page 1', "Step 27.5: Verify 'Page 1' in Navigation bar.")
        
        ''' Column 1 assertion '''
        verify_column_data(1, ['Regional Sales Trend', 'Panel 2', 'Panel 3'], '27.6')
        expected_legend= ['EMEA', 'North America', 'Oceania', 'South America']
        verify_panel_frame_data('legend', 'Panel_1', expected_legend, '27.7')
        verify_panel_data('Panel 2', 'Tab 1', '27.8')
        verify_panel_data('Panel 2', 'Domains', '27.9')
        verify_panel_data('Panel 3', 'Area 1', '27.10')
        verify_panel_data('Panel 3', portal_name, '27.11')
        
        ''' Column 2 assertion '''
        verify_column_data(2, ['Discount by Region', 'Accordion_report'], '27.12')
        verify_panel_frame_data('riser', 'Panel_4', 16, '27.13')
        verify_panel_frame_data('text', 'Panel_5_1', 'Budget Units', '27.14', custom_css="table[ibiattr='table1'] tr:nth-child(1) td:nth-child(2)")
        
        ''' Column 3 assertion '''
        verify_column_data(3, ['Regional Profit by Category', 'Panel 7'], '27.15')
        verify_panel_frame_data('riser', 'Panel_6', 28, '27.16')
        verify_panel_frame_data('riser', 'Panel_7', 5, '27.17')
        
        """ Step 28: Close the portal
        """
        portal_run.select_or_verify_portal_menu_bar_item(select='Close')
        utillobj.synchronize_with_visble_text(welcome_page_parent_css, 'Domains', 50)
        
        """ Step 29: Sign Out from WebFOCUS
        """
        time.sleep(3)
