...
from common.pages import visualization_resultarea, wf_mainpage, vfour_miscelaneous, vfour_portal_ribbon, \
                            vfour_portal_canvas, vfour_portal_properties, security_center, wf_legacymainpage
...
class C2324209_TestClass(BaseTestCase):
    ...
    def test_C2324209(self):
        ...
        portal_url = "/portal/PortalDesigner?path=%252FP292%252FS10117%252FBIP_V4_Portal%252FBIP_xxx_Portal123_V4"
        ...
        """
        vfour_miscelaneousobj.select_resource_menu('Domains', 'View->Display By Name')
        time.sleep(1)
        vfour_miscelaneousobj.verify_resource_item(BIP_Portal_Path, Portal_Name1, '15:01', item_exit=True)
        vfour_miscelaneousobj.select_resource_menu('Domains', 'View->Display By Title') 
        ...
        """
        vfour_ribbonobj.invoke_and_verify_wf_resource_tree(launch_point='keybord')
        vfour_miscelaneousobj.verify_resource_item(BIP_Portal_Path, Portal_Resource_Name, '19:', item_exit=True)
