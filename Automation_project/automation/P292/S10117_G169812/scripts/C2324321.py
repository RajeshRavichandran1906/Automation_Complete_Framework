...
from common.pages import visualization_resultarea, ia_resultarea, wf_mainpage, vfour_portal_canvas, wf_legacymainpage, vfour_portal_run, vfour_portal_ribbon, vfour_miscelaneous, vfour_portal_properties
...
class C2324321_TestClass(BaseTestCase):
    ...
    def test_C2324321(self):
        ...
        def verify_panel_data(panel_name, step_num):
            ...
            utillobj.asin('P292', actual_panel_text, "Step " + str(step_num) + ": Verify 'Resource Tree' added in '" + str(panel_name) + "'.")
        ...
        """
        wf_mainpageobj.expand_tree('P292')
        parent_css = "#PortalResourcevBOX table tr td"
        resultobj.wait_for_property(parent_css, 1, expire_time=50, string_value="Domains", with_regular_exprestion=True)
        ...
        if bool('BIP_V4_Portal' in actual_domain_tree_text):
            print("P292->S10117 expanded already")
        else:
            print("P292->S10117 not expanded already")
        ...
        verify_column_data(1, ['Panel 1', 'Area 1', 'Category Sales', 'New Area', 'tagCloud_chart'], '7')
        verify_column_data(2, ['Panel 2', 'Tab 1', 'Units Profit Treemap', 'New Tab', 'tagCloud_chart'], '7.1')
        verify_column_data(3, ['Panel 3', 'Area 1', 'Accordion DataTable', 'New Area', 'tagCloud_chart'], '7.2')
        time.sleep(1)
        ...
        verify_panel_frame_data('legend', 'Panel_2', ['Gross Profit', '0.3M', '13.1M', '26M', '38.9M', '51.8M'], '7.4')
        ...
        """
        portal_canvas.select_panel_in_column(1, 'tagCloud_chart')
        ...
        time.sleep(2)
        portal_canvas.select_panel_in_column(2, 'tagCloud_chart')
        time.sleep(2)
        portal_properties.edit_input_control('panel', 'Freeze Container', 'checkbox', checkbox_input='check', msg='Step 9.1: ')
        time.sleep(2)
        portal_canvas.select_panel_in_column(3, 'tagCloud_chart')
        portal_canvas.scroll_panel(0, 0, 'up', option='autohotkey', number_of_times=20)
        time.sleep(2)
        ...
        column2_panel = panel_elems[['tagCloud_chart' in el1 for el1 in [el.text.strip() for el in panel_elems]].index(True)]
        portal_run.drag_portal_resource_tree_item(BIP_Portal_Path+'->cd7', column2_panel)
        verify_coumn_panel_title(2, ['Panel 2', 'tagCloud_chart'], '16')
        ...
        column3_panel = panel_elems[['tagCloud_chart' in el1 for el1 in [el.text.strip() for el in panel_elems]].index(True)]
        ...
        time.sleep(3)
        verify_coumn_panel_title(2, ['Panel 2', 'tagCloud_chart', 'tagCloud_chart'], '17')
        ...
        portal_run.verify_column_panel_title_menubar_button(1, 'tagCloud_chart', expected_opt=['Minimize', 'Maximize', 'Refresh'], msg="Step 20.2: ")
        portal_run.select_panel_in_column(1, 'tagCloud_chart')
        portal_canvas.scroll_panel(0, 0, 'down', option='autohotkey', number_of_times=30)
        portal_run.verify_column_panel_title_menu_with_index(2, 2,'tagCloud_chart', ['Minimize', 'Maximize', 'Refresh'], "Step 20.3: ")
        ...
        parent_css="div[id^='BipNavigatorTop'] div[id^='BipNavigatorButton'][class*='checked']"
        resultobj.wait_for_property(parent_css, 1, expire_time=50)
        verify_coumn_panel_title(1, ['Panel 1', 'tagCloud_chart'], '25.1')
        verify_coumn_panel_title(2, ['Panel 2', 'tagCloud_chart', 'tagCloud_chart'], '25.2')
        verify_coumn_panel_title(3, ['Panel 3'], '25.3')
        verify_coumn_panel_title(4, ['Discount by Region', 'Panel 8', 'Panel 9', 'Panel 10', 'Regional Sales Trend'], '25.4')
