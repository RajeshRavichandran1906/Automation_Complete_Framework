...
from common.pages import visualization_resultarea, ia_resultarea, wf_mainpage, vfour_portal_canvas, wf_legacymainpage, vfour_portal_ribbon, vfour_miscelaneous, vfour_portal_properties
...
class C2324325_TestClass(BaseTestCase):
    ...
    def test_C2324325(self):
        ...
        BIP_Portal_Path = 'P292->S10117->BIP_V4_Portal->Pages_Folder'
        ...
        time.sleep(1)
        verify_panel_data('Panel 1', 'P292', "14")
