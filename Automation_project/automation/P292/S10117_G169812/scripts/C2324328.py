...
from common.pages import visualization_resultarea, wf_mainpage, vfour_portal_canvas, wf_legacymainpage, vfour_portal_ribbon, vfour_miscelaneous, vfour_portal_properties
...
class C2324328_TestClass(BaseTestCase):
    ...
    def test_C2324328(self):
        ...
        if utillobj.parseinitfile('nodeid') in ('wfinst02', 'wfinst03', 'wfinst04','wfinst05'):
        ...
        while run_loop:
            ...
            if len(driver.window_handles) > 1:
                run_loop = False
            count_time += 1
        utillobj.switch_to_window(1,  pause=7)
        ...
        portal_misobj.open_file_from_repostitory_window(BIP_Portal_Path, 'honda_integra', file_type='GIF (*.gif)')
        portal_properties.verify_input_control('page', 'Page Icon', 'image', "Step 8: Verify Page icon changed to 'honda_integra'", page_icon_image_name='honda_integra')
        ...
        time.sleep(1)
        verify_panel_data('Panel 1', 'P292', '10')
        ...
        portal_properties.edit_input_control('page', 'Page Icon', 'checkbox', checkbox_input='check', msg='Step 8:')
        portal_properties.edit_input_control('page', 'Change Image', 'button')
        portal_misobj.open_file_from_repostitory_window(BIP_Portal_Path, 'babydeer', file_type='JPEG (*.jpg;*.jpeg;*.jpe)')
        portal_properties.verify_input_control('page', 'Page Icon', 'image', "Step 14: Verify Page icon changed to 'babydeer'", page_icon_image_name='babydeer')
