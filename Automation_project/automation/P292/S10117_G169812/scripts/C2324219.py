...
from common.pages import wf_mainpage,visualization_resultarea,vfour_portal_ribbon,vfour_portal_canvas, wf_legacymainpage
...
class C2324219_TestClass(BaseTestCase):
    ...
    def test_C2324219(self):
        ...
        if utiliobj.parseinitfile('nodeid') in ('wfinst01','wfinst02','wfinst03','wfinst05'):
        ...
        resultobj.wait_for_property("#topBannerMenuBox #SignoffBannerBtn",1,string_value='Sign Out')
        time.sleep(15)
        ...
        '''
        menus=['autodevuser43', 'Tools', 'Administration', 'Resources', 'Help', 'Close', 'Sign Out']
        ...
        '''
        v4p_ribbon.bip_save_and_exit('Yes')
        time.sleep(2)
        utiliobj.switch_to_window(0)
        time.sleep(3)
