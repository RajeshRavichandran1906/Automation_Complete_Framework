...
from common.pages import visualization_resultarea, wf_mainpage, vfour_portal_canvas, wf_legacymainpage, vfour_portal_run
...
class C2324267_TestClass(BaseTestCase):
    ...
    def test_C2324267(self):
        ...
        """
        wf_mainpageobj.select_menu('Domains', 'View->Display By Name')
        ...
        utillobj.verify_popup(css,'Step 4: Verify that you get an error message stating that you have illegal characters',caption_css=cap_css,caption_text=cap_txt,popup_text_css=pop_css,popup_text=pop_txt)
        ...
        time.sleep(2)
        wf_mainpageobj.verify_repositery_item(folder_path+'->BIP_V4_Portal','testing_change_name.prtl', msg='5')
        ...
        time.sleep(2)
        portal_canvas.verify_page_in_navigation_bar('Page 1', "Step 6: Verify portal opened without any error.")
        portal_run.select_or_verify_portal_menu_bar_item(select='Close')
        parent_css = "#PortalResourcevBOX table tr td"
        resultobj.wait_for_property(parent_css, 1, expire_time=50, string_value="Domains", with_regular_exprestion=True)
        
        """ Step 7: Right Click on tagCloud chart and choose Change name
        ...
        time.sleep(2)
        wf_mainpageobj.verify_repositery_item(folder_path+'->BIP_V4_Portal','tagCloud_change_name.fex', msg='7')
        
        """ Step 8: Right click on the IA_Chart1 and choose properties
        ...
        time.sleep(2)
        wf_mainpageobj.verify_repositery_item('P292->S10117->BIP_V4_Portal','IA_Chart1_1_1.fex', msg='8')
        time.sleep(1)
        
        """ Step 9: Right Click on the Content node and choose View by title
        """
        wf_mainpageobj.select_menu('Domains', 'View->Display By Title')
