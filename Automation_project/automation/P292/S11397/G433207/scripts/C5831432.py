...
class C5831432_TestClass(BaseTestCase):

    def test_C5831432(self):
        ...
        """
        Step 4:Check Personal and Shared tags
        Verify only 'Report1', 'Report2', 'Report3', 'ReportA (advanced user)' and 'ReportB (advanced user)' are listed under Items.
        """
        homepage.check_tags_in_homepage("Shared")
        time.sleep(2)
        homepage.check_tags_in_homepage("Personal")
        time.sleep(2)
        homepage.verify_items_in_grid_view(['Report1', 'Report2', 'Report3', 'ReportA (advanced user)', 'ReportB (advanced user)'],'asequal',msg="Step 04:Verify only 'Report1', 'Report2', 'Report3', 'ReportA (advanced user)' and 'ReportB (advanced user)' are listed under Items.")
        
        """
        Step 5: Un-check Personal and Shared tags
        ...
        homepage.check_tags_in_homepage("Personal")
        time.sleep(2)
        homepage.verify_items_in_grid_view(['Chart1', 'Chart2', 'Report1', 'Report2', 'Report3', 'ReportA (advanced user)', 'ReportB (advanced user)'],'asequal',msg="Step 05:Verify all items are displayed related to Search string (*) set under domain HOME-1091.")
