...
class C5831425_TestClass(BaseTestCase):

    def test_C583145(self):
        ...
        """
        main_page.verify_items_in_grid_view(['ReportA (advanced user)', 'ReportB (advanced user)', 'Visual1 (advanced user)'], 'asequal', "Step 4.1 : Verify only 'ReportA (advanced user)', 'ReportB (advanced user)' and 'Visual1 (advanced user)' items appear.")
