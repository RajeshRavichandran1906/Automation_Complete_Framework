...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/8792400
Test case Name =  Search for portal - lower case
'''
import unittest
...
class C8792400_TestClass(BaseTestCase):
    def test_C8792400(self):
        """ Testcase objects"""
