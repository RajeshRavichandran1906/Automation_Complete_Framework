...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667777
TestCase Name = Verify new Theme from Templates with multipage
'''
import unittest
...
class C6667777_TestClass(BaseTestCase):

    def test_C6667777(self):
        
        Test_Case_ID = "C6667777"
        driver = self.driver
        ...
        utillobj.invoke_infoassist_api_login('document','ibisamp/car','P292_S11397/G512951', 'mrid', 'mrpass')
        resultobj.wait_for_property("#iaCanvasCaptionLabel", 1, expire_time=80, string_value='Document')  
        ...
        exp_item_list=['Dark.sty', 'Flat.sty', 'Infographic.sty', 'Warm.sty']
        ...
        #ia_resultobj.create_report_data_set('TableChart_1', 10, 3, 'C6667777_Ds01.xlsx')
        ia_resultobj.verify_report_data_set('TableChart_1', 10, 3, 'C6667777_Ds01.xlsx', 'Step 08b: Verify Preview report dataset')
        ...
        #utillobj.create_data_set('ITableData0', 'I0r', 'C6667777_Ds02.xlsx')
        utillobj.verify_data_set('ITableData0', 'I0r', 'C6667777_Ds02.xlsx', 'Step 10c: Verify data.')
...
#         ia_resultobj.create_report_data_set('TableChart_2', 15, 2, 'C6667777_Ds03.xlsx')
        ia_resultobj.verify_report_data_set('TableChart_2', 15, 2, 'C6667777_Ds03.xlsx', 'Step 13b: Verify Preview report dataset', no_of_cells=2)
        ...
        utillobj.verify_data_set('ITableData0', 'I0r', 'C6667777_Ds02.xlsx', 'Step 15c: Verify data.')
        ...
        #utillobj.create_data_set('ITableData1', 'I1r', 'C6667777_Ds04.xlsx')
        utillobj.verify_data_set('ITableData1', 'I1r', 'C6667777_Ds04.xlsx', 'Step 16c: Verify data.')
        utillobj.switch_to_default_content()
         
        """    17. Click "IA" > "Save".    """
        """    18. Enter Title = "C6667777".    """
        """    19. Click "Save".    """
        ...
        """    21. Reopen saved FEX: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS10006%2FC6667777.fex&tool=Document    """
        utillobj.infoassist_api_edit_(Test_Case_ID, 'document', 'P292_S11397/G512951',mrid='mrid', mrpass='mrpass')
