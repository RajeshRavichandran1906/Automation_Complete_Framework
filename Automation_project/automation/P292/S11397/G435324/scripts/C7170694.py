...
TestCase Name = Portal View - Verify Type drop down options
'''
...
class C7170694_TestClass(BaseTestCase):

    def test_C7170694(self):
        ...
        matching_list=['Any','Collaborative Portal','Basic Portal']
        ...
        2.Collaborative Portal and 
        3.Basic Portal.
        
        """
        main_page_obj.type_dropdown_in_advanced_folder_search(verify_selected='Any', verify_list_options=matching_list,label_text='Type',
                                                              comparision_type='asequal',step_number='4')
