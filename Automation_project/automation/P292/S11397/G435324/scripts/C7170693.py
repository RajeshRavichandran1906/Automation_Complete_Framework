...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/7170693
TestCase Name = Portal View - Verify Search drop down options
'''
...
class C7170693_TestClass(BaseTestCase):

    def test_C7170693(self):
