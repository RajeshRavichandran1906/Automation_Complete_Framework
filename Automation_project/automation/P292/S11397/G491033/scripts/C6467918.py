...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6467918
TestCase Name = Verify what Side Bar options show / are functional for Basic Users
'''
...
class C6467918_TestClass(BaseTestCase):

    def test_C6467918(self):
        
        """
        TESTCASE VARIABLES
        """
        
        Test_Case_ID = 'C6467918'
        long_wait = 90
        medium_wait = 45
        short_wait = 30
        ...
        """
        Step01: Verify what Side Bar options show / are functional for Basic Users
        ...
        utillobj.verify_picture_using_sikuli("ask_webfocus.png", "Step01.2d: Verify Ask WebFOCUS image is displayed")
        ...
        tree_collapse_status = driver.find_element_by_css_selector("div.tree-collapse-button").is_displayed()
        utillobj.asequal(True, tree_collapse_status, "Step02.2.2b: Verify tree collapse button displays in grid view")
        ...
        verify_list(expected_portals, item_css, 'asin', "Step06.2b: Verify V4 portal is listed")
        ...
        """
        Step10: Click Content from sidebar > Retail Samples > Reports > Right click on "Margin by Product Category" > Add to Favorites.
        ...
        wfmain_obj.right_click_folder_item_and_select_menu("Margin by Product Category", 'Add to Favorites', 'Retail Samples->Reports')
        ...
        verify_list(expected_favorites, item_css, 'asListEqual', "Step11.2b: Verify Margin by Product Category report in grid view")
        ...
        verify_list(expected_favorites, list_item_css, 'asListEqual', "Step12.1e: Verify Margin by Product Category report in list view")
...
#         utillobj.verify_picture_using_sikuli("list_view.png", "Step13.1b: Verify list view image displayed when grid view is selected")
        ...
        verify_list(expected_favorites, item_css, 'asListEqual', "Step13.2b: Verify Margin by Product Category report in grid view")
           
        """
        Step14: Right Click on "Margin by Product Category" > Click Remove favorite.
        ...
        wfmain_obj.right_click_folder_item_and_select_menu("Margin by Product Category", 'Remove from Favorites')
        utillobj.synchronize_with_visble_text(".files-box-files .ibx-label-text", "Your Favorites will appear here", medium_wait)
        verify_list(expected_favorites, item_css, 'asnotin', "Step14.1: Verify Margin by Product Category report not in grid view")
           
        """
        Click Ask WebFOCUS from the sidebar.
        ...
        """
        Step16: Click on the Collapse side bar icon.
        ...
        utillobj.verify_picture_using_sikuli("collapse_content.png", "Step16.2a: Verify content image is displayed")
        utillobj.verify_picture_using_sikuli("collapse_portal.png", "Step16.2b: Verify portals image displayed")
        utillobj.verify_picture_using_sikuli("collapse_favourites.png", "Step16.2c: Verify favorites image is displayed")
        ...
        """
        Step17: Sign Out and Sign back into WebFOCUS Home Page as Basic User.
        ...
        wfmain_obj.verify_left_panel([], "Step17.1: Verify Side bar(left panel) options shows description for each option",'')
        ...
        """
        Step18: Revert back the Home Page by its default state.
        """
        ...
        """
        Step19: Sign Out WebFOCUS Home Page.
        """
        wfmain_obj.signout_from_username_dropdown_menu()
