...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6467919
...
class C6467919_TestClass(BaseTestCase):

    def test_C6467919(self):
        ...
        wfmain_obj.verify_grid_view_title_labels(expected_label_content_files_list, "Step02.2.2a: Verify content title label files")
        ...
        """
        Step06: Click Portals from the sidebar and Click "P292_S10660" and "Retail Samples" tags at the top of the content area.
        Verify content area displayed in grid view with the portals (Retail Samples and V4 Portal) available for selected tags (P292_S10660 and Retail Samples),
        """
        ...
        verify_list(expected_portals, item_css, 'asin', "Step08.2b: Verify Retail samples and V4 portal")
        ...
        wfmain_obj.right_click_folder_item_and_select_menu("Quantity Sold By Stores", 'Add to Favorites', folder_path='Retail Samples->Reports')
        ...
        verify_list(expected_favorites, item_css, 'asin', "Step11.2b: Verify Quantity Sold By Stores report in grid view")
        ...
        verify_list(expected_favorites, list_item_css, 'asin', "Step12.1e: Verify Quantity Sold By Stores report in list view")
        ...
        verify_list(expected_favorites, item_css, 'asin', "Step13.2b: Verify Quantity Sold By Stores report in grid view")
        ...
        """
        Step15: Click Ask WebFOCUS from the sidebar.
        ...
        """
        Step17: In the banner link, click on the top right username > Click Sign Out and Sign back into WebFOCUS Home Page as Developer User.
