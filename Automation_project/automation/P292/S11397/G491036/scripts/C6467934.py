...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6467934
TestCase Name = Verify Open item location for Portals W/ Dev user
'''
...
class C6467934_TestClass(BaseTestCase):

    def test_C6467934(self):
        ...
        """
        wfmain_obj.verify_repository_folder_item_context_menu(expected_portals[0], context_menu_options, msg="Step 03", comparision_type='asnotin')
        ...
        """
        wfmain_obj.verify_repository_folder_item_context_menu(expected_portals[1], context_menu_options, msg="Step 04", comparision_type='asin')
        coreutil_obj.python_left_click(utillobj.validate_and_get_webdriver_object(".main-panel .left-main-panel","left panel"))
        ...
        wfmain_obj.verify_repository_folder_item_context_menu(retail_sample_item, context_menu_options, msg="Step 08", comparision_type='asnotin')
