...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157208
...
class C6157208_TestClass(BaseTestCase):

    def test_C6157208(self):
