...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157191
Test Case Title =  Adding optional other static single-select dropdown control to the Page
-----------------------------------------------------------------------------------------------"""
...
class C6157191_TestClass(BaseTestCase):

    def test_C6157191(self):
