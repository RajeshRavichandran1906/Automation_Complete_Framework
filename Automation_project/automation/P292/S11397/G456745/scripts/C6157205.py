...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157205
...
class C6157205_TestClass(BaseTestCase):

    def test_C6157205(self):
