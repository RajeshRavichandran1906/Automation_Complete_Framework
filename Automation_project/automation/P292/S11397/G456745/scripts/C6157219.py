...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157219
Test Case Title =  Adding required static checkbox control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C6157219_TestClass(BaseTestCase):

    def test_C6157219(self):
        ...
        EXPECTED_CONTAINERS=['25 - Multi-Select Static Required']
        EXPECTED_FILTER_CONVERTER_CONTROLS=['Checkbox', 'Button set']
        EXPECTED_FILTER_CHECKBOX_OPTIONS=['South America', 'EMEA', 'North America']
        ...
        """
            STEP 04 : Drag "25 - Multi-Select Static Required" report into the page canvas from P292_S10660 > G433312 > Reference Items folder.
        """
        ...
        pd_design.verify_filter_dropdown_is_not_optional(FILTER_CONTRTOL_NAME, 'Step 05.04 : Verify filter control bounded to the page with solid red border.')
        pd_design.verify_selected_value_of_filter_dropdown(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_FILTER_DROPDOWN_VALUE, 'Step 05.05 : Verify default filter drop down value')
        ...
        """
            STEP 07.1 : Verify dropdown control converted to checkbox control and solid red border retained over the control.
        """
        ...
        pd_design.verify_filter_checkbox_is_not_optional(FILTER_CONTRTOL_NAME, 'Step 07.03 : Verify filter checkbox control is optional')
        ...
        pd_design.verify_selected_options_in_filter_checkbox(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_FILTER_VALUE, 'Step 07.05 : Verify no option selected as default in filter check box control')
        ...
        """
            STEP 08 : Right click filter control (right click over filter control label or checkbox group, else grid cell will be selected) and select Settings.
        """
        ...
        """
            STEP 09.1 : Verify page loads successfully in preview with required checkbox control.
        """
        ...
        pd_preview.verify_filter_checkbox_is_not_optional(FILTER_CONTRTOL_NAME, 'Step 09.06 : Verify filter checkbox control is optional')
        ...
        pd_preview.verify_selected_options_in_filter_checkbox(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_FILTER_VALUE, 'Step 09.08 : Verify no option selected as default in filter check box control')
        ...
        pd_preview.verify_default_output_for_input_required_container(CONTAINER_ITEM, 'Step 09.12 : Verify page loads successfully in preview with required checkbox control')
       
        """
            STEP 10 : Check "North America" value in filter control.
        """
        ...
        """
        pd_preview.verify_filter_checkbox_is_optional(FILTER_CONTRTOL_NAME, 'Step 10.01 : Verify solid red border over filter the control removed')
        pd_preview.verify_filter_checkbox_options(FILTER_CONTRTOL_NAME, EXPECTED_FILTER_CHECKBOX_OPTIONS, 'Step 10.02 : Verify {0} options are display in filter check box control'.format(EXPECTED_FILTER_CHECKBOX_OPTIONS))
        pd_preview.verify_selected_options_in_filter_checkbox(FILTER_CONTRTOL_NAME, FILTER_CHECKBOX_OPTIONS_TO_SELECT, 'Step 10.03 : Verify {0} option selected in filter check box control'.format(FILTER_CHECKBOX_OPTIONS_TO_SELECT))
        pd_preview.switch_to_container_frame(CONTAINER_ITEM)
        pd_preview.wait_for_visible_text("table[summary]>tbody>tr:nth-child(2)>td:first-child", 'North America', time_out=LONG_TIME)
        #pd_preview.create_html_report_data_set(DATA_SET_NAME1)
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 10.04 : Verify selected condition applied in the page')
        ...
        """
            STEP 13.1 : Verify page runs successfully with required (solid red border around the control) checkbox control.
        """
        ...
        pd_run.verify_filter_checkbox_is_not_optional(FILTER_CONTRTOL_NAME, 'Step 13.04 : Verify filter check box control is optional in run page')
        ...
        pd_run.verify_selected_options_in_filter_checkbox(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_FILTER_VALUE, 'Step 13.06 : Verify no option selected as default in filter check box control')
        ...
        pd_run.verify_default_output_for_input_required_container(CONTAINER_ITEM, 'Step 13.10 : Verify page loads successfully in preview with required checkbox control')
        pd_run.swtich_to_homepage_runwindow_frame()
        ...
        """
            STEP 14.1 : Verify selected condition applied in the page and solid red border removed from the control.
        """
        pd_run.verify_filter_checkbox_is_optional(FILTER_CONTRTOL_NAME, 'Step 14.01 : Verify solid red border over filter the control removed')
        pd_run.verify_filter_checkbox_options(FILTER_CONTRTOL_NAME, EXPECTED_FILTER_CHECKBOX_OPTIONS, 'Step 14.02 : Verify {0} options are display in filter check box control'.format(EXPECTED_FILTER_CHECKBOX_OPTIONS))
        pd_run.verify_selected_options_in_filter_checkbox(FILTER_CONTRTOL_NAME, FILTER_CHECKBOX_OPTIONS_TO_SELECT, 'Step 14.03 : Verify {0} option selected in filter check box control'.format(FILTER_CHECKBOX_OPTIONS_TO_SELECT))
        pd_run.switch_to_container_frame(CONTAINER_ITEM)
        pd_run.wait_for_visible_text("table[summary]>tbody>tr:nth-child(2)>td:first-child", 'EMEA', time_out=LONG_TIME)
        #pd_run.create_html_report_data_set(DATA_SET_NAME2)
        pd_run.verify_html_report_data_set(DATA_SET_NAME2, 'Step 14.04 : Verify selected condition applied in the page')
