...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157215
...
class C6157215_TestClass(BaseTestCase):

    def test_C6157215(self):
        ...
        """
        pd_preview.verify_selected_options_in_filter_radio_group(FILTER_CONTRTOL_NAME,  [FILTER_RADIOGROUP_OPTIONS_TO_SELECT], 'Step 10.01 : Verify {0} option selected in filter radio group'.format([FILTER_RADIOGROUP_OPTIONS_TO_SELECT]))
