...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157204
Test Case Title =  Adding required dynamic single-select button set control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C6157204_TestClass(BaseTestCase):

    def test_C6157204(self):
