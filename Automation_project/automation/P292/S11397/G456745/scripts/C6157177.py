...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157177
...
class C6157177_TestClass(BaseTestCase):

    def test_C6157177(self):
        ...
        pd_run.verify_default_output_for_input_required_container(CONTAINER_ITEM, 'Step 10.09 : Verify report display in run page')
