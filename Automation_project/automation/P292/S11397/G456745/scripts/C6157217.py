...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157217
...
class C6157217_TestClass(BaseTestCase):

    def test_C6157217(self):
