...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157207
...
class C6157207_TestClass(BaseTestCase):

    def test_C6157207(self):
