...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157199
Test Case Title =  Adding optional dynamic multi-select dropdown control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C6157199_TestClass(BaseTestCase):

    def test_C6157199(self):
