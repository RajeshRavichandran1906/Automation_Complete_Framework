...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157178
...
class C6157178_TestClass(BaseTestCase):

    def test_C6157178(self):
