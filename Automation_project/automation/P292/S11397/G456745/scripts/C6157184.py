...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157184
Test Case Title =  Adding optional date control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C6157184_TestClass(BaseTestCase):

    def test_C6157184(self):
        ...
        EXPECTED_CONTAINERS=['14 - Date Optional All']
        ...
        """
            STEP 04 : Drag "14 - Date Optional All" report into the page canvas from P292_S10660 > G433312 > Reference Items folder.
        """
        ...
        """
            STEP 05.1 : Verify date filter control bounded to the page with red dotted border.
        """
        ...
        """
            STEP 07.1 : Verify page loads successfully with Date filter control in preview.
        """
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 07.11 : Verify page loads successfully with Date filter control in preview')
        ...
        """
            STEP 11.1 : Verify page runs successfully with Date filter control.
        """
        ...
        pd_run.verify_selected_date_in_filter_date_picker(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_DATE_FILTER_VALUE, 'Step 11.05 : Verify no date selected as default in date filter control')
        ...
        """
            STEP 12.1 : Verify filter condition applied in the page.
        """
