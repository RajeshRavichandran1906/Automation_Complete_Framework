...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157218
...
class C6157218_TestClass(BaseTestCase):

    def test_C6157218(self):
