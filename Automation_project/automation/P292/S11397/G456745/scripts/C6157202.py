...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157202
...
class C6157202_TestClass(BaseTestCase):

    def test_C6157202(self):
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 09.13 : Verify page loads successfully with "All" filter condition')
