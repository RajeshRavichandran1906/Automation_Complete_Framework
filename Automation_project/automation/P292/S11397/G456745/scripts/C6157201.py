...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157201
...
class C6157201_TestClass(BaseTestCase):

    def test_C6157201(self):
