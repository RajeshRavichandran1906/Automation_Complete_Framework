...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157193
Test Case Title =  Adding optional dynamic single-select dropdown control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C6157193_TestClass(BaseTestCase):

    def test_C6157193(self):
        ...
        EXPECTED_FILTER_DROPDOWN_OPTIONS=['All', 'EMEA', 'North America', 'Oceania', 'South America']
        ...
        """
            STEP 07.1 : Verify page loads successfully in preview with "All" filter condition.
        """
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 07.11 : Verify page loads successfully in preview with "All" filter condition')
        pd_preview.switch_to_default_page()
       
        """
            STEP 08 : Select "North America" value in dropdown.
        """
        ...
        pd_preview.verify_selected_value_of_filter_dropdown(FILTER_CONTRTOL_NAME, [FILTER_DROPDOWN_SELECTION_OPTION], 'Step 08.02 : Verify {0} option selected in filter drop down'.format(FILTER_DROPDOWN_SELECTION_OPTION))
        ...
        """
            STEP 11.1 : Verify page runs successfully with "All" filter condition.
        """
        ...
        pd_run.verify_filter_dropdown_is_optional(FILTER_CONTRTOL_NAME, 'Step 11.04 : Verify {0} drop down control is optional in run page'.format(FILTER_CONTRTOL_NAME))
        pd_run.verify_selected_value_of_filter_dropdown(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_FILTER_DROPDOWN_VALUE, 'Step 11.05 : Verify {0} option selected as default in filter drop down'.format(EXPECTED_DEFAULT_FILTER_DROPDOWN_VALUE))
        ...
        pd_run.verify_html_report_data_set(DATA_SET_NAME1, 'Step 11.09 : Verify page runs successfully with "All" filter condition')
