...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157221
Test Case Title =  Adding optional static checkbox control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C6157221_TestClass(BaseTestCase):

    def test_C6157221(self):
        ...
        """
            STEP 07.1 : Verify dropdown control converted to checkbox control with default value selected.
        """
        ...
        """
            STEP 10 : Select "North America" value and uncheck "EMEA" value in checkbox control.
        """
        FILTER_CHECKBOX_OPTIONS_TO_SELECT = ['North America', 'EMEA']
        ...
        """
        pd_preview.verify_selected_options_in_filter_checkbox(FILTER_CONTRTOL_NAME, ['North America'], 'Step 10.01 : Verify {0} option selected in filter check box control'.format(FILTER_CHECKBOX_OPTIONS_TO_SELECT))
        pd_preview.switch_to_container_frame(CONTAINER_ITEM)
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME2, 'Step 10.02 : Verify selected condition applied in the page')
        pd_preview.switch_to_default_page()
