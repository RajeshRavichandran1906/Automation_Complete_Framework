...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157220
...
class C6157220_TestClass(BaseTestCase):

    def test_C6157220(self):
        ...
        EXPECTED_FILTER_CHECKBOX_OPTIONS=['All', 'South America', 'EMEA', 'North America']
        ...
        """
            STEP 10 : Multi-select "EMEA" and "North America" values in checkbox control.
        """
        ...
        """
            STEP 14 : Select "North America" value in checkbox control.
        """
        ...
        pd_run.switch_to_container_frame(CONTAINER_ITEM)
        pd_run.wait_for_visible_text("table[summary]>tbody>tr:nth-child(2)>td:first-child", 'North America', time_out=LONG_TIME)
