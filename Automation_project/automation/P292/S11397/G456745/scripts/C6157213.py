...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157213
...
class C6157213_TestClass(BaseTestCase):

    def test_C6157213(self):
