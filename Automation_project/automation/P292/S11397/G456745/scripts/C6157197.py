...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157197
...
class C6157197_TestClass(BaseTestCase):

    def test_C6157197(self):
