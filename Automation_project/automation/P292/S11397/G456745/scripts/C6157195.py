...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157195
...
class C6157195_TestClass(BaseTestCase):

    def test_C6157195(self):
