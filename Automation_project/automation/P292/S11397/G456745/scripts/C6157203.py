...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157203
Test Case Title =  Adding optional other static single-select button set control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C6157203_TestClass(BaseTestCase):

    def test_C6157203(self):
        ...
        pd_run.verify_html_report_data_set(DATA_SET_NAME2, 'Step 14.02 : Verify selected North America condition applied in the page')
        pd_run.switch_to_default_page()
