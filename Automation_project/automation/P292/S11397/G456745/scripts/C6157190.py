...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157190
...
class C6157190_TestClass(BaseTestCase):

    def test_C6157190(self):
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 07.12 : Verify all values are available')
