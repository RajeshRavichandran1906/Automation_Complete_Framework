...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157181
...
class C6157181_TestClass(BaseTestCase):

    def test_C6157181(self):
