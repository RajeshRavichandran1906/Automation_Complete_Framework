...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157216
Test Case Title =  Adding required dynamic radio button control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C6157216_TestClass(BaseTestCase):

    def test_C6157216(self):
        ...
        pd_design.verify_filter_dropdown_is_not_optional(FILTER_CONTRTOL_NAME, 'Step 05.03 : Verify filter drop down control bounded to the page with solid red border around it')
        ...
        pd_design.verify_filter_radio_group_is_not_optional(FILTER_CONTRTOL_NAME, 'Step 07.03 : Verify filter radio group control bounded to the page with solid red border around it')
        ...
        pd_preview.verify_filter_radio_group_is_not_optional(FILTER_CONTRTOL_NAME, 'Step 09.06 : Verify filter radio group control bounded to the page with solid red border around it')
        ...
        pd_run.verify_filter_radio_group_is_not_optional(FILTER_CONTRTOL_NAME, 'Step 13.04 : Verify filter radio group control bounded to the page with solid red border around it')
