...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157194
...
class C6157194_TestClass(BaseTestCase):

    def test_C6157194(self):
