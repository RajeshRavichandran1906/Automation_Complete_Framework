...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6157214
...
class C6157214_TestClass(BaseTestCase):

    def test_C6157214(self):
