...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6522018
TestCase Name = Verify Global Resources folder under resource tree for Advanced user
'''
...
class C6522018_TestClass(BaseTestCase):

    def test_C6522018(self):
