...
class C2333392_TestClass(BaseTestCase):
    ...
    def test_C2333392(self):
        ...
        propertyobj.verify_slider_range_filter_prompts('#ar_Prompt_1','min','2015/01/01','str',msg="Step08: Verify filter prompt range values- min")
        propertyobj.verify_slider_range_filter_prompts('#ar_Prompt_1','max','2017/03/19','str',msg="Step08: Verify filter prompt range values- max")
        ...
        if browser != 'Firefox':
            ...
            time.sleep(10)
        propertyobj.verify_slider_range_filter_prompts('#sliderPROMPT_1','min','2015/01/01','str',msg="Step10: Verify filter prompt range values- min")
        ...
        propertyobj.verify_slider_range_filter_prompts('#ar_Prompt_1','min','2015/01/01','str',msg="Step16: Verify filter prompt range values- min")
        ...
        time.sleep(5)        
        propertyobj.verify_slider_range_filter_prompts('#ar_Prompt_1','min','2015/01/01','str',msg="Step18: Verify filter prompt range values- min")
        propertyobj.verify_slider_range_filter_prompts('#ar_Prompt_1','max','2017/03/19','str',msg="Step18: Verify filter prompt range values- max")
        time.sleep(2)
        ...
        if browser != 'Firefox':
            driver.maximize_window()
        time.sleep(10)    
        propertyobj.verify_slider_range_filter_prompts('#sliderPROMPT_1','min','2016/03/29','str',msg="Step22: Verify filter prompt range values- min")
        propertyobj.verify_slider_range_filter_prompts('#sliderPROMPT_1','max','2017/03/19','str',msg="Step22: Verify filter prompt range values- max")
        time.sleep(2)
