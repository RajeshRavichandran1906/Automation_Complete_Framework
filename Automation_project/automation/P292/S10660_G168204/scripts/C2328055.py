...
class C2328055_TestClass(BaseTestCase):
    ...
    def test_C2328055(self):
        ...
        """
            Step 01 : Run fex IA API with chart in run mode (edit the domain, port and alias of the URL - do not use the URL as is):
            http://domain:port/alias/run.bip?BIP_REQUEST_TYPE=BIP_RUN&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FS10660&BIP_item=C2328055a.fex
        """
        ...
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "annotation", expected_tooltip_list, "Step 03:01: Verify Salary bar value")
        ...
        utillobj.click_on_screen(annotation_obj, coordinate_type='middle', click_type=0)
        time.sleep(3)
        ...
        """
            Step 08 : Run fex IA API with chart in run mode (edit the domain, port and alias of the URL - do not use the URL as is):
            http://domain:port/alias/run.bip?BIP_REQUEST_TYPE=BIP_RUN&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FS10660&BIP_item=C2328055b.fex
        """
        ...
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "annotation", expected_tooltip_list, "Step 10:01: Verify Salary bar value")
        ...
        utillobj.asequal('logo',alternate_text,'Step 13: Verify Information Builders Web page is displayed in a new window (or tab)')
        time.sleep(8)
