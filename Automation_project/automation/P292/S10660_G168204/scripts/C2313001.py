...
class C2313001_TestClass(BaseTestCase):
    ...
    def test_C2313001(self):
        ...
        """
        Step 01: Open existing visualization (created in previous test case) in design mode "Continue from previous testcase: C2313000"
        http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS8979%2FC2313000.fex&tool=idis
        """
        ...
        time.sleep(3)
        resultobj.select_or_verify_lasso_filter(verify=['1 point','Filter Chart','Exclude from Chart','Edit group PRODUCT_CATEGORY_1','Rename group PRODUCT_CATEGORY_1','Rename Accessories and Computers...','Ungroup Accessories and Computers...','Ungroup All'],msg='Step 02: Expect to see the options appear in the tooltip (in addition the filter options):')
