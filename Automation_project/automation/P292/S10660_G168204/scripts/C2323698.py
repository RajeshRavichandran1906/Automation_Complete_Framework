...
class C2323698_TestClass(BaseTestCase):


    def test_C2323698(self):
        driver = self.driver #Driver reference object created
        
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2323698'
        ...
        """
            Step 02: Format > Chart Type > Other > Line Charts > Horizontal Dual-axis Stacked Line Chart.
        """
        ...
        """
            ...
            Horizontal Dual-axis Stacked Line Chart Preview...
        """
        ...
        ia_resultarea_obj.verify_number_of_chart_segment('TableChart_1', 4, 'Step 03.07: Verify Number of riser', custom_css="path[class^='riser']")
        ...
        """
            ...
            Hover over the left point (Dealer_Cost) for Alfa Romeo.
            Hover over the right point(Width) for Alfa Romeo.
        """
        time.sleep(2)
        ...
        """
            ...
            Horizontal Dual-axis Stacked Line Chart, including Tool tip information.
        ...
        parent_obj = driver.find_element_by_css_selector("#jschart_HOLD_0 [class='marker!s0!g0!mmarker!']")
        ...
        parent_obj = driver.find_element_by_css_selector("#jschart_HOLD_0 [class='marker!s3!g0!mmarker!']")
        utillobj.click_on_screen(parent_obj,'middle', javascript_marker_enable=True, mouse_duration=2.5)
        time.sleep(3)
        ...
        """
            ...
            Horizontal Dual-axis Stacked Line Chart, now with the chart reflecting colors using the Color By bucket.
            Note that the Legend contains one entry for each of the 4 Measures.
        ...
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "marker!s0!g0!mmarker!", expected_tooltip_list, "Step 05:07: Hover over the third from the top point (Dealer_Cost) for Alfa Romeo")
        parent_obj = driver.find_element_by_css_selector("#jschart_HOLD_0 [class='marker!s3!g0!mmarker!']")
        utillobj.click_on_screen(parent_obj,'middle', javascript_marker_enable=True, mouse_duration=2.5)
        time.sleep(3)
        expected_tooltip_list=['CAR:ALFA ROMEO', 'WIDTH:188', 'SEATS:8']
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "marker!s3!g0!mmarker!", expected_tooltip_list, "Step 05:08: Hover over the bottom point(Width) for Alfa Romeo")
        ...
        """
            Expect to see the following
            Horizontal Dual-axis Stacked Line Chart.
        ...
        """
            Verification :
            Expect to see the following
            Horizontal Dual-axis Stacked Line Chart, now with additional Tool tip information for MPG.
            Dealer_Cost bar uses the left-side axis:
        """
        ribbonobj.select_top_toolbar_item('toolbar_run')
        time.sleep(5)
        ...
        """
            Step 08: Save with name C2323698 and close.
        """
        ...
        """
           ...
           http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10660%C2323698.fex
        ...
        expected_color_scale=['SEATS', '2', '8.8', '15.5', '22.3', '29']
        ia_resultarea_obj.verify_color_scale_esri_maps("TableChart_1", expected_color_scale, "Step 09:02 : Verify the color scale values")
        ia_resultarea_obj.verify_number_of_chart_segment('TableChart_1', 4, 'Step 09:03: Verify Number of riser', custom_css="path[class^='riser']")
        expected_data_labels=['0', '400', '800', '1,200', '1,600']
        resultobj.verify_data_labels('TableChart_1', expected_data_labels, "Step 09:04 : Verify data labels right side x labels", custom_css="g.chartPanel text[class*='y2axis-labels!']")
        time.sleep(1)
        resultobj.verify_xaxis_title("TableChart_1", 'CAR', "Step 09:05: Verify X-Axis Title")
        exected_multicolor_list=['sandy_brown', 'sorbus1','elf_green','cinnabar3','crusta1','cinnabar3','persian_red','sorbus1','cinnabar3','persian_red']
        ia_resultarea_obj.verify_multicolor("#TableChart_1", "fill", exected_multicolor_list, "Step 09:06: Veirfy line colors")
        utillobj.infoassist_api_logout()
        time.sleep(3)
