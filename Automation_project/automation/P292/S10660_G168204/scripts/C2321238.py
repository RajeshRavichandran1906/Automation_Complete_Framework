...
class C2321238_TestClass(BaseTestCase):
    ...
    def test_C2321238(self):
        ...
        legend_css="#TableChart_1 [class*='legend']"
        ...
        """
            Step 07 : Save with name C2321238 and close.
        """
        utillobj.switch_to_default_content(pause=1)
        time.sleep(2)
        ...
        """
            ...
            http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10660%C2321238.fex
        """
