...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2319019
...
class C2319019_TestClass(BaseTestCase):

    def test_C2319019(self):
        ...
        time.sleep(6)
        resultobj.select_or_verify_lasso_filter(verify=['1 point', 'Filter Chart', 'Exclude from Chart','Group Product,Category Selection'],msg='Step 04: Expect to see the Right-click options appear')
        ...
        time.sleep(5)
        resultobj.select_or_verify_lasso_filter(verify=['2 points', 'Filter Chart', 'Exclude from Chart', 'Group Product,Category Selection'],msg='Step 08: Expect to see the Right-click options appear')
        resultobj.select_or_verify_lasso_filter(select='Filter Chart')
        ...
        if browser in ['Firefox','Chrome']:
            ...
            ActionChains(self.driver).move_to_element(parent_elem).perform()
            parent_elem.click()
        ...
        """
        Step 16: Click "Save" > Save as "C2319019" > click Save
        """
        time.sleep(2)
        ...
        """
        Step 18: Reopen fex using IA API: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS8979%2FC2319019.fex&tool=idis
        """
        ...
        utillobj.take_screenshot(ele,'C2319019_Actual_step20', image_type='actual',x=1, y=1, w=-1, h=-1)       
