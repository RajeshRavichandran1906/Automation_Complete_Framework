...
from common.pages import visualization_metadata, visualization_resultarea, visualization_ribbon, wf_mainpage
...
class C2336134_TestClass(BaseTestCase):
    ...
    def test_C2336134(self):
        ...
        wf_mainpage_obj.select_repository_folder_item_menu('P292->S10660_chart_2', Test_Case_ID, 'Edit with text editor')
