...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2334338
Test case Name =  Chart - Basemaps configured in server 
'''
import unittest
...
class C2334338_TestClass(BaseTestCase):

    def test_C2334338(self):
...
#         utillobj.infoassist_api_edit('a', 'chart', 'P292/S10032', mrid='mrid', mrpass='mrpass')
        ...
        """    2. Format > Chart Type > ESRI Choropleth,    """
        ...
        defcss="#pfjTableChart_1 circle[class^='riser!s0!g42!mregion!']"
        visualization_resultarea.Visualization_Resultarea.wait_for_property(self, defcss, 1,expire_time=25)
        ...
        defcss="#jschart_HOLD_0 circle[class^='riser!s0!g42!mregion!']"
        visualization_resultarea.Visualization_Resultarea.wait_for_property(self, defcss, 1,expire_time=25)
        topomap_css="#jschart_HOLD_0 div img[class^='layerTile'][src*='World_Topo_Map']"
        ...
        """    Step 7. Click Save > enter name C2334338 > Save. Close window.    """
        ...
        visualization_resultarea.Visualization_Resultarea.wait_for_property(self, defcss, 1,expire_time=25)
        topomap_css="#jschart_HOLD_0 div img[class^='layerTile'][src*='World_Topo_Map']"
        utillobj.verify_object_visible(topomap_css, True, 'Step 8. Verify World Topographical Map displayed in runtime using API call')
        ...
        """    Step 9. Close output window. Restore chart in IA editor    """
        """    Step 10. Close IA window.   """
        utillobj.infoassist_api_logout()
        time.sleep(3)
        ...
        topomap_css="#pfjTableChart_1 div img[class^='layerTile'][src*='World_Topo_Map']"
        utillobj.verify_object_visible(topomap_css, True, 'Step 9. Verify World Topographical Map displayed in preview')
        
        
        parentcss="pfjTableChart_1"
        
        iaresult.verify_color_scale_esri_maps(parentcss, ['Revenue', '0M', '82M', '164M', '245.9M', '327.8M'], "Step 9.1")
        utillobj.verify_chart_color(parentcss, "riser!s0!g42!mregion!", 'punch', 'Step 9.2 Verify map color')
        utillobj.verify_chart_color(parentcss, "riser!s0!g50!mregion!", 'elf_green', 'Step 9.3 Verify map color')
