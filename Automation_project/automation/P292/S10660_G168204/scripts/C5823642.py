...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5823642
Filter Chart - ESRI Choropleth Map
'''
import unittest
...
class C5823642_TestClass(BaseTestCase):
    def test_C5823642(self):
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C5823642'
        ...
        utillobj.infoassist_api_login('idis','new_retail/wf_retail_lite','P292/S1660_visual_1', 'mrid', 'mrpass') 
...
#         utillobj.infoassist_api_edit(Test_Case_ID, 'idis', 'S10032_visual_2',mrid='mrid',mrpass='mrpass')
        ...
        Step10: Click Save in thetoolbar, Save as "C2158150" > Click Save
        """
        time.sleep(5)
        self.driver.close()
        time.sleep(2)
...
#         utillobj.infoassist_api_edit(Test_Case_ID, 'idis', 'S10032_visual_2',mrid='mrid',mrpass='mrpass')
        ...
        time.sleep(2)
        legend=['Revenue', '25.5M', '25.7M', '26M', '26.2M', '26.5M']
