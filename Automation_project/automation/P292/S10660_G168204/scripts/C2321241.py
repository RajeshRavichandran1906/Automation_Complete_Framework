...
class C2321241_TestClass(BaseTestCase):
    ...
    def test_C2321241(self):
        ...
        """
            ...
            Vertical Dual-axis Clustered Bar Chart Preview.
        """
        utillobj.synchronize_with_number_of_element(number_of_riser_css, 30, 15)
        ...
        time.sleep(5)
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "riser!s8!g0!mbar!", expected_tooltip_list, "Step 05:10 Verify leftbar width for alfa romeo")
        expected_tooltip_list=['CAR:ALFA ROMEO', 'WIDTH:188', 'COUNTRY:ITALY']
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "riser!s11!g0!mbar!", expected_tooltip_list, "Step 05:11 Verify rightbar width for alfa romeo")
        
        first_barobj_after=self.driver.find_element_by_css_selector("#jschart_HOLD_0 rect[class='riser!s11!g0!mbar!']")
        ...
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "riser!s8!g0!mbar!", expected_tooltip_list, "Step 06:10 Verify leftbar tooltip for alfa romeo")
        time.sleep(2)
        expected_tooltip_list=['CAR:ALFA ROMEO', 'WIDTH:188', 'SALES:30200', 'COUNTRY:ITALY']
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "riser!s11!g0!mbar!", expected_tooltip_list, "Step 06:11 Verify rightbar toolbar for alfa romeo")
        time.sleep(1)
        """
