...
#         utillobj.infoassist_api_edit(Test_Case_ID, 'chart', 'P292/S10032', mrid='mrid', mrpass='mrpass')
        ...
        pan_css="#TableChart_1 button[class$='button leaflet-control']"
        ...
        resultobj.create_lasso("TableChart_1",'path', 'riser!s0!g41!mstate!' ,offsetx='-70',offsety='70')
        time.sleep(5)
        
        resultobj.select_or_verify_lasso_filter(verify=['3 points', 'Filter Chart', 'Exclude from Chart', 'Group Store,State,Province Selection'],msg='Step 10: Verify Lasso menu')
        ...
        pan_css="#MAINTABLE_wbody1 button[class$='button leaflet-control']"
        ...
        resultobj.create_lasso("MAINTABLE_wbody1",'path', 'riser!s0!g69!mstate!' ,offsetx='650',offsety='350')
        ...
        resultobj.wait_for_property("#MAINTABLE_wbody1 path[class^='riser!s']", 31, expire_time=60)
        time.sleep(5)
        ...
        time.sleep(8)
        resultobj.wait_for_property("#TableChart_1 path[class^='riser!s0!g1!mstate!']", 1,expire_time=60)  
