...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6694058
TestCase Name = Verify multi-select optional prompting fields
'''
import unittest
...
class C6694058_TestClass(BaseTestCase):
    ...
    def test_C6694058(self):
        ...
        """    5. Select Dynamic radio button and select Product,Subcategory field in list and check Optional and Select multiple values at runtime checkboxes and click OK and OK.    """
        ...
        ia_report.select_filter_parameter_checkbox(ParamOptional=True, ParamMultiple=True)
        ia_report.select_field_in_filter_tree("Dimensions->Product->Product->Product,Subcategory", 1)
