...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/tests/view/22267156&group_by=cases:section_id&group_id=426908&group_order=asc
Test Case Title =  Check Insert section below
-----------------------------------------------------------------------------------------------"""
import unittest
...
class C5743407_TestClass(BaseTestCase):

    def test_C5743407(self):
        ...
        """
            STEP 5 : Right mouse click anywhere on the page canvas and choose 'Insert section below' menu
        """
        pd_design.select_page_section_context_menu(1, "Insert section below")

        """
            STEP 05.01 : Verify section has been inserted below and the first section has been highlighted in red dotted line as below
        """
        pd_design.verify_number_of_page_sections(2, "Step 05.01 : Verify section has been inserted")
