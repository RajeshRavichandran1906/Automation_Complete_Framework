...
@author: Robert
Testcase Name : Verify Ask WebFOCUS Side Bar option show / are functional for Developers
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2967308
'''
...
class C2967308_TestClass(BaseTestCase):
    
    def test_C2967308(self):
        """
        Test_case variables
        """
        ...
        """
        Step 3. Sign Out and Sign back into WebFOCUS Home Page as Developer User.
