...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/5825020
TestCase Name = Verify clicking on user selects only that user
'''
...
class C5825020_TestClass(BaseTestCase):

    def test_C5825020(self):
        ...
        """
        Step 4: Click on My Content folder > Right click on report1 > Share with...
        """
        ...
        """
        Step 6: Enter 'autoadvuser04' in the 'Enter users' search box > Click on 'autoadvuser04' user. 
        Verify under 'Shared with' still it shows 'autoadvuser04' name as in bold and 'autoadvuser04(auto@devmail.com)' description as in 
        normal text with x icon and 'Enter users' search box is empty
        """
