...
class C5852254_TestClass(BaseTestCase):
    ...
    def test_C5852254(self):
        ...
        """
        utility.infoassist_api_login('idis','baseapp/wf_retail_lite','P292/S10032_visual_3', 'mrid', 'mrpass')
        ...
        """
        folder_path = "P292_S10032_G157398 (Folder Name is P292 - Remain as is due to HTML pages)->S10032_visual_3->"+TESTCASE_ID
        legacy_homepage.expand_repository_tree(folder_path)
