...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5824544
...
class C5824544_TestClass(BaseTestCase):

    def test_C5824544(self):
        
        """   
                TESTCASE VARIABLES 
        """
        Test_Case_ID = 'C5824544'
        ...
        """
        utillobj.invoke_infoassist_api_login('Report','ibisamp/empdata','P292_S10863/G432775', 'mrid', 'mrpass')
