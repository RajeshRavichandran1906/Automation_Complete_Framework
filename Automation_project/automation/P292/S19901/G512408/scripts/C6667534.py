...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6667534
'''
import unittest
...
class C6667534_TestClass(BaseTestCase):
    
    def test_C6667534(self):
        """
        Test_case objects
        """
        ...
        util_obj.asequal(property_title,property_title_element,'Step 3.1a): Verify the Title is Retail Samples')
        util_obj.verify_object_visible(properties_close_button_css, True, "Step 3.1b): Verify Close button is visible")
        main_page_obj.verify_property_dialog_tab_list(property_tab_list, "Step 3.2: Verify 3 tabs are available")
        main_page_obj.verify_selected_tab_in_property_dialog('General', 'Step 3.3: Verify General tab is selected')
        main_page_obj.verify_property_dialog_save_cancel_button_enable_disable('Save', 'disable' , 'Step 3.4: Verify Save button is disabled')
        ...
        util_obj.verify_object_visible(properties_tab_css, False, "Step 4.1: Verify Property Dialog tab is closed")
        main_page_obj.verify_action_bar_tab_all_options(domains_actionbar_list, "Step 4.2: Verify Domain and Folder are Present")
