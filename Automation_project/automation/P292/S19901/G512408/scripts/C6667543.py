...
@author: Magesh
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667543
Testcase Name : Verify action Bar Visualization option for Dev User
'''
import unittest
...
class C6667543_TestClass(BaseTestCase):

    def test_C6667543(self):
        """
        TESTCASE_OBJECTS
        """
        ...
        util_obj.synchronize_with_number_of_element("#TableChart_1 rect[class*='riser']", 12, 90)
        
        """
        Verify that default Visualization Chart is Displayed
        """
        chart_obj.verify_number_of_risers("#TableChart_1 rect", 3, 4, 'Step 6:01: Verify number of risers')
