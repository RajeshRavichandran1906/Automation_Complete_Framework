...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6670655'''
...
class C6670655_TestClass(AS_BaseTestCase):
    
    def test_C6670655(self):
...
#         
        ...
        '''Step 2.1. Click 'Yes' in the AppStudio prompt'''
        ...
        '''Step 3. Click Run from QAT toolbar'''

        
        hcanvas.run_canvas_item_in_browser("P292_S10032_G157549/API", run_item)
       
        
        '''Step 4. Select Tab 4 value 4 from the drop down list and click on Button'''
        ...
        '''Step 5. Close the HtmlPage browser page'''
