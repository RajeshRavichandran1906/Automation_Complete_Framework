...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/7232596
'''
import unittest
...
class C7232596_TestClass(BaseTestCase):
    
    def test_C7232596(self):
        """
        Test_case objects
        """
        ...
        Test case variables
        """
        domain_tab_options = ['Domain','Folder']
        ...
        Verify that only 'Domain' and 'Folder' action bar are displayed
        """
