...
Test Case Link  =  http://172.19.2.180/testrail/index.php?/cases/view/6986648
...
class C6986648_TestClass(BaseTestCase):
    
    def test_C6986648(self):
        ...
        SECURITY_MENU_CSS = ".pop-top div[data-ibx-name*='miMenuItemRules']"
