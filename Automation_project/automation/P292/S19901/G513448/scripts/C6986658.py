...
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6986658
...
class C6986658_TestClass(BaseTestCase):

    def test_C6986658(self):
        ...
        utillobj.synchronize_with_visble_text(crumb_box_css, 'Domains', 30, 1)
        ...
        wfmain_obj.verify_left_panel(content_list, "Step 05a: Verify Favorites View is selected.", default_selected='Favorites')
        wfmain_obj.verify_items_in_grid_view(['Portal for Context Menu Testing2'], 'asin', "Step 05b: Verify Portal for Context Menu Testing item listed under Favorites")
        ...
        wfmain_obj.verify_items_in_grid_view(['Portal for Context Menu Testing2'], 'asnotin', "Step 06a: Portal for Context Menu Testing item removed under Favorites")
