...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6670292
Test Case Title =  Test expand menu using admin
-----------------------------------------------------------------------------------------------"""
...
class C6670292_TestClass(BaseTestCase):

    def test_C6670292(self):
