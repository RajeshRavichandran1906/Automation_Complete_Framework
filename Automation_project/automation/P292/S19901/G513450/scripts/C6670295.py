...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6670295
'''
...
class C6670295_TestClass(BaseTestCase):
    
    def test_C6670295(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_number_of_element(folders_css, 1, Global_variables.mediumwait * 10)
        
        """
        Step 2: Click Content View from the side bar > Click on Domains from the resource tree
        """
        main_page_obj.select_content_from_sidebar()
        util_obj.synchronize_with_visble_text(files_box_css, "Folders", Global_variables.mediumwait * 10)
...
#         main_page_obj.right_click_folder_item_and_select_menu('Portal for Context Menu Testing', 'Properties')
        ...
        """
        util_obj.synchronize_with_number_of_element(tab_css, 3, Global_variables.mediumwait * 10)
