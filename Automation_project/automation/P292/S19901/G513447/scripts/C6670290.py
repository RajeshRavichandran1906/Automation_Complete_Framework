...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6670290
'''
...
class C6670290_TestClass(BaseTestCase):
    
    def test_C6670290(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_number_of_element(tab_css, 3, Global_variables.mediumwait)
        ...
        main_page_obj.verify_selected_tab_in_property_dialog("Advanced", "Step 5.1: propery tab verification")
