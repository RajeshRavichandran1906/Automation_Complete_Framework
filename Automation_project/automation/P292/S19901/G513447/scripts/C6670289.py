...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6670289
'''
...
class C6670289_TestClass(BaseTestCase):
    
    def test_C6670289(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_visble_text(edit_portal_css, 'Edit Portal', Global_variables.mediumwait * 5)
