...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6986585
'''
...
class C6986585_TestClass(BaseTestCase):
    
    def test_C6986585(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_visble_text(edit_portal_css, 'Edit Portal', Global_variables.mediumwait)
