...
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6779488
'''
...
class C6779488_TestClass(BaseTestCase):
    
    def test_C6779488(self):
        """
        Test_case variables
        """
        ...
        util_obj.verify_current_url('portal/123', 'Step 9: Verify URL in the new page')
