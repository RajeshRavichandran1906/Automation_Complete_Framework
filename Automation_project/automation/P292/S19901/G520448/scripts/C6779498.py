...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6779498
'''
...
class C6779498_TestClass(BaseTestCase):
    
    def test_C6779498(self):
        """
        Test_case variables
        """
        ...
        util_obj.verify_picture_using_sikuli("info_build_logo.png","Step 6.5: Verify the Infobuilders icon logo")    
