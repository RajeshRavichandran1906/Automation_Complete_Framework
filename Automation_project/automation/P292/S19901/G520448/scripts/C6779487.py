...
class C6779487_TestClass(BaseTestCase):
    
    def test_C6779487(self):
        """
        Test_case variables
        """
        ...
        designer_portal_obj.theme_dropdown_in_new_or_edit_portal_dialog(verify_theme='Light', current_mode='enable', step_number='Step 3.')
        designer_portal_obj.url_textbox_in_new_or_edit_portal_dialog(verify_value='portal/P292_S19901/G520448/'+portal_name, step_number='Step 3.')
        ...
        designer_portal_obj.cancel_button_inside_new_or_edit_portal_dialog(verify_button='Cancel', current_mode='enable', step_number='Step 3.')
        ...
        designer_portal_obj.url_textbox_in_new_or_edit_portal_dialog(verify_value='portal/abcABCAD', step_number='Step 4.')
        ...
        designer_portal_obj.url_textbox_in_new_or_edit_portal_dialog(verify_value='portal/P292_S19901/G520448/'+portal_name, step_number='Step 5.')
         
        """
        Step 6. Hove over (x)
        Verify close tooltip appears
        """
        designer_portal_obj.close_button_inside_new_or_edit_portal_dialog(title_tooltip='Close', step_number='Step 6.')        
        """
        Step 7. Click Save
        ...
        designer_portal_obj.verify_portal_dialog_open_or_close('close', 'Step 7. Verify Edit Portal dialog is closed')
        ...
        util_obj.synchronize_with_number_of_element(portals_css, 1, 20)
        main_page_obj.right_click_folder_item_and_select_menu(portal_name,'Edit')
        ...
        Cancel button is enabled.
        """
        designer_portal_obj.verify_caption_in_new_or_edit_portal_dialog('Edit Portal', step_number='Step 8.')
        designer_portal_obj.title_textbox_in_new_or_edit_portal_dialog(verify_value=portal_name, step_number='Step 8.')
        designer_portal_obj.name_textbox_in_new_or_edit_portal_dialog(verify_value=portal_name,  step_number='Step 8.')
        designer_portal_obj.banner_toggle_button_in_new_or_edit_portal_dialog(verify_toggle='check', current_mode='enable', step_number='Step 8.')
        designer_portal_obj.show_portal_title_in_banner_checkbox_inside_new_or_edit_portal_dialog(verify_checkbox='check', current_mode='enable', step_number='Step 8.')
        designer_portal_obj.logo_textbox_in_new_or_edit_portal_dialog(verify_placeholder_value='Not Selected', step_number='Step 8.')
        designer_portal_obj.two_level_side_navigation_radiobutton_in_new_or_edit_portal_dialog(verify_navigation='check', current_mode='enable', step_number='Step 8.')
        designer_portal_obj.theme_dropdown_in_new_or_edit_portal_dialog(verify_theme='Light', current_mode='enable', step_number='Step 8.')
        designer_portal_obj.url_textbox_in_new_or_edit_portal_dialog(verify_value='portal/P292_S19901/G520448/'+portal_name, step_number='Step 8.')
        designer_portal_obj.save_button_inside_new_or_edit_portal_dialog(verify_button='Save', current_mode='disable', step_number='Step 8.')
        designer_portal_obj.cancel_button_inside_new_or_edit_portal_dialog(verify_button='Cancel', current_mode='enable', step_number='Step 8.')
        ...
        main_page_obj.verify_items_in_grid_view(['v5-mypages-test1-title-changed-contenttree'], 'asin', 'Step 10. Verify portal title appears')
        ...
        main_page_obj.verify_content_area_item_publish_or_unpublish(portal_renamed, 'publish', 'Step 11. Verify portal is published')
        main_page_obj.verify_item_icon_in_content_area(portal_renamed, 'portal', '11', verify_color_name='bar_blue', item_name_index=1)
        ...
        """
        util_obj.synchronize_with_visble_text(WfMainPageLocators.FOLDER_ITEM_PUBLISHED, 'v5-mypages-test1-title-changed-contenttree', 15)
        main_page_obj.verify_content_area_folder_publish_or_unpublish(portal_renamed, 'publish', 'Step 11. Verify portal is published')
        main_page_obj.verify_folder_icon_in_content_area(portal_renamed, 'portal', '11', verify_color_name='bar_blue', item_name_index=1)
