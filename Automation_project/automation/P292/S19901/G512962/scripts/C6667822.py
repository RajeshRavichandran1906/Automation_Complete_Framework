...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6667822
...
class C6667822_TestClass(BaseTestCase):

    def test_C6667822(self):
        ...
        wfmain_obj.verify_ribbon_button(labels_list, 'Step 4.1: Verify that 2 action bars (Folder, Shortcut) is displayed', repository_section_area='My Content')
        ...
        labels_list=['','']
        wfmain_obj.verify_ribbon_button(labels_list, 'Step 5.2: Verify that action bar is Collapsed', repository_section_area='My Content')
        ...
        """
        labels_list=['Folder','Shortcut']
        wfmain_obj.verify_ribbon_button(labels_list, 'Step 6.1: Verify that action bar is Expanded', repository_section_area='My Content')
