...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6779093
'''
...
class C6779093_TestClass(BaseTestCase):
    
    def test_C6779093(self):
        """
        Test_case variables
        """
        ...
        for item in check_list:
            main_page_obj.verify_label_in_property_dialog('Advanced', item, '3')
