...
Testcase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/6779146
'''
...
class C6779146_TestClass(BaseTestCase):
    
    def test_C6779146(self):
        """
        Test_case variables
        """
        ...
        main_page_obj.verify_label_in_property_dialog('Advanced', 'Restrict schedule to Library only', '3',checkbox='enable')
