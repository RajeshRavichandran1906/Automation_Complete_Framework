...
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/6693963
'''
import unittest
import time
...
class C6693963_TestClass(BaseTestCase):
    
    def test_C6693963(self):
        """
        Test_case variables
        """
        ...
        page_designobj.close_page_designer_from_application_menu()
        core_util_obj.switch_to_previous_window(window_close=False)
        main_page_obj.verify_items_in_grid_view(expected_list1,'asequal',"Step8.1:Verify Test page 1.1 and Test page 1.2 are created and shown in the content area")
        ...
        page_designobj.close_page_designer_from_application_menu()
        core_util_obj.switch_to_previous_window(window_close=False)
        main_page_obj.verify_items_in_grid_view(expected_list2,'asequal',"Step8.1:Verify Test page 1.1 and Test page 1.2 are created and shown in the content area")
        ...
        page_designobj.close_page_designer_from_application_menu()
        core_util_obj.switch_to_previous_window(window_close=False)
        main_page_obj.verify_items_in_grid_view(expected_list3,'asequal',"Step8.1:Verify Test page 1.1 and Test page 1.2 are created and shown in the content area")
        """
