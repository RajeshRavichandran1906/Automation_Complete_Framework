...
@author: Vpriya
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/6693962
...
class C6693962_TestClass(BaseTestCase):
    
    def test_C6693962(self):
        """
        CLASS OBJECTS
        """
        ...
        """
        main_page_obj.select_ribbon_button('Page',repository_section_area='web content')
        ...
        page_designer_obj.close_page_designer_from_application_menu()
        core_utility_obj.switch_to_previous_window(window_close=False)
        main_page_obj.verify_items_in_grid_view(["Base Page 1","Base Page 2","Base Page 3"],"asequal","Step 16:Verify Base Page1,2 and 3 are shown in the content area.")
