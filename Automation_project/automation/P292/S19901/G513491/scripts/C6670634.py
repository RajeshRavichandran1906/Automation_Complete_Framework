...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6670634'''
...
class C6670634_TestClass(AS_BaseTestCase):
    def test_C6670634(self):
        ...
        C6670634_file="C6670634"
        saved_fex_C6670634="C6670634.fex"
        
        '''Testcase verification'''
        
        verify_new_report="App Studio - Report1*"
        verify_push_buttons=['HTML','HTML Analytic Document','PDF','PDF Analytic Document','Output Format Options','Destination (PCHOLD)']
        verify_push_button_1=['Excel','PowerPoint','Output Format']
        verify_output_format_dialog="Output Format Options"
        verify_default_stylesheet="step3_C6670634.png"
        verify_html_table="step5_C6670634_Ds01.xlsx"
        verify_output_in_chrome="step8_C6670634_cr.png"
        verify_output_in_firefox="step8_C6670634_ff.png"
        verify_output_in_ie="step8_C6670634_ie.png"
        verify_active_report_in_firefox="step14_C6670634_ff.png"
        verify_active_report_in_chrome="step14_C6670634_cr.png"
        verify_active_report_in_ie="step14_C6670634_ie.png"
        ...
        as_utilobj.save_as_UI_dialog(C6670634_file)
        time.sleep(6)
               
        hcanvas.run_canvas_item_in_browser(base_folder,saved_fex_C6670634)
        time.sleep(10)
        ...
        as_env_tree_obj.ui_double_click_tree_view_item(C6670634_file)
        time.sleep(10)
        ...
        as_utilobj.save_file_from_browser('C6670634_actual_1')
        time.sleep(5)
           
        as_utilobj.verify_xml_xls('C6670634_base_1.xlsx','C6670634_actual_1.xlsx',verify_msg_8)
        time.sleep(2)
        ...
        as_utilobj.click_element_using_ui(button_item=True,name=report_canvas_locators.html_analytic_document)
        time.sleep(1)
