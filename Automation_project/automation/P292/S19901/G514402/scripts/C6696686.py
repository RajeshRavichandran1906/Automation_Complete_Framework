...
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/6696686
'''
import unittest
...
class C6696686_TestClass(BaseTestCase):
    
    def test_C6696686(self):
        """
        Test_case variables
        """
        ...
        """
        util_obj.synchronize_with_number_of_element(page_container_css, 7,90)
...
#         core_util_obj.python_left_click(submit_button_obj)
        ...
        page_designer_obj.create_html_report_data_set('C6693956')
        page_designer_obj.verify_html_report_data_set('C6693956', 'Step 7.2: Verify data inside container 2')
