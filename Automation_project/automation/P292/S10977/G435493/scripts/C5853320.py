...
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/5853320
'''
...
class C5853320_TestClass(BaseTestCase):

    def test_C5853320(self):
        
        """   
        TESTCASE VARIABLES 
        """
        Test_Case_ID = 'C5853320'
        ...
        """
            Step 01 : Launch Report Mode: http://machine:port/ibi_apps/ia?tool=Report&master=ibisamp/empdata&item=IBFS:/WFC/Repository/P292_S10977/G435493
        """
        utillobj.invoke_infoassist_api_login('report','ibisamp/empdata','P292_S10977/G435493','mrid','mrpass')
        ...
        """
            ...
            Step 04 : Click OK
        """
        iaribbon.create_join("ibisamp", "training")
        ...
        """
        resultobj.verify_report_titles_on_preview(4,4,'TableChart_1',['DEPT', 'LASTNAME', 'COURSECODE', 'EXPENSES'],'Step 10.1 : Verify Live Preview')
        ...
        """
            Step 12 : Click 'Save' in the toolbar > Save as > C5853320 > Click 'Save'
        """
        ...
        """
            Step 14 : Restore saved Fex: http://machine:port/ibi_apps/ia?item=IBFS:/WFC/Repository/P292_S10977/G435493/C5853320.fex&tool=Report
        """
        utillobj.infoassist_api_edit_(Test_Case_ID,'report','P292_S10977/G435493',mrid='mrid',mrpass='mrpass')
        resultobj.wait_for_property("#queryTreeColumn table[class='bi-tree-view-table']>tbody>tr:nth-child(2)", 1,60,string_value='Sum')
        time.sleep(5)
        ...
        """
        resultobj.verify_report_titles_on_preview(4,4,'TableChart_1',['DEPT', 'LASTNAME', 'COURSECODE', 'EXPENSES'],'Step 15.1 : Verify Live Preview')
        none_value_element=self.driver.find_elements_by_css_selector("#TableChart_1 div[class^='x']")[10]
