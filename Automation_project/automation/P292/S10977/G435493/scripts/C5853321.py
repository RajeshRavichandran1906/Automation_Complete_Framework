...
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/5853321
'''
...
class C5853321_TestClass(BaseTestCase):

    def test_C5853321(self):
        
        """   
        TESTCASE VARIABLES 
        """
        Test_Case_ID = 'C5853321'
        ...
        """
            Step 19 : Save the Document fex: Click 'Save' in the toolbar > Save as > C5853321 > Click 'Save'
        """
        ...
        """
            Step 21 : Restore saved Fex: http://machine:port/ibi_apps/ia?item=IBFS:/WFC/Repository/P292_S10977/G435493/C5853321.fex&tool=Document
        """
        utillobj.infoassist_api_edit_(Test_Case_ID,'Document','P292_S10977/G435493',mrid='mrid',mrpass='mrpass')
        resultobj.wait_for_property("#canvasContainer #TableChart_1 div[class^='x']", 1,20,string_value='COUNTRY')
        time.sleep(2)
