...
Testcase ID : http://172.19.2.180/testrail/index.php?/cases/view/5853319
'''
...
class C5853319_TestClass(BaseTestCase):

    def test_C5853319(self):
        
        """   
        TESTCASE VARIABLES 
        """
        Test_Case_ID = 'C5853319'
        ...
        """
            Step 01 : Launch Report Mode: http://machine:port/ibi_apps/ia?tool=Report&master=ibisamp/car&item=IBFS:/WFC/Repository/P292_S10977/G435493
        """
        utillobj.invoke_infoassist_api_login('report','ibisamp/car','P292_S10977/G435493','mrid','mrpass')
        ...
        """
            Step 16 : Click 'Save' in the toolbar > Save as > C5853319  > Click 'Save'
        """
        ...
        """
            Step 18 : Restore saved Fex: http://machine:port/ibi_apps/ia?item=IBFS:/WFC/Repository/P292_S10977/G435493/C5853319.fex&tool=Report
        """
