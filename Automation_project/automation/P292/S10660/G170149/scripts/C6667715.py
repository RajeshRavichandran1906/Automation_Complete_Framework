...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667715
Test Case Title =  AUTHZ_AdminUser:Check WebFOCUS Online Help and Change Password functionality
-----------------------------------------------------------------------------------------------"""
...
class C6667715_TestClass(BaseTestCase):

    def test_C6667715(self):
        ...
        """
        main_page.change_password("password", "password1")
        ...
        """
            STEP 7 : Sign into WebFOCUS Home Page as Admin User with the new password.
        """
        login.invoke_home_page('mridadmnew', 'mrpassadmnew')
        utils.synchronize_with_visble_text(locator.CONTENT_CSS, "Content", main_page.home_page_long_timesleep)
        ...
        """
        main_page.change_password("password1", "password")
        ...
        """
            STEP 11 : Sign into WebFOCUS Home Page as Admin User with the new password.
        """ 
        login.invoke_home_page('mridadm', 'mrpassadm')
        utils.synchronize_with_visble_text(locator.CONTENT_CSS, "Content", main_page.home_page_long_timesleep)
