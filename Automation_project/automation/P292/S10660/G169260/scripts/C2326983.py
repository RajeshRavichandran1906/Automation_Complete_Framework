...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2326983
...
class C2326983_TestClass(BaseTestCase):

    def test_C2326983(self):
        
        """
        TESTCASE VARIABLES
        """
        
        Test_Case_ID = 'C2326983'
        long_wait = 90
        medium_wait = 45
        short_wait = 30
        ...
        expected_mobile_favorites = ['Quantity Sold By Stores']
        ...
        wfmain_obj.right_click_folder_item_and_select_menu("Margin by Product Category", 'Remove favorite')
        ...
        verify_list(expected_mobile_favorites, item_css, 'asListEqual', "Step17.2b: Verify Quantity Sold By Stores report in grid view")
        ...
        verify_list(expected_mobile_favorites, list_item_css, 'asListEqual', "Step18.1e: Verify Quantity Sold By Stores report in list view")
        ...
        verify_list(expected_mobile_favorites, item_css, 'asListEqual', "Step19.2b: Verify Quantity Sold By Stores report in grid view")
          
        """
        Step20: Right Click on "Quantity Sold By Stores" > Click Remove mobile favorite.
        Verify "Margin by Product Category" mobile favorite is removed from the content area.
        """
        utillobj.synchronize_with_visble_text(files_box_css, "Items", short_wait)
        ...
        verify_list(expected_mobile_favorites, item_css, 'asnotin', "Step20.1: Verify Quantity Sold By Stores report not in grid view")
        ...
        """
        Step22: Sign Out and Sign back into WebFOCUS Home Page as Basic User.
        ...
        wftools_login_obj.invoke_home_page('mridbas', 'mrpassbas')
        utillobj.synchronize_with_visble_text(crumb_box_css, "Mobile Favorites", medium_wait)
        wfmain_obj.verify_left_panel([], "Step22.1: Verify Side bar(left panel) options shows description for each option",'')
