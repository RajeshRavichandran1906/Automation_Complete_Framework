...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2325647
...
class C2325647_TestClass(BaseTestCase):

    def test_C2325647(self):
        
        """
        TESTCASE VARIABLES
        """
        
        Test_Case_ID = 'C2325647'
        long_wait = 90
        medium_wait = 45
        short_wait = 30
        ...
        wfmain_obj.verify_file_item_grid_view("V3 portal", "V4 Portal", "Step06.1a: Verify content area shows in grid view")
        ...
        """
        wfmain_obj.select_list_view()
        wfmain_obj.verify_list_view("V3 portal", "V4 Portal", "Step07.1a: Verify Portal area shows in list view")
        ...
        """
        wfmain_obj.select_grid_view()
        wfmain_obj.verify_file_item_grid_view("V3 portal", "V4 Portal", "Step08.1a: Verify content area shows in grid view")
        ...
        """
        Step16: Click Content from sidebar > Retail Samples > Reports > Right click on "Margin by Product Category" > Add to Mobile Favorites.
        Verify Mobile Favorite added popup opens with a background transparent green layer over the popup.
        """
        wfmain_obj.select_content_from_sidebar()
        utillobj.synchronize_with_visble_text(files_box_css, "Folders", 45)
        wfmain_obj.right_click_folder_item_and_select_menu("Margin by Product Category", 'Add to Mobile Favorites', 'Retail Samples->Reports')
        ...
        verify_list(expected_favorites, item_css, 'asListEqual', "Step17.2b: Verify Margin by Product Category report in grid view")
        ...
        verify_list(expected_favorites, item_css, 'asListEqual', "Step19.2b: Verify Margin by Product Category report in grid view")
         
        """
        Step20: Right Click on "Margin by Product Category" > Click Remove mobile favorite.
        Verify "Margin by Product Category" mobile favorite is removed from the content area.
        """
        utillobj.synchronize_with_visble_text(files_box_css, "Items", short_wait)
        wfmain_obj.right_click_folder_item_and_select_menu("Margin by Product Category", 'Remove mobile favorite')
        utillobj.synchronize_with_visble_text(".files-box-files .ibx-label-text", "Your Mobile Favorites will appear here", medium_wait)
        verify_list(expected_favorites, item_css, 'asnotin', "Step20.1: Verify Margin by Product Category report not in grid view")
        ...
        """
        Step22: Sign Out and Sign back into WebFOCUS Home Page as Admin User.
