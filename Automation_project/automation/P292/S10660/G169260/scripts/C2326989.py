...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2326989
...
class C2326989_TestClass(BaseTestCase):

    def test_C2326989(self):
        
        """
        TESTCASE VARIABLES
        """
        
        Test_Case_ID = 'C2326989'
        long_wait = 90
        medium_wait = 45
        short_wait = 30
