...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2325639
...
class C2325639_TestClass(BaseTestCase):

    def test_C2325639(self):
        
        """
        TESTCASE VARIABLES
        """
        
        advuser_username = 'mrid02'
        advuser_password = 'mrpass02'
        long_wait = 120
        medium_wait = 60
        ...
        """
        wftools_login_obj.invoke_home_page(advuser_username, advuser_password)
        ...
        """
        Step05: In the banner link, click on the top right username > Click Sign Out.
        """
