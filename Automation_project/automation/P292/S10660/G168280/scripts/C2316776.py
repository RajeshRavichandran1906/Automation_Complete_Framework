...
class C2316776_TestClass(BaseTestCase):
    ...
    def test_C2316776(self):
        ...
        """
        utillobj.select_or_verify_bipop_menu(verify='true', expected_popup_list=['Use field titles', 'Preserve null value', 'Missing Values'], expected_ticked_list=['Use field titles'], msg='Step 06.00:')
        defcomp_obj.select_menu_button_in_compute("additional_option")     
        """
        ...
        define.verify_text_area_expression(expected_textarea_value, '07.00')
        ...
        """
        utillobj.synchronize_with_visble_text('#queryTreeColumn', 'Compute_1', 30)
        metaobj.verify_query_pane_field("Vertical Axis", "Compute_1", 1, "Step 12.00")
        """
            Verify Live Preview
        """
        ...
        resultobj.verify_riser_chart_XY_labels("TableChart_1", expected_xval_list, expected_yval_list, 'Step 12.02: X and Y axis labels')
        resultobj.verify_number_of_riser('TableChart_1',1,7, 'Step 12.03: Verify Number of risers in the bar chart')
        resultobj.verify_yaxis_title("TableChart_1", 'Compute_1', "Step 12.04: Verify X-Axis Title")
        """ 
        ...
        """
        expected_textarea_value='"Revenue" - "Cost of Goods" '
        define.verify_text_area_expression(expected_textarea_value, '18.00')
