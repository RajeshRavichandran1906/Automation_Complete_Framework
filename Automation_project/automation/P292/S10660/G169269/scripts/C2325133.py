...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2325133
TestCase Name = Select sub folder as developers
'''
...
class C2325133_TestClass(BaseTestCase):

    def test_C2325133(self):
        ...
        """
        """ Step 4: Click on Retail Samples in tree
                    Verify breadcrumb trail is "Domains > P292_S10660_G169261> Breadcrumb Trail and Search > Retail Samples"
        """
