...
Test Case = http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2325134
TestCase Name = Open folder as developers
'''
...
class C2325134_TestClass(BaseTestCase):

    def test_C2325134(self):
        ...
        """
        """ Step 4: Click on Charts in the content area
                    Verify breadcrumb trail is "Domains > P292_S10660_G169261>Breadcrumb Trail and Search > Retail Samples > Charts"
        """
