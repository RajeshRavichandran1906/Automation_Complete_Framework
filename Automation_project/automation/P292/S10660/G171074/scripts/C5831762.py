...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5831762
...
class C5831762_TestClass(BaseTestCase):

    def test_C5831762(self):
        driver = self.driver #Driver reference object created
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C5831762'
        
        """
        Step 01: Launch the IA API with wf_retail_lite, Visualization mode:
        http://machine:port/alias/ia?tool=idis&master=baseapp/WF_RETAIL_LITE&item=IBFS%3A%2FWFC%2FRepository%2FS10660%2F
        """
        ...
        propertyobj.select_or_verify_show_prompt_item(1, '[All]', verify=True, verify_type=False, msg="Step14: Verify [All] is unchecked in filter prompt")       
        ...
        utillobj.take_screenshot(ele, 'C5831762_Actual_step16', image_type='actual',x=1, y=1, w=-1, h=-1)
        time.sleep(5)        
        propertyobj.select_or_verify_show_prompt_item(1, '[All]', verify=True, verify_type=False, msg="Step16: Verify All is unchecked in filter prompt")
        ...
        Step19: Save as "C5831762" > Click Save
        ...
        http://machine:port/alias/ia?item=IBFS%3A%2FWFC%2FRepository%2FS10660%2FC5831762.fex
        """
        ...
        propertyobj.select_or_verify_show_prompt_item(1, '[All]', verify=True, verify_type=False, msg="Step22: Verify All is unchecked in filter prompt")   
