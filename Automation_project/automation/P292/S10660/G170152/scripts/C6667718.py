...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6667718
Test Case Title =  AUTHZ_DeveloperUser:Check WebFOCUS Online Help and Change Password functionality for developer user
-----------------------------------------------------------------------------------------------"""
...
class C6667718_TestClass(BaseTestCase):

    def test_C6667718(self):
        ...
        """
            ...
            New Password: password4 
            Confirm New Password: password4
            Click OK button.
            Verify the window should disappear and displays a confirmation message "Your Password has been changed" with a background transparent green layer over the message.
        """
        main_page.change_password("password", "password4")
        utils.synchronize_until_element_disappear("div.change-old-password", main_page.home_page_medium_timesleep)
        ...
        """
            STEP 7 : Sign into WebFOCUS Home Page as Developer User with the new password.
        """
        login.invoke_home_page('mriddevnew', 'mrpassdevnew')
        ...
        """
            ...
            Old Password: password4 
            New Password: password 
            Confirm New Password: password
            Click OK button.
            Verify the window should disappear and displays a confirmation message "Your Password has been changed" with a background transparent green layer over the message.
        """
        main_page.change_password("password4", "password")
        utils.synchronize_until_element_disappear("div.change-old-password", main_page.home_page_medium_timesleep)
        ...
        """
            STEP 11 : Sign into WebFOCUS Home Page as Developer User with the new password.
        """
        login.invoke_home_page('mriddev', 'mrpassdev')
