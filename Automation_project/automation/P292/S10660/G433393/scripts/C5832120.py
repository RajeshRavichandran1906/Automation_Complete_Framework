...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5832120
...
class C5832120_TestClass(BaseTestCase):

    def test_C5832120(self):
        ...
        """
        pd_design.drag_content_item_to_container(CONTAINER_ITEM, DROP_PANEL)
        ...
        pd_run.verify_html_report_vertical_scrollbar_reached_bottom('Step 10.10 : Verify report vertical scroll bar reached bottom')
