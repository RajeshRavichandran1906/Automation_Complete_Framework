...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852253
...
class C5852258_TestClass(BaseTestCase):

    def test_C5852258(self):
