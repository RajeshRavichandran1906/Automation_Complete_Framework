...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5832124
...
class C5832124_TestClass(BaseTestCase):

    def test_C5832124(self):
        ...
        """
            STEP 05.1 : Verify filter control bounded to the page with red dotted border around it.
        """
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME, 'Step 07.12 : Verify page loads successfully in preview')
