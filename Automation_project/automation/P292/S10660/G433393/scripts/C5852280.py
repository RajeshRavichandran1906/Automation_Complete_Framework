...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852280
...
class C5852280_TestClass(BaseTestCase):

    def test_C5852280(self):
