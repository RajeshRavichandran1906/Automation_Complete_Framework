...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852261
Test Case Title =  Adding optional other dynamic single-select dropdown control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C5852261_TestClass(BaseTestCase):

    def test_C5852261(self):
