...
class C5852253_TestClass(BaseTestCase):

    def test_C5852253(self):
        ...
        """
            STEP 05.1 : Verify drop down control bounded to the page with red dotted border around it.
        """
        ...
        pd_design.verify_filter_dropdown_is_optional(FILTER_CONTRTOL_NAME, 'Step 05.03 : Verify {0} drop down control not bounded to the page with solid red border'.format(FILTER_CONTRTOL_NAME))
        ...
        """
            STEP 07.1 : Verify page loads successfully in preview, scroll down the report and verify all values are available.
        """
        ...
        pd_preview.verify_filter_dropdown_is_optional(FILTER_CONTRTOL_NAME, 'Step 07.06 : Verify {0} drop down control not bounded to the page with solid red border in preview'.format(FILTER_CONTRTOL_NAME))
        ...
        pd_preview.verify_html_report_vertical_scrollbar_reached_bottom('Step 07.12 : Verify report scroll reached bottom')
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 07.13 : Verify all values are available')
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME2, 'Step 08.02 : Verify filter condition applied in the page')
        pd_preview.switch_to_default_page()
        pd_preview.verify_selected_value_of_filter_dropdown(FILTER_CONTRTOL_NAME, [FILTER_DROPDOWN_SELECTION_OPTION], 'Step 08.03 : Verify {0} option selected in filter drop down'.format(FILTER_DROPDOWN_SELECTION_OPTION))
