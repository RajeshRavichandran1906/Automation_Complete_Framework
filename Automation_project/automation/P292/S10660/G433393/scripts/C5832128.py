...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5832128
Test Case Title =  Adding optional slider range control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C5832128_TestClass(BaseTestCase):

    def test_C5832128(self):
        ...
        LONG_TIME=40
        TEMPLATE_NAME='Blank'
        TEST_CASE_ID='C5832128'
        DATA_SET_NAME=TEST_CASE_ID + '_DataSet_01'
        CONTAINER_ITEM='11 - Slider Range Optional'
        ...
        EXPECTED_CONTAINERS=['11 - Slider Range Optional']
        ...
        """
            STEP 04 : Drag "11 - Slider Range Optional" report into the page canvas from P292_S10660 > G433312 > Reference Items folder..
        """
        ...
        """
            STEP 05.1 : Verify filter controls bounded to the page with red dotted border.
        """
        ...
        pd_design.verify_filter_inputbox_is_optional(FILTER_CONTRTOL_NAME, 'Step 05.04 : Verify first {0} filter control input box not bounded to the page with solid red border'.format(FILTER_CONTRTOL_NAME))
        pd_design.verify_filter_inputbox_is_optional(FILTER_CONTRTOL_NAME, 'Step 05.06 : Verify second {0} filter control input not box bounded to the page with solid red border'.format(FILTER_CONTRTOL_NAME), 2)
        ...
        """
            STEP 07.1 : Page loads successfully in preview.
        """
        ...
        pd_preview.verify_filter_inputbox_is_optional(FILTER_CONTRTOL_NAME, 'Step 07.07 : Verify first {0} filter control input box not box bounded to the page with solid red border in preview'.format(FILTER_CONTRTOL_NAME))
        pd_preview.verify_filter_inputbox_is_optional(FILTER_CONTRTOL_NAME, 'Step 07.08 : Verify second {0} filter control input box not box bounded to the page with solid red border in preview'.format(FILTER_CONTRTOL_NAME), 2)
        ...
        pd_preview.verify_html_report_has_vertical_scrollbar('Step 07.13 : Verify container report has vertical scroll bar in preview')
        pd_preview.verify_html_report_data_set(DATA_SET_NAME, 'Step 07.14 : Verify Page loads successfully in preview')
        ...
        pd_run.verify_filter_inputbox_is_optional(FILTER_CONTRTOL_NAME, 'Step 10.04 : Verify first {0} filter control input box is box bounded to the page with solid red border in run page'.format(FILTER_CONTRTOL_NAME))
        pd_run.verify_filter_inputbox_is_optional(FILTER_CONTRTOL_NAME, 'Step 10.05 : Verify second {0} filter control input box is box bounded to the page with solid red border in run page'.format(FILTER_CONTRTOL_NAME), 2)
        ...
        pd_run.verify_html_report_data_set(DATA_SET_NAME, 'Step 10.10 : Verify page runs successfully without error in run page')
