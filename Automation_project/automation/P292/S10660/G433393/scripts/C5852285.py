...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852285
Test Case Title =  Adding optional static multi-select button set control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C5852285_TestClass(BaseTestCase):

    def test_C5852285(self):
        ...
        EXPECTED_CONTAINERS=['26 - Multi-Select Static Optional', 'Panel 2', 'Panel 3']
        ...
        """
            STEP 04 : Drag "26 - Multi-Select Static Optional" report into Panel 1 from P292_S10660 > G433312 > Reference Items folder.
        """
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 09.14 : Verify report added to the page successfully')
        ...
        pd_preview.switch_to_container_frame(CONTAINER_ITEM)
        pd_preview.wait_for_number_of_element("table[summary]>tbody>tr", 16, time_out=SHORT_TIME)
        ...
        pd_run.verify_filter_buttonset_is_optional(FILTER_CONTRTOL_NAME, 'Step 14.02 : Verify solid red border not over filter the control')
        pd_run.switch_to_container_frame(CONTAINER_ITEM)
