...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852281
...
class C5852281_TestClass(BaseTestCase):

    def test_C5852281(self):
        ...
        """
            STEP 04 : Drag "22 - Single Select Dynamic Required" report into the page canvas from P292_S10660 > G433312 > Reference Items folder.
        """
        ...
        pd_preview.verify_number_of_panels(EXPECTED_TOTAL_PANELS, 'Step 09.10 : Verify 1 panel display in preview')
        pd_preview.verify_default_output_for_input_required_container(CONTAINER_ITEM, 'Step 09.11 : Verify report loads successfully in preview')
        ...
        """
            STEP 14.1 : Verify solid red border over filter the control removed and selected condition applied in the page.
        """
