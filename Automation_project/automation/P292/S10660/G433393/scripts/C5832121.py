...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5832121
...
class C5832121_TestClass(BaseTestCase):

    def test_C5832121(self):
        ...
        pd_design.verify_filter_inputbox_value(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_FILTER_CONTROL_VALUE, 'Step 05.04 : Verify Enter 5012 filter condition default input value is None')
        ...
        pd_preview.verify_filter_inputbox_value(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_FILTER_CONTROL_VALUE, 'Step 07.04 : Verify Enter 5012 filter condition default input value is None in preview')
        ...
        pd_run.verify_filter_inputbox_value(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_FILTER_CONTROL_VALUE, 'Step 10.05 : Verify Enter 5012 filter condition default input value is None in run page')
