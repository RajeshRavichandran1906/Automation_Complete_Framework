...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852362
...
class C5852362_TestClass(BaseTestCase):

    def test_C5852362(self):
