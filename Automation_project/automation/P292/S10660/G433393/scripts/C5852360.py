...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852360
Test Case Title =  Adding optional dynamic radio button control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C5852360_TestClass(BaseTestCase):

    def test_C5852360(self):
        ...
        EXPECTED_CONTAINERS=['23 - Single Select Dynamic Optional']
        EXPECTED_FILTER_CONVERTER_CONTROLS=['Radio', 'Button set']
        EXPECTED_FILTER_RADIOGROUP_OPTIONS=['All', 'EMEA', 'North America', 'Oceania', 'South America']
        ...
        """
            STEP 04 : Drag "23 - Single Select Dynamic Optional" report into the page canvas from P292_S10660 > G433312 > Reference Items folder.
        """
        ...
        """
            STEP 07.1 : Verify dropdown control converted to radio button control and "All" radio button is selected.
        """
        ...
        pd_design.verify_filter_radio_group_is_optional(FILTER_CONTRTOL_NAME, 'Step 07.03 : Verify {0} filter radio group control is optional'.format(FILTER_CONTRTOL_NAME))
        ...
        """
            STEP 09.1 : Verify page loads successfully in preview, scroll down the report and verify all values are available in the report.
        """
        ...
        pd_preview.verify_filter_radio_group_is_optional(FILTER_CONTRTOL_NAME, 'Step 09.06 : Verify {0} filter radio group control is optional'.format(FILTER_CONTRTOL_NAME))
        ...
        """
            STEP 10 : Select "Oceania" radio button.
        """
        ...
        """
            STEP 10.1 : Verify selected condition applied in the page.
        """
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME2, 'Step 10.03 : Verify selected condition applied in the page')
        pd_preview.switch_to_default_page()
        ...
        """
            STEP 13 : Right click created page and select Run.
        """
        ...
        """
            STEP 13.1 : Verify page runs successfully with "All" filter condition.
        """
        ...
        pd_run.verify_filter_radio_group_is_optional(FILTER_CONTRTOL_NAME, 'Step 13.04 : Verify {0} filter radio group control is optional'.format(FILTER_CONTRTOL_NAME))
        ...
        pd_run.verify_html_report_data_set(DATA_SET_NAME1, 'Step 13.10 : Verify page runs successfully with "All" filter condition')
        pd_run.switch_to_default_page()
        pd_run.swtich_to_homepage_runwindow_frame()
        
        """
            STEP 14 : Select "North America" radio button.
        """
        FILTER_RADIOGROUP_OPTIONS_TO_SELECT = 'North America'
        pd_run.select_filter_radio_group_option(FILTER_CONTRTOL_NAME, FILTER_RADIOGROUP_OPTIONS_TO_SELECT)
        
        """
            STEP 14.1 : Verify selected condition applied in the page.
        """
        EXPECTED_SELECTED_OPTION_IN_FILTER_RADIOFROUP = [FILTER_RADIOGROUP_OPTIONS_TO_SELECT]
        pd_run.verify_selected_options_in_filter_radio_group(FILTER_CONTRTOL_NAME, EXPECTED_SELECTED_OPTION_IN_FILTER_RADIOFROUP, 'Step 14.01 : Verify {0} option selected in filter radio group'.format(EXPECTED_SELECTED_OPTION_IN_FILTER_RADIOFROUP))
        pd_run.verify_filter_radio_group_is_optional(FILTER_CONTRTOL_NAME, 'Step 14.02 : Verify solid red border over filter the control removed')
        pd_run.switch_to_container_frame(CONTAINER_ITEM)
        ...
        pd_run.verify_html_report_data_set(DATA_SET_NAME3, 'Step 14.03 : Verify selected condition applied in the page')
        pd_run.switch_to_default_page()
