...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5849046
Test Case Title =  Adding required static single-select drop down control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C5849046_TestClass(BaseTestCase):

    def test_C5849046(self):
