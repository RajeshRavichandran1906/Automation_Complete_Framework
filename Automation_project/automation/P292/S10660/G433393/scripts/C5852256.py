...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852256
...
class C5852256_TestClass(BaseTestCase):

    def test_C5852256(self):
