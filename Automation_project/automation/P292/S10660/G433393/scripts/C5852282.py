...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852282
Test Case Title =  Adding optional dynamic single-select button set control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C5852282_TestClass(BaseTestCase):

    def test_C5852282(self):
        ...
        #d_design.create_html_report_data_set(DATA_SET_NAME1)
        ...
        """
            STEP 12.1 : Verify page runs successfully with "All" condition.
        """
        ...
        pd_run.verify_html_report_data_set(DATA_SET_NAME1, 'Step 12.10 : Verify page runs successfully with "All" condition')
        pd_run.switch_to_default_page()
        pd_run.swtich_to_homepage_runwindow_frame()
        
        """
            STEP 13 : Select "North America" value in button set control.
        """
        pd_run.select_filter_buttonset_option(FILTER_CONTRTOL_NAME, FILTER_BUTTONSET_OPTIONS_TO_SELECT)
        
        """
            STEP 13.1 : Verify selected condition applied in the page.
        """
        EXPECTED_FILTER_BUTTONSET_SELECTED_OPTIONS=['North America']
        pd_run.verify_selected_options_in_filter_buttonset(FILTER_CONTRTOL_NAME, EXPECTED_FILTER_BUTTONSET_SELECTED_OPTIONS, 'Step 13.01 : Verify {0} option selected in filter button set'.format(EXPECTED_FILTER_BUTTONSET_SELECTED_OPTIONS))
        pd_run.switch_to_container_frame(CONTAINER_ITEM)
        ...
        pd_run.verify_html_report_data_set(DATA_SET_NAME2, 'Step 13.02 : Verify selected condition applied in the page')
        pd_run.switch_to_default_page()
