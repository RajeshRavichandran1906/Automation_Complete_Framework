...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852287
...
class C5852287_TestClass(BaseTestCase):

    def test_C5852287(self):
