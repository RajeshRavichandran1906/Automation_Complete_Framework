...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852269
...
class C5852269_TestClass(BaseTestCase):

    def test_C5852269(self):
        ...
        MULTI_FILTER_DROPDOWN_OPTIONS_TO_SELECT=['EMEA']
        ...
        pd_preview.verify_html_report_vertical_scrollbar_reached_bottom('Step 07.12 : Verify vertical scroll bar reached bottom of the report')
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 07.13 : Verify page loads successfully with "All" filter condition')
        pd_preview.switch_to_default_page()
       
        """
            STEP 08 : Select "EMEA" value in dropdown control.
        """
        ...
        """
        pd_preview.switch_to_container_frame(CONTAINER_ITEM)
        pd_preview.wait_for_number_of_element("table[summary]>tbody>tr", expected_number=9, time_out=LONG_TIME)
        #pd_preview.create_html_report_data_set(DATA_SET_NAME2)
        pd_preview.verify_html_report_data_set(DATA_SET_NAME2, 'Step 08.01 : Verify filter condition applied in the page.')
        pd_preview.switch_to_default_page()
        ...
        """
            STEP 11.1 : Verify page runs successfully.
        """
        ...
        pd_run.verify_html_report_data_set(DATA_SET_NAME1, 'Step 11.09 : Verify page runs successfully.')
