...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852357
Test Case Title =  Adding optional other static radio button control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C5852357_TestClass(BaseTestCase):

    def test_C5852357(self):
        ...
        """
            STEP 12 : Close and Save the Designer.
        """
        pd_design.close_and_save_page_with_default_name()
