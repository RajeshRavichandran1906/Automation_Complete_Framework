...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852356
...
class C5852356_TestClass(BaseTestCase):

    def test_C5852356(self):
        ...
        """
        pd_design.run_page_designer_in_new_window()
