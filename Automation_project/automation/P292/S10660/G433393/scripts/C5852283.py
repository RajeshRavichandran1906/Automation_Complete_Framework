...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852283
...
class C5852283_TestClass(BaseTestCase):

    def test_C5852283(self):
