...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852265
...
class C5852265_TestClass(BaseTestCase):

    def test_C5852265(self):
        ...
        pd_preview.verify_selected_filter_dropdown_options(FILTER_CONTRTOL_NAME, [DROPDOWN_OPTION_TO_SELECT], 'Step 09.02 : Verify {0} options are checked in filter drop down'.format(EXPECTED_SELECTED_FILTER_DROPDOWN_OPTIONS))
        ...
        pd_preview.scroll_down_html_report()
        pd_preview.verify_html_report_vertical_scrollbar_reached_bottom('Step 09.04 : Verify vertical scroll bar reached bottom of the report')
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 09.05 : Verify all values are available')
        pd_preview.switch_to_default_page()
