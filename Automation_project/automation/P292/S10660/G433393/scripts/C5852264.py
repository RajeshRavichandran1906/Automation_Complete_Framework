...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5852264
Test Case Title =  Adding required static multi-select dropdown control to the Page
-----------------------------------------------------------------------------------------------"""

from common.lib.basetestcase import BaseTestCase
from common.wftools import page_designer

class C5852264_TestClass(BaseTestCase):

    def test_C5852264(self):
        ...
        EXPECTED_CONTROL_TAB_PROPERTIES=['Optional=off', 'Placeholder text=Make a selection...', 'Search=off', 'Selection controls=off']
        ...
        pd_preview.verify_selected_value_of_filter_dropdown(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_FILTER_DROPDOWN_VALUE, 'Step 07.07 : Verify {0} text display in filter drop down'.format(EXPECTED_DEFAULT_FILTER_DROPDOWN_VALUE))
        ...
        """
        pd_preview.verify_filter_dropdown_is_optional(FILTER_CONTRTOL_NAME, 'Step 08.04 : Verify solid red border not available over the filter control')
        ...
        pd_preview.verify_html_report_data_set(DATA_SET_NAME1, 'Step 08.02 : Verify selected filter condition applied in the page')
        ...
        pd_run.verify_selected_value_of_filter_dropdown(FILTER_CONTRTOL_NAME, EXPECTED_DEFAULT_FILTER_DROPDOWN_VALUE, 'Step 11.05 : Verify {0} text display in filter drop down'.format(EXPECTED_DEFAULT_FILTER_DROPDOWN_VALUE))
        ...
        pd_run.verify_default_output_for_input_required_container(CONTAINER_ITEM, 'Step 11.09 : Verify report display in run page')
