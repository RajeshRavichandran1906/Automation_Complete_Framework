...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5832127
...
class C5832127_TestClass(BaseTestCase):

    def test_C5832127(self):
        ...
        pd_preview.verify_html_report_does_not_have_vertical_scrollbar('Step 10.09 : Verify container report does not have vertical scroll bar in run page')
        pd_preview.verify_html_report_does_not_have_horizontal_scrollbar('Step 10.10 : Verify container report does not have horizontal scroll bar in run page')
        pd_run.switch_to_default_page()
        pd_run.swtich_to_homepage_runwindow_frame()
        pd_preview.verify_default_output_for_input_required_container(CONTAINER_ITEM, 'Step 10.11 : Verify blank report display in run page', expected_output='')
