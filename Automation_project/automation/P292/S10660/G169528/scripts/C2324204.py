...
class C2324204_TestClass(BaseTestCase):

    def test_C2324204(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2324204'
        ...
        """
            Step 02 : Select Format tab > Chart Type > Other > Special > "Funnel chart"
        """
        
        ribbonobj.select_ribbon_item('Format', 'Other')
        ia_ribbonobj.select_other_chart_type('special', 'funnel', 6, ok_btn_click=True)
        ...
        utillobj.synchronize_with_number_of_element('#TableChart_1 [class*="riser!s1!g0!mriser!"]', 1, 90)
        ...
        utillobj.synchronize_with_number_of_element(path_css, 1, 190)
        ...
        """
        expected_tooltip=['Sale Year:2015', 'Cost of Goods:$202,610,814.00  (26.61%)']
        resultobj.verify_default_tooltip_values("jschart_HOLD_0","riser!s4!g0!mriser!",expected_tooltip, "Step 08:01 verify the default tooltip values")
        """
        ...
        """
            Step 11: Click Run and Hover on chart.
        """
        ribbonobj.select_top_toolbar_item('toolbar_run')
        time.sleep(5)
        utillobj.switch_to_frame(pause=2)
        ...
        """
        expected_tooltip=['Sale Year:2015', 'Revenue:$282,541,804.48  (26.62%)', 'Gross Profit:$79,930,990.48']
        resultobj.verify_default_tooltip_values("jschart_HOLD_0","riser!s4!g1!mriser!",expected_tooltip, "Step 11:09 Expect to see Revenue and Gross Profit added.")
        
        """
            Step 13 :Click Save in the toolbar > Save as "C2324204" > Click Save
        """
        utillobj.switch_to_default_content(pause=1)
        time.sleep(1)
        obj1=driver.find_element_by_css_selector("#resultArea")
        utillobj.take_screenshot(obj1,Test_Case_ID + '_Actual_step13', image_type='actual',x=1, y=1, w=-1, h=-1)
        ...
        """
            Step 14 :Step 14 : Logout using API
        ...
        """
            ...
            http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10660%2FC2324204.fex
        """
