...
class C2321275_TestClass(BaseTestCase):
    ...
    def test_C2321275(self):
        ...
        utillobj.synchronize_with_visble_text(yaxis_title_css, "DEALER_COST", 15)
        
        metadataobj.datatree_field_click('RETAIL_COST', 2, 1)
        utillobj.synchronize_with_number_of_element(number_of_riser_css, 20, 20)
       
        metadataobj.drag_drop_data_tree_items_to_query_tree_("LENGTH", 0,'Vertical Axis 2', 0)
        ...
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "riser!s3!g0!ay2!mbar!", expected_tooltip_list, "Step 04:11 Verify right top bar width for alfa romeo")
        ...
        metadataobj.verify_query_pane_field('Color BY', 'COUNTRY', 1, "Step 05:00: Verify Quantity,Sold is visible underneath Vertical Axis")
        ...
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "riser!s9!g0!ay2!mbar!", expected_tooltip_list, "Step 05:10 Verify top left bar width for alfa romeo")
        expected_tooltip_list=['CAR:ALFA ROMEO', 'WIDTH:188', 'COUNTRY:ITALY']
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "riser!s11!g0!ay2!mbar!", expected_tooltip_list, "Step 05:11 Verify top rightbar width for alfa romeo")
        
        """
            Verify width of the first riser bar
        """
        bmw_barobj_before=self.driver.find_element_by_css_selector("#jschart_HOLD_0 rect[class*='riser!s16!g2!ay2!mbar!']")
        ...
        resultobj.verify_default_tooltip_values("jschart_HOLD_0", "riser!s8!g0!ay2!mbar!", expected_tooltip_list, "Step 06:10 Verify leftbar width for alfa romeo")
        time.sleep(1)
        ...
        time.sleep(2)
        metadataobj.verify_query_pane_field('Tooltip', 'MPG', 1, "Step 07:00: Verify Quantity,Sold is visible underneath Vertical Axis")
...
#         utillobj.take_screenshot(obj1,Test_Case_ID + '_Actual_step07', image_type='actual',x=1, y=1, w=-1, h=-1)
        ...
        """
            Step 08:Click Save in the toolbar > Save as "C2321275" > Click Save
        """
        ...
        """
           Step 10 :  Restore the fex using API (edit the domain, port and alias of the URL - do not use the URL as is):
            http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10660%2FC2321275.fex
            Expect to see the regenerated 
            Vertical Dual-axis Stacked Bar Chart.
        """
        ...
        utillobj.verify_chart_color("jschart_HOLD_0", "riser!s8!g0!ay2!mbar!", "dark_green1", "Step 09:02: Verify first bar color")
        utillobj.verify_chart_color("jschart_HOLD_0", "riser!s9!g0!ay2!mbar!", "pale_yellow4", "Step 09:03: Verify second bar color")
        utillobj.verify_chart_color("jschart_HOLD_0", "riser!s10!g0!ay2!mbar!", "orange1", "Step 09:04: Verify third bar color")
        utillobj.verify_chart_color("jschart_HOLD_0", "riser!s11!g0!ay2!mbar!", "pale_brown", "Step 09:05: Verify four bar color")
        legends_item=['DEALER_COST : ENGLAND', 'RETAIL_COST : ENGLAND', 'LENGTH : ENGLAND', 'WIDTH : ENGLAND', 'DEALER_COST : FRANCE', 'RETAIL_COST : FRANCE', 'LENGTH : FRANCE', 'WIDTH : FRANCE', 'DEALER_COST : ITALY', 'RETAIL_COST : ITALY', 'LENGTH : ITALY', 'WIDTH : ITALY', 'DEALER_COST : JAPAN', 'RETAIL_COST : JAPAN', 'LENGTH : JAPAN', 'WIDTH : JAPAN', 'DEALER_COST : W GERMANY', 'RETAIL_COST : W GERMANY', 'LENGTH : W GERMANY', 'WIDTH : W GERMANY']
