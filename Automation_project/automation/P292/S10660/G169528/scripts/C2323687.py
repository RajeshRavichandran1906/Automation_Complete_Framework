...
class C2323687_TestClass(BaseTestCase):
    ...
    def test_C2323687(self):
        ...
        utillobj.synchronize_with_number_of_element(elem1, 1, 45)
        ...
        """
            Step 08: Click Save in the toolbar > Save as "C2323687" > Click Save
        """
        ...
        """
           Step 10 :Restore the fex using API (edit the domain, port and alias of the URL - do not use the URL as is):
            http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10660%2FC2323687.fex
        """
