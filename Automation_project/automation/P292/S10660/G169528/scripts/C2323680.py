...
class C2323680_TestClass(BaseTestCase):


    def test_C2323680(self):
        driver = self.driver #Driver reference object created
        
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2323680'
        ...
        utillobj.synchronize_with_number_of_element("#TableChart_1", 1, 60)
        ...
        """
            ...
            Vertical Dual-axis Absolute Line Chart Preview..
        """
        ...
        """
            ...
            Vertical Dual-axis Absolute Line Chart, now with the chart reflecting colors using the Color By bucket.
            Note that the Legend contains one entry for each of the 4 Measures.
            Also expect to see the Tool tip information for Retail_Cost. & Weight.
            Dealer_cost bar uses the left-side axis:
        """
        utillobj.switch_to_default_content(pause=1)
        metadataobj.datatree_field_click("SEATS",1,0,'Add To Query','Color')
        time.sleep(2)
        ...
        miscobj.select_or_verify_marker_tooltip('marker!s3!g0!mmarker!', verify_tooltip_list=expected_tooltip_list, msg="step 6.08", parent_css="#jschart_HOLD_0")
        expected_tooltip_list=['CAR:ALFA ROMEO', 'DEALER_COST:16,235', 'SALES:30200', 'SEATS:8']
       
        miscobj.select_or_verify_marker_tooltip('marker!s0!g0!mmarker!', verify_tooltip_list=expected_tooltip_list, msg="step 6.09", parent_css="#jschart_HOLD_0")
        ...
        exected_multicolor_list=['sandy_brown', 'sorbus1','elf_green','cinnabar3','crusta1','cinnabar3','persian_red','sorbus1','cinnabar3','persian_red']
        ia_resultarea_obj.verify_multicolor("#jschart_HOLD_0", "fill", exected_multicolor_list, "Step 07:07: Verify line colors")
         
        """
            Verification :
            Expect to see the following
            Vertical Dual-axis Absolute Line Chart, now with additional Tool tip information for MPG.
            Dealer_cost bar uses the left-side axis:
        """
        ...
        """
            Step 08: Click Save in the toolbar > Save as "C2323680" > Click Save
        """
        time.sleep(2)
        ...
        """
           Step 10 :Restore the fex using API (edit the domain, port and alias of the URL - do not use the URL as is):
            http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10660%2FC2323680.fex
