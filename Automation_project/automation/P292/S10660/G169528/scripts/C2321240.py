...
class C2321240_TestClass(BaseTestCase):
    ...
    def test_C2321240(self):
        ...
        """
        expected_tooltip_list=['CAR:JAGUAR', 'DEALER_COST:18,621', 'RETAIL_COST:22,369', 'FST COUNTRY:ENGLAND']
        ...
        """
            Step 07: Click Save in the toolbar > Save as "C2321240" > Click Save
        """
        ...
        """
            ...
            http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10660%2FC2321240.fex
