...
class C2323698_TestClass(BaseTestCase):
    ...
    def test_C2323698(self):
        ...
        miscobj.select_or_verify_marker_tooltip('marker!s0!g0!mmarker!', verify_tooltip_list=expected_tooltip_list, msg="step 04.09", parent_css="#jschart_HOLD_0")

        time.sleep(3)
        expected_tooltip_list=['CAR:ALFA ROMEO', 'WIDTH:188']
        miscobj.select_or_verify_marker_tooltip('marker!s3!g0!mmarker!', verify_tooltip_list=expected_tooltip_list, msg="step 4.10", parent_css="#jschart_HOLD_0")
        ...
        miscobj.select_or_verify_marker_tooltip('marker!s0!g0!mmarker!', verify_tooltip_list=expected_tooltip_list, msg="step 6.08", parent_css="#jschart_HOLD_0")
        time.sleep(3)
        ...
        """
            Step 08: Click Save in the toolbar > Save as "C2323698" > Click Save
        """
        ...
        """
           Step 10 :Restore the fex using API (edit the domain, port and alias of the URL - do not use the URL as is):
            http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10660%2FC2323698.fex
        """
