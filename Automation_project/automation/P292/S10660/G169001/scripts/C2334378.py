...
Test Case Link  =  http://172.19.2.180/testrail/index.php?/cases/view/2334378&group_by=cases:section_id&group_id=169001&group_order=asc
Test Case Title =  Create IBX Page with Grid 3-3-3 template
-----------------------------------------------------------------------------------------------"""
import unittest
...
class C2334378_TestClass(BaseTestCase):

    def test_C2334378(self):
        ...
        """
            STEP 4 : Choose the Grid 3-3-3 template.
        """
        pd_design.select_page_designer_template("Grid 3-3-3")
        pd_design.wait_for_visible_text(".pd-page-header", "Page")
        
        """
            STEP 4.1 : Verify the Content tab is highlighted and tree shows on the left.
        """
        ...
        """
            ...
            Verify content added into the Grid 3-3-3 template:
        """
        pd_design.verify_containers_title(['Blue', 'Gray', 'Green', 'Red', 'Panel 5', 'Panel 6', 'Panel 7', 'Panel 8', 'Panel 9'], "Step 6.5 : Verify content added into the Grid 3-3-3 template:")
