...
@author: BM13368
TestCase ID :http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/C5852525
...
class C5852525_TestClass(BaseTestCase):

    def test_C5852525(self):
        
        Test_Case_ID = "C5852525"
        driver = self.driver
        ...
        """
            ...
            Step 03:Select "Tag Cloud" chart type.
            Step 04:Click "OK".
        """
        ...
        """ 
            Step 06:Double click "LAST_NAME","CURR_SAL".
        """
        ...
        expected_text_list=['BANNING', 'CROSS', 'IRVING', 'SMITH', 'BLACKWOOD', 'ROMANS', 'JONES', 'MCCOY', 'MCKNIGHT', 'STEVENS', 'GREENSPAN']
        ia_resultarea_obj.verify_tagcloud_chart_text("#TableChart_1", expected_text_list, "Step 03:01: Verify the tag cloud text")
        ...
        """ 
            Step 10:Hover over "BANNING" and verify the tooltip displays "CURR_SAL" value.
        """
        ...
        time.sleep(2)     
        """ 
            Step 11:Click Save in the toolbar > Save as "C5852525" > Click Save
        """
        ...
        time.sleep(4)
        """ 
            Step 13:Run saved fex from bip using API
            http://domain:port/alias/run.bip?BIP_REQUEST_TYPE=BIP_RUN&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FS10032&BIP_item=C5852525.fex
        """
        ...
        """ 
            Step 15:Hover over "BANNING" and verify the tooltip displays "CURR_SAL" value.
        """ 
        expected_tooltip_list=['LAST_NAME:BANNING', 'CURR_SAL:$29,700.00']
        ...
        """ 
            Step 17:Restore the fex using API
            http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC5852525.fex
        """
