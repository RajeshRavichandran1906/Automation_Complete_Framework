...
#         time.sleep(1)
        ...
        """
            Step 15 : Run the chart from bip
            http://domain:port/alias/run.bip?BIP_REQUEST_TYPE=BIP_RUN&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FS10660&BIP_item=C2334509.fex
        """
        utillobj.active_run_fex_api_login(Test_Case_ID+".fex", "S10660_chart_2", 'mrid', 'mrpass')
        utillobj.synchronize_with_visble_text("#jschart_HOLD_0 text[class^='xaxis'][class$='title']", 'Product Subcategory', 65)
        ...
        """
            ...
            Expected to restored successfully
        """
        utillobj.infoassist_api_edit(Test_Case_ID, 'chart', 'S10660_chart_2', mrid='mrid', mrpass='mrpass')
        utillobj.synchronize_with_visble_text("#TableChart_1 text[class^='xaxis'][class$='title']", 'Product Subcategory', 65)
        ...
        """
        parent_css="#TableChart_1 text[class^='xaxis'][class$='title']"
        utillobj.synchronize_with_visble_text("#TableChart_1 text[class^='xaxis'][class$='title']", 'Product Subcategory', 35)
