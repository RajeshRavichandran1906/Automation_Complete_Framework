...
#         utillobj.infoassist_api_edit('a', 'chart', 'P292/S10032', mrid='mrid', mrpass='mrpass')
        ...
        utillobj.synchronize_with_number_of_element(element_css, 34, 90, 1)
        ...
        utillobj.synchronize_with_number_of_element(chart_type_css, 1, 50, 1)
...
#         ribbonobj._validate_page(elem1)
        ...
        utillobj.synchronize_with_number_of_element(streetmap_css, 18, 50, 1)
...
#         ribbonobj._validate_page(elem1)
        ...
        utillobj.synchronize_with_number_of_element(map_css, 18, 50, 1)
