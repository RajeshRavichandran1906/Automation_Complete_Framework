...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6668390
Test Case Title =  Verify Information Builders text logo functionality for Public User
-----------------------------------------------------------------------------------------------"""
...
class C6668390_TestClass(BaseTestCase):

    def test_C6668390(self):
        ...
        """
            STEP 01 : Sign into WebFOCUS Home Page as Public User by clicking the Public access Link.
        """
        wf_login.invoke_home_page_with_public_access()
        ...
        """
        utils.verify_picture_using_sikuli("collapse_logo_8202m.png", "Step 02.01 : Verify that it shows Information builders logo icon")
        ...
        """
        utils.verify_picture_using_sikuli("expanded_menu_icon_8202m.png", "Step 05.01 : Verify that it shows Information Builders text logo.")
        ...
        """       
        wf_home.signin_from_username_dropdown_menu()
