...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6668389
Test Case Title =  Verify Information Builders text logo functionality for Developers
-----------------------------------------------------------------------------------------------"""
...
class C6668389_TestClass(BaseTestCase):

    def test_C6668389(self):
