...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2510936
Test Case Title =  Verify Information Builders text logo functionality for Admin User
-----------------------------------------------------------------------------------------------"""
...
class C2510936_TestClass(BaseTestCase):

    def test_C2510936(self):
        ...
        """
        wf_login.invoke_home_page('mridgadmin', 'mrpassgadmin')
