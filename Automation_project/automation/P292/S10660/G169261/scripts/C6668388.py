...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/6668388
Test Case Title =  Verify Information Builders text logo functionality for Advanced User
-----------------------------------------------------------------------------------------------"""
...
class C6668388_TestClass(BaseTestCase):

    def test_C6668388(self):
