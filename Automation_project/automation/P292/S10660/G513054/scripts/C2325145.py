...
@author: varun
Testcase Name : Search Domains - upper case
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2325145
'''
...
class C2325145_TestClass(BaseTestCase):
    
    def test_C2325145(self):
        """
        Test_case variables
        """
