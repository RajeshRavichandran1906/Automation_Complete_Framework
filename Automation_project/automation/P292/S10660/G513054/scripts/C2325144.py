...
@author: varun
Testcase Name : Search Domains - lower case
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2325144
'''
...
class C2325144_TestClass(BaseTestCase):
    
    def test_C2325144(self):
        """
        Test_case variables
        """
