...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2325150
Test Case Title =  Search folder - lower case
-----------------------------------------------------------------------------------------------"""
...
class C2325150_TestClass(BaseTestCase):

    def test_C2325150(self):
        ...
        """
            STEP 07.01 : Verify two reports (Analytical Dashboard and Executive Dashboard) are removed from the content area
        """
        wf_home.verify_items_in_grid_view(['Analytical Dashboard', 'Executive Dashboard', 'Sales by Country and Product', 'Store and Product Profits Over Time'], 'as_List_equal', 'Step 07.01 : Verify two reports (Analytical Dashboard and Executive Dashboard) are removed from the content area')
