...
@author: varun
Testcase Name : Search for Favorite - mixed case
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/7279873
'''
...
class C7279873_TestClass(BaseTestCase):
    
    def test_C7279873(self):
        """
        Test_case variables
        """
        ...
        util_obj.synchronize_with_visble_text(locator_obj.content_area_css, portal_items[0], main_page_obj.home_page_long_timesleep)
