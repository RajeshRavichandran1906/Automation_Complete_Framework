...
@author: varun
Testcase Name : Search for Favorite - lower case
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2325158
'''
...
class C2325158_TestClass(BaseTestCase):
    
    def test_C2325158(self):
        """
        Test_case variables
        """
