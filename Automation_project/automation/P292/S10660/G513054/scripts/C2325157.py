...
@author: varun
Testcase Name : Search for portal - upper case
Testcase ID : http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2325157
'''
...
class C2325157_TestClass(BaseTestCase):
    
    def test_C2325157(self):
        """
        Test_case variables
        """
        ...
        main_page_obj.verify_items_in_grid_view(portal_items, 'asin', 'Step 3.1: Verify 2 Retail Samples are present')
