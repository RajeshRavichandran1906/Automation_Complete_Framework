...
class C2334455_TestClass(BaseTestCase):
    ...
    def test_C2334455(self):
        ...
        """
            ...
            http://domain:port/alias/run.bip?BIP_REQUEST_TYPE=BIP_LAUNCH&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FP292%252FS10660_chart_2%252F&BIP_item=C2334455a.fex
        """
        ...
        utillobj.synchronize_with_visble_text(parent_css, "COUNTRY", 65)
        ...
        """
            Step 02 : Logout from WebFOCUS BI Portal using the below API Link.
            http://domain.com:port/alias/service/wf_security_logout.jsp
        """
        utillobj.infoassist_api_logout()
        time.sleep(3)
        
        """
            Step 03 : Run the chart from bip
            http://domain:port/alias/run.bip?BIP_REQUEST_TYPE=BIP_LAUNCH&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FP292%252FS10660_chart_2%252F&BIP_item=C2334455b.fex 
        """
        utillobj.active_run_fex_api_login(Test_Case_ID1, "S10660_chart_2", 'mrid', 'mrpass')
        parent_css="#jschart_HOLD_0 text[class^='xaxis'][class$='title']"
        utillobj.synchronize_with_visble_text(parent_css, "Customer Business Region", 75)
