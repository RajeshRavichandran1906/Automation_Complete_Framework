...
Test Case Link  =  http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/2510940
Test Case Title =  Verify Open item location for Portals W/ admin user
-----------------------------------------------------------------------------------------------"""
...
class C2510940_TestClass(BaseTestCase):

    def test_C2510940(self):
