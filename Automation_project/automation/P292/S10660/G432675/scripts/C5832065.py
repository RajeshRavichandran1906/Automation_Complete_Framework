...
Test Case = http://lnxtestrail.ibi.com/testrail/index.php?/cases/view/5832065
...
class C5832065_TestClass(BaseTestCase):

    def test_C5832065(self):
        driver = self.driver #Driver reference object created
        
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C5832065'
        ...
        resultobj.wait_for_property(parent_css, 7, 30)
        ...
        parent_css= "#MAINTABLE_wbody1 svg g text[class*='zaxisOrdinal-labels']"
        resultobj.wait_for_property(parent_css, 3, 30)
        time.sleep(5)
        ...
        """
        parent_css= "#MAINTABLE_wbody1 svg g text[class*='zaxisOrdinal-labels']"
        resultobj.wait_for_property(parent_css, 4, 30)
        parent_css="#MAINTABLE_wbody1 svg g text[class*='colorScaleLegend-title']"
        resultobj.wait_for_property(parent_css, 1, 30)
        time.sleep(3)
        xaxis_value="Model"
        ...
        utillobj.take_screenshot(ele,'C5832065_Actual_step10', image_type='actual',x=1, y=1, w=-1, h=-1)
        ...
        """
        Step 11: Click "Save" > Save as "C5832065" > Click Save
        """
        time.sleep(2)
        ...
        http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10032%2FC5832065.fex
        """
