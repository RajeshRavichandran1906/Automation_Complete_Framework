...
class C2316722_TestClass(BaseTestCase):
    ...
    def test_C2316722(self):
        ...
        """
            Step 01 :Restore C2316722_base.fex using API (edit the domain, port and alias of the URL - do not use the URL as is):
            http://domain.com:port/alias/ia?&item=IBFS%3A%2FWFC%2FRepository%2FS10660%2FC2316722_base.fex
        """
        ...
        """
        metaobj.datatree_field_click("Dimensions->PRICE_DOLLARS_BIN_1", 1, 0, "Edit Bins...")
        ...
        """
            ...
            http://machine:port/alias/service/wf_security_logout.j
        """
        time.sleep(2)
