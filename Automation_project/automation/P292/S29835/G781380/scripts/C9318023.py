...
Test Case Link  =  http://172.19.2.180/testrail/index.php?/cases/view/9318023
...
class C9318023_TestClass(BaseTestCase):

    def test_C9318023(self):
        ...
        """
            STEP 05 : Drag "23 - Single Select Dynamic Optional" report into the page canvas from P292_S10660 > G433312 > Reference Items folder.
        """
        ...
        pd_preview.verify_filter_control_labels(EXPECTED_FILTER_CONTROLS, 'Step 09.04 : Verify filter controls display in preview')
        ...
        pd_run.verify_filter_control_labels(EXPECTED_FILTER_CONTROLS, 'Step 13.03 : Verify filter controls display in run page')
        ...
        """
        pd_design.delete_saved_page_designer('C9318023')
