...
Test Case : http://172.19.2.180/testrail/index.php?/cases/view/8777570
...
class C8777570_TestClass(BaseTestCase):

    def test_C8777570(self):
        """
            CLASS OBJECTS 
        """
        ...
        SAMPLE_DATA_FILE_NAME_1 =  "c8777570_step5"
        ...
        SAMPLE_DATA_FILE_NAME_2 = "c8777570_step6"
        ...
        SAMPLE_DATA_FILE_NAME_3  = "c8777570_step7"
        ...
        MULTIPLE_JOIN_SAMPLE_DATA = "c8777570_step9"
        ...
        designer_chart_obj.verify_number_of_risers(".risers rect", 5, 0,"Step 01:01 Verify the number of risiers in preview")
        ...
        joining_data_obj.canvas(['wf_retail_sales'],"c8777570_step2").verify_canvas_image("Step 02:03 Data canvas visible without error.")
        ...
        joining_data_obj.canvas(NODE_NAME_1,'c8777570_step5_01').verify_canvas_image("Step 05:01 Join 1 created without error.")
        ...
        joining_data_obj.configure().verify_configure_image("c8777570_step5_06.png","Step:05:06")
        ...
        joining_data_obj.canvas(NODE_NAME_2,'c8777570_step6_01').verify_canvas_image("Step 06:01 Join 2 created without error")
        ...
        joining_data_obj.configure().verify_configure_image("c8777570_step6_06.png","Step:06:06")
        ...
        """
        joining_data_obj.canvas(NODE_NAME_3,'c8777570_step7_01').verify_canvas_image("Step 07.01:Join 3 created without error.")
        ...
        joining_data_obj.configure().verify_configure_image("c8777570_step7_06.png","Step:07:06")
        ...
        joining_data_obj.canvas(NODE_NAME_1,'c8777570_step8_02').verify_canvas_image("Step 8:01 join canvas")
        ...
        """
        joining_data_obj.canvas(MULTIPLE_JOIN_NODES,'c8777570_step9_01').verify_canvas_image(" step 09:01 Joins created without error and the sample data frame was restored.")
        joining_data_obj.canvas(MULTIPLE_JOIN_NODES,'c8777570_step9_01').verify_node_available("09:02")
        ...
        joining_data_obj.configure().verify_configure_image("c8777570_step9_06","Step:09:06")
        ...
        """
        Step 13:Click Save and enter "C8777570" in Title and click Save button.
        """
        designer_chart_obj.save_designer_chart_from_toolbar("C8777570")
           
 
        """
        Step 14:Run the chart using API:
         
        http://machine:port/alias/run.bip?BIP_REQUEST_TYPE=BIP_LAUNCH&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FP292_S29835%252FG728361%252F&BIP_item=c8777570.fex.
         
        Chart runs successfully.
        """
        designer_chart_obj.api_logout()
        designer_chart_obj.run_designer_chart_using_api("c8777570")
        ...
        """
        Step 15:Restore saved C8777570 chart using API:
        
        http://domain:port/alias/designer?&item=IBFS%3A%2FWFC%2FRepository%2FP292_S29835%2FG728361%2Fc8777570.fex
        
        Chart restored without error and Product, Customer and Store folders available in both Dimensions and Measures Fields.
        """
        
        designer_chart_obj.api_logout()
        designer_chart_obj.invoke_designer_chart_in_edit_mode_using_api('c8777570')
        designer_chart_obj.wait_for_visible_text("text[class^='xaxis'][class$='title']",'Product Category',designer_chart_obj.chart_medium_timesleep)
        ...
        utils.verify_object_visible(".pop-top",False,"Step 02:01 Verify the data opens without any error")
        joining_data_obj.canvas(MULTIPLE_JOIN_NODES,'c8777570_step9_01').verify_canvas_image(" step 16:01 Joins created without error and the sample data frame was restored.")
        joining_data_obj.canvas(MULTIPLE_JOIN_NODES,'c8777570_step9_01').verify_node_available("16:02")
        ...
        joining_data_obj.canvas(['Join 2']).select_option_from_right_click("Delete")
        time.sleep(2)
        joining_data_obj.canvas(['Join 2'],'c8777570_step17_01').verify_canvas_image("Step 17:wf_retail_customer and its related wf_retail_geography nodes are deleted.")
        ...
        Select "C8777570" tab below the data prep canvas.
        """
        joining_data_obj.canvas().select_button_in_warning_dialog("Cancel")
        joining_data_obj.switch_to_default_content()
        designer_chart_obj.select_tab_button("C8777570")
        designer_chart_obj.wait_for_visible_text("text[class^='xaxis'][class$='title']",'Product Category',designer_chart_obj.chart_medium_timesleep)
        ...
        """
        Step 21:Select "C8777570" tab below the data prep canvas.
        ...
        """
        Step 22:Click Application menu and click Save as, enter "C8777570_1" in Title and click Save as.
        """
        
        designer_chart_obj.save_as_from_application_menu("C8777570_1")
     
        """
        Step 23:Run C8777570_1 chart using API:
        http://machine:port/alias/run.bip?BIP_REQUEST_TYPE=BIP_LAUNCH&BIP_folder=IBFS%253A%252FWFC%252FRepository%252FP292_S29835%252FG728361%252F&BIP_item=c8777570_1.fex.
        Chart runs successfully.
        """
        designer_chart_obj.api_logout()
        designer_chart_obj.run_designer_chart_using_api("c8777570_1")
        designer_chart_obj.wait_for_visible_text("text[class^='xaxis'][class$='title']",'Product Category',designer_chart_obj.chart_medium_timesleep)
        ...
        designer_chart_obj.verify_number_of_risers("#jschart_HOLD_0 rect", 4, 7,msg="Step:23.06")
        
        
        """
        Step 24:Restore saved C8777570_1 chart using API:
        http://domain:port/alias/designer?&item=IBFS%3A%2FWFC%2FRepository%2FP292_S29835%2FG728361%2Fc8777570_1.fex
        Chart restored without error and Product node available in both Dimensions and Measures Fields.
        """
        
        designer_chart_obj.api_logout()
        designer_chart_obj.invoke_designer_chart_in_edit_mode_using_api('c8777570_1')
        designer_chart_obj.wait_for_visible_text("text[class^='xaxis'][class$='title']",'Product Category',designer_chart_obj.chart_medium_timesleep)
        ...
        designer_chart_obj.verify_number_of_risers("rect", 4, 7, msg="Step:24:03")
