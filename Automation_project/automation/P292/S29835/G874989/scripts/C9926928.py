...
class C9926928_TestClass(BaseTestCase):

    def test_C9926928(self):
        ...
        """
        alert_process = Thread(target = enter_to_accept_alert)
        alert_process.start()
        alert_process.join()
        time.sleep(25)
        core_utils.switch_to_new_window()
        ...
        Step16 = """
            STEP 16 : Close the new window with "Product Sales Analysis" HTML.
        """
        ...
        Step17 = """
            STEP 17 : Return back to designer using blue arrow in preview.
        """
        pd_run.go_back_to_design_from_preview()
        utils.capture_screenshot("17.01", Step17)
        
        Step18 = """
            STEP 18 : Click "Save" in toolbar Enter "C6349658" and Click "Save" button.
        """ 
        pd_design.save_page_from_toolbar("C6349658")
        utils.capture_screenshot("18.01", Step18)
        
        Step19 = """
            STEP 19 : Click the Application menu and Select "Close".
        """
        pd_design.close_page_designer_from_application_menu()
        core_utils.switch_to_previous_window(window_close = False)
        utils.capture_screenshot("19.01", Step19)
        
        Step20 = """
            STEP 20 : Double click on "C6349658" page and Click on Link tile widget.
        """
        ...
        chart.switch_to_default_content()
        utils.capture_screenshot("21.01", Step21, expected_image_verify = True)
        
        Step22 = """
            STEP 22 : Close the new window with "Product Sales Analysis" HTML.
        """
        core_utils.switch_to_previous_window(window_close = True)
        chart.switch_to_frame(frame_css = "iframe[class='ibx-iframe-frame'][src*='c6349658']")
        pd_design.wait_for_visible_text("div.pd-page-title", "Page")
