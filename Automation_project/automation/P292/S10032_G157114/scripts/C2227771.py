...
class C2227771_TestClass(BaseTestCase):
    ...
    def test_C2227771(self):
        ...
        #utillobj.create_data_set('ITableData0','I0r','C2227771_Ds01.xlsx')
        ...
        '''    '5. Click dropdown next to Category column and select Export > XML (Excel) > Filtered only.    '''
        ...
        time.sleep(15)
        utillobj.save_as_excel_sheet(Test_Case_ID+"_Step5_actual.xlsx")
        time.sleep(15)
        utillobj.verify_excel_files(Test_Case_ID+"_Step5_base.xlsx", 'Sheet1', Test_Case_ID+"_Step5_actual.xlsx", 'Sheet1', 34, 6, 'Step 5. Verify Excel content after filtering', tool='openpyxl')
