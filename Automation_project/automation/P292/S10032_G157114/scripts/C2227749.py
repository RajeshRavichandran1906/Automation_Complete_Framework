...
class C2227749_TestClass(BaseTestCase):

    def test_C2227749(self):
...
#         utillobj.create_data_set('ITableData0','I0r','C2227749_Ds01.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227749_Ds01.xlsx', 'Step 03.2:Verify the report is generated.')
        time.sleep(4)
...
#         utillobj.create_data_set('ITableData0','I0r','C2227749_Ds02.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227749_Ds02.xlsx', 'Step 04.2:Verify the report is generated.')
        time.sleep(4)
