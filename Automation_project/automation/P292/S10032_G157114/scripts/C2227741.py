...
class C2227741_TestClass(BaseTestCase):
    ...
    def test_C2227741(self):
        ...
        resobj.verify_yaxis_title("MAINTABLE_wbody0", "Unit Sales", "Step 03.6: Verify yaxis title")
        expected_tooltip_list=['Category:Food', 'Product:Croissant', 'Unit Sales:630054', 'Filter Chart', 'Exclude from Chart']
        resobj.verify_default_tooltip_values("MAINTABLE_wbody0_f", "riser!s0!g4!mbar!r0!c1!", expected_tooltip_list, "Step 03.7: Verify bar value")
        ...
        resobj.verify_visualization_row_column_header_labels("MAINTABLE_wbody0", "Columns", "Category",expected_label,"Step 03.11: Verify visualization column header lables")       
        ...
        elem1=driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class='riser!s0!g5!mbar!r0!c0!']")
        source_elem=utillobj.enable_marker_using_javascript(elem1)
        elem2=driver.find_element_by_css_selector("#MAINTABLE_wbody0 [class='riser!s0!g6!mbar!r0!c0!']")
        ...
        time.sleep(2)
        resobj.select_default_tooltip_menu("MAINTABLE_wbody0","riser!s0!g1!mbar!r0!c0!",  'Remove Filter',default_move=True)
        time.sleep(5)
        ...
        resobj.verify_yaxis_title("MAINTABLE_wbody0", "Unit Sales", "Step 07.6: Verify yaxis title")
        expected_tooltip_list=['Category:Food', 'Product:Croissant', 'Unit Sales:630054', 'Filter Chart', 'Exclude from Chart']
        resobj.verify_default_tooltip_values("MAINTABLE_wbody0_f", "riser!s0!g4!mbar!r0!c1!", expected_tooltip_list, "Step 07.7: Verify bar value")
        ...
        expected_label=['Coffee','Food','Gifts']
        resobj.verify_visualization_row_column_header_labels("MAINTABLE_wbody0", "Columns", "Category",expected_label,"Step 07.11: Verify visualization column header lables")       
        ...
        time.sleep(3)
        utillobj.drag_drop_on_screen(sx_offset=source_elem['x']-20,sy_offset=source_elem['y']+20,tx_offset=target_elem['x']+20,ty_offset=target_elem['y']-20)
        resobj.select_or_verify_lasso_filter(verify=['2 points','Filter Chart','Exclude from Chart'],msg='Step 08.1:Verify these menu items appear on the chart')
        time.sleep(3)
        ...
        resobj.verify_yaxis_title("MAINTABLE_wbody0", "Unit Sales", "Step 09.6: Verify yaxis title")
        ...
        utillobj.verify_object_visible("#MAINTABLE_0 .arChartMenuBar div[title][onclick*='Filter']", True, 'Step 09.10: Filter Button Visible')
        ...
        expected_tooltip_list=['Category:Food', 'Product:Croissant', 'Unit Sales:630054', 'Filter Chart', 'Exclude from Chart']
        resobj.verify_default_tooltip_values("MAINTABLE_wbody0_f", "riser!s0!g4!mbar!r0!c1!", expected_tooltip_list, "Step 11.7: Verify bar value")
        ...
        expected_label=['Coffee','Food','Gifts']
        resobj.verify_visualization_row_column_header_labels("MAINTABLE_wbody0", "Columns", "Category",expected_label,"Step 11.11: Verify visualization column header lables")       
