...
class C2227774_TestClass(BaseTestCase):
    ...
    def test_C2227774(self):
        ...
        """
        document_obj.invoke_document_using_api("new_retail/wf_retail_lite", mrid='autodevuser01', mrpass='')
        ...
        utillobj.synchronize_with_number_of_element("#ITableData1", 1, 30, 1)
