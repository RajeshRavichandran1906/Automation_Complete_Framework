...
class C2511582_TestClass(BaseTestCase):

    def test_C2511582(self):
        ...
        expected_tooltip_list=['Gifts', 'State:44', '41.1% of 107']
        resultobj.verify_default_tooltip_values('wall1', 'riser!s2!g0!mwedge!', expected_tooltip_list, 'Step 06.10: verify the default tooltip values')
        time.sleep(2)
