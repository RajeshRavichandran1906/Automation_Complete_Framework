...
class C2511578_TestClass(BaseTestCase):

    def test_C2511578(self):
        ...
        utillobj.verify_data_set('ITableData0','I0r',Test_Case_ID+'_Ds02.xlsx', 'Step 04.4: Verify that report containing 9 records, first Filtered for State = "IL"')
#         utillobj.create_data_set('ITableData0','I0r','C2227789_Ds02.xlsx')
        ...
        utillobj.verify_data_set('ITableData0','I0r',Test_Case_ID+'_Ds03.xlsx', 'Step 06.2: Verify that report now with 8 records, as Espresso has been removed from the list of Products for State = "IL".')
#         utillobj.create_data_set('ITableData0','I0r','C2227789_Ds03.xlsx')
        ...
        utillobj.verify_data_set('ITableData0','I0r',Test_Case_ID+'_Ds04.xlsx', 'Step 07.2: Verify that report 30 records, all with Category Equal to "Coffee"')
#         utillobj.create_data_set('ITableData0','I0r','C2227789_Ds04.xlsx')
        ...
        utillobj.verify_data_set('ITableData0','I0r',Test_Case_ID+'_Ds05.xlsx', 'Step 09.2: Verify that 41 records, all with Category Equal to "Coffee" or with Product value of "Scone"')
