...
class C2227787_TestClass(BaseTestCase):

    def test_C2227787(self):
...
#         utillobj.create_data_set('ITableData0','I0r','C2227787_Ds01.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227787_Ds01.xlsx', 'Step 04.4: Verify that report returns 29 of 107 records')
        time.sleep(4)
...
#         utillobj.create_data_set('ITableData0','I0r','C2227787_Ds02.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227787_Ds02.xlsx', 'Step 06.4: Verify that report returns 55 of 107 records, all Less Than 15905.')
        time.sleep(4)
...
#         utillobj.create_data_set('ITableData0','I0r','C2227787_Ds03.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227787_Ds03.xlsx', 'Step 08.4: Verify that report returns 22 of 107 records, Both Biscotti and Croissant contain the string "is"')
        time.sleep(4)
...
#         utillobj.create_data_set('ITableData0','I0r','C2227787_Ds04.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227787_Ds04.xlsx', 'Step 13.4: Verify that report returns 22 of 107 records, Both Biscotti and Croissant contain the string "is"')
        time.sleep(4)
...
#         utillobj.create_data_set('ITableData0','I0r','C2227787_Ds06.xlsx')
        utillobj.verify_data_set('ITableData0','I0r','C2227787_Ds06.xlsx', 'Step 16.2: Verify that report returns 96 of 107 records. Only records that have exact value "C141" are Omitted.')
        time.sleep(4)
