...
from common.pages import visualization_resultarea, active_miscelaneous, active_tools,active_chart_rollup
from common.lib import utillity
from common.wftools import active_report

class C2227780_TestClass(BaseTestCase):

    def test_C2227780(self):
        
        """
            TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227780'
        ...
        resultobj.wait_for_property("#wall1 .arWindowBarTitle>span",1,8,string_value='Chart/Rollup Tool') 
       
        
        """
            Step 03.2 : Expect to see the following Active Report with the Chart/Rollup Tool activated.
        """ 
        miscelanousobj.verify_popup_appears('wall1','Chart/Rollup Tool', 'Step 03.3 : Verify Active Report with the Chart/Rollup Tool activated')
        ...
        time.sleep(3)
        resultobj.wait_for_property("#wbody2_ft div",1,8,string_value='Unit Sales BY Category')
        ...
        miscelanousobj.verify_active_chart_tooltip('wbody2_f', 'riser!s0!g1!mbar!', ['Unit Sales: 1.4M', 'X: Food'], 'Step 05.6 : Verify chart tooltip')
        ...
        screenshot_element=self.driver.find_element_by_id('wall2')
        ...
        resultobj.wait_for_property("#wbody2_ft div",1,5,string_value='Unit Sales, Dollar Sales BY Category')
        ...
        miscelanousobj.verify_active_chart_tooltip('wbody2_f', 'riser!s1!g1!mbar!', ['Dollar Sales: 17.2M', 'X: Food'], 'Step 06.8 : Verify chart tooltip')
        ...
        resultobj.wait_for_property("#wbody2_ft div",1,5,string_value='Unit Sales, Dollar Sales BY Category, Product ID') 
        ...
        miscelanousobj.verify_active_chart_tooltip('wbody2_f', 'riser!s1!g1!mbar!', ['Dollar Sales: 10.9M', 'X: Coffee/C142'], 'Step 07.8 : Verify chart tooltip')
        ...
        screenshot_element=self.driver.find_element_by_id('wall2')
        utillobj.take_screenshot(screenshot_element,Test_Case_ID+'_Actual_Step_07','actual')
        ...
        self.driver.execute_script("arguments[0].scrollIntoView(true);", top)
        time.sleep(3)
        resultobj.wait_for_property("#wbody2_ft div",1,8,string_value='Dollar Sales BY Category')
        ...
        miscelanousobj.verify_active_chart_tooltip('wbody2_f', 'riser!s0!g0!mwedge!', ['Coffee', 'Dollar Sales: 17.2M' ,'37.3% of 46.2M'], 'Step 09.9 : Verify chart tooltip')
        ...
        resultobj.wait_for_property("#wbody2_ft div",1,5,string_value='Dollar Sales BY Category, Product') 
        ...
        miscelanousobj.verify_active_chart_tooltip('wbody2_f', 'riser!s2!g0!mwedge!', ['Coffee/Latte', 'Dollar Sales: 10.9M' ,'23.7% of 46.2M'], 'Step 10.9 : Verify chart tooltip')
        ...
        screenshot_element=self.driver.find_element_by_id('wall2')
        utillobj.take_screenshot(screenshot_element,Test_Case_ID+'_Actual_Step_10','actual')
        ...
        miscelanousobj.verify_active_chart_tooltip('wbody2_f', 'riser!s2!g0!mwedge!', ['Coffee/Latte', 'Dollar Sales: 10.9M' ,'23.7% of 46.2M'], 'Step 11.12 : Verify chart tooltip')
        miscelanousobj.verify_active_chart_tooltip('wbody2_f', 'riser!s2!g1!mwedge!', ['Coffee/Latte', 'Unit Sales: 878K' ,'23.8% of 3.7M'], 'Step 11.13 : Verify chart tooltip')
