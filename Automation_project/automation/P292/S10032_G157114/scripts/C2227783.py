...
TestCase ID : http://lnxtestrail.ibi.com/testrail//index.php?/cases/view/2227783
...
class C2227783_TestClass(BaseTestCase):

    def test_C2227783(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227783'
