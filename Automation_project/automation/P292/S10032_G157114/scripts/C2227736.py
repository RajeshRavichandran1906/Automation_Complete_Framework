...
class C2227736_TestClass(BaseTestCase):

    def test_C2227736(self):
        """
        TESTCASE VARIABLES
        """
        Test_Case_ID = 'C2227736'
        ...
        active_reportobj.run_active_report_using_api(fex_name,column_css="#IWindowBody0 span[title='Move to Top'] img", synchronize_visible_element_text='Category')
