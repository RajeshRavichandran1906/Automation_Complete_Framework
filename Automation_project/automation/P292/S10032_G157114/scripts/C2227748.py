...
class C2227748_TestClass(BaseTestCase):

    def test_C2227748(self):
        
        """
            TESTCASE VARIABLES
        """
        
        Test_Case_ID='C2227748'
        ...
        """
        active_reportobj.run_active_report_using_api(fex_name, column_css="#MAINTABLE_wbody0_ft tbody", synchronize_visible_element_text='DEALER_COST,RETAIL_COSTBYCOUNTRY')
        """
