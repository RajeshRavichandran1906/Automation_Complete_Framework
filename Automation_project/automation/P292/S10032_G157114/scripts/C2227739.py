...
class C2227739_TestClass(BaseTestCase):

    def test_C2227739(self):
        ...
        miscelaneous_obj.verify_column_heading('ITableData0', expected_list,'Step 05r.1: Verify column heading')
        miscelaneous_obj.verify_page_summary(0, '107of107records,Page1of2', "Step 05r.2:  107of107records,Page1of2 Active Report. - page summary verification")
        utillobj.verify_data_set('ITableData0', 'I0r',report_dataset_name+".xlsx", "Step 05r.3: AHTML_OFF_001.fex data verification")   
        ...
        miscelaneous_obj.verify_menu_items("ITableData0",0, None,expected_menu_list, 'Step 05r.4:  Verify all the report menu options are present on a report')
        
        miscelaneous_obj.verify_chart_title("MAINTABLE_wbody1_ft","Sequence# BY Category, Product", "Step 05c.1 : Verify chart title ")
        ...
        resobj.verify_riser_chart_XY_labels("MAINTABLE_wbody1", expected_xval_list, expected_yval1_list, "Step 05c.2: Verify XY labels")
        resobj.verify_number_of_riser("MAINTABLE_wbody1", 1, 10, 'Step 05c.3: Verify the total number of risers displayed on preview')
        ...
        resobj.verify_yaxis_title("MAINTABLE_wbody1", "Sequence#", "Step 05c.6: Verify yaxis title")
        expected_tooltip_list=['Category:Food', 'Product:Croissant', 'Sequence#:1481273', 'Filter Chart', 'Exclude from Chart']
        resobj.verify_default_tooltip_values("MAINTABLE_wbody1_f", "riser!s0!g4!mbar!r0!c1!", expected_tooltip_list, "Step 05c.7: Verify bar value")
        miscelaneous_obj.verify_arChartToolbar('MAINTABLE_wmenu1', ['More Options','Advanced Chart','Original Chart'],"Step 05c.8: Verify Chart toolbar")
        miscelaneous_obj.verify_arChartToolbar('MAINTABLE_wmenu1', ['Aggregation'],"Step 05c.9: Verify Chart toolbar", custom_css='.arChartMenuBarContainer .tabPagingText1 td[title]')
        miscelaneous_obj.verify_arChartToolbar('MAINTABLE_wmenu1', ['Sum'],"Step 05c.10: Verify Chart toolbar", custom_css=".arChartMenuBarContainer [id*='SUM']", text=True)
        expected_label=['Coffee','Food','Gifts']
        resobj.verify_visualization_row_column_header_labels("MAINTABLE_wbody1", "Columns", "Category",expected_label,"Step 05c.11: Verify visualization column header lables")       
