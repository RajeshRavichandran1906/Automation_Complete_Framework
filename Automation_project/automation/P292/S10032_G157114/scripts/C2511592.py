...
class C2511592_TestClass(BaseTestCase):

    def test_C2511592(self):
...
#         utillobj.create_pivot_data_set('piv1', 'C2227732_Ds02.xlsx')
        utillobj.verify_pivot_data_set('piv1', Test_Case_ID+'_Ds02.xlsx','Step 04.2: Verify pivot data')
