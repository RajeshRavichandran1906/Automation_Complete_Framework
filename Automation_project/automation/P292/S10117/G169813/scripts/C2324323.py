...
class C2324323_TestClass(BaseTestCase):
    ...
    def test_C2324323(self):
        ...
        """ Step 12: Click on the Page refresh testing page
        """
        portal_canvas.select_page_in_navigation_bar('Page refresh testing')
        
        """ Step 13: Uncheck the Show refresh box
        """
        time.sleep(2)
        portal_properties.edit_input_control('page', 'Show Refresh', 'checkbox', checkbox_input='uncheck', msg="Step 13:")
        
        """ Step 14: Save and exit the portal
        """
        portal_ribbon.select_tool_menu_item('menu_Save')
        portal_ribbon.select_tool_menu_item('menu_Exit')
        core_utillobj.switch_to_previous_window(window_close=False)
        ...
        """ Step 16: Right Click on the page tab
        ...
        try:
            ...
            status_ = True
        utillobj.asequal(True, status_, "Step 16: Verify that refresh does not show.")
        
        """ Step 17: Right click on the other base pages
                     Verify that refresh does show for the other pages.
        """
        portal_canvas.verify_page_menu('Page 1', ['Refresh'], 'Step 17: Verify that refresh shows')
        
        """ Step 18: Check the menus for the new page added in run time
                     Change title, page layout, delete and refresh
        """
        portal_canvas.verify_page_menu('Page refresh testing1', ['Change Title', 'Page Layout', 'Refresh', 'Delete'], 'Step 18: Verify that Page menu option Change title, page layout, delete and refresh.')
        
        """ Step 19: Close the portal
        """
        portal_run.select_or_verify_portal_menu_bar_item(select='Close')
