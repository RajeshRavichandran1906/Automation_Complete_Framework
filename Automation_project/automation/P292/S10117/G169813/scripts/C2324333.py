...
from common.pages import vfour_portal_canvas, wf_legacymainpage, ia_resultarea, vfour_portal_properties, vfour_portal_run, vfour_portal_ribbon, vfour_miscelaneous
...
class C2324333_TestClass(BaseTestCase):
    ...
    def test_C2324333(self):
        ...
        """ Step 21: Navigate URL to http://environment_name:port/alias/legacyhome
        """
        utillobj.navigate_to_legacyhomepage()
        utillobj.synchronize_with_visble_text(welcome_page_parent_css, workspace, 190)
        
        """ Step 22: Expand 'P292_S10117_G169813' domain , right click on S10117 folder > Right click on Comments and publish the portal
        """
        wf_mainpageobj.select_menu(BIP_Portal_Path+'->'+portal_name, 'Publish')
         
        """ Step 23: Edit the comments portal.
        ...
        core_utilobj.switch_to_new_window()
        utillobj.synchronize_with_number_of_element(edit_page_parent_css, 1, 50)
        portal_canvas.verify_page_in_navigation_bar('Page 1', "Step 23: Verify 'Page 1' in Navigation bar.")
        time.sleep(2)
        portal_canvas.verify_comment_section_location('Top', "Step 23.1: Verify Comment Section is Displayed on Top of the page.")
        portal_canvas.verify_comments_section_text("Step 23.2: Verify the Comment panel still appears on the top with your comment.", 'This is a test for a Page')
        portal_ribbon.invoke_and_verify_wf_resource_tree()
          
        """ Step 24: Drag IA_Chart1 into Panel 1
        """
        portal_canvas.dragdrop_repository_item_to_canvas(BIP_Portal_Path+'->IA_Chart1', 'panel', 'Panel 1')
        time.sleep(2)
        verify_panel_frame_data('Panel_1', 5, '24')
          
        """ Step 25: Click panel 1 and check the comments box in the properties section if not checked already.
        ...
        """ Step 26: Click on the down arrow on IA_Chart1's title bar to bring down the menu options
        """
        """ Step 27: Select Show Comments
                     Verify a Comment panel appears in the IA_Chart1 panel
        """
        select_show_comment_from_panel_menu()
        time.sleep(2)
        portal_canvas.verify_comment_section_location('Bottom', "Step 27: Verify Comment Section is Displayed on Bottom of the IA_Chart1 panel.", comment_section_exist_in='panel', panel_name='IA_Chart1')
        portal_canvas.verify_comments_section_text("Step 27.1: Verify a Comment panel appears in the IA_Chart1 panel.", comment_section_exist_in='panel', panel_name='IA_Chart1')
         
        """ Step 28: Add a comment This is a test for a panel
