...
from common.pages import vfour_miscelaneous, vfour_portal_canvas, vfour_portal_ribbon, wf_legacymainpage
...
class C2324215_TestClass(BaseTestCase):
    ...
    def test_C2324215(self):
        ...
        """
        wf_mainpageobj.select_repository_menu(proj_id+'->'+suite_id+'->BIP_V4_Portal->BIP_xxx_Portal123_V4', 'Edit')
        run_loop = True
        count_time=0
        while run_loop:
            if count_time == 25:
