...
class C2324322_TestClass(BaseTestCase):
    ...
    def test_C2324322(self):
        ...
        time.sleep(3)
        verify_panel_frame_data('legend', 'Panel_1', ['Product Category', 'Accessories', 'Camcorder', 'Computers', 'Media Player', 'Stereo Systems', 'Televisions', 'Video Production'], '04.00')
#         verify_panel_frame_data('legend', 'Panel_3', ['EMEA', 'North America', 'Oceania', 'South America'], '4.1')
        verify_panel_frame_data('riser', 'Panel_3', 16, '04.02')
        ...
        utillobj.asequal('850', str(int(column2_widht)), "Step 05.00: Verify Column 2 width change to 850 and that column got bigger.")
        
        """ Step 6: Check the Lock Width box
        """
        portal_properties.edit_input_control('column', 'Lock Width', 'checkbox', checkbox_input='check', msg='Step 05.01')
        ...
        verify_coumn_panel_title(2, ['Regional Sales Trend'], '07.01')
        verify_coumn_panel_title(3, ['Discount by Region'], '07.02')
        ...
        """
        verify_panel_frame_data('legend', 'Panel_1', ['Product Category', 'Accessories', 'Camcorder', 'Computers', 'Media Player', 'Stereo Systems', 'Televisions', 'Video Production'], '08.00')
#         verify_panel_frame_data('legend', 'Panel_2', ['EMEA', 'North America', 'Oceania', 'South America'], '8.1')
        verify_panel_frame_data('riser', 'Panel_3', 16, '08.02')
        time.sleep(1)
        driver.set_window_size(860, 560)
        elem = portal_canvas.get_current_page()
        utillobj.take_screenshot(elem, 'C2324321_Actual_Step_8')
        width_br = self.driver.execute_script("return document.documentElement.scrollWidth")
        if int(width_br) in range(839, 890):
            status = True
        else:
            status = False
        utillobj.asequal(True, status, "Step 08.01: Verify that you see a horizontal scroll bar at the bottom of the browser.")
