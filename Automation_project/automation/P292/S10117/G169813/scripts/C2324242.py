...
from common.pages import vfour_portal_ribbon, vfour_portal_canvas, vfour_portal_run,wf_legacymainpage
...
class C2324242_TestClass(BaseTestCase):
    ...
    def test_C2324242(self):
        ...
        element_css = "#applicationButtonBox img[src*='bip_button']"
        ...
        """ Step 10: Close portal and In the banner link, click on the top right username > Click Sign Out.
        """
