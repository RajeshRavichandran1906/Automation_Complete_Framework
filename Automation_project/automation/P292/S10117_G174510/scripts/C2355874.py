...
class C2355874_TestClass(BaseTestCase):
    ...
    def test_C2355874(self):
        ...
        driver.implicitly_wait(5) #Intializing common implicit wait for throughout the test
        ...
        resultobj.wait_for_property(parent_css, 1, 20)
        time.sleep(3)
        ...
        text_input_css = driver.find_element_by_css_selector("[id='editIBI_TEXT_GENERATION_SERVER_URL'][class='bi-text-field text-field']")
        ...
        """
        utillobj.infoassist_api_login('chart','new_retail/wf_retail','P292/S10117_chart_visual_1', 'mrid', 'mrpass')
        time.sleep(4)
        parent_css= "#TableChart_1 svg rect[class^='riser']"
        resultobj.wait_for_property(parent_css, 25, expire_time=15)
