...
Development Date : 26-Sep-2018

Test Suite = http://lnxtestrail.ibi.com/testrail/index.php?/runs/view/77756&group_by=cases:section_id&group_order=asc
Test Case = http://172.19.2.180/testrail/index.php?/cases/view/6777463
...
class C6777463_TestClass(BaseTestCase):
    def test_C6777463(self):
        driver = self.driver
        utillobj = utillity.UtillityMethods(self.driver)
        Test_Case_ID = "C6777463"
        ...
        xaxis_value="Store Business Region : Product Category"
        yaxis_value="Revenue"
        resultobj.verify_xaxis_title("jschart_HOLD_0", xaxis_value, "Step 3d(i): Verify X-Axis Title", custom_css="text[class*='colHeader-label!']")
        ...
        resultobj.verify_number_of_riser('jschart_HOLD_0', 1, 8, "Step 04b: Verify bo of bars")
        resultobj.verify_xaxis_title('jschart_HOLD_0', "Store Business Sub Region : Product Category", "Step 04c: verify X axis title", custom_css="text[class*='colHeader-label!']")
        ...
        resultobj.verify_xaxis_title('jschart_HOLD_0', "Store Business Sub Region : Product Category", "Step 05c: verify X axis title", custom_css="text[class*='colHeader-label!']")
        ...
        resultobj.verify_xaxis_title('jschart_HOLD_0', "Store Business Sub Region : Product Subcategory", "Step 06c: verify X axis title", custom_css="text[class*='colHeader-label!']")
        ...
        """    7. Click IA > Save As > Type C6777463a > click Save    """
        ...
        """    9. Open saved fex: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS9970%2FC6777463a.fex&tool=Chart    """
        ...
        """    16. Click IA > Save As > Type C6777463b > click Save    """
        ribbonobj.select_tool_menu_item('menu_save_as')
        utillobj.ibfs_save_as(Test_Case_ID+"b")
        utillobj.synchronize_with_number_of_element("#runButton img", 1, 15)
        
        """    17. Open saved fex: http://machine:port/ibi_apps/ia?item=IBFS%3A%2FWFC%2FRepository%2FS9970%2F6777463a.fex&tool=Chart    """
        utillobj.infoassist_api_logout()
