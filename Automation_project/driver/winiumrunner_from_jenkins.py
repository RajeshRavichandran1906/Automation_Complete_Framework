...
suiteDir=root+'/'+seleniumDir+group

if release == "8201m" or release == "8201":
    aspath='D:/'+confid+'/'+release+'/ibi/AppStudio82_'+release+'/bin/Focshell.exe'
else:
    aspath='D:/'+confid+'/'+release+'/ibi/AppStudio82_'+release+'/bin/AppStudio.exe'
...
if os.path.isfile(aspath):
    ...
    print(aspath + "cannot be located")
    exit()
...
shutil.copy(root+'/qa/selenium/driver/singlerunner.py', root+'/qa/selenium/'+'/'+group+'/')
