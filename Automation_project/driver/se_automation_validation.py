...
passing_result_comment="[" + author_credit + "] has modified a case promoted from " + status_to_test + " to " +  status_to_assign + " by the automation infrastructure."
        ...
        for name in glob.glob(suiteDir+'/results/*'+test+'*.xml'):
            ...
            if fail == '0' and err == '0': 
                try:         
                    ...
                    failing_details = "Attempt to modify case and test results failed due to API error. " + str(e)
