...
class Testrail_Utils(object):
    
    '''
    Constructor function
    '''
    def __init__(self,sleep_time=MIN_SLEEP_TIME,upper_limit=MIN_LOOP_COUNT,config_file='testrail_config.ini'):
        '''
        Private variables
        '''
    ...
    def post(self, cmd, data_dictionary):
        response_from_testrail = None
#         print('cmd : ',cmd)
