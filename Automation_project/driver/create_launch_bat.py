...
for line_dict in line_info:
    ...
    if str(line_dict[asconf_key]) != None:
        ...
        msg = launch_cmd + conf + br + project + suite + subsection + runid + plan_id + runner_grp + asconf + launch_key_suffix
    else:
...
for info in output_info:
    line = info + '\n'
    print("*******************line_by_line_from_output_info****************************")
    print("")
    print(line)
    print("")
    print("*******************line_by_line_from_output_info****************************")
