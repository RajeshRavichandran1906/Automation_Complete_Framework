...
rel = {'8105m': '2', '8106': '3', 'head': '4', '8200': '5', 'headcont': '6', '8106cont': '7', '8200m': '8', '8201': '9', '8201cont': '10', '8201m': '11', '8202': '14'}
conf = {'bue1':'55','bue2':'56','wf1':'57','wf2':'82','wf3':'65','as1':'58','507':'31','500':'28','580':'64', 'wf4':'66','wf5':'67','623':'78','as8':'80'}
...
R = {'ie': '2', 'cr': '29', 'ff': '12','eg':'22'}
browser=R[browser]
release=rel[release]

for test in tests:
    try:
      subprocess.call('C:/Sikuli/runsikulix.cmd -r '+suiteDir+'/'+test+'.sikuli')
    except OSError:
      print (test+' testrun causing error')
      continue
    for name in glob.glob(suiteDir+'/reports/*'+test+'*.xml'):
