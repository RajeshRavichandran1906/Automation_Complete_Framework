...
class UpdateChrome:
    ...
    def update(self):
        ...
        for machine_name, credential in machines.items():
            ...
            try:
                win32wnet.WNetAddConnection2(0, None, machine_c_path, None, user_name, password)
    ...
    def _get_application_path(self):
        ...
        win32wnet.WNetAddConnection2(0, None, shared_location_path, None, user_name, password)
    ...
    def _write_info_log(self, msg): print("[INFO]  : " + msg)
        
    def _write_error_log(self, msg): print("[ERROR] : " + msg)
        
    def _get_machines(self):
        """
        Description : Return the machines and credential as list
        """
        machines_config_file = "runnerbox.config"
