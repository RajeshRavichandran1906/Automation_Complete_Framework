...
if browser=='ie':
    for zone in range(1,5):
        subprocess.Popen('REG ADD HKCU\\Software\\Microsoft\\Windows\\CurrentVersion\\Internet" "Settings\\Zones\\'+str(zone)+' /v 2500 /t REG_DWORD /d 0 /f', stdout=subprocess.PIPE)
