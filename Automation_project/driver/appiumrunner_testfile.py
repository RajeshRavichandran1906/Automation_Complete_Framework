...
TestResult=resultDir+'/test_results.txt'
#open(TestResult,'w').close()
#ruunig tests
os.chdir(suiteDir)
os.system('open -a Terminal /usr/local/bin/appium')
# os.chdir(driverDir)
# subprocess.call('/Library/Frameworks/Python.framework/Versions/3.5/bin/python3 Mobile_Setup.py '+suite,shell=True)
# os.chdir(suiteDir)
time.sleep(60)
