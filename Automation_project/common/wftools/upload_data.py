from common.pages import upload_data
...
class ContentTree(BasePage):
    ...
    def __init__(self, driver):
        ...
        self._content_tree = upload_data.ContentTree(self.driver)
...
class ToolBar(BasePage):
    ...
    def __init__(self, driver):
        ...
        self._toobar = upload_data.ToolBar(self.driver)
...
class UploadData(ContentTree, ToolBar):
    
    def __init__(self, driver):
        
        super(UploadData, self).__init__(driver)